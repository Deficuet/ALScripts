...
function var_0_0.execute(arg_1_0, arg_1_1)
	...
	pg.ConnectionMgr.GetInstance():Send(11202, var_1_2, 11203, function(arg_6_0)
		if arg_6_0.result == 0 then
			local var_6_0 = IslandDropHelper.AddItems({
				drop_list = arg_6_0.award_list
			})
			local var_6_1 = getProxy(ActivityProxy):getActivityById(var_1_0.activity_id)
			local var_6_2 = {}

			switch(var_1_0.op, {
				set_list = function()
					var_6_1:SetList(var_1_0.list)
				end,
				do_draw = function()
					var_6_2 = underscore.to_array(arg_6_0.number)

					var_6_1:ResultDraw(var_6_2)
				end,
				count_award = function()
					var_6_2 = {
						var_1_0.target_id
					...
					var_6_1:CountAward(var_1_0.target_id)
				end
			}, function()
				assert(false, "error draw award activity cmd:" .. var_1_0.op)
			end)
			getProxy(ActivityProxy):updateActivity(var_6_1)
