return {
	...
	scripts = {
		...
		},
		{
			...
			actorName = "ナビィ",
			nameColor = "#A9F548FF",
			say = "ポンコツ{tb}ったら、こんなあざといやつとよく出会うわね",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
		...
		},
		{
			...
			nameColor = "#A9F548FF",
			hidePaintObj = true,
			say = "っと。{tb}、本当に餌に食いついちゃダメよ。あんたのために言ってるんだから",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			}
