...
var_0_0.Battle.BattleBuffPointAirStrike = class("BattleBuffPointAirStrike", var_0_0.Battle.BattleBuffEffect)
var_0_0.Battle.BattleBuffPointAirStrike.__name = "BattleBuffPointAirStrike"

local var_0_1 = var_0_0.Battle.BattleBuffPointAirStrike
...
function var_0_1.addManualWeapon(arg_4_0, arg_4_1)
