...
function var_0_0.InitUpdateStrategy(arg_3_0, arg_3_1)
	...
	if arg_3_1 == var_0_2 then
		var_3_0 = CourtYardFollowInteraction.New(arg_3_0)
	elseif arg_3_1 == var_0_3 then
		var_3_0 = CourtYardMonglineInteraction.New(arg_3_0)
	elseif arg_3_1 == var_0_4 then
		var_3_0 = CourtYardVariedInteraction.New(arg_3_0)
	else
		var_3_0 = CourtYardInteraction.New(arg_3_0)
	end
...
function var_0_0.SetAnimators(arg_4_0, arg_4_1)
	...
	local var_4_1 = var_4_0[arg_4_0.id] or var_4_0[1] or {}
	local var_4_2 = type(var_4_1) == "string" and {
		var_4_1
	} or var_4_1
...
function var_0_0.GetSubstituteAction(arg_8_0, arg_8_1, arg_8_2)
	...
	return var_8_1 and var_8_1.replace or arg_8_1
end
...
local function var_0_5(arg_15_0)
	...
	for iter_15_0, iter_15_1 in ipairs(arg_15_0.variedActions) do
		local var_15_5 = iter_15_1[math.random(1, #iter_15_1)]

		table.insert(var_15_0, var_15_5)
...
local function var_0_6(arg_16_0)
	...
	for iter_16_0, iter_16_1 in ipairs(arg_16_0.actions) do
		...
		local var_16_7 = arg_16_0:GetOwnerSubstituteAction(var_16_6)

		table.insert(var_16_1, var_16_7)

		local var_16_8 = arg_16_0:GetUserSubstituteAction(var_16_5 or var_16_6)

		table.insert(var_16_2, var_16_8)
