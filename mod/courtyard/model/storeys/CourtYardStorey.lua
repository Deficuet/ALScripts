...
function var_0_0.RefreshCombineFruniture(arg_16_0, arg_16_1)
	local var_16_0 = pg.furniture_data_template[arg_16_1]
	local var_16_1 = {
		arg_16_1
	}

	if type(var_16_0.spine_combine_action_replace) == "table" then
		for iter_16_0, iter_16_1 in pairs(var_16_0.spine_combine_action_replace) do
	...
	for iter_16_4, iter_16_5 in pairs(arg_16_0.furnitures) do
		if table.contains(var_16_1, iter_16_5.configId) then
...
function var_0_0.AddChildFurniture(arg_18_0, arg_18_1, arg_18_2)
	...
	local var_18_0 = arg_18_0.furnitures[arg_18_2]

	arg_18_0:DispatchEvent(CourtYardEvent.CHILD_ITEM, arg_18_1, var_18_0)
...
function var_0_0.GetPlaceableArea(arg_21_0, arg_21_1)
	return arg_21_1:HasParent() and arg_21_1:GetParent():GetPlaceableArea() or arg_21_0
end
...
function var_0_0.ExitShip(arg_23_0, arg_23_1)
	local var_23_0 = arg_23_0.ships[arg_23_1]

	if var_23_0 then
		arg_23_0:RemoveShip(var_23_0)
	end
end
...
function var_0_0.ReadyMoveShip(arg_25_0, arg_25_1)
	...
	if CourtYardCalcUtil.HalfProbability() then
		if var_25_0:HasParent() and var_25_0:GetParent():IsType(Furniture.TYPE_ARCH) then
			var_25_1 = arg_25_0:ShipExitArch(var_25_0)
		else
			var_25_2 = arg_25_0:ShipEnterArch(var_25_0)
...
function var_0_0.ShipAddFollower(arg_26_0, arg_26_1)
	...
	local function var_26_1(arg_27_0)
		return _.detect(var_26_0, function(arg_28_0)
			...
			return _.any(var_28_0, function(arg_29_0)
	...
	for iter_26_0, iter_26_1 in ipairs(arg_26_1:GetAroundPositions()) do
		...
		if var_26_3 and var_26_3:CanFollower(arg_26_1) then
			var_26_2()
			arg_26_0:RemoveItemAndRefresh(var_26_3)
			var_26_3:GetInteractionSlot():Occupy(var_26_3, arg_26_1, arg_26_0)
...
function var_0_0.ShipEnterArch(arg_32_0, arg_32_1)
	...
	for iter_32_0, iter_32_1 in ipairs(arg_32_1:GetAroundPositions()) do
		local var_32_1 = arg_32_0:GetParentForItem(arg_32_1, iter_32_1)
...
function var_0_0.RandomNextShipPosition(arg_34_0, arg_34_1)
	...
	local var_34_2 = var_34_1:GetNextPositionForMove(var_34_0)

	if not var_34_2 then
		var_34_0:ChangeState(CourtYardShip.STATE_IDLE)

		return
	end

	var_34_1:LockPosition(var_34_2)
	var_34_0:Move(var_34_2)
end
...
function var_0_0.DragShip(arg_36_0, arg_36_1)
	...
	arg_36_0:GetPlaceableArea(var_36_0):_ClearLockPosition(var_36_0)
	...
	local var_36_4 = arg_36_0:AreaWithInfo(var_36_0, var_36_1, var_36_0:GetOffset())

	var_36_0:UpdateOpFlag(true)
	arg_36_0:DispatchEvent(CourtYardEvent.SELETED_ITEM, var_36_0, var_36_4)
...
function var_0_0.DragingShip(arg_37_0, arg_37_1, arg_37_2)
	...
	local var_37_3 = var_37_1 and var_37_1:RawGetOffset() or var_37_0:GetOffset()
	local var_37_4 = arg_37_0:AreaWithInfo(var_37_0, arg_37_2, var_37_3, var_37_2 or var_37_1)

	arg_37_0:DispatchEvent(CourtYardEvent.DRAGING_ITEM, var_37_0, var_37_4, arg_37_2, var_37_3)
end

function var_0_0.DragShipEnd(arg_38_0, arg_38_1, arg_38_2)
	local var_38_0 = arg_38_0.ships[arg_38_1]

	if not var_38_0:GetOpFlag() then
		return
	end
...
function var_0_0.TouchShip(arg_40_0, arg_40_1)
	...
	arg_40_0:GetPlaceableArea(var_40_0):_ClearLockPosition(var_40_0)
	var_40_0:ChangeState(CourtYardShip.STATE_TOUCH)
end
...
function var_0_0.UpdateShipIntimacy(arg_41_0, arg_41_1, arg_41_2)
	...
	var_41_0:ChangeInimacy(arg_41_2)
end
...
function var_0_0.ClearShipIntimacy(arg_43_0, arg_43_1, arg_43_2)
	...
	var_43_0:ClearInimacy(arg_43_2)
end
...
function var_0_0.ClearShipCoin(arg_44_0, arg_44_1)
	...
	arg_44_0:GetPlaceableArea(var_44_0):_ClearLockPosition(var_44_0)
	var_44_0:ClearCoin(value)
end
...
function var_0_0.ShipAnimtionFinish(arg_46_0, arg_46_1, arg_46_2)
	...
	if arg_46_2 == CourtYardShip.STATE_TOUCH or arg_46_2 == CourtYardShip.STATE_GETAWARD then
		var_46_0:ChangeState(CourtYardShip.STATE_IDLE)
	elseif arg_46_2 == CourtYardShip.STATE_INTERACT then
		local var_46_1 = var_46_0:GetInterActionData()

		if var_46_1 then
			var_46_1:Continue(var_46_0)
		end
	end
end
...
function var_0_0.ResetShip(arg_47_0, arg_47_1, arg_47_2)
	...
	if arg_47_0:LegalPosition(arg_47_2, arg_47_1) then
		...
		local var_47_1 = arg_47_0:GetRandomPosition(arg_47_1)
...
function var_0_0.SelectFurniture(arg_49_0, arg_49_1)
	...
	local var_49_2 = var_49_0:GetPosition()
	local var_49_3 = arg_49_0:AreaWithInfo(var_49_0, var_49_2, var_49_0:GetOffset(), true)

	var_49_0:UpdateOpFlag(true)
	arg_49_0:DispatchEvent(CourtYardEvent.SELETED_ITEM, var_49_0, var_49_3)
end

function var_0_0.ClickFurniture(arg_51_0, arg_51_1)
	local var_51_0 = arg_51_0.furnitures[arg_51_1]

	if var_51_0:HasDescription() then
		arg_51_0:DispatchEvent(CourtYardEvent.SHOW_FURNITURE_DESC, var_51_0)
	elseif var_51_0:CanTouch() then
		if var_51_0:GetTouchBg() then
			arg_51_0:CheckFurnitureTouchBG(var_51_0)
		end

		if not var_51_0:IsTouchState() then
			var_51_0:ChangeState(CourtYardFurniture.STATE_TOUCH)
			arg_51_0:DispatchEvent(CourtYardEvent.ON_TOUCH_ITEM, var_51_0)
		else
			var_51_0:ChangeState(CourtYardFurniture.STATE_IDLE)
			arg_51_0:DispatchEvent(CourtYardEvent.ON_CANCEL_TOUCH_ITEM, var_51_0)
		end
	end
end
...
function var_0_0.PlayMusicalInstruments(arg_53_0, arg_53_1)
	...
	arg_53_0:MuteAll()
	arg_53_0:DispatchEvent(CourtYardEvent.FURNITURE_PLAY_MUSICALINSTRUMENTS, var_53_0)
end

function var_0_0.StopPlayMusicalInstruments(arg_54_0, arg_54_1)
	local var_54_0 = arg_54_0.furnitures[arg_54_1]

	arg_54_0:DispatchEvent(CourtYardEvent.FURNITURE_STOP_PLAY_MUSICALINSTRUMENTS, var_54_0)
end

function var_0_0.PlayFurnitureVoice(arg_55_0, arg_55_1)
	local var_55_0 = arg_55_0.furnitures[arg_55_1]
	local var_55_1 = _.select(var_55_0.musicDatas, function(arg_56_0)
		return arg_56_0.voiceType == 1
	end)

	if #var_55_1 > 0 then
		local var_55_2 = var_55_1[math.random(1, #var_55_1)]

		arg_55_0:DispatchEvent(CourtYardEvent.ON_ITEM_PLAY_MUSIC, var_55_2.voice, var_55_2.voiceType)
	end
end

function var_0_0.PlayFurnitureBg(arg_57_0, arg_57_1)
	local var_57_0 = arg_57_0.furnitures[arg_57_1]
	local var_57_1 = arg_57_0:StopPrevFurnitureVoice()

	if var_57_1 and var_57_1.id == var_57_0.id then
		return
	end

	var_57_0:ChangeState(CourtYardFurniture.STATE_PLAY_MUSIC)

	local var_57_2 = var_57_0:GetMusicData()

	if var_57_2 then
		arg_57_0:DispatchEvent(CourtYardEvent.ON_ITEM_PLAY_MUSIC, var_57_2.voice, var_57_2.voiceType)
	end
end
...
function var_0_0.FurnitureAnimtionFinish(arg_60_0, arg_60_1, arg_60_2)
	...
	if arg_60_2 == CourtYardFurniture.STATE_TOUCH then
		var_60_0:ChangeState(CourtYardFurniture.STATE_IDLE)
	elseif arg_60_2 == CourtYardFurniture.STATE_INTERACT then
		local var_60_1 = var_60_0:GetUsingSlots()

		_.each(var_60_1, function(arg_61_0)
			arg_61_0:Continue(var_60_0)
		end)
	elseif arg_60_2 == CourtYardFurniture.STATE_TOUCH_PREPARE then
		var_60_0:_ChangeState(CourtYardFurniture.STATE_TOUCH)
	end
end
...
function var_0_0.DragingFurniture(arg_63_0, arg_63_1, arg_63_2)
	...
	if not var_63_0:GetOpFlag() then
		return
	end
...
function var_0_0.DragFurnitureEnd(arg_67_0, arg_67_1, arg_67_2)
	...
	if not var_67_0:GetOpFlag() then
		return
	end
...
function var_0_0.UnSelectFurniture(arg_71_0, arg_71_1)
	...
	if not var_71_0:GetOpFlag() then
		return
	end

	var_71_0:UpdateOpFlag(false)
	arg_71_0:DispatchEvent(CourtYardEvent.UNSELETED_ITEM, var_71_0)
end

function var_0_0.RotateFurniture(arg_72_0, arg_72_1)
	local var_72_0 = arg_72_0.furnitures[arg_72_1]

	if var_72_0:DisableRotation() then
		arg_72_0:DispatchEvent(CourtYardEvent.DISABLE_ROTATE_ITEM)
	elseif not arg_72_0:CanRotateItem(var_72_0) then
		...
		local var_72_2 = arg_72_0:AreaWithInfo(var_72_0, var_72_0:GetPosition(), var_72_0:GetOffset())

		if not var_72_1 then
			arg_72_0:AddItem(var_72_0)
		end

		arg_72_0:DispatchEvent(CourtYardEvent.ROTATE_ITEM, var_72_0, var_72_2)
	end
end

function var_0_0.RemoveFurniture(arg_73_0, arg_73_1)
	local var_73_0 = arg_73_0.furnitures[arg_73_1]
	local var_73_1 = var_73_0:HasParent()

	if var_73_1 then
		var_73_0:GetParent():RemoveChild(var_73_0)
	end

	local var_73_2 = var_73_0.childs or {}
	...
	if not var_73_1 then
		arg_73_0:RemoveItem(var_73_0)
	end

	local var_73_3 = var_73_0:GetMusicData()

	if var_73_3 then
		arg_73_0:DispatchEvent(CourtYardEvent.ON_ITEM_STOP_MUSIC, var_73_3.voice, var_73_3.voiceType)
		var_73_0:ChangeState(CourtYardFurniture.STATE_STOP_MUSIC)
	end

	arg_73_0:UnSelectFurniture(arg_73_1)

	local var_73_4 = var_73_0.configId

	arg_73_0.furnitures[arg_73_1]:Dispose()

	arg_73_0.furnitures[arg_73_1] = nil

	arg_73_0:DispatchEvent(CourtYardEvent.DETORY_ITEM, var_73_0)
	arg_73_0.composeChecker:Check()
	arg_73_0:RefreshCombineFruniture(var_73_4)
end
...
function var_0_0.ReadyMoveFurniture(arg_77_0, arg_77_1)
	...
	local var_77_1 = arg_77_0:GetNextPositionForMove(var_77_0)
	...
	if var_77_0:IsDifferentDirection(var_77_1) and arg_77_0:CanRotateItem(var_77_0) then
		arg_77_0:RotateFurniture(arg_77_1)
	end

	var_77_0:Move(var_77_1)
	arg_77_0:RemoveItem(var_77_0)
	var_77_0:SetPosition(var_77_1)
...
function var_0_0.ExitEditMode(arg_80_0)
	for iter_80_0, iter_80_1 in pairs(arg_80_0.ships) do
		if iter_80_1:ShouldResetPosition() then
			...
			arg_80_0:ResetShip(iter_80_1, var_80_0)
		end
	end
	...
	local var_80_1 = _.detect(_.values(arg_80_0.furnitures), function(arg_81_0)
		return arg_81_0:GetOpFlag()
	end)

	if var_80_1 then
		arg_80_0:UnSelectFurniture(var_80_1.id)
	end
...
function var_0_0.StartInteraction(arg_86_0, arg_86_1)
	...
	if isa(var_86_1, CourtYardFurniture) and var_86_1:GetInterActionBgm() then
	...
	arg_86_0:DispatchEvent(CourtYardEvent.ITEM_INTERACTION, var_86_0, var_86_1, arg_86_1)
end
...
function var_0_0.WillClearInteraction(arg_87_0, arg_87_1, arg_87_2)
	...
	arg_87_0:DispatchEvent(CourtYardEvent.CLEAR_ITEM_INTERACTION, var_87_0, var_87_1, arg_87_1)
end
...
function var_0_0.ClearInteractionForTransPort(arg_90_0, arg_90_1, arg_90_2, arg_90_3)
	if arg_90_3:IsFirstTime() then
		local var_90_0 = arg_90_0:GetFurnituresByType(Furniture.TYPE_TRANSPORT)
		local var_90_1 = _.select(var_90_0, function(arg_91_0)
			return arg_91_0.id ~= arg_90_2.id
		end)
		local var_90_2 = var_90_1[math.random(1, #var_90_1)]

		if var_90_2 and var_90_2:CanInterAction(arg_90_1) then
			var_90_2:GetInteractionSlot():Link(var_90_2, arg_90_1, arg_90_0)
		else
...
function var_0_0.ToTable(arg_96_0)
	...
	if arg_96_0.wallPaper then
		var_96_1(arg_96_0.wallPaper:ToTable())
	end

	if arg_96_0.floorPaper then
		var_96_1(arg_96_0.floorPaper:ToTable())
	end
