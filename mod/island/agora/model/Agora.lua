...
function var_0_0.PlaceItem(arg_23_0, arg_23_1, arg_23_2, arg_23_3, arg_23_4)
	...
	var_23_0:UpdatePosition(arg_23_2)
	var_23_0:UpdateRotation(arg_23_3)
	arg_23_0:AddItem(var_23_0)
	arg_23_0:DispatchEvent(ISLAND_AGORA_EVT.GEN_ITEM, var_23_0, arg_23_4)
	arg_23_0:AddVirtualInteractUnitData(arg_23_1, var_23_0)
end
...
function var_0_0.UnPlaceItem(arg_24_0, arg_24_1)
	...
	arg_24_0:DispatchEvent(ISLAND_AGORA_EVT.REMOVE_ITEM, var_24_0)
end
...
function var_0_0.PlaceTile(arg_30_0, arg_30_1, arg_30_2, arg_30_3)
	...
	arg_30_0:DispatchEvent(ISLAND_AGORA_EVT.FILL_TILE_CELL, var_30_0)
end
...
function var_0_0.PlaceFloor(arg_34_0, arg_34_1, arg_34_2, arg_34_3)
	...
	arg_34_0:DispatchEvent(ISLAND_AGORA_EVT.FILL_FLOOR_CELL, var_34_0)
end
...
function var_0_0.AddVirtualInteractUnitData(arg_36_0, arg_36_1, arg_36_2)
	if arg_36_2:CanInteraction() then
		for iter_36_0, iter_36_1 in ipairs(arg_36_2:GetInteractionPoints()) do
			...
			local var_36_3 = AgoraCalc.GetAreaCenterPos(arg_36_2:GetArea()) + Vector3(unpack(var_36_1.offset)) * Quaternion.Euler(0, var_36_2.y, 0) + IslandConst.AGORA_POSITION_OFFSET
			...
			arg_36_0.virtualInteractUnitData[var_36_0] = var_36_4

			arg_36_2:AddListener(ISLAND_AGORA_EVT.ITEM_POSITION_UPDATE, function(arg_37_0, arg_37_1)
				local var_37_0 = AgoraCalc.GetAreaCenterPos(arg_37_1)
				local var_37_1 = Vector3(unpack(var_36_1.offset)) * Quaternion.Euler(0, arg_36_2:GetRotation().y, 0)

				arg_36_0:DispatchEvent(ISLAND_EVT.RESET_UNIT_POS, var_36_4.id, IslandConst.UNIT_LIST_OBJ, var_37_0 + var_37_1 + IslandConst.AGORA_POSITION_OFFSET)
			end)
			arg_36_2:AddListener(ISLAND_AGORA_EVT.ITEM_DIR_UPDATE, function(arg_38_0, arg_38_1)
				arg_36_0:DispatchEvent(ISLAND_EVT.RESET_UNIT_ROT, var_36_4.id, IslandConst.UNIT_LIST_OBJ, arg_38_1)
			end)
			arg_36_0:DispatchEvent(ISLAND_EVT.GEN_UNIT, var_36_4)
		end
	end
end
