...
function var_0_0.GetNeighborPoints(arg_17_0)
	...
	local var_17_2 = var_17_0.y
	local var_17_3 = var_17_0.z
	local var_17_4 = var_17_0.w

	return {
		arg_17_0.position + Vector2(0, var_17_2 + 1),
		arg_17_0.position + Vector2(0, var_17_4 - 1),
		arg_17_0.position + Vector2(var_17_1 - 1, 0),
		arg_17_0.position + Vector2(var_17_3 + 1, 0)
	}
end
