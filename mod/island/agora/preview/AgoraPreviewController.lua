...
function var_0_0.CreateAgora(arg_7_0, arg_7_1)
	...
	for iter_7_0, iter_7_1 in ipairs({
		...
		for iter_7_2 = 1, iter_7_1.count do
			local var_7_3 = AgoraCalc.GetUniqueId(iter_7_1.id, iter_7_2)
			local var_7_4 = AgoraFurniture.New({
				id = var_7_3,
				configId = iter_7_1.id
			})

			var_7_2[var_7_4.id] = var_7_4
		end
	end

	local var_7_5 = var_7_0:GetLevel()
	local var_7_6 = math.clamp(var_7_5, 1, #IslandConst.AGORA_LEVEL_2_SIZE)
	local var_7_7 = IslandConst.AGORA_LEVEL_2_SIZE[var_7_6]
	local var_7_8 = var_7_0:GetCapacity()

	return Agora.New({
		size = Vector2(var_7_7, var_7_7),
		placeableList = var_7_2,
		capacity = var_7_8,
		themes = {},
		systemThemes = {}
	}), {
