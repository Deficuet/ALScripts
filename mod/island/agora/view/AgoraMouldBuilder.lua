local var_0_0 = class("AgoraMouldBuilder", import("Mod.Island.Core.Builder.IslandItemInteractBuilder"))
...
function var_0_0.Build(arg_2_0, arg_2_1, arg_2_2)
	...
	seriesAsync({
		...
		function(arg_6_0)
			arg_2_0:LoadTimeline(var_2_0, var_2_1, arg_2_1, arg_6_0)
		end
	}, function()
...
function var_0_0.SetupBT(arg_8_0, arg_8_1, arg_8_2, arg_8_3)
	...
	ResourceMgr.Inst:getAssetAsync(arg_8_2, "", typeof(NodeCanvas.BehaviourTrees.BehaviourTree), UnityEngine.Events.UnityAction_UnityEngine_Object(function(arg_9_0)
		assert(arg_9_0, arg_8_2)
...
function var_0_0.GetModule(arg_10_0, arg_10_1, arg_10_2)
	return AgoraFurnitrueMould.New(arg_10_0.view, arg_10_1, arg_10_2)
end

function var_0_0.Load(arg_11_0, arg_11_1, arg_11_2)
	arg_11_0:GetPoolMgr():GetAgoraObj(arg_11_1:GetResPath(), arg_11_2)
end

function var_0_0.Recycle(arg_12_0, arg_12_1, arg_12_2)
	if arg_12_2 then
		arg_12_0:GetPoolMgr():ReturnAgoraObj(arg_12_1:GetResPath(), arg_12_2)
	end
end

function var_0_0.RecycleRoot(arg_13_0, arg_13_1)
	arg_13_0:GetPoolMgr():ReturnAgoraRoot(arg_13_1)
end
