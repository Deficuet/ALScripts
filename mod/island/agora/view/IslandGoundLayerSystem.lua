...
function var_0_0.FillFloorCell(arg_3_0, arg_3_1)
	...
	local var_3_1 = arg_3_1:GetShapeId()
	local var_3_2 = arg_3_0:ItemID2TextureId(arg_3_1)
	local var_3_3 = IslandConst.AGORA_LAYER_FLOOR

	arg_3_0.floorTileRenderer:SetTexture(var_3_3, var_3_2, var_3_1, var_3_0.x, var_3_0.y)
end

function var_0_0.ClearFloorCell(arg_4_0, arg_4_1)
	local var_4_0 = IslandConst.AGORA_LAYER_FLOOR
	local var_4_1 = arg_4_0.data:MapPoint2GroundPoint(arg_4_1)

	arg_4_0.floorTileRenderer:RemoveTexture(var_4_0, var_4_1.x, var_4_1.y)
end

function var_0_0.FillTileCell(arg_5_0, arg_5_1)
	local var_5_0 = arg_5_0.data:MapPoint2GroundPoint(arg_5_1:GetPosition())
	local var_5_1 = arg_5_1:GetShapeId()
	local var_5_2 = arg_5_0:ItemID2TextureId(arg_5_1)
	local var_5_3 = IslandConst.AGORA_LAYER_TILE

	arg_5_0.floorTileRenderer:SetTexture(var_5_3, var_5_2, var_5_1, var_5_0.x, var_5_0.y)
end

function var_0_0.ClearTileCell(arg_6_0, arg_6_1)
	local var_6_0 = IslandConst.AGORA_LAYER_TILE
	local var_6_1 = arg_6_0.data:MapPoint2GroundPoint(arg_6_1)

	arg_6_0.floorTileRenderer:RemoveTexture(var_6_0, var_6_1.x, var_6_1.y)
end
