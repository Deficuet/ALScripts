...
function var_0_0.Update(arg_2_0, arg_2_1, arg_2_2)
	...
	local var_2_2 = GetSpriteFromAtlas("ui/IslandDecorationUI_atlas", "r" .. var_2_0:GetRarity())
...
function var_0_0.UpdateSelected(arg_4_0, arg_4_1)
	local var_4_0 = arg_4_0.valueObject:GetFirstItem()

	setActive(arg_4_0.mark, var_4_0.id == arg_4_1)
end
