...
function var_0_0.LoadRawTex(arg_3_0, arg_3_1)
	...
	local var_3_1 = System.IO.File.ReadAllBytes(var_3_0)
	local var_3_2 = UnityEngine.Texture2D.New(426, 320)

	Tex2DExtension.LoadImage(var_3_2, var_3_1)

	arg_3_0.iconRaw.texture = var_3_2
