...
function var_0_0.IsType(arg_16_0, arg_16_1)
	return arg_16_0:GetFirstItem():GetType() == arg_16_1
end
...
function var_0_0.GetSortValue(arg_18_0, arg_18_1, arg_18_2)
	...
	if arg_18_1 == AgoraFurnitureType.SORT_RARITY then
		var_18_0 = arg_18_0:GetFirstItem():GetRarity()
	elseif arg_18_1 == AgoraFurnitureType.SORT_TIME then
		var_18_0 = arg_18_0:GetFirstItem():GetTime()
	elseif arg_18_1 == AgoraFurnitureType.SORT_CAPACITY then
		var_18_0 = arg_18_0:GetFirstItem():GetCost()
	else
...
function var_0_0.GetThemeName(arg_22_0)
	...
	local var_22_1 = arg_22_0.agora:GetSystemThemes()
