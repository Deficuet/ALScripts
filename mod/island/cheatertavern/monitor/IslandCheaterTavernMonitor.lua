...
function var_0_0.register(arg_1_0)
	...
	arg_1_0:on(23117, function(arg_11_0)
		...
		local var_11_1 = getProxy(ActivityProxy):getActivityByType(ActivityConst.ACTIVITY_TYPE_ISLAND_CHEAT_BAR)
		local var_11_2 = arg_11_0.cur_score - var_11_1.data1

		var_11_1.data1 = arg_11_0.cur_score
		var_11_1.data2 = math.max(arg_11_0.cur_score, var_11_1.data2)

		var_11_0:updateActivity(var_11_1)
	end)
end

function var_0_0.InitPlayerDate(arg_12_0, arg_12_1)
	for iter_12_0, iter_12_1 in ipairs(arg_12_1.player_list or {}) do
		local var_12_0 = iter_12_1.seat
		local var_12_1 = iter_12_1.player_info
		local var_12_2 = {
			user_view = PlayRoomTools.GetGameViewID(var_12_1.user_view),
			seat = var_12_0,
			id = var_12_1.id
		}

		arg_12_0:GetIsland():DispatchEvent(IslandCheaterTavernMonitor.ADD_CHEATERTAVERN_PLAYER, var_12_2)
	end
...
function var_0_0.PlayOperateHandle(arg_16_0, arg_16_1)
	...
	switch(arg_16_1.type, {
		[IslandCheaterTavernConst.PlayerOperateType.PutCard] = function()
			...
			if var_17_0 and var_16_0 == getProxy(PlayerProxy):getRawData().id then
				var_16_3 = arg_16_0.cheaterTavernAgency:GetMainPlayerAutoPutCard(var_17_1)

				arg_16_0.cheaterTavernAgency:MainPlayerPutCard(var_16_3)
			end

			arg_16_0.cheaterTavernAgency:ReducePlayerCardNum(var_16_0, var_17_1)
		...
		[IslandCheaterTavernConst.PlayerOperateType.Shoot] = function()
			...
			warning(tostring(var_16_0) .. "PlayOperateHandle" .. tostring(var_19_0))
			arg_16_0.cheaterTavernAgency:UpdatePlayerBombState(var_16_0, var_19_0, var_19_1)
		end
	}, function()
		return
	end)
