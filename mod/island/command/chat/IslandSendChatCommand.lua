...
function var_0_0.execute(arg_1_0, arg_1_1)
	...
	if var_1_8 < var_1_4.chatMsgBanTime then
		local var_1_9 = os.date("%Y/%m/%d %H:%M:%S", var_1_4.chatMsgBanTime)

		pg.MsgboxMgr.GetInstance():ShowMsgBox({
			hideNo = true,
			content = i18n("chat_msg_ban", var_1_9)
		})
	...
	elseif var_1_8 - var_1_5 < 10 then
		local var_1_10 = 10 - (var_1_8 - var_1_5)

		pg.TipsMgr.GetInstance():ShowTips(i18n("dont_send_message_frequently", var_1_10))
	else
