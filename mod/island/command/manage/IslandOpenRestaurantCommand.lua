...
function var_0_0.execute(arg_1_0, arg_1_1)
	...
	pg.ConnectionMgr.GetInstance():Send(21418, {
		...
		if arg_2_0.result == 0 then
			...
			local var_2_3 = arg_2_0.trade_data.end_time

			var_2_2:SetEndTime(var_2_3)
			var_2_2:ReduceRemainCnt()

			local var_2_4 = var_2_0:GetCharacterAgency()

			for iter_2_2, iter_2_3 in ipairs(arg_2_0.ship_power) do
				local var_2_5 = var_2_4:GetShipById(iter_2_3.ship_id)

				var_2_5:UpdateEnergy(iter_2_3.power)
				var_2_5:UpdateEnergyBeginRecoverTime(var_2_3)
				var_2_5:UpdateState(IslandShip.STATE_RESTAURANT, var_1_1)
			end
