	...
	pg.ConnectionMgr.GetInstance():Send(21505, {
		...
		if arg_2_0.result == 0 then
			...
			if var_1_2 == IslandTechnologyAgency.PLACE_ID then
				local var_2_1 = var_2_0:GetDelegationSlotData(var_1_3):GetFormulaId()

				var_1_6:GetTechnologyAgency():AddFinishCntByFormulatId(var_2_1)
			end

			local var_2_2 = var_2_0:GetShipAddExpData(var_1_3)

			var_2_0:UpdateDeleationRewardDataBySlotId(var_1_3, nil)

			if var_1_4 == 1 then
				local var_2_3 = var_2_0:GetDelegationSlotData(var_1_3):GetSlotRoleData()

				if var_2_3 then
					var_2_3:OnGetAwardMidway(arg_2_0.start_time, arg_2_0.rest_time_list, arg_2_0.get_times)
				end
			end
