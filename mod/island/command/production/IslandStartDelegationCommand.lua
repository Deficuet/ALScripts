...
function var_0_0.execute(arg_1_0, arg_1_1)
	...
	pg.ConnectionMgr.GetInstance():Send(21501, {
		...
		if arg_2_0.result == 0 then
			...
			local var_2_2 = var_2_0:GetDelegationSlotData(arg_2_0.ship_appoint.id):GetRoleDelegateFinishTime()

			var_2_1:UpdateEnergyBeginRecoverTime(var_2_2)

			local var_2_3 = var_1_1 == IslandTechnologyAgency.PLACE_ID and IslandShip.STATE_DELEGATION or IslandShip.STATE_TECHNOLOGY

			var_2_1:UpdateState(var_2_3, var_1_1)

			local var_2_4 = pg.island_formula[var_1_4].commission_cost
