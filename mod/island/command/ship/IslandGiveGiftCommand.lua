...
function var_0_0.execute(arg_1_0, arg_1_1)
	...
	pg.ConnectionMgr.GetInstance():Send(21613, {
		...
		if arg_2_0.result == 0 then
			...
			local var_2_2 = var_2_1:IsFavoriteGift(var_1_2) and IslandConst.GIFT_INDEX_FAVORITE or IslandConst.GIFT_INDEX_COMMON
			...
			for iter_2_0, iter_2_1 in ipairs(var_2_0) do
				if var_2_2 == iter_2_0 then
					...
					for iter_2_2, iter_2_3 in ipairs(var_2_4) do
						local var_2_5 = IslandShipStatus.New({
							id = iter_2_3,
							start_time = pg.TimeMgr.GetInstance():GetServerTime()
						})

						var_2_1:AddStatus(var_2_5)
					end

					var_2_1:AddEnergy(var_2_3)
				end
			end
