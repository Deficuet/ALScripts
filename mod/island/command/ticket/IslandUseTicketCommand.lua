...
function var_0_0.execute(arg_1_0, arg_1_1)
	...
	if var_1_1 == var_0_0.TYPES.ORDER_CD or var_1_1 == var_0_0.TYPES.SHIP_ORDER or var_1_1 == var_0_0.TYPES.MANAGE then
...
function var_0_0.SendForAppoint(arg_9_0, arg_9_1, arg_9_2, arg_9_3)
	pg.ConnectionMgr.GetInstance():Send(21427, {
		area_id = arg_9_1,
		tickets = arg_9_2
	}, 21428, function(arg_10_0)
		if arg_10_0.result == 0 then
			local var_10_0 = getProxy(IslandProxy):GetIsland()
			local var_10_1 = pg.island_production_slot[arg_9_1].place
			local var_10_2 = var_10_0:GetBuildingAgency():GetBuilding(var_10_1):GetDelegationSlotData(arg_9_1):GetSlotRoleData()

			var_10_2:AddSpeedTime(arg_9_3)
			var_10_2:SetCostList(arg_10_0.time_list)
			var_10_0:GetCharacterAgency():GetShipById(var_10_2.ship_id):UpdateEnergyBeginRecoverTime(var_10_2:GetFinishTime())

			local var_10_3 = var_10_0:GetTicketAgency()

			for iter_10_0, iter_10_1 in ipairs(arg_9_2) do
				var_10_3:ReduceTicket(iter_10_1.key.speed_id, iter_10_1.key.end_time, iter_10_1.num)
			end

			pg.TipsMgr.GetInstance():ShowTips(i18n("island_use_ticket_success"))
			arg_9_0:sendNotification(GAME.ISLAND_USE_TICKET_DONE, {
