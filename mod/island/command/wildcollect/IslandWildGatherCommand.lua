...
function var_0_0.execute(arg_1_0, arg_1_1)
	...
	local var_1_2 = var_1_0.gather_id
	local var_1_3 = getProxy(IslandProxy):GetIsland()
	local var_1_4 = var_1_0.unitId
	...
	pg.ConnectionMgr.GetInstance():Send(21524, {
		...
		if arg_2_0.result == 0 then
			pg.GameTrackerMgr.GetInstance():Record(GameTrackerBuilder.BuildIslandWildGather(var_1_4))

			local var_2_0 = IslandDropHelper.AddItems({
