...
function var_0_0.SetUp(arg_9_0, arg_9_1)
	...
	if not arg_9_0.handle then
		arg_9_0.handle = UpdateBeat:CreateListener(arg_9_0.Update, arg_9_0)
	end
...
function var_0_0.Dispose(arg_18_0, arg_18_1)
	local var_18_0 = pg.TimeMgr.GetInstance():GetServerTime() - arg_18_0.enterTime

	pg.GameTrackerMgr.GetInstance():Record(GameTrackerBuilder.BuildMapExit(arg_18_0.controller.mapId, var_18_0))
...
function var_0_0.GetViewAndController(arg_20_0, arg_20_1, arg_20_2)
	...
	local var_20_3 = pg.island_map[var_20_2]

	if var_20_2 == IslandConst.AGORA_MAP_ID then
		var_20_1 = AgoraController.New(arg_20_0, arg_20_1)

		local var_20_4 = var_20_1:GetAgora()

		var_20_0 = AgoraView.New(arg_20_0, var_20_4, arg_20_2)
	...
	elseif var_20_3.minigame_id > 0 then
