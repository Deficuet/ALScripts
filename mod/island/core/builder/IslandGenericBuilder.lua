...
function var_0_0.SetupBT(arg_9_0, arg_9_1, arg_9_2, arg_9_3)
	...
	local var_9_1 = IslandAssetLoadDispatcher.Instance:Enqueue(var_9_0, "", typeof(NodeCanvas.BehaviourTrees.BehaviourTree), UnityEngine.Events.UnityAction_UnityEngine_Object(function(arg_10_0)
