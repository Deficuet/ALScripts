...
function var_0_0.IsSelfIsland(arg_4_0)
	return getProxy(IslandProxy):GetIsland().id == arg_4_0.island.id
end
...
function var_0_0.AddIslandListener(arg_9_0, arg_9_1, arg_9_2)
	...
	arg_9_0.island:AddListener(arg_9_1, var_9_0)
end

function var_0_0.RemoveIslandListener(arg_11_0, arg_11_1, arg_11_2)
	local var_11_0 = arg_11_0.__callbacks[arg_11_2]

	if var_11_0 then
		arg_11_0.island:RemoveListener(arg_11_1, var_11_0)

		arg_11_0.__callbacks[var_11_0] = nil
	end
end
