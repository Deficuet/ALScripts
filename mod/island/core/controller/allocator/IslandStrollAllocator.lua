...
function var_0_0.Ctor(arg_1_0, arg_1_1)
	...
	for iter_1_0, iter_1_1 in ipairs(var_1_0) do
		local var_1_1 = pg.island_waypoint[iter_1_1]

		if not arg_1_0.paths[var_1_1.group] then
			arg_1_0.paths[var_1_1.group] = {}
		end

		table.insert(arg_1_0.paths[var_1_1.group], iter_1_1)
	end
...
function var_0_0.Allocator(arg_2_0, arg_2_1)
	...
	local var_2_1 = pg.island_waypoint[var_2_0[1]].position
