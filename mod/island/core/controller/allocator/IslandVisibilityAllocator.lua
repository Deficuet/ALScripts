...
function var_0_0.OnCompareSample(arg_3_0, arg_3_1, arg_3_2)
	for iter_3_0, iter_3_1 in pairs(arg_3_1) do
		...
		if var_3_0 ~= nil and var_3_1 ~= nil and var_3_0 ~= var_3_1 then
			...
			elseif var_3_0 == false and var_3_1 == true then
				local var_3_2 = arg_3_0:GetUnitData(iter_3_0)

				if var_3_2 then
					arg_3_0:GenUnit(var_3_2)
				end
			end
		end
	end
...
function var_0_0.IsTaskType(arg_13_0, arg_13_1)
	...
	return var_13_0 == IslandConst.UNIT_SHOW_TYPE_ACCEPT_TASK or var_13_0 == IslandConst.UNIT_SHOW_TYPE_FINISH_TASK or var_13_0 == IslandConst.UNIT_SHOW_TYPE_RECIVE_TASK
end
...
function var_0_0.IsLockNpc(arg_22_0, arg_22_1, arg_22_2)
	return _.any(arg_22_0.lockNpcList or {}, function(arg_23_0)
...
function var_0_0.ReleaseNpc(arg_25_0, arg_25_1, arg_25_2)
	for iter_25_0 = #arg_25_0.lockNpcList, 1, -1 do
		local var_25_0 = arg_25_0.lockNpcList[iter_25_0]

		if var_25_0[1] == arg_25_1 and var_25_0[2] == arg_25_2 then
