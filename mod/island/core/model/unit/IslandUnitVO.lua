...
function var_0_0.GetPersonality(arg_10_0)
	...
	if arg_10_0:IsNpcType() then
		local var_10_2 = pg.island_unit_character[arg_10_0.modelId]

		var_10_0, var_10_1 = var_10_2.personality or 0, var_10_2.is_active or 0
	end
