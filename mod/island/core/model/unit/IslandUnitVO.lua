...
function var_0_0.GetAssetPath(arg_8_0)
	...
	return string.lower(var_8_0)
end

function var_0_0.GetBehaviourTree(arg_9_0)
	return arg_9_0.behaviourTree
end
...
function var_0_0.GetShowCondition(arg_11_0)
	local var_11_0 = {}

	for iter_11_0, iter_11_1 in ipairs(arg_11_0.showCondition) do
...
function var_0_0.GetHideCondition(arg_12_0)
	local var_12_0 = {}

	for iter_12_0, iter_12_1 in ipairs(arg_12_0.hideCondition) do
