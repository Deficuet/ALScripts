...
function var_0_0.SetUIParent(arg_2_0, arg_2_1)
	setParent(arg_2_1, arg_2_0:GetView().hudContainer)
end
...
function var_0_0.OnLateUpdate(arg_5_0)
	for iter_5_0, iter_5_1 in pairs(arg_5_0.unitHudDic) do
		...
		local var_5_2 = var_5_1 and var_5_1._go or nil
...
function var_0_0.UpdateTplPosition(arg_6_0, arg_6_1, arg_6_2, arg_6_3)
	local var_6_0 = IslandCalcUtil.WorldPosition2LocalPosition(arg_6_0.parent, arg_6_3)
