...
function var_0_0.InitArgs(arg_26_0, arg_26_1, arg_26_2)
	local var_26_0 = pg.island_fish[arg_26_1]

	assert(var_26_0, "island_fish>>>>>>>>>>>>" .. arg_26_1)
	...
	arg_26_0.biteTime = math.random(var_26_1, var_26_2)

	local var_26_3 = arg_26_0:GetView():GetSelfIsland():GetFishingAgency()

	arg_26_0.isNew = var_26_3:IsNewFish(arg_26_1)
	arg_26_0.isNewRecord = var_26_3:IsNewRecord(arg_26_1, arg_26_2)

	local var_26_4 = var_26_3:GetFishRodId()

	assert(pg.island_fish_rod[var_26_4], "island_fish_rod>>>>>>>>>>>>" .. var_26_4)

	arg_26_0.fishRodId = pg.island_fish_rod[var_26_4].attachment_id
	arg_26_0.rodProfile = pg.island_fish_rod[var_26_4].qte_effect
...
function var_0_0.LoadQteUI(arg_37_0, arg_37_1)
	...
	seriesAsync({
		function(arg_38_0)
			local var_38_0 = IslandAssetLoadDispatcher.Instance:Enqueue("island/FishRod/" .. arg_37_0.rodProfile, "", typeof(FishRodProfile), UnityEngine.Events.UnityAction_UnityEngine_Object(function(arg_39_0)
				var_37_0 = arg_39_0

				arg_38_0()
			end), true, true)

			arg_37_0:AddLoadingID(var_38_0)
		end,
		function(arg_40_0)
			onNextTick(arg_40_0)
		end,
		function(arg_41_0)
			local var_41_0 = IslandAssetLoadDispatcher.Instance:Enqueue("island/fishingcurve/" .. arg_37_0.fishPrifile, "", typeof(FishMotionProfile), UnityEngine.Events.UnityAction_UnityEngine_Object(function(arg_42_0)
				var_37_1 = arg_42_0

				arg_41_0()
			end), true, true)

			arg_37_0:AddLoadingID(var_41_0)
		end,
		function(arg_43_0)
			local var_43_0 = IslandAssetLoadDispatcher.Instance:Enqueue("UI/IslandFishingQteUI", "", typeof(GameObject), UnityEngine.Events.UnityAction_UnityEngine_Object(function(arg_44_0)
				arg_37_0:OnLoadQTE(arg_44_0, var_37_1, var_37_0)
				arg_43_0()
			end), true, true)

			arg_37_0:AddLoadingID(var_43_0)
		end,
		function(arg_45_0)
			onNextTick(arg_45_0)
		end
...
function var_0_0.UpdateQteLayout(arg_48_0)
	...
	local var_48_0 = arg_48_0._tf:TransformPoint(arg_48_0.opBtnLocalPosition)
	local var_48_1 = arg_48_0.qteTr.transform:InverseTransformPoint(var_48_0)

	arg_48_0.qteTr.transform:Find("fishing_btn").localPosition = Vector3(var_48_1.x, var_48_1.y, 0)
end
...
function var_0_0.IsRunning(arg_64_0)
	return arg_64_0.state == var_0_5
end

function var_0_0.IsPausing(arg_65_0)
	return arg_65_0.state == var_0_9
end

function var_0_0.PauseGame(arg_66_0)
	arg_66_0.state = var_0_9
...
function var_0_0.BuildResultData(arg_68_0, arg_68_1)
	...
	local var_68_1 = var_68_0:GetFishRodId()
	local var_68_2 = var_68_0:GetBaitId()
	local var_68_3 = arg_68_0.fishingSliderDriver.SuccesCnt
	local var_68_4 = arg_68_0.fishingSliderDriver.FailCnt
	local var_68_5 = math.floor(arg_68_0.fishingSliderDriver.PowerRatio * 100)
	local var_68_6 = math.floor(arg_68_0.fishingSliderDriver.Ratio * 100)

	pg.GameTrackerMgr.GetInstance():Record(GameTrackerBuilder.BuildIslandFishingResult(arg_68_0.fishPointId, var_68_1, var_68_2, arg_68_0.fishId, arg_68_0.fishWeight, var_68_3, var_68_4, var_68_5, var_68_6, arg_68_1))
end

function var_0_0.OnQteSuccess(arg_69_0)
	arg_69_0.state = var_0_6
...
function var_0_0.WaitForExit(arg_79_0, arg_79_1)
	...
	local var_79_0 = pg.island_set.island_fishing_success_exit_time.key_value_int

	arg_79_0.exitTimer = Timer.New(arg_79_1, math.max(0.01, var_79_0), 1)
...
function var_0_0.OnCancel(arg_89_0, arg_89_1)
	if arg_89_0.state == var_0_5 or arg_89_0.state == var_0_4 then
...
function var_0_0.DisplayResult(arg_94_0)
	...
	setActive(arg_94_0.resultCupMaxTr, arg_94_0.cupType == var_0_3)
	setActive(arg_94_0.resultCupMinTr, arg_94_0.cupType == var_0_2)
...
function var_0_0.Clear(arg_104_0)
	...
	arg_104_0.state = var_0_4

	local var_104_0 = pg.TimeMgr.GetInstance():GetServerTime() - arg_104_0.startTime

	pg.GameTrackerMgr.GetInstance():Record(GameTrackerBuilder.BuildIslandFishingExit(arg_104_0.fishPointId, var_104_0))
end
