...
function var_0_0.OnUpdate(arg_6_0)
	local var_6_0 = arg_6_0.data:GetStatus()

	if arg_6_0.isShowing and var_6_0 ~= IslandRestaurant.STATUS.OPENING then
	...
	local var_6_2 = var_6_1:GetUnits()

	for iter_6_0, iter_6_1 in ipairs(var_6_2) do
		local var_6_3 = arg_6_0:GetView():GetUnitModuleWithType(IslandConst.UNIT_LIST_MANAGE, iter_6_1.id)

		if not var_6_3:IsLoaded() then
			return
		end

		if iter_6_1.type == IslandConst.UNIT_TYPE_MANAGE_CHARA and not var_6_3._go:GetComponent(typeof(ParadoxNotion.Services.EventRouter)) then
			return
		end
	end
