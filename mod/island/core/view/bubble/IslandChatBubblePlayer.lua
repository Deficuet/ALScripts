...
function var_0_0.UpdateChatTypeEmoji(arg_12_0, arg_12_1, arg_12_2)
	...
	PoolMgr.GetInstance():GetPrefab("emoji/" .. var_12_0.pic, var_12_0.pic, true, function(arg_13_0)
		...
		if arg_13_0:GetComponent(typeof(CriManaEffectUI)) or var_13_0 then
			arg_13_0.transform.localScale = Vector3(0.72, 0.72, 1)
		else
			arg_13_0.transform.localScale = Vector3(0.72, 0.72, 1)
		end
...
function var_0_0.PlayCharatorAnimation(arg_19_0, arg_19_1)
	...
	local var_19_2 = var_19_0:GetComponent(typeof(Animator)) or var_19_0.transform:GetChild(0):GetComponent(typeof(Animator))
