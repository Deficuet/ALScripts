...
function var_0_0.Ctor(arg_1_0, arg_1_1)
	...
	local var_1_0 = Animator.StringToHash("UpperBase." .. var_0_0.STATE_THROW)

	arg_1_0.player._animator:GetBehaviours(var_1_0, 0)[0].StateEnterFixComplete = function(arg_2_0, arg_2_1)
...
function var_0_0.TriggerState(arg_8_0, arg_8_1, arg_8_2, arg_8_3)
	...
	if arg_8_0.fishRodAnimator then
		local var_8_0 = string.gsub(arg_8_1, "fish_sub_state.", "")
		local var_8_1 = Animator.StringToHash(var_8_0)

		arg_8_0.fishRodAnimator:CrossFadeInFixedTime(var_8_1, arg_8_2, 0)
	end
end
...
function var_0_0.Dispose(arg_11_0)
	local var_11_0 = Animator.StringToHash("UpperBase." .. var_0_0.STATE_THROW)

	arg_11_0.player._animator:GetBehaviours(var_11_0, 0)[0].StateEnterFixComplete = nil
