...
function var_0_0.TurnToFishPoistion(arg_12_0, arg_12_1, arg_12_2)
	...
	local var_12_1 = arg_12_0.player._tf
	local var_12_2 = var_12_0._go.transform.position - var_12_1.position

	var_12_2.y = 0
	var_12_1.rotation = Quaternion.LookRotation(var_12_2)
...
function var_0_0.LoadFishRodModel(arg_13_0, arg_13_1)
	...
	local var_13_0 = pg.island_animation_attachments[arg_13_0.fishRodId]

	arg_13_0:GetPoolMgr():GetFishRod(var_13_0.model, var_13_0.animator, function(arg_14_0)
...
function var_0_0.UnLoadFishRodModel(arg_15_0)
	if arg_15_0.fishRodId and arg_15_0.fishRodAnimator and arg_15_0.fishRodAnimator.gameObject then
		local var_15_0 = pg.island_animation_attachments[arg_15_0.fishRodId]

		arg_15_0:GetPoolMgr():ReturnFishRod(var_15_0.model, var_15_0.animator, arg_15_0.fishRodAnimator.gameObject)
...
function var_0_0.LoadFishModel(arg_16_0, arg_16_1)
	...
	local var_16_0 = pg.island_fish[arg_16_0.fishId]
	local var_16_1 = pg.island_unit_character[var_16_0.unit_id]

	arg_16_0:GetPoolMgr():GetFish(var_16_1.model, var_16_1.animator, function(arg_17_0)
...
function var_0_0.UnLoadFishModel(arg_18_0)
	if arg_18_0.fishAnimator then
		local var_18_0 = pg.island_fish[arg_18_0.fishId]
		local var_18_1 = pg.island_unit_character[var_18_0.unit_id]

		arg_18_0:GetPoolMgr():ReturnFish(var_18_1.model, var_18_1.animator, arg_18_0.fishAnimator.gameObject)
