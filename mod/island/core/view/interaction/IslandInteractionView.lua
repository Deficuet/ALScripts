...
function var_0_0.UpdateInteractionBtns(arg_5_0, arg_5_1)
	...
	local var_5_1 = IslandInteractionUntil.GetInteractionOptions(arg_5_0:GetView():GetIsland(), arg_5_0.interactionData.type, var_5_0)
	...
	arg_5_0.interactionUIItemList:make(function(arg_6_0, arg_6_1, arg_6_2)
		if arg_6_0 == UIItemList.EventUpdate then
			...
			onButton(arg_5_0, arg_6_2, function()
				...
				IslandInteractionUntil.Response(arg_5_0, var_5_0, var_6_0.id)
			end, SFX_PANEL)
			arg_5_0:SetInteractionText(arg_6_2, var_6_0)
		end
	end)
	arg_5_0.interactionUIItemList:align(#var_5_1)
end
...
function var_0_0.SetInteractionText(arg_10_0, arg_10_1, arg_10_2)
	...
	local var_10_0 = GetSpriteFromAtlas("island/IslandInteractionBtns", tostring(arg_10_2.icon))

	setImageSprite(arg_10_1:Find("icon_type"), var_10_0, true)
end
...
function var_0_0.AddTimer(arg_11_0, arg_11_1, arg_11_2)
	...
	local var_11_1 = Timer.New(function()
		...
		local var_12_1 = var_11_0 - var_12_0
		...
		if var_12_1 <= 0 then
			...
			setText(arg_11_1:Find("time/Text"), pg.TimeMgr.GetInstance():DescCDTime(var_12_1))
		end
	end, 1, -1)
