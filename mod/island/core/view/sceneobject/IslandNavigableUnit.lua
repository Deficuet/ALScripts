...
function var_0_0.WarpAgent(arg_1_0)
	...
	local var_1_0 = arg_1_0.agent.steeringTarget - arg_1_0._tf.position

	var_1_0.y = 0

	if var_1_0.sqrMagnitude > 0.001 then
		arg_1_0._tf.rotation = Quaternion.LookRotation(var_1_0)
	end
end
...
function var_0_0.NavUpdate(arg_7_0)
	...
	if not arg_7_0.reached then
		local var_7_1 = arg_7_0.agent.velocity
		local var_7_2 = Vector3(var_7_1.x, 0, var_7_1.z)
		local var_7_3 = 1
		local var_7_4 = arg_7_0.agent.stoppingDistance * 2

		if var_7_4 > arg_7_0.agent.remainingDistance then
			var_7_3 = arg_7_0.agent.remainingDistance / var_7_4
		end

		arg_7_0.smoothVelocity = Vector3.Lerp(arg_7_0.smoothVelocity or Vector3.zero, var_7_2 * var_7_3, Time.deltaTime * 10)
		var_7_0 = arg_7_0.smoothVelocity
	end

	local var_7_5 = Vector3(var_7_0.x, 0, var_7_0.z)

	if not arg_7_0.reached and var_7_5.sqrMagnitude > 0.05 then
		local var_7_6 = Quaternion.LookRotation(var_7_5)

		arg_7_0._tf.rotation = Quaternion.Slerp(arg_7_0._tf.rotation, var_7_6, Time.deltaTime * 10)
	end

	if arg_7_0._characterController.isGrounded then
		arg_7_0.verticalVelocity = -0.1
	else
		arg_7_0.verticalVelocity = arg_7_0.verticalVelocity + -9.81 * Time.deltaTime
	end
	...
	local var_7_7 = arg_7_0._tf.position

	arg_7_0.agent.nextPosition = Vector3.Lerp(arg_7_0.agent.nextPosition, var_7_7, Time.deltaTime * 20)

	local var_7_8 = var_7_5.magnitude * 1.5

	if arg_7_0._animator then
		arg_7_0._animator:SetFloat(IslandConst.SPEED_FLAG_HASH, var_7_8)
	end
end
...
function var_0_0.CheckMovement(arg_19_0)
	...
	if not var_19_0:IsName(var_19_1) then
...
function var_0_0.CheckAnimationState(arg_22_0)
	...
	local var_22_3 = var_22_2:GetCurrentAnimatorStateInfo(0)

	if var_22_3:IsName(var_22_0) and not arg_22_0.endTime then
		local var_22_4 = var_22_3.length / var_22_2.speed
