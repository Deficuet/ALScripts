...
local var_0_3 = class("IslandThirdTakePhotoUnit", import(".IslandSceneUnit"))
...
function var_0_3.Move(arg_7_0, arg_7_1)
	...
	arg_7_0.characterController:Move(arg_7_0.velocity * Time.deltaTime + var_7_6)
end
...
function var_0_3.ChangeHeight(arg_11_0, arg_11_1)
	arg_11_0.characterController.center = Vector3(0, arg_11_1, 0)
end

function var_0_3.OnStopPlayerSprint(arg_12_0)
