...
function var_0_0.CheckType(arg_9_0, arg_9_1, arg_9_2, arg_9_3)
	...
	local var_9_2 = _.detect(var_9_1, function(arg_10_0)
		return table.contains(var_9_0, arg_10_0:GetGroup())
	end)

	if var_9_2 and not var_0_0.IsTip(var_9_2.id) then
		arg_9_0:ShowMsgBox({
		...
		table.insert(var_0_0.tipList, var_9_2.id)
	else
		arg_9_3()
	end
end
...
function var_0_0.CheckSpecific(arg_11_0, arg_11_1, arg_11_2, arg_11_3)
	...
	local var_11_2 = _.detect(var_11_1, function(arg_12_0)
		return table.contains(var_11_0, arg_12_0.id)
	end)

	if var_11_2 and not var_0_0.IsTip(var_11_2.id) then
		arg_11_0:ShowMsgBox({
		...
		table.insert(var_0_0.tipList, var_11_2.id)
	else
		arg_11_3()
	end
end
