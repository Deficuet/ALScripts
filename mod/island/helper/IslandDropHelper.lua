...
function var_0_0.AddIslandFurnitureDrops(arg_20_0)
	...
	for iter_20_0, iter_20_1 in ipairs(arg_20_0) do
		local var_20_2 = IslandFurniture.New({
			id = iter_20_1.id,
			count = iter_20_1.number or iter_20_1.num or iter_20_1.count
		})

		var_20_2:SetTime(pg.TimeMgr:GetInstance():GetServerTime())
		var_20_0:AddFurniture(var_20_2)
...
function var_0_0.AddIslandTicketDrops(arg_25_0, arg_25_1)
	...
	for iter_25_0, iter_25_1 in ipairs(arg_25_0) do
		local var_25_2 = arg_25_1[DROP_TYPE_ISLAND_SPEEDUP_TICKET][iter_25_1.id]
		local var_25_3 = IslandTicket.GetEndTimeById(iter_25_1.id, var_25_2)
		local var_25_4 = iter_25_1.number or iter_25_1.num or iter_25_1.count

		var_25_0:AddTicket(iter_25_1.id, var_25_3, var_25_4)
