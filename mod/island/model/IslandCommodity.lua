...
function var_0_0.GetTag(arg_26_0)
	...
	return switch(var_26_0, {
		[0] = function()
			return arg_26_0:IsTimeLimitCommodity() and var_0_0.TAG.TIME or var_0_0.TAG.NONE
		end,
		function()
...
function var_0_0.IsCharacterInviteItemHold(arg_32_0)
	...
	local var_32_1 = pg.island_chara_template.all
	local var_32_2 = {}

	for iter_32_0, iter_32_1 in ipairs(pg.island_chara_template.all) do
		table.insert(var_32_2, pg.island_chara_template[iter_32_1].invite_item)
	end

	if #var_32_0 ~= 1 or not table.contains(var_32_2, var_32_0[1][2]) then
		return false
	end

	local var_32_3 = var_32_1[table.indexof(var_32_2, var_32_0[1][2])]

	return getProxy(IslandProxy):GetIsland():GetCharacterAgency():HasInvite(var_32_3)
end
...
function var_0_0.IsHideCommondity(arg_34_0)
	...
	if var_34_0 == DROP_TYPE_ISLAND_DRESS then
		local var_34_2 = pg.island_dress_template[var_34_1]

		if var_34_2 and var_34_2.is_hide == 1 then
			return true
		end
	end
