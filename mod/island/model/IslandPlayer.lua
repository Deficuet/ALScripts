...
function var_0_0.GetHairFaceBodyDress(arg_6_0)
	local var_6_0 = arg_6_0:GetDressByType(IslandShipDressHelperNew.DressType.Hair)
	local var_6_1 = arg_6_0:GetDressByType(IslandShipDressHelperNew.DressType.Face)
	local var_6_2 = arg_6_0:GetDressByType(IslandShipDressHelperNew.DressType.Body)
...
function var_0_0.IsSelf(arg_8_0)
	return arg_8_0.id == getProxy(PlayerProxy):getRawData().id
end
