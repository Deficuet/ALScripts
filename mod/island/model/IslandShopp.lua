...
function var_0_0.GetPlayerRefreshResource(arg_17_0)
	local var_17_0 = var_0_2[arg_17_0.id].refresh_player
...
function var_0_0.SetCommodities(arg_21_0, arg_21_1)
	...
	if arg_21_0:IsTemporaryShop() then
		for iter_21_0, iter_21_1 in ipairs(arg_21_1) do
			local var_21_0 = IslandCommodity.New(iter_21_1, arg_21_0.id)

			table.insert(arg_21_0.commodities, var_21_0)
		...
		for iter_21_2, iter_21_3 in ipairs(arg_21_0:GetGoodIds()) do
			if arg_21_0:ShouldShowCommodity(iter_21_3) then
				local var_21_1 = IslandCommodity.New({
					num = 0,
					id = iter_21_3
				}, arg_21_0.id)

				table.insert(arg_21_0.commodities, var_21_1)
				table.insert(arg_21_0.commodityIds, iter_21_3)
			end
		end

		for iter_21_4, iter_21_5 in ipairs(arg_21_1) do
			local var_21_2 = arg_21_0:GetCommodityById(iter_21_5.id)

			if var_21_2 then
				var_21_2:UpdateNum(iter_21_5.num)

				if var_21_2:GetMaxNum() ~= 0 and var_21_2.purchasedNum == var_21_2:GetMaxNum() and not var_21_2:IsShowSellOut() then
					table.removebyvalue(arg_21_0.commodities, var_21_2)
					table.removebyvalue(arg_21_0.commodityIds, var_21_2.id)
				end
			end
		end
	end
...
function var_0_0.ShouldShowCommodity(arg_22_0, arg_22_1)
	...
	local var_22_1 = var_0_3[arg_22_1].unlock
	local var_22_2 = true

	if type(var_22_1) == "table" and #var_22_1 > 0 then
	...
	local var_22_3 = pg.TimeMgr.GetInstance():inTime(var_0_3[arg_22_1].time)

	return var_22_2 and var_22_3
end
...
function var_0_0.IsInTime(arg_28_0)
	...
	elseif arg_28_0:IsTemporaryShop() then
		return pg.TimeMgr.GetInstance():GetServerTime() < arg_28_0.existTime
	end
end
