...
function var_0_0.WillExpire(arg_16_0)
	...
	return var_16_0 > 0 and var_16_0 < 172800
end

function var_0_0.GetEndTimeById(arg_17_0, arg_17_1)
	local var_17_0 = pg.island_speedup_ticket[arg_17_0]

	if var_17_0.expiration_type == 2 then
		local var_17_1 = var_17_0.expiration_time

		if var_17_1 == "always" then
			return 0
		end

		return pg.TimeMgr.GetInstance():parseTimeFromConfig(var_17_1)
	elseif var_17_0.expiration_type == 1 then
		return (arg_17_1 or pg.TimeMgr.GetInstance():GetTimeToNextTime() - 86400) + 86400 * var_17_0.duration - 1
	end
