...
function var_0_0.ExistFragment(arg_3_0, arg_3_1)
	local var_3_0 = pg.island_collect_fragment[arg_3_1].collection_id
	...
	local var_3_1 = arg_3_0.collectData[var_3_0]

	if var_3_1 then
		return var_3_1:CheckFragment(arg_3_1)
	end
...
function var_0_0.AddCollectFragment(arg_4_0, arg_4_1)
	local var_4_0 = pg.island_collect_fragment[arg_4_1].collection_id

	if not arg_4_0.collectData[var_4_0] then
		arg_4_0.collectData[var_4_0] = IslandCollectItemData.New({
			id = var_4_0
		})
	end

	arg_4_0.collectData[var_4_0]:AddFragment(arg_4_1)
...
function var_0_0.AddFinishCollectData(arg_5_0, arg_5_1)
	local var_5_0 = arg_5_0.collectData[arg_5_1]

	if var_5_0 then
		var_5_0:ResetFragment()
	end
