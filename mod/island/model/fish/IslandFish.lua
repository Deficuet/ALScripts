...
function var_0_0.SetCupState(arg_8_0, arg_8_1)
	...
	if arg_8_1 == 1 then
		arg_8_0.cupState = arg_8_0.cupState == var_0_0.CUP_STATE_MAX and var_0_0.CUP_STATE_NIN_AND_MAX or var_0_0.CUP_STATE_MIN
	elseif arg_8_1 == 2 then
		arg_8_0.cupState = arg_8_0.cupState == var_0_0.CUP_STATE_MIN and var_0_0.CUP_STATE_NIN_AND_MAX or var_0_0.CUP_STATE_MAX
	end
end
