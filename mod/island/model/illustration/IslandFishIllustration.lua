...
function var_0_0.CheckTip(arg_5_0)
	...
	local var_5_1 = getProxy(IslandProxy):GetIsland():GetFishingAgency():GetFish(var_5_0)
	...
	arg_5_0.isTip = arg_5_0:GetReachPoints(var_5_1:ReachMinCup(), var_5_1:ReachMaxCup()) > arg_5_0:GetPoints()
end
