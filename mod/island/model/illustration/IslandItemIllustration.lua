...
function var_0_0.GetReachPoints(arg_1_0)
	local var_1_0 = underscore.reduce(arg_1_0:getConfig("collect_star"), 0, function(arg_2_0, arg_2_1)
		return arg_2_0 + (arg_1_0.historyCount >= arg_2_1[1] and arg_2_1[2] or 0)
	end)
