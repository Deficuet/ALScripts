...
function var_0_0.FillDelegate(arg_4_0, arg_4_1)
	...
	arg_4_0.order:FillConsumeList(Clone(var_4_0))
	arg_4_0.order:FillAwardList(Clone(var_4_1))
end
...
function var_0_0.GetNextRefreshFinishCntTime(arg_12_0)
	local var_12_0 = GetZeroTime() - 86400
	local var_12_1 = pg.island_set.island_shiporder_refresh.key_value_varchar
	local var_12_2 = _.map(var_12_1, function(arg_13_0)
		return arg_13_0 + var_12_0
	end)
	local var_12_3 = pg.TimeMgr.GetInstance():GetServerTime()

	return _.detect(var_12_2, function(arg_14_0)
		return arg_14_0 > var_12_3
	end) or GetZeroTime() + var_12_1[1]
end
...
function var_0_0.IsEmpty(arg_19_0)
	if arg_19_0:IsWaiting() then
		return pg.TimeMgr.GetInstance():GetServerTime() < arg_19_0:GetShowTime()
	else
		return false
	end
end
...
function var_0_0.IsFinished(arg_23_0)
	local function var_23_0()
		return pg.TimeMgr.GetInstance():GetServerTime() >= arg_23_0:GetEndTime()
	end

	return arg_23_0:IsSubmited() and var_23_0()
end
...
function var_0_0.CanUnlock(arg_28_0)
	...
	if not getProxy(IslandProxy):GetIsland():GetAblityAgency():IsUnlockShipOrder(arg_28_0.id) then
		return false
	end
