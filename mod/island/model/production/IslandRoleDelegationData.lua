...
function var_0_0.GetExtraMainProduct(arg_4_0, arg_4_1)
	return arg_4_0.extraList[arg_4_1] and arg_4_0.extraList[arg_4_1].main_extra or 0
end

function var_0_0.GetExtraExtraProduct(arg_5_0, arg_5_1)
	return arg_5_0.extraList[arg_5_1] and arg_5_0.extraList[arg_5_1].other_extra or 0
end

function var_0_0.GetExtraExtraCost(arg_6_0, arg_6_1)
	return arg_6_0.extraList[arg_6_1] and arg_6_0.extraList[arg_6_1].cost_extra or 0
end

function var_0_0.AddCostList(arg_7_0, arg_7_1)
	local var_7_0 = #arg_7_0.cost_time_list
	local var_7_1 = var_7_0 == 0 and 0 or arg_7_0.cost_time_list[var_7_0]
	local var_7_2 = 0
...
function var_0_0.isEnd(arg_10_0)
	return arg_10_0.end_time > 0 and pg.TimeMgr.GetInstance():GetServerTime() >= arg_10_0.end_time + 1
end
