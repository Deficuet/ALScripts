...
function var_0_0.GetEmoji(arg_3_0)
	return arg_3_0.emoji
end

function var_0_0.GetHideType(arg_4_0)
	return arg_4_0.hideType, arg_4_0.hideTime
end

function var_0_0.GetTime(arg_5_0)
	return arg_5_0.time
end
