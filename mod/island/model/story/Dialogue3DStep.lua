...
function var_0_0.Ctor(arg_1_0, arg_1_1, arg_1_2)
	...
	for iter_1_0, iter_1_1 in ipairs(arg_1_1.face2Face or {}) do
		...
		local var_1_2 = arg_1_0.script:GetUnitIdFromCharaId(var_1_0)
		local var_1_3 = arg_1_0.script:GetUnitIdFromCharaId(var_1_1)
		local var_1_4 = arg_1_0:GenUnitData(var_1_2, IslandConst.UNIT_LIST_OBJ)
		local var_1_5 = arg_1_0:GenUnitData(var_1_3, IslandConst.UNIT_LIST_OBJ)
	...
	for iter_1_2, iter_1_3 in ipairs(arg_1_1.turnto or {}) do
		local var_1_6 = iter_1_3[1]
		local var_1_7 = iter_1_3[2] or 0

		assert(var_1_6 ~= var_1_7, "turnto配置错误，两个角色id不能相同")

		local var_1_8 = arg_1_0.script:GetUnitIdFromCharaId(var_1_6)
		local var_1_9 = arg_1_0.script:GetUnitIdFromCharaId(var_1_7)
		local var_1_10 = arg_1_0:GenUnitData(var_1_8, IslandConst.UNIT_LIST_OBJ)
		local var_1_11 = arg_1_0:GenUnitData(var_1_9, IslandConst.UNIT_LIST_OBJ)
	...
	for iter_1_4, iter_1_5 in ipairs(arg_1_1.options or {}) do
		local var_1_12 = arg_1_0:GenOption(iter_1_5)

		table.insert(arg_1_0.optionList, var_1_12)
	end
...
function var_0_0.GetNavObject(arg_3_0)
	if arg_3_0.style == var_0_0.STYLE_EXIT_GROUP or arg_3_0.style == var_0_0.STYLE_JOIN_GROUP then
		local var_3_0 = arg_3_0.script:GetUnitIdFromCharaId(arg_3_0.navData.characterId)
...
function var_0_0.GetAsideSequences(arg_4_0)
	if arg_4_0.style == var_0_0.STYLE_ASIDE then
		...
		for iter_4_0, iter_4_1 in ipairs(arg_4_0.sequences or {}) do
