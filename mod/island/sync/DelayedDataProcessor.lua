...
function var_0_0.RemoveDataById(arg_4_0, arg_4_1)
	if arg_4_0.delayedDataDic[arg_4_1] then
		arg_4_0.delayedDataDic[arg_4_1] = nil
	end

	if arg_4_0.preTimeStampDic[arg_4_1] then
		arg_4_0.preTimeStampDic[arg_4_1] = nil
	end
end
