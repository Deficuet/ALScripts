...
function var_0_0.OnVisitorExit(arg_11_0, arg_11_1)
	local var_11_0 = arg_11_0.visitorDic[arg_11_1]

	if var_11_0 then
		local var_11_1 = var_11_0:GetLastInteract()

		if var_11_1 then
			arg_11_0:GetUnit(var_11_1.type, var_11_1.id):RemoveOwner(arg_11_1)

			if var_11_1.type == IslandConst.SYNC_TYPE_AGORA then
				arg_11_0:Op("AgoraVirtualInterActionEndSync", var_11_1.id, arg_11_1)
			elseif var_11_1.type == IslandConst.SYNC_TYPE_UNIT_STATIC then
				arg_11_0:Op("WorldObjectInterActionEndSync", var_11_1.id, arg_11_1)
			end
		end
...
function var_0_0.UpdateLocalPlayer(arg_12_0)
	...
	if arg_12_0.player:IsLoaded() and not arg_12_0.player:InTimeline() then
		local var_12_1 = arg_12_0.player:CreateSyncData()
...
function var_0_0.UpdateVisitorSyncData(arg_15_0, arg_15_1)
	...
	if not arg_15_0.visitorDic[var_15_0] then
		Debugger.LogWarning(string.format("访客不存在 id=%d", var_15_0))
...
function var_0_0.InitAgora(arg_17_0, arg_17_1)
	...
	arg_17_0.unitDic[IslandConst.SYNC_TYPE_AGORA] = var_17_0
end

function var_0_0.CancelAgoraInteract(arg_18_0)
	local var_18_0 = arg_18_0.unitDic[IslandConst.SYNC_TYPE_AGORA]
...
function var_0_0.ResumeAgoraInteract(arg_19_0)
	local var_19_0 = arg_19_0.unitDic[IslandConst.SYNC_TYPE_AGORA]
...
function var_0_0.OnVisitorInteract(arg_28_0, arg_28_1, arg_28_2, arg_28_3)
	...
	local var_28_4 = arg_28_0.visitorDic[var_28_2]
...
function var_0_0.ControlUnit(arg_33_0, arg_33_1, arg_33_2, arg_33_3, arg_33_4, arg_33_5, arg_33_6)
	...
	pg.m02:sendNotification(GAME.ISLAND_SYNC_CONTROL, {
		...
		onResult = function(arg_34_0)
			...
			existCall(arg_33_0.controlResultDic[arg_33_1], var_34_0)
