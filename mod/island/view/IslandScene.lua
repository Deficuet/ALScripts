...
function var_0_0.didEnter(arg_12_0)
	...
	local var_12_0 = arg_12_0.contextData.resumeCallback
...
function var_0_0.OnSwitchMapByPoint(arg_30_0, arg_30_1)
	...
	arg_30_0:emit(IslandBaseMediator.SWITCH_MAP, var_30_0)
end
...
function var_0_0.OnSwitchMap(arg_35_0, arg_35_1)
	local var_35_0 = pg.island_world_objects[arg_35_1].mapId

	arg_35_0:emit(IslandBaseMediator.SWITCH_MAP, var_35_0, arg_35_1)
end
...
function var_0_0.OnShipGetState(arg_49_0, arg_49_1)
	...
	arg_49_0:ShowToast({
		...
		content = i18n("island_toast_status", var_49_1:GetName(), var_49_2)
	})
end
...
function var_0_0.OnShipLevelUp(arg_50_0, arg_50_1)
	...
	arg_50_0:ShowToast({
		content = i18n("island_toast_level", var_50_1, var_50_0)
	})
end

function var_0_0.OnAddShip(arg_51_0, arg_51_1)
	local var_51_0 = arg_51_1:GetName()
	local var_51_1 = arg_51_0:GetIsland():GetName()

	arg_51_0:ShowToast({
		content = i18n("island_toast_ship", var_51_1, var_51_0)
	})
end
