...
function var_0_0.Hide(arg_14_0, arg_14_1, arg_14_2)
	local var_14_0 = defaultValue(arg_14_1, true)
	local var_14_1 = {}
...
function var_0_0.AddListener(arg_28_0, arg_28_1, arg_28_2)
	...
	arg_28_0:GetIsland():AddListener(arg_28_1, var_28_0)
end

function var_0_0.RemoveListener(arg_30_0, arg_30_1, arg_30_2)
	local var_30_0 = arg_30_0.__callbacks__[arg_30_1]

	if var_30_0 then
		local var_30_1 = arg_30_0.eventStore[var_30_0]

		arg_30_0:GetIsland():RemoveListener(arg_30_1, var_30_1.callback)
		arg_30_0:disconnect(var_30_0)
