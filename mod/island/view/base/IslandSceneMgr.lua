...
function var_0_0.GetContext(arg_7_0, arg_7_1)
	...
	for iter_7_2, iter_7_3 in ipairs(arg_7_0.stack) do
		...
		if var_7_0 then
			return iter_7_3, var_7_0:GetLevel()
		end
	end
...
function var_0_0.CreateScenePage(arg_17_0, arg_17_1)
	...
	local var_17_2 = var_17_1:NeedCache() and arg_17_0.pages or arg_17_0.noStatePages
...
function var_0_0.GetLongestNoUsePage(arg_23_0, arg_23_1)
	...
	local var_23_2 = math.max(var_23_1, 1)

	return arg_23_0.pages[var_23_2]
end

function var_0_0.ClosePage(arg_25_0, arg_25_1)
	if not (arg_25_0:CheckAndCloseSubPage(arg_25_1) or arg_25_0:CheckAndCloseNoStatePage(arg_25_1)) then
...
function var_0_0.CheckAndCloseScenePage(arg_27_0, arg_27_1)
	...
	if var_27_0 then
		...
		if var_27_1 and var_27_1:GetLoaded() and var_27_1:isShowing() then
			local var_27_2 = var_27_0:GetOpenPrevWhenClose()
			...
			for iter_27_0, iter_27_1 in ipairs(var_27_0:GetSubPages()) do
				local var_27_3 = arg_27_0:GetSubPage(iter_27_1.class)

				if var_27_3 and var_27_3:GetLoaded() then
					var_27_3:Destroy()
					table.removebyvalue(arg_27_0.subPages, var_27_3)
				end
			end
...
function var_0_0.OnBackPressed(arg_40_0)
	local var_40_0 = arg_40_0.stack[#arg_40_0.stack]

	if var_40_0 then
		local var_40_1 = arg_40_0:GetPage(var_40_0.class)

		if var_40_1 and var_40_1:CanEsc() then
			var_40_1:Hide()
		end
...
function var_0_0.Dispose(arg_42_0)
	...
	for iter_42_0 = #arg_42_0.pages, 1, -1 do
		...
		var_42_0:ActiveOrDisactive(false)
		arg_42_0:DestroyPage(var_42_0)
	end

	for iter_42_1 = #arg_42_0.noStatePages, 1, -1 do
		local var_42_1 = arg_42_0.noStatePages[iter_42_1]

		var_42_1:ActiveOrDisactive(false)
		arg_42_0:DestroyPage(var_42_1)
	end
...
function var_0_0.Debug(arg_43_0)
	...
	local function var_43_0(arg_44_0)
		local var_44_0 = _.map(arg_44_0:GetSubPages(), function(arg_45_0)
			return arg_45_0.class.__cname
		end)

		return table.concat(var_44_0, ",")
	end

	local var_43_1 = _.map(arg_43_0.stack, function(arg_46_0)
		return arg_46_0.class.__cname .. ":[" .. var_43_0(arg_46_0) .. "]"
	end)
	local var_43_2 = table.concat(var_43_1, "\n")
