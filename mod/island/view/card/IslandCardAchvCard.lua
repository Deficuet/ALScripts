...
function var_0_0.Update(arg_2_0, arg_2_1, arg_2_2)
	...
	local var_2_0 = pg.island_achievement[arg_2_1]

	setText(arg_2_0.nameTF, var_2_0.name)
	GetImageSpriteFromAtlasAsync("islandachievement", "achv_stage_" .. var_2_0.stage, arg_2_0.iconTF, true)
