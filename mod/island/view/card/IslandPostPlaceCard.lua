...
function var_0_0.Update(arg_4_0, arg_4_1, arg_4_2)
	...
	local var_4_0 = pg.island_production_place[arg_4_0.id]

	setText(arg_4_0.nameTF, var_4_0.name)
	...
	local var_4_1 = var_4_0.commission_slot

	arg_4_0.slotIds = {}
	arg_4_0.slotId2CommissionId = {}

	for iter_4_0, iter_4_1 in ipairs(var_4_1) do
		local var_4_2 = pg.island_production_commission[iter_4_1].slot

		table.insert(arg_4_0.slotIds, pg.island_production_commission[iter_4_1].slot)

		arg_4_0.slotId2CommissionId[var_4_2] = iter_4_1
	end
...
function var_0_0.UpdateSlotItem(arg_6_0, arg_6_1, arg_6_2)
	...
	if var_6_0 then
		...
		if var_6_1 then
			local var_6_2 = pg.island_formula[var_6_1].commission_product[1][1]
			...
			LoadImageSpriteAsync("island/" .. var_6_3, arg_6_2:Find("unlock/formula/icon"))
		end

		local var_6_4 = var_6_0:GetSlotRoleData()

		setActive(arg_6_2:Find("unlock/formula/get"), not var_6_4)
...
function var_0_0.UpdateSlotShip(arg_8_0, arg_8_1, arg_8_2)
	...
	if var_8_0 then
		...
		if var_8_1 then
			local var_8_2 = IslandShip.StaticGetPrefab(var_8_1.ship_id)

			LoadImageSpriteAsync("squareicon/" .. var_8_2, arg_8_2:Find("unlock/ship/mask/icon"))
		end
...
function var_0_0.AddTimer(arg_10_0, arg_10_1, arg_10_2)
	...
	local var_10_0 = arg_10_1:Find("unlock/formula/fill"):GetComponent(typeof(Image))

	local function var_10_1()
		arg_10_0:RemoveTimer(arg_10_2.id)
		setActive(arg_10_1:Find("unlock/formula/get"), true)

		var_10_0.fillAmount = 1
	end

	local var_10_2 = Timer.New(function()
		...
		if not var_12_0 then
			...
			local var_12_2 = pg.TimeMgr.GetInstance():GetServerTime() - var_12_0:InCurrentTimeStart(var_12_1)

			var_10_0.fillAmount = var_12_2 / var_12_0:CurrentTimeNeed(var_12_1)
		end
	end, 1, -1)
	...
	arg_10_0.timers[arg_10_2.id] = var_10_2
end
