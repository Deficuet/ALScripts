...
function var_0_0.TrackUI(arg_9_0)
	...
	local var_9_0 = arg_9_0.task:GetTraceParam()
...
function var_0_0._SkipBtn(arg_12_0, arg_12_1)
	local var_12_0 = pg.island_main_btns[arg_12_1]

	if not getProxy(IslandProxy):GetIsland():GetAblityAgency():HasAbility(var_12_0.ability_id) then
	...
	if var_12_0.open_page ~= "" then
		arg_12_0:emit(IslandMediator.OPEN_PAGE, var_12_0.open_page, var_12_0.page_param)
	end
end

function var_0_0._SkipObj(arg_13_0, arg_13_1)
	local var_13_0 = pg.island_world_objects[arg_13_1].mapId

	if not getProxy(IslandProxy):GetIsland():GetAblityAgency():IsUnlockMap(var_13_0) then
		pg.TipsMgr.GetInstance():ShowTips(i18n("island_taskjump_placenoopen_tips"))

		return
	end

	arg_13_0:emit(IslandBaseMediator.SWITCH_MAP, var_13_0, pg.island_map[var_13_0].born_object)
end
...
function var_0_0.UpdateTargetBtnItem(arg_14_0, arg_14_1, arg_14_2)
	...
	if var_14_0 then
		local var_14_2 = pg.island_task_target[var_14_0.id]
		local var_14_3 = tonumber(var_14_2.tips)
		local var_14_4 = tonumber(var_14_2.jump_ui)

		if not var_14_0:IsFinish() then
			if var_14_4 then
				setActive(var_14_1, true)
				onButton(arg_14_0, var_14_1, function()
					arg_14_0:_SkipBtn(var_14_4)
				end, SFX_PANEL)
			elseif var_14_3 then
				local var_14_5 = pg.island_world_objects[var_14_3].mapId

				if IslandMainBtnTipHelper.IsUnlock("map") and arg_14_0.curMapId ~= var_14_5 then
					setActive(var_14_1, true)
					onButton(arg_14_0, var_14_1, function()
						arg_14_0:_SkipObj(var_14_3)
					end, SFX_PANEL)
				end
			end
		end
		...
		local var_14_6 = tonumber(arg_14_0.task:getConfig("complete_data"))

		if var_14_6 and var_14_6 ~= 0 then
			local var_14_7 = pg.island_world_objects[var_14_6].mapId

			if IslandMainBtnTipHelper.IsUnlock("map") and arg_14_0.curMapId ~= var_14_7 then
				setActive(var_14_1, true)
				onButton(arg_14_0, var_14_1, function()
					arg_14_0:_SkipObj(var_14_6)
				end, SFX_PANEL)
			end
		end
	end
