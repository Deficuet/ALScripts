...
function var_0_0.UpdateItem(arg_3_0, arg_3_1, arg_3_2)
	...
	local var_3_1 = getProxy(IslandProxy):GetIsland():GetTechnologyAgency():GetTechnology(var_3_0)
	...
	local var_3_3 = var_3_2 == IslandTechnology.STATUS.STUDYING or var_3_2 == IslandTechnology.STATUS.LOCK or var_3_2 == IslandTechnology.STATUS.NORMAL and var_3_1:GetFinishedCnt() == 0

	setImageAlpha(arg_3_2:Find("icon"), var_3_3 and 0.5 or 1)

	local var_3_4 = arg_3_2:GetComponent(typeof(Animation))

	if var_3_2 == IslandTechnology.STATUS.NORMAL and var_3_1:GetFinishedCnt() == 0 then
		var_3_4:Play("anim_Island_technology_tplicon_in")
	elseif var_3_2 == IslandTechnology.STATUS.STUDYING then
		var_3_4:Play("anim_Island_technology_tplstudy_in")
	elseif var_3_2 == IslandTechnology.STATUS.RECEIVE then
		var_3_4:Play("anim_Island_technology_tplreceive_in")
	else
		var_3_4:Stop()
	end

	onButton(arg_3_0, arg_3_2, function()
		existCall(arg_3_0.onItemClick, var_3_0)
	end, SFX_PANEL)
end
