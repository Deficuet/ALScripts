...
function var_0_0.InitToggle(arg_8_0, arg_8_1, arg_8_2)
	...
	local var_8_1 = pg.island_achievement_group[var_8_0]

	LoadImageSpriteAtlasAsync("islandachievement", var_8_1.icon, arg_8_2:Find("icon"), true)
	setText(arg_8_2:Find("name"), var_8_1.name)
...
function var_0_0.UpdateToggle(arg_10_0, arg_10_1, arg_10_2)
	...
	local var_10_1 = pg.island_achievement_group[var_10_0].achievement_list
	local var_10_2 = {}

	for iter_10_0, iter_10_1 in ipairs(var_10_1) do
		local var_10_3 = arg_10_0.achvAgency:GetGroup(iter_10_1)

		for iter_10_2, iter_10_3 in ipairs(var_10_3:GetSortAchvList()) do
			table.insert(var_10_2, iter_10_3)
		end
	end

	local var_10_4 = underscore.any(var_10_2, function(arg_11_0)
		return arg_11_0:GetStatus() == IslandAchievement.STATUS.GET
	end)

	setActive(arg_10_2:Find("name/tip"), var_10_4)
end
...
function var_0_0.FlushDetail(arg_16_0)
	...
	arg_16_0.scrollRect:SetTotalCount(#arg_16_0.showAchvList, -1)
end
