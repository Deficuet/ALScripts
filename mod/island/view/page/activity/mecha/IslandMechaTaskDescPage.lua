...
function var_0_0.UpdateList(arg_8_0)
	arg_8_0.uiItemList:make(function(arg_9_0, arg_9_1, arg_9_2)
		...
		setText(arg_9_2:Find("day"), var_9_1 < 10 and "0" .. var_9_1 or var_9_1)
	end)
	arg_8_0.uiItemList:align(#arg_8_0.taskGroup)
end

function var_0_0.GetDayDesc(arg_10_0, arg_10_1)
	local var_10_0 = arg_10_0.startTime + arg_10_1 * 86400
	local var_10_1 = pg.TimeMgr.GetInstance():STimeDescS(var_10_0, "%Y/%m/%d/%H/%M/%S")
	local var_10_2 = string.split(var_10_1, "/")

	return var_10_2[2], var_10_2[3]
end
...
function var_0_0.UpdateTask(arg_11_0, arg_11_1, arg_11_2, arg_11_3)
	...
	local var_11_6, var_11_7 = arg_11_0:GetDayDesc(arg_11_1 - 1)
