...
function var_0_0.FlushRightPanel(arg_5_0)
	...
	local var_5_2 = getProxy(IslandProxy):GetIsland():GetFishingAgency():GetFish(var_5_1)

	setText(arg_5_0.minWeightTF:Find("value"), var_5_2:GetMinWeight() / 1000 .. "KG")
	setText(arg_5_0.maxWeightTF:Find("value"), var_5_2:GetMaxWeight() / 1000 .. "KG")
	setActive(arg_5_0.minWeightTF:Find("Image"), var_5_2:ReachMinCup())
	setActive(arg_5_0.maxWeightTF:Find("Image"), var_5_2:ReachMaxCup())
end
