...
function var_0_0.OnUpdateItem(arg_19_0, arg_19_1, arg_19_2)
	...
	if var_19_1 then
		var_19_0:Update(var_19_1, arg_19_0.showIllustration and arg_19_0.showIllustration.id)
	end
...
function var_0_0.OnGetPointAwardDone(arg_23_0, arg_23_1)
	...
	for iter_23_0, iter_23_1 in ipairs(var_23_0) do
		local var_23_1 = pg.island_ability_template[iter_23_1.id].unlock_text
...
function var_0_0.FlushOnlyItem(arg_29_0)
	...
	if var_29_0 then
		...
		setText(arg_29_0.rightProgressTF, var_29_2 and var_29_1 .. "/" .. var_29_2 or var_29_1)
	end
end
...
function var_0_0.FlushPointAwardInfos(arg_30_0)
	...
	local var_30_2 = Drop.Create(arg_30_0.awardConfig.award_display)

	GetImageSpriteFromAtlasAsync(var_30_2:getIcon(), "", arg_30_0.pointAwardIcon)
end
