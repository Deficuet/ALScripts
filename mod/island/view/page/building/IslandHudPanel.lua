...
function var_0_0.InitHudHeight(arg_6_0)
	...
	local var_6_0 = pg.island_set.information_hud_height.key_value_varchar[2]
...
function var_0_0.UpdateHudDisplay(arg_9_0)
	...
	if arg_9_0.hudInfo.hudState then
		local var_9_0 = arg_9_0.hudInfo.hudState
		...
		if var_9_0.stateEndTime then
			...
			setText(arg_9_0.timeTF, var_9_0.stateText)
		end
	else
...
function var_0_0.LateUpdate(arg_13_0)
	...
	if not IslandCalcUtil.IsInViewport(var_13_0) then
		...
		local var_13_1 = IslandCalcUtil.WorldPosition2LocalPosition(arg_13_0.parentTF, var_13_0)

		arg_13_0._tf.localPosition = var_13_1
	end
end
