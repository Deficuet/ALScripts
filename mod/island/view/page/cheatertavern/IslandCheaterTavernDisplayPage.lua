...
function var_0_0.OnShow(arg_12_0)
	...
	local var_12_1 = var_12_0:GetViewGameShipViewId(PlayRoomTools.GetGameTypeID())
	local var_12_2 = var_12_0:GetShipById(var_12_1)

	if not arg_12_0.shipDressHelper then
		arg_12_0.shipDressHelper = IslandShipDressHelperNew.New()
	end

	arg_12_0.shipDressHelper:SetShipId(var_12_2.configId, {}, true)
	arg_12_0:LoadCharacter(var_12_2:GetModel())
...
function var_0_0.SetCharterPos(arg_19_0)
	...
	local var_19_2 = var_19_1._mainCamera:ScreenToWorldPoint(Vector3(var_19_0.x, var_19_0.y, 7))

	arg_19_0.role.transform.localPosition = var_19_2
end
...
function var_0_0.LoadCharacter(arg_20_0, arg_20_1, arg_20_2)
	...
	local function var_20_1(arg_21_0, arg_21_1)
		...
		local var_21_0 = arg_20_0:GetSmoothRotateObject()
		local var_21_1 = GetOrAddComponent(var_21_0, typeof(SmoothRotateObject))

		var_21_1:SetUp(arg_20_0.role.transform)

		var_21_1.rotationSpeed = pg.island_set.character_detail_camera_speed.key_value_int

		if arg_21_1 and arg_21_1 ~= "" then
			local var_21_2 = GetOrAddComponent(arg_20_0.role.transform:GetChild(0), typeof(Animator))

			for iter_21_0 = 1, var_21_2.layerCount do
				var_21_2:CrossFadeInFixedTime(arg_21_1, 0, iter_21_0 - 1)
			end
		end
	...
	arg_20_0:_LoadModel(var_20_0, var_20_1)
end
...
function var_0_0.LoadCharacterScene(arg_22_0, arg_22_1)
	...
	SceneOpMgr.Inst:LoadSceneAsyncWithProgress(var_22_0, "map_xyd_bar_character02", LoadSceneMode.Additive, function(arg_23_0)
		if arg_23_0 == 1 then
			arg_22_1()
		end
	end)
...
function var_0_0.UnLoadCharacterScene(arg_24_0, arg_24_1)
	...
	SceneOpMgr.Inst:UnloadSceneAsync(var_24_0, "map_xyd_bar_character02", function()
		if arg_24_1 then
			arg_24_1()
		end
	end)
