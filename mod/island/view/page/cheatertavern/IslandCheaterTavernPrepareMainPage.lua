...
function var_0_0.OnCloseSubPage(arg_9_0, arg_9_1)
	...
	if not table.contains(var_9_0, arg_9_1) then
		return
	end
	...
	if var_9_1 ~= 0 then
		table.remove(arg_9_0.subPageStack, var_9_1)
	end

	if var_9_1 > 1 then
		local var_9_2 = var_9_1 - 1
		local var_9_3 = arg_9_0.subPageStack[var_9_2]

		if var_9_3.__cname == "IslandCheaterTavernPlayRoomInfoPage" then
			arg_9_0:OpenPage(var_9_3, IslandCheaterTavernConst.SceneRoomType.CustomRoom)
		else
			arg_9_0:OpenPage(var_9_3)
		end

		arg_9_0.pageClass = var_9_3
