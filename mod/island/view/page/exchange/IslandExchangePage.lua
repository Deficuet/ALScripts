...
function var_0_0.UpdateToggleItem(arg_20_0, arg_20_1, arg_20_2)
	...
	local var_20_1 = pg.island_exchange_group[var_20_0]

	setText(arg_20_2:Find("title/name"), var_20_1.text[1])
	setText(arg_20_2:Find("title/name/en"), var_20_1.text[2])
	GetImageSpriteFromAtlasAsync("island/islandshopicon", var_20_1.text[3], arg_20_2:Find("title/sel/icon"))
	...
	local var_20_2 = var_20_1.exchange_group

	UIItemList.StaticAlign(arg_20_2:Find("list"), arg_20_2:Find("list/tpl"), #var_20_2, function(arg_22_0, arg_22_1, arg_22_2)
		if arg_22_0 == UIItemList.EventUpdate then
			local var_22_0 = arg_22_1 + 1
			local var_22_1 = var_20_2[var_22_0][1]
			local var_22_2 = var_20_2[var_22_0][2]

			setText(arg_22_2:Find("name"), var_22_1)
			setText(arg_22_2:Find("sel/name"), var_22_1)
			setActive(arg_22_2:Find("line2"), var_22_0 ~= #var_20_2)
...
function var_0_0.FlushGroup(arg_24_0)
	...
	local var_24_0 = pg.island_item_data_template[arg_24_0.showItemId]
...
function var_0_0.UpdateCount(arg_26_0)
	...
	arg_26_0.itemAddTxt.text = arg_26_0.totalAddCnt > 0 and "+" .. arg_26_0.totalAddCnt or ""
end
...
function var_0_0.OnInitItem(arg_27_0, arg_27_1)
	...
	onInputEndEdit(arg_27_0, var_27_0.valueInput, function(arg_30_0)
		...
		local var_30_3 = tonumber(arg_30_0) - arg_27_0.values[var_30_0]

		arg_27_0:UpdateCardSel(var_27_0, var_30_3)
	end)
...
function var_0_0.UpdateCardSel(arg_33_0, arg_33_1, arg_33_2)
	...
	local var_33_1 = arg_33_0.values[var_33_0] + arg_33_2

	arg_33_0.values[var_33_0] = math.max(0, math.min(var_33_1, arg_33_1.item:GetCount()))
...
function var_0_0.CollectDisplayItems(arg_37_0)
	...
	local var_37_2 = pg.island_exchange_template

	arg_37_0.showExchangeIds = var_37_2.get_id_list_by_group[arg_37_0.showGroupId]
	arg_37_0.showItemId = var_37_2[arg_37_0.showExchangeIds[1]].target_item

	for iter_37_0, iter_37_1 in ipairs(arg_37_0.showExchangeIds) do
		local var_37_3 = var_37_2[iter_37_1].origin_item
		local var_37_4 = var_37_1:GetItemById(var_37_3)

		if var_37_4 then
			local var_37_5 = Clone(var_37_4)

			var_37_5.exchangeId = iter_37_1
			var_37_5.targetNum = var_37_2[iter_37_1].target_num
