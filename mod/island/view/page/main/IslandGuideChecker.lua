...
var_0_0.FISHING_TASK_ID = 20016003
...
var_0_0.pageConfig = {
	...
	},
	{
		...
		condition = function()
			...
			local var_7_1 = var_7_0:GetTaskAgency():GetTask(var_0_0.TECH_TASK_ID)
			local var_7_2 = var_7_0:GetTechnologyAgency():GetTechnology(var_0_0.TECH_FIRST_ID):GetStatus()

			return var_7_1 and (var_7_2 == IslandTechnology.STATUS.LOCK or var_7_2 == IslandTechnology.STATUS.UNLOCK or var_7_2 == IslandTechnology.STATUS.NORMAL)
		end,
		type = var_0_0.FINISH_TYPE.ON_GUIDE
	},
	{
...
function var_0_0.CheckOnLoaded(arg_18_0, arg_18_1)
	local var_18_0 = _.detect(var_0_0.loadedConfig, function(arg_19_0)
		...
		return not pg.NewStoryMgr.GetInstance():IsPlayed(var_19_0) and (var_19_1 == 0 or var_19_1 == arg_18_0) and var_19_2()
	end)
...
function var_0_0.CheckOnShowInteraction(arg_20_0, arg_20_1)
	local var_20_0 = _.detect(var_0_0.interactionConfig, function(arg_21_0)
		...
		return not pg.NewStoryMgr.GetInstance():IsPlayed(var_21_0) and (var_21_1 == 0 or var_21_1 == arg_20_0) and var_21_2()
	end)
...
function var_0_0.CheckOnOpenPage(arg_22_0, arg_22_1)
	local var_22_0 = _.detect(var_0_0.pageConfig, function(arg_23_0)
		...
		return not pg.NewStoryMgr.GetInstance():IsPlayed(var_23_0) and var_23_1 == arg_22_0 and var_23_2()
	end)
...
function var_0_0.CheckGuide(arg_24_0, arg_24_1, arg_24_2)
	...
	local var_24_0 = arg_24_1 or var_0_0.FINISH_TYPE.ON_BEGIN

	var_0_0._PlayGuide(arg_24_0, var_24_0, arg_24_2)
end
...
function var_0_0.CheckGuideWithArgs(arg_25_0, arg_25_1, arg_25_2, arg_25_3)
	...
	local var_25_0 = arg_25_1 or var_0_0.FINISH_TYPE.ON_BEGIN

	var_0_0._PlayGuide(arg_25_0, var_25_0, arg_25_2, arg_25_3)
end
...
function var_0_0.Record(arg_29_0, arg_29_1, arg_29_2)
	local var_29_0 = pg.TimeMgr.GetInstance():GetServerTime() - arg_29_1

	pg.GameTrackerMgr.GetInstance():Record(GameTrackerBuilder.BuildIslandGuide(arg_29_0, var_29_0, arg_29_2))
end
