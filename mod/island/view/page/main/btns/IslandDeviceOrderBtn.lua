...
function var_0_0.FlushDataUI(arg_2_0)
	...
	local var_2_2 = var_2_0:GetFinishCnt()

	arg_2_0.normalTxt.text = var_2_1 - var_2_2 .. "/" .. var_2_1

	local var_2_3 = var_2_0:GetMaxUrgentFinishCnt()
	local var_2_4 = var_2_0:GetLeftUrgentCnt()

	arg_2_0.urgencyTxt.text = var_2_4 .. "/" .. var_2_3
end
