...
function var_0_0.AddTimer(arg_3_0, arg_3_1)
	...
	arg_3_0.timer = Timer.New(function(arg_4_0, arg_4_1, arg_4_2)
		...
		local var_4_1 = var_3_0 - var_4_0

		arg_3_0.timeTxt.text = pg.TimeMgr.GetInstance():DescCDTime(var_4_1)
...
function var_0_0.GetState(arg_6_0)
	...
	local var_6_1 = underscore.values(var_6_0:GetShipSlotList())
	local var_6_2 = underscore.detect(var_6_1, function(arg_7_0)
		return arg_7_0:IsFinished()
	end)

	if var_6_2 then
		return var_0_0.STATES.FINISHED, var_6_2
	end

	local var_6_3 = underscore.select(var_6_1, function(arg_8_0)
		return arg_8_0:IsSubmited() and not arg_8_0:IsFinished()
	end)

	table.sort(var_6_3, CompareFuncs({
		function(arg_9_0)
	...
	if #var_6_3 > 0 then
		return var_0_0.STATES.RUNNING, var_6_3[1]
	end
