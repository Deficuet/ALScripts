...
function var_0_0.ShowAwards(arg_7_0, arg_7_1)
	...
	if not arg_7_1.shipExp then
		...
		for iter_7_0, iter_7_1 in ipairs(var_7_0) do
			...
			setActive(findTF(var_7_1, "name"), true)
			setActive(findTF(var_7_1, "exp"), false)

			local var_7_2 = iter_7_1:getIcon()
			local var_7_3 = iter_7_1:getName()

			setText(findTF(var_7_1, "name"), string.format(var_7_3))
			GetImageSpriteFromAtlasAsync(var_7_2, "", findTF(var_7_1, "icon"))
			setText(findTF(var_7_1, "name/count"), iter_7_1:getCount())
		end
	else
		local var_7_4 = arg_7_0:CreateItem()

		setActive(findTF(var_7_4, "name"), false)
		setActive(findTF(var_7_4, "exp"), true)
		GetImageSpriteFromAtlasAsync(arg_7_1.icon, "", findTF(var_7_4, "icon"))
		setText(findTF(var_7_4, "exp/count"), arg_7_1.num)
	end
end
...
function var_0_0.CreateItem(arg_8_0)
	...
	local var_8_1 = arg_8_0.showCount - 1

	var_8_0.transform:SetSiblingIndex(var_8_1)
