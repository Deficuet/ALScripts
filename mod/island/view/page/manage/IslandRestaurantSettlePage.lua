...
function var_0_0.OnInit(arg_3_0)
	...
	arg_3_0.saleUIList:make(function(arg_7_0, arg_7_1, arg_7_2)
		if arg_7_0 == UIItemList.EventUpdate then
			...
			arg_3_0:UpdateCommonItem(arg_7_2, var_7_0)
			setText(arg_7_2:Find("price/Text"), var_7_0.price)
		end
	end)
	arg_3_0.remainUIList:make(function(arg_8_0, arg_8_1, arg_8_2)
		if arg_8_0 == UIItemList.EventUpdate then
			...
			arg_3_0:UpdateCommonItem(arg_8_2, var_8_0)
		end
	end)
...
function var_0_0.OnShow(arg_9_0, arg_9_1, arg_9_2)
	...
	local var_9_1 = getProxy(IslandProxy):GetIsland():GetManageAgency():GetRestaurant(arg_9_0.restId)
...
function var_0_0.UpdateCommonItem(arg_10_0, arg_10_1, arg_10_2)
	local var_10_0 = pg.island_item_data_template[arg_10_2.id].icon

	LoadImageSpriteAsync("island/" .. var_10_0, arg_10_1:Find("bg/icon"))
	setText(arg_10_1:Find("count/Text"), arg_10_2.num)

	local var_10_1 = arg_10_0:GetAttrsFactorsRatio(arg_10_2.id)

	setFillAmount(arg_10_1:Find("bg/silder/bar"), var_10_1)
end
