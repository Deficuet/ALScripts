...
function var_0_0.UpdateProductionList(arg_3_0, arg_3_1)
	local var_3_0 = pg.island_map_details.get_id_list_by_belong_map[arg_3_1]
	local var_3_1 = arg_3_0:GetIsland():GetAblityAgency()
	local var_3_2 = _.select(var_3_0, function(arg_4_0)
		return var_3_1:HasAbility(pg.island_map_details[arg_4_0].ability_id)
	end)

	arg_3_0.uiProductionList:make(function(arg_5_0, arg_5_1, arg_5_2)
		if arg_5_0 == UIItemList.EventUpdate then
			local var_5_0 = var_3_2[arg_5_1 + 1]
			local var_5_1 = pg.island_map_details[var_5_0]

			GetImageSpriteFromAtlasAsync("island/IslandMapRes", var_5_1.detail_icon, arg_5_2)
			setText(arg_5_2:Find("Text"), var_5_1.name)
			arg_3_0:AddTimer(arg_5_2, var_5_1.production_place_id)
		end
	end)
	arg_3_0.uiProductionList:align(#var_3_2)
end
...
function var_0_0.AddTimer(arg_6_0, arg_6_1, arg_6_2)
	...
	local var_6_1 = getProxy(IslandProxy):GetIsland():GetBuildingAgency():GetBuilding(arg_6_2)
	local var_6_2 = var_6_1 and var_6_1:GetMinRoleDeleGationTime() or -1

	if var_6_2 < 0 then
		return
	end

	local var_6_3 = pg.TimeMgr.GetInstance():GetServerTime()
