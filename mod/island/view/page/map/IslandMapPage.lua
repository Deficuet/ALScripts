...
function var_0_0.CheckAcceptableTask(arg_4_0, arg_4_1)
	local function var_4_0(arg_5_0)
		...
		SetActive(var_5_0:Find("fetch"), arg_5_0)
	end

	local var_4_1 = getProxy(IslandProxy):GetIsland():GetTaskAgency():GetCanAcceptTasksByMapId(arg_4_1)
...
function var_0_0.CheckFinishableTask(arg_6_0, arg_6_1)
	local function var_6_0(arg_7_0)
		...
		SetActive(var_7_0:Find("finish"), arg_7_0)
	end

	local var_6_1 = getProxy(IslandProxy):GetIsland():GetTaskAgency():GetCanSubmitTasksByMapId(arg_6_1)
...
function var_0_0.CheckProductions(arg_8_0, arg_8_1)
	local function var_8_0(arg_9_0)
		...
		SetActive(var_9_0:Find("full"), arg_9_0)
	end
