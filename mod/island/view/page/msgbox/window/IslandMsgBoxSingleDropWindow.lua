...
function var_0_0.OnShow(arg_3_0)
	...
	local var_3_1 = IslandDropDescribeInfo.New(var_3_0)
...
function var_0_0.FlushMain(arg_4_0, arg_4_1)
	...
	local var_4_0 = arg_4_1:GetOwnCount()

	arg_4_0.ownTxt.text = i18n("island_own_cnt") .. setColorStr(var_4_0, "#39beff")
...
function var_0_0.FlushAcquiringWay(arg_5_0, arg_5_1)
	...
	setActive(arg_5_0._tf:Find("line"), var_5_2)
	setActive(arg_5_0._tf:Find("label"), var_5_2)
	setActive(arg_5_0._tf:Find("way"), var_5_2)
	arg_5_0.uiItemList:make(function(arg_6_0, arg_6_1, arg_6_2)
		if arg_6_0 == UIItemList.EventUpdate then
			...
			onButton(arg_5_0, arg_6_2:Find("go"), function()
				...
				arg_5_0:GetMsgBoxMgr():emit(IslandMediator.OPEN_PAGE, var_7_1, var_7_0)
				arg_5_0:Hide()
			end, SFX_PANEL)
