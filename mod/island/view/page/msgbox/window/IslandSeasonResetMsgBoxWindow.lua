...
function var_0_0.FlushResetInfo(arg_5_0)
	...
	local var_5_1 = var_5_0.awards

	setActive(arg_5_0.emptyTF, #var_5_1 == 0)
	setActive(arg_5_0.awardTF, #var_5_1 > 0)

	local var_5_2 = #var_5_1 == 0 and arg_5_0.emptyTF or arg_5_0.awardTF
	local var_5_3 = pg.island_season[var_5_0.seasonId].name

	setText(var_5_2:Find("reset/name/Text"), i18n("island_season_window_pt", var_5_3))
	setText(var_5_2:Find("reset/value/Text"), var_5_0.pt)
	setText(var_5_2:Find("rank/name/Text"), i18n("island_season_window_ranking"))
	setText(var_5_2:Find("rank/value"), var_5_0.rank > 0 and var_5_0.rank or i18n("island_season_window_out"))
