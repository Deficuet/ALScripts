...
function var_0_0.OnInit(arg_3_0)
	...
	arg_3_0.bottomItemList:make(function(arg_10_0, arg_10_1, arg_10_2)
		if arg_10_0 == UIItemList.EventUpdate then
			...
			updateCustomDrop(arg_10_2, var_10_1)
	...
	onButton(arg_3_0, arg_3_0.buyBtn, function()
		if arg_3_0.curCount <= 0 then
			local var_11_0 = arg_3_0.settings

			if var_11_0.mode == IslandConst.TRADE_PURCHASE then
				pg.TipsMgr.GetInstance():ShowTips(i18n("island_trade_cnt_inadequate"))
			elseif var_11_0.mode == IslandConst.TRADE_SELL then
...
function var_0_0.OnShow(arg_12_0)
	...
	local var_12_0 = arg_12_0.settings

	arg_12_0.price = var_12_0.price or 0
	arg_12_0.maxCnt = var_12_0.maxCnt or 0
	arg_12_0.awards = {}

	local var_12_1 = IslandItem.New({
		id = IslandItem.PEARL_ID
	})
	local var_12_2 = IslandItem.New({
		id = IslandItem.GOLD_ID
	})

	if var_12_0.mode == IslandConst.TRADE_PURCHASE then
		...
		GetImageSpriteFromAtlasAsync("island/" .. var_12_2:GetIcon(), "", arg_12_0.consumeIcon)
		table.insert(arg_12_0.awards, var_12_1)
	elseif var_12_0.mode == IslandConst.TRADE_SELL then
		...
		table.insert(arg_12_0.awards, var_12_2)
	end

	GetImageSpriteFromAtlasAsync("island/" .. var_12_1:GetIcon(), "", arg_12_0.icon)

	arg_12_0.name.text = var_12_1:getConfig("name")
	arg_12_0.desc.text = var_12_1:getConfig("desc")
