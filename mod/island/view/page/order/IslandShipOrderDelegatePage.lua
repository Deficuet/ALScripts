...
function var_0_0.GetDisplays(arg_21_0)
	local var_21_0 = {}
	local var_21_1 = arg_21_0:GetIsland():GetOrderAgency():GetDelegateList()
...
function var_0_0.AddNextAutoRefreshTimer(arg_25_0)
	...
	arg_25_0.autoTimer = Timer.New(function()
		...
		if var_26_1 < 0 then
			...
			arg_25_0.autoRefreshTimeTxt.text = pg.TimeMgr.GetInstance():DescCDTime(var_26_1)
		end
	end, 1, -1)
...
function var_0_0.UpdateItem(arg_28_0, arg_28_1, arg_28_2)
	...
	var_28_1:make(function(arg_29_0, arg_29_1, arg_29_2)
		if arg_29_0 == UIItemList.EventUpdate then
			...
			local var_29_1 = Drop.New(var_29_0)
			local var_29_2 = var_29_1.icon or var_29_1:getConfig("icon")

			GetImageSpriteFromAtlasAsync("island/" .. var_29_2, "", arg_29_2:Find("icon"))

			local var_29_3 = var_29_1:getOwnedCount()

			setText(arg_29_2:Find("cnt"), setColorStr(var_29_3 .. "/" .. var_29_1.count, var_29_3 >= var_29_1.count and "#39beff" or "#f36c6e"))
			setActive(arg_29_2:Find("mark"), var_29_3 >= var_29_1.count)
		end
	end)
	...
	var_28_3:make(function(arg_30_0, arg_30_1, arg_30_2)
		if arg_30_0 == UIItemList.EventUpdate then
			...
			local var_30_1 = Drop.New(var_30_0)

			updateCustomDrop(arg_30_2, Drop.New(var_30_0))
		end
	end)
...
function var_0_0.AddRefreshTimer(arg_32_0, arg_32_1)
	arg_32_0.timer = Timer.New(function()
		...
		local var_33_1 = arg_32_1 - var_33_0
		...
		if var_33_1 < 0 then
			...
			arg_32_0.refreshTimeTxt.text = pg.TimeMgr.GetInstance():DescCDTime(var_33_1)
		end
	end, 1, -1)
...
function var_0_0.SwitchPage(arg_37_0, arg_37_1)
	...
	for iter_37_0, iter_37_1 in pairs(arg_37_0.toggles) do
		...
		local var_37_1 = setColorStr(arg_37_0.toggleLabels[iter_37_0], var_37_0)
