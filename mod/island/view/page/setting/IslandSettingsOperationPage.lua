...
function var_0_0.InitInterfaceComponents(arg_10_0)
	local var_10_0 = IslandSettingsConst.ISLAND_JOY_STICK_DEFAULT_PREFERENCE

	arg_10_0:InitInterfaceComponent(arg_10_0.stick, arg_10_0.eventStick, IslandSettingsConst.ISLAND_KEY_JOYSTICK_ANCHORX, IslandSettingsConst.ISLAND_KEY_JOYSTICK_ANCHORY, var_10_0)
	...
	local var_10_1 = arg_10_0:GetScale()
	...
	for iter_10_4 = 2, #arg_10_0.components do
		setLocalScale(arg_10_0.components[iter_10_4], var_10_1)
	end
...
function var_0_0.SetInterfaceAnchor(arg_17_0, arg_17_1, arg_17_2, arg_17_3, arg_17_4, arg_17_5)
	...
	arg_17_1.anchoredPosition = Vector3(var_17_2, var_17_3, 0)
end
...
function var_0_0.CheckInterfaceIntersect(arg_19_0)
	...
	local var_19_2 = {}
	local var_19_3 = var_0_1(arg_19_0.interface)
...
function var_0_0.RevertInterfaceSetting(arg_20_0, arg_20_1)
	local var_20_0 = IslandSettingsConst.ISLAND_JOY_STICK_DEFAULT_PREFERENCE

	arg_20_0:SetInterfaceAnchor(arg_20_0.stick, IslandSettingsConst.ISLAND_KEY_JOYSTICK_ANCHORX, IslandSettingsConst.ISLAND_KEY_JOYSTICK_ANCHORY, var_20_0, arg_20_1)
...
function var_0_0.OverrideInterfaceSetting(arg_22_0, arg_22_1, arg_22_2, arg_22_3)
	...
	PlayerPrefs.SetFloat(arg_22_2, var_22_0)
	PlayerPrefs.SetFloat(arg_22_3, var_22_1)
end
