...
function var_0_0.OnUpdate(arg_6_0)
	...
	local var_6_1 = math.clamp(Screen.width / Screen.height - 0.001, 1.3333333333333333, 2.3333333333333335)

	setSlider(arg_6_0.notchSlider, ADAPT_MIN, var_6_1, var_6_0:GetScreenRatio())
	OnSliderWithButton(arg_6_0, arg_6_0.notchSlider, function(arg_7_0)
		...
		NewNotchAdapt.CheckNotchRatio = arg_7_0
	end)
end
