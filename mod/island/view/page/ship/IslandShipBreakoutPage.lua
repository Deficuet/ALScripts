...
function var_0_0.OnLoaded(arg_2_0)
	arg_2_0.uiStarPreList = UIItemList.New(arg_2_0:findTF("frame_1/star/prev"), arg_2_0:findTF("frame_1/star/prev/tpl"))
	arg_2_0.uiStarNextList = UIItemList.New(arg_2_0:findTF("frame_1/star/now"), arg_2_0:findTF("frame_1/star/now/tpl"))
	arg_2_0.prevLevelTxt = arg_2_0:findTF("frame_1/level/prev"):GetComponent(typeof(Text))
	arg_2_0.nextLevelTxt = arg_2_0:findTF("frame_1/level/now"):GetComponent(typeof(Text))
	arg_2_0.skillTxt = arg_2_0:findTF("frame_1/skill/Text"):GetComponent(typeof(Text))
	arg_2_0.skillLabelTxt = arg_2_0:findTF("frame_1/skill/now"):GetComponent(typeof(Text))
	arg_2_0.uiAttrList = UIItemList.New(arg_2_0:findTF("frame_3/attrs"), arg_2_0:findTF("frame_3/attrs/tpl"))
	arg_2_0.uiConsumeList = UIItemList.New(arg_2_0:findTF("frame_2/comsume"), arg_2_0:findTF("frame_2/comsume/tpl"))
	arg_2_0.upgradeBtn = arg_2_0:findTF("btn_confirm")
	arg_2_0.closeBtn = arg_2_0:findTF("frame_1/close")

	setText(arg_2_0:findTF("frame_1/title"), i18n("island_ship_breakout"))
	setText(arg_2_0:findTF("frame_2/consume_title/Text"), i18n("island_ship_breakout_consume"))
...
function var_0_0.UpdateSkill(arg_14_0, arg_14_1, arg_14_2)
	local var_14_0 = not arg_14_2:GetSkill():IsUnlock()

	if arg_14_1:GetSkill():IsUnlock() and var_14_0 then
		local var_14_1 = arg_14_2:GetSkill():GetName()

		arg_14_0.skillTxt.text = var_14_1
...
function var_0_0.UpdateAttrs(arg_15_0, arg_15_1, arg_15_2)
	...
	arg_15_0.uiAttrList:make(function(arg_16_0, arg_16_1, arg_16_2)
		if arg_16_0 == UIItemList.EventUpdate then
			local var_16_0 = IslandShipAttr.ATTRS[arg_16_1 + 1]
			local var_16_1 = arg_15_2:GetAttrGrade(var_16_0)
			local var_16_2 = IslandShipAttr.Grade2Img(var_16_1)

			arg_16_2:Find("grade_bg"):GetComponent(typeof(Image)).sprite = GetSpriteFromAtlas("ui/IslandShipUI_atlas", var_16_2[2])

			setText(arg_16_2:Find("name"), IslandShipAttr.ToChinese(var_16_0))
			setText(arg_16_2:Find("value"), "+" .. (var_15_1[var_16_0] or 0) .. "  >>>  +" .. (var_15_0[var_16_0] or 0))
		end
	end)
...
function var_0_0.UpdateConsume(arg_17_0, arg_17_1, arg_17_2)
	...
	arg_17_0.uiConsumeList:make(function(arg_18_0, arg_18_1, arg_18_2)
		if arg_18_0 == UIItemList.EventUpdate then
			...
			updateCustomDrop(arg_18_2, var_18_0)

			local var_18_1 = var_17_1:GetOwnCount(var_18_0.id)
			local var_18_2 = setColorStr(var_18_1, var_18_1 >= var_18_0.count and COLOR_GREEN or COLOR_RED)

			setText(arg_18_2:Find("icon_bg/count_bg/count"), var_18_2 .. "/" .. var_18_0.count)
		end
	end)
	arg_17_0.uiConsumeList:align(#var_17_0)
end

function var_0_0.UpdateUpgradeBtn(arg_19_0, arg_19_1)
	local var_19_0 = arg_19_1:GetBreakoutMatrials()
	local var_19_1 = getProxy(IslandProxy):GetIsland():GetInventoryAgency()
	local var_19_2 = _.all(var_19_0, function(arg_20_0)
		return var_19_1:GetOwnCount(arg_20_0.id) >= arg_20_0.count
	end)

	setGray(arg_19_0.upgradeBtn, not var_19_2, true)
