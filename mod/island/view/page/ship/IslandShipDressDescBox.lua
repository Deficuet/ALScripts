...
function var_0_0.OnInit(arg_3_0)
	arg_3_0.tagUIList:make(function(arg_4_0, arg_4_1, arg_4_2)
		if arg_4_0 == UIItemList.EventUpdate then
			...
			setScrollText(arg_4_2:Find("mask/Text"), var_0_0.TAG2NAME[var_4_0])
		end
	end)
end
...
function var_0_0.Show(arg_5_0, arg_5_1, arg_5_2, arg_5_3)
	...
	arg_5_0.id = arg_5_2
	arg_5_0.cfg = arg_5_0.type == var_0_0.TYPE.DRESS and pg.island_dress_template[arg_5_2] or pg.island_skin_template[arg_5_2]
