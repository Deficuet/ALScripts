...
function var_0_0.UpdateConsume(arg_12_0, arg_12_1)
	...
	arg_12_0.uiItemList:make(function(arg_13_0, arg_13_1, arg_13_2)
		if arg_13_0 == UIItemList.EventUpdate then
			...
			updateCustomDrop(arg_13_2, var_13_0)

			local var_13_1 = var_12_1:GetOwnCount(var_13_0.id)
			local var_13_2 = setColorStr(var_13_1, var_13_1 >= var_13_0.count and COLOR_GREEN or COLOR_RED)

			setText(arg_13_2:Find("icon_bg/count_bg/count"), var_13_2 .. "/" .. var_13_0.count)
		end
	end)
