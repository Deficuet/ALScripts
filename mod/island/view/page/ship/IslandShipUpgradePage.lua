...
function var_0_0.OnLoaded(arg_2_0)
	arg_2_0.expBar = arg_2_0:findTF("frame/frame_1/exp/bar")
	arg_2_0.expBarPre = arg_2_0:findTF("frame/frame_1/exp/bar_pre")
	arg_2_0.levelTxt = arg_2_0:findTF("frame/frame_1/exp/level"):GetComponent(typeof(Text))
	arg_2_0.expTxt = arg_2_0:findTF("frame/frame_1/exp/Text"):GetComponent(typeof(Text))
	arg_2_0.closeBtn = arg_2_0:findTF("frame/frame_1/close")
	arg_2_0.confirmBtn = arg_2_0:findTF("frame/btn_confirm")
	arg_2_0.delBtn = arg_2_0:findTF("frame/frame_2/del")
	arg_2_0.maxBtn = arg_2_0:findTF("frame/frame_2/max")
	arg_2_0.switchBtn = arg_2_0:findTF("frame/frame_1/switch")
	arg_2_0.uiBreakList = UIItemList.New(arg_2_0:findTF("frame/frame_1/attr/stars"), arg_2_0:findTF("frame/frame_1/attr/stars/tpl"))
	arg_2_0.uiAttrList = UIItemList.New(arg_2_0:findTF("frame/frame_1/attr/list"), arg_2_0:findTF("frame/frame_1/attr/list/tpl"))
	arg_2_0.uiItemList = UIItemList.New(arg_2_0:findTF("frame/frame_2/items"), arg_2_0:findTF("frame/frame_2/items/tpl"))

	setText(arg_2_0:findTF("frame/frame_1/title"), i18n("island_word_ship_level_upgrade"))
	setText(arg_2_0:findTF("frame/frame_2/sub_title/Text"), i18n("island_skill_consume_title"))
	setText(arg_2_0:findTF("frame/frame_1/attr/label"), i18n("island_word_ship_level_upgrade_1"))
	setText(arg_2_0:findTF("frame/frame_1/attr/title/Text"), i18n("island_word_ship_rank"))
	...
	arg_12_0.uiItemList:make(function(arg_13_0, arg_13_1, arg_13_2)
		if arg_13_0 == UIItemList.EventUpdate then
			...
			updateCustomDrop(arg_13_2, Drop.New({
				...
				id = var_13_0.id,
				count = var_13_0.count
			}))
			setActive(arg_13_2:Find("icon_bg/count_bg"), true)
			setText(arg_13_2:Find("icon_bg/count_bg/count"), "X" .. var_13_0.count)
			...
			arg_12_0:UpdateCalcPanel(arg_13_2, var_13_0)
		end
	end)
...
function var_0_0.OpenCalcPanel(arg_15_0, arg_15_1, arg_15_2)
	arg_15_0.selected[arg_15_2.id] = math.min(arg_15_2.count, (arg_15_0.selected[arg_15_2.id] or 0) + 1)
...
function var_0_0.UpdateCalcPanel(arg_18_0, arg_18_1, arg_18_2)
	...
	onButton(arg_18_0, arg_18_1:Find("calc/bg"), function()
		arg_18_0.selected[arg_18_2.id] = (arg_18_0.selected[arg_18_2.id] or 0) - 1
...
function var_0_0.FillSelected(arg_21_0, arg_21_1)
	...
	for iter_21_0, iter_21_1 in ipairs(var_21_1) do
		for iter_21_2 = 1, iter_21_1.count do
			...
			local var_21_2 = tonumber(iter_21_1:GetUseArg())

			var_21_0:AddExp(var_21_2)

			arg_21_0.selected[iter_21_1.id] = (arg_21_0.selected[iter_21_1.id] or 0) + 1
		end
	end
...
function var_0_0.UpdateAttrs(arg_24_0, arg_24_1)
	...
	arg_24_0.uiAttrList:make(function(arg_25_0, arg_25_1, arg_25_2)
		if arg_25_0 == UIItemList.EventUpdate then
			local var_25_0 = IslandShipAttr.ATTRS[arg_25_1 + 1]
			local var_25_1 = arg_24_1:GetAttrGrade(var_25_0)
			local var_25_2 = IslandShipAttr.Grade2Img(var_25_1)

			arg_25_2:Find("grade_bg"):GetComponent(typeof(Image)).sprite = GetSpriteFromAtlas("ui/IslandShipUI_atlas", var_25_2[2])

			setText(arg_25_2:Find("name"), IslandShipAttr.ToChinese(var_25_0))
			setText(arg_25_2:Find("value"), "+" .. (var_24_0[var_25_0] or 0))
		end
	end)
