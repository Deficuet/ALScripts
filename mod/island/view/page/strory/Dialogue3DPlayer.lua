...
function var_0_0.NextOne(arg_2_0)
	...
	if arg_2_0.isRegisterEvent then
		...
		local var_2_0 = arg_2_0.callback
...
function var_0_0.StartFadeIn(arg_20_0, arg_20_1, arg_20_2)
	...
	arg_20_0:CollectFadeInFunc(var_20_1, var_20_0)
...
function var_0_0.StartFadeOut(arg_21_0, arg_21_1, arg_21_2)
	...
	arg_21_0:CollectFadeOutFunc(var_21_1, var_21_0)
...
function var_0_0.ActiveDefaultCamera(arg_22_0, arg_22_1)
	...
	if var_22_3.Length > 1 then
		if arg_22_1:ShouldSetCamOffset() then
			local var_22_5 = arg_22_1:GetFollowOffset()

			IslandCameraMgr.instance:SetVirtualCameraBodyOffset(IslandConst.INTERACTION_CAMERA_NAME, var_22_5)
		end
...
function var_0_0.ShowOptions(arg_24_0, arg_24_1, arg_24_2)
	...
	arg_24_0.uiOptionList:make(function(arg_25_0, arg_25_1, arg_25_2)
		if arg_25_0 == UIItemList.EventUpdate then
			...
			setText(arg_25_2.transform:Find("main/content/Text"), HXSet.hxLan(var_25_0.content))

			local var_25_1

			var_25_1.sprite, var_25_1 = GetSpriteFromAtlas("ui/story_atlas", var_25_0.icon), arg_25_2.transform:Find("main/icon"):GetComponent(typeof(Image))
	...
	arg_24_0.uiOptionList:align(#var_24_0)
end
...
function var_0_0.CollectFadeInFunc(arg_38_0, arg_38_1, arg_38_2)
	...
	table.insert(arg_38_1, function(arg_39_0)
		arg_38_0:TweenValueForcanvasGroup(arg_38_0.blackBg, 1, 0, arg_38_2 or 0.5, 0, arg_39_0)
	end)
...
function var_0_0.CollectFadeOutFunc(arg_41_0, arg_41_1, arg_41_2)
	...
	table.insert(arg_41_1, function(arg_42_0)
		arg_41_0:TweenValueForcanvasGroup(arg_41_0.blackBg, 0, 1, arg_41_2 or 0.5, 0, arg_42_0)
	end)
end
...
function var_0_0.ActiveCamera(arg_43_0, arg_43_1, arg_43_2)
	...
	table.insert(var_43_1, function(arg_44_0)
		local var_44_0 = arg_43_1:GetActiveCamera()

		IslandCameraMgr.instance:ActiveVirtualCamera(var_44_0)
		arg_44_0()
	end)
...
function var_0_0.LoadShakeSrc(arg_48_0, arg_48_1, arg_48_2)
	...
	PoolMgr.GetInstance():GetUI(var_48_0, true, function(arg_49_0)
...
function var_0_0.TryTurn2Unit(arg_58_0, arg_58_1, arg_58_2)
	...
	for iter_58_0, iter_58_1 in ipairs(arg_58_1:GetTurntoList()) do
		table.insert(var_58_0, function(arg_59_0)
			...
			local var_59_2 = var_59_0.transform
			local var_59_3 = var_59_1.transform

			arg_58_0:Turn2Unit(var_59_2, var_59_3, arg_59_0)
		end)
	end
...
function var_0_0.Turn2Unit(arg_60_0, arg_60_1, arg_60_2, arg_60_3)
	...
	local var_60_1 = Quaternion.LookRotation(var_60_0)

	arg_60_1.rotation = Quaternion.Euler(0, var_60_1.eulerAngles.y, 0)
...
function var_0_0.TryFace2Face(arg_61_0, arg_61_1, arg_61_2)
	...
	for iter_61_0, iter_61_1 in ipairs(arg_61_1:GetFace2FaceList()) do
		table.insert(var_61_0, function(arg_62_0)
			...
			local var_62_2 = var_62_0.transform
			local var_62_3 = var_62_1.transform

			arg_61_0:Face2Face(var_62_2, var_62_3, arg_62_0)
		end)
	end
...
function var_0_0.StartUIAnimations(arg_64_0, arg_64_1, arg_64_2)
	...
	local var_64_2 = var_64_0.number
	local var_64_3 = var_64_0.delay
	local var_64_4 = var_64_0.speed
	local var_64_5 = arg_64_0.dialoguePanel.localPosition.x

	arg_64_0:TweenMovex(arg_64_0.dialoguePanel, var_64_1, var_64_5, var_64_4, var_64_3, var_64_2, arg_64_2)
end
...
function var_0_0.RegisterEvent(arg_65_0, arg_65_1, arg_65_2)
	...
	elseif arg_65_0.autoNext then
		local var_65_0 = arg_65_0.script:GetTriggerDelayTime()

		arg_65_0:UnscaleDelayCall(var_65_0, arg_65_2)
	else
...
function var_0_0.UpdateTypeWriter(arg_66_0, arg_66_1, arg_66_2)
	...
	arg_66_0.typewriterSpeed = math.max((var_66_2.speed or 0.1) * arg_66_0.timeScale, 0.001)

	local var_66_3 = var_66_2.speedUp or arg_66_0.typewriterSpeed
	...
	onButton(arg_66_0, arg_66_0._tf, function()
		...
		arg_66_0.typewriterSpeed = math.min(arg_66_0.typewriterSpeed, var_66_3)
...
function var_0_0.LoadContentAndIcon(arg_69_0, arg_69_1, arg_69_2)
	...
	local var_69_1 = arg_69_1:GetActorIcon()

	if var_69_1 then
		GetImageSpriteFromAtlasAsync("island/IslandShipIcon/" .. var_69_1, "", arg_69_0.iconImg)
	end
...
function var_0_0.PlayCharatorAnimation(arg_70_0, arg_70_1, arg_70_2)
	...
	local var_70_2 = var_70_0:GetComponent(typeof(Animator)) or var_70_0.transform:GetChild(0):GetComponent(typeof(Animator))
