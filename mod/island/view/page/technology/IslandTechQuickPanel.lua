...
function var_0_0.QuickGetAward(arg_14_0)
	...
	local var_14_1 = arg_14_0.buildingData:GetDelegationSlotData(var_14_0):GetSlotRewardData().formula_id
	local var_14_2 = arg_14_0.technologyAgency:GetTechnologyByFormulaId(var_14_1).id

	arg_14_0:emit(IslandMediator.GET_DELEGATION_AWARD, IslandTechnologyAgency.PLACE_ID, var_14_0, 2, function()
		existCall(arg_14_0.contextData.onGetAwardDone, var_14_2)
	end)
end
...
function var_0_0.UpdateTime(arg_17_0)
	...
	arg_17_0.uiList:eachActive(function(arg_18_0, arg_18_1)
		...
		local var_18_1 = arg_17_0.buildingData:GetDelegationSlotData(var_18_0)

		if var_18_1 and var_18_1:GetFormulaId() then
			local var_18_2 = arg_18_1:Find("content")
			local var_18_3 = var_18_1:GetSlotRoleData()

			setActive(var_18_2:Find("icon_bg"), var_18_3)

			if var_18_3 then
				local var_18_4 = var_18_3:GetFinishTime() - arg_17_0.timeMgr:GetServerTime()

				setSlider(var_18_2:Find("silder"), 0, 1, 1 - var_18_4 / var_18_3:GetAllTime())
				setText(var_18_2:Find("silder/Text"), var_18_4 > 0 and arg_17_0.timeMgr:DescCDTime(var_18_4) or "00:00:00")
			end

			local var_18_5 = var_18_1:GetSlotRewardData()

			setActive(var_18_2:Find("get"), var_18_5)
			setActive(var_18_2:Find("silder"), not var_18_5)
