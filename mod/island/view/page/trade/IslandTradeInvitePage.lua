...
function var_0_0.OnUpdateItem(arg_5_0, arg_5_1, arg_5_2)
	...
	local var_5_3 = var_5_1:GetTradeAgency():IsInvited(var_5_2.id)

	var_5_0:Update(var_5_2, var_5_3)
end
...
function var_0_0.OnOneKey(arg_9_0)
	...
	local var_9_2, var_9_3, var_9_4 = arg_9_0:GetInfo()

	arg_9_0:emit(IslandBaseMediator.TRADE_INVITATION, var_9_1, var_9_2, var_9_4)
end
