...
function var_0_0.OnInit(arg_3_0)
	...
	onButton(arg_3_0, arg_3_0.helpBtn, function()
		...
		if var_5_0 == IslandConst.TRADE_PURCHASE then
			var_5_1 = i18n("island_trade_help_1")
		elseif var_5_0 == IslandConst.TRADE_SELL then
			var_5_1 = i18n("island_trade_help_2")
		end
...
function var_0_0.UpdateLimit(arg_18_0)
	...
	elseif arg_18_0.mode == var_0_0.MODE_SELL then
		local var_18_2 = arg_18_0:GetIsland()
		local var_18_3 = var_18_0:GetSellLimit(var_18_2.id)
		local var_18_4 = var_18_0:GetSellLimitMax()

		arg_18_0.limitTxt.text = i18n("island_trade_sell_tip_label", math.max(0, var_18_4 - var_18_3) .. "/" .. var_18_4)
	end
end
...
function var_0_0.InitPageSwitcher(arg_21_0, arg_21_1)
	local var_21_0 = arg_21_0:IsSellMode(arg_21_1) and {
		var_0_2,
		var_0_3,
		var_0_4
	} or {
	...
	arg_21_0.pagesUIList:make(function(arg_22_0, arg_22_1, arg_22_2)
		if arg_22_0 == UIItemList.EventUpdate then
			...
			local var_22_1 = arg_21_0:Page2Name(var_22_0)
...
function var_0_0.SwitchPage(arg_24_0, arg_24_1)
	...
	var_24_0:ExecuteAction("Show", arg_24_0:GetIsland(), arg_24_0.mode)
