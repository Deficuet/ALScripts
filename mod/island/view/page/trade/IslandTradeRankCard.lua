...
function var_0_0.Update(arg_2_0, arg_2_1, arg_2_2, arg_2_3)
	...
	arg_2_0.valueTxt.text = arg_2_2.value > 0 and arg_2_2.value or "-"
	arg_2_0.numTxt.text = arg_2_1 < 10 and "0" .. arg_2_1 or arg_2_1
	arg_2_0.nameTxt.text = arg_2_2.name
	arg_2_0.lvTxt.text = "lv." .. arg_2_2.islandLevel

	local var_2_0 = "qicon/" .. pg.ship_skin_template[arg_2_2.skinId].prefab

	GetImageSpriteFromAtlasAsync(var_2_0, "", arg_2_0.iconTF)

	local var_2_1 = arg_2_2:IsSelf()

	setActive(arg_2_0.visitBtn, not var_2_1)
	setActive(arg_2_0.inviteBtn, var_2_1)
