local var_0_0 = class("IslandAgoraFurnitureTplPool", import(".IslandPoolBase"))

function var_0_0.Ctor(arg_1_0, arg_1_1, arg_1_2, arg_1_3)
	arg_1_0.root = arg_1_1
	arg_1_0.pool = IslandObjectPool.New(arg_1_0.root, "ui/agorafurnituretpl", typeof(GameObject), arg_1_3)
end
