...
function var_0_0.NewItemAsyn(arg_10_0, arg_10_1)
	...
	local var_10_0 = FrameAsyncInstantiateManager.Instance:EnqueueInstantiate(arg_10_0.asset, function(arg_11_0)
		arg_10_1(arg_11_0)
	end)

	table.insert(arg_10_0.insIdList, var_10_0)
end
...
function var_0_0.Dequeue(arg_14_0)
	...
	if #arg_14_0.items > 0 then
		var_14_0 = table.remove(arg_14_0.items, 1)
	else
