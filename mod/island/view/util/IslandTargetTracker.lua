...
function var_0_0.SetUp(arg_12_0, arg_12_1, arg_12_2, arg_12_3)
	...
	arg_12_0.timer = FrameTimer.New(function()
		...
		arg_12_0.distanceTxt.text = math.ceil(var_13_3) .. "M"

		local var_13_4, var_13_5 = arg_12_0:CalcPosition(arg_12_2.transform)
...
function var_0_0.CalcPosition(arg_14_0, arg_14_1)
	...
	if math.pow(var_14_6.x / arg_14_0.radiusOfEllipse.x, 2) + math.pow(var_14_6.y / arg_14_0.radiusOfEllipse.y, 2) > 1 then
		local var_14_7 = var_14_6.y / (var_14_6.x + 1e-07)
		local var_14_8 = Mathf.Pow(arg_14_0.radiusOfEllipse.x * arg_14_0.radiusOfEllipse.y, 2)
		local var_14_9 = Mathf.Pow(arg_14_0.radiusOfEllipse.y, 2) + Mathf.Pow(var_14_7, 2) * Mathf.Pow(arg_14_0.radiusOfEllipse.x, 2)
		local var_14_10 = math.sqrt(var_14_8 / var_14_9)

		if math.sign(var_14_10) ~= math.sign(var_14_6.x) then
			var_14_10 = -1 * var_14_10
		end

		local var_14_11 = var_14_10 * var_14_7

		return Vector2(var_14_10, var_14_11), IslandCalcUtil.SignedAngle(Vector2.up, Vector2(var_14_6.x, var_14_6.y))
	else
		return var_14_6, IslandCalcUtil.SignedAngle(Vector2.up, Vector2(var_14_6.x, var_14_6.y))
	end
end

function var_0_0.ClearLine(arg_15_0)
	for iter_15_0, iter_15_1 in pairs(arg_15_0.lines) do
