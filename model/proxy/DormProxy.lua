...
function var_0_0.RequestShipExp(arg_6_0)
	local var_6_0 = arg_6_0.data:GetNextSettlementShipExpTime() - pg.TimeMgr.GetInstance():GetServerTime()
...
function var_0_0.RequestPopEvent(arg_9_0)
	...
	local var_9_0 = pg.gameset.dorm_pop_time.key_value
...
function var_0_0.getData(arg_16_0)
	return (arg_16_0.data or Dorm.New({
		id = 1
	})):clone()
end
...
function var_0_0.GetThemeTemplateCollectionCnt(arg_35_0)
	return table.getCount(arg_35_0.collectionThemeTemplates or {})
end
...
function var_0_0.GetTemplateNewID(arg_37_0)
	local var_37_0 = _.map(_.values(arg_37_0.customThemeTemplates or {}), function(arg_38_0)
		return arg_38_0:GetPos()
	end)

	for iter_37_0 = 1, 10 do
		if not table.contains(var_37_0, iter_37_0) then
			return iter_37_0
		end
	end
end
...
function var_0_0.GetSystemThemes(arg_39_0)
	if not arg_39_0.systemThemes or #arg_39_0.systemThemes == 0 then
		...
		for iter_39_0, iter_39_1 in ipairs(var_39_0.all) do
			if var_39_0[iter_39_1].is_view == 1 then
				local var_39_1 = BackYardSystemTheme.New({
					id = iter_39_1
				})

				table.insert(arg_39_0.systemThemes, var_39_1)
			end
		end
	end
...
function var_0_0.NeedCollectionTip(arg_42_0)
	local var_42_0 = getProxy(PlayerProxy):getRawData().id
	local var_42_1 = PlayerPrefs.GetInt("backyard_template" .. var_42_0, 0)
	local var_42_2 = arg_42_0:GetThemeTemplateCollectionCnt()

	if var_42_2 ~= var_42_1 then
		PlayerPrefs.SetInt("backyard_template" .. var_42_0, var_42_2)
		PlayerPrefs.Save()
	end
...
function var_0_0.NeedShopShowHelp(arg_43_0)
	...
	if not (PlayerPrefs.GetInt("backyard_template_help" .. var_43_0, 0) > 0) then
...
function var_0_0.GetTag7Furnitures(arg_44_0)
	local var_44_0 = {}
	local var_44_1 = pg.furniture_data_template.get_id_list_by_tag[7]

	for iter_44_0, iter_44_1 in ipairs(var_44_1) do
		local var_44_2 = pg.furniture_shop_template[iter_44_1]

		if var_44_2 and var_44_2.not_for_sale == 0 and pg.TimeMgr.GetInstance():inTime(var_44_2.time) then
...
function var_0_0.IsShowRedDot(arg_45_0)
	local var_45_0 = getProxy(PlayerProxy):getRawData()
	local var_45_1 = pg.SystemOpenMgr.GetInstance():isOpenSystem(var_45_0.level, "CourtYardMediator")
	local var_45_2 = getProxy(DormProxy):getRawData()
	local var_45_3 = var_45_2:IsLackOfFood()
	local var_45_4 = var_45_2:AnyShipExistIntimacyOrMoney()

	return var_45_1 and (var_45_3 or var_45_4 or getProxy(SettingsProxy):IsTipNewTheme() or getProxy(SettingsProxy):IsTipNewGemFurniture())
end
