...
function var_0_0.GetNextPushTime(arg_22_0)
	local var_22_0 = pg.activity_ins_template.all
	local var_22_1
	local var_22_2

	for iter_22_0, iter_22_1 in ipairs(var_22_0) do
		local var_22_3 = pg.activity_ins_template[iter_22_1]

		if var_22_3.type == InstagramConst.INSTAGRAM_TYPE.OFFICIAL_ACCOUNT then
			if arg_22_0.officialAccounts[iter_22_1] == nil then
				local var_22_4 = pg.TimeMgr.GetInstance():parseTimeFromConfig(var_22_3.time)
		...
		elseif var_22_3.is_active == 1 and arg_22_0:GetMessageById(iter_22_1) == nil then
			local var_22_5 = pg.TimeMgr.GetInstance():parseTimeFromConfig(var_22_3.time)
