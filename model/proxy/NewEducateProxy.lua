...
function var_0_0.AddBuff(arg_12_0, arg_12_1, arg_12_2)
	...
	local var_12_0 = pg.child2_benefit_list[arg_12_1].type

	if var_12_0 == NewEducateBuff.TYPE.TALENT then
		arg_12_0:sendNotification(var_0_0.TALENT_UPDATED)
	elseif var_12_0 == NewEducateBuff.TYPE.STATUS then
...
function var_0_0.UpdateAttr(arg_16_0, arg_16_1, arg_16_2)
	local var_16_0 = arg_16_0.data[arg_16_0.curId]:GetPersonalityTag()
...
function var_0_0.GetStoryInfo(arg_28_0)
	...
	return var_28_0:GetPaintingName(), var_28_0:GetCallName(), var_28_0:GetBGName()
end
