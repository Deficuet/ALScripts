...
function var_0_0.GetRingElement(arg_9_0, arg_9_1)
	...
	if arg_9_0:GetType() == var_0_0.TYPE.ANY and arg_9_1 then
		if arg_9_1:GetType() == AtelierMaterial.TYPE.SAIREN then
			var_9_0 = var_0_0.ELEMENT_TYPE.SAIREN
		else
...
function var_0_0.GetElementRingColor(arg_10_0, arg_10_1)
	local var_10_0 = var_0_0.ELEMENT_RING_COLOR[arg_10_0:GetRingElement(arg_10_1)]

	return SummerFeastScene.TransformColor(var_10_0)
end

function var_0_0.GetElementLightColor(arg_11_0, arg_11_1)
	local var_11_0 = var_0_0.ELEMENT_LIGHT_COLOR[arg_11_0:GetRingElement(arg_11_1)]

	return SummerFeastScene.TransformColor(var_11_0)
end
...
function var_0_0.CanUseMaterial(arg_17_0, arg_17_1, arg_17_2, arg_17_3)
	...
	local var_17_4 = arg_17_0:GetLimitItemID()
