...
local var_0_4 = pg.activity_ninja_enemy
...
function var_0_0.Ctor(arg_1_0, arg_1_1)
	...
	for iter_1_2, iter_1_3 in ipairs(arg_1_0.buffs) do
		local var_1_0 = var_0_3[iter_1_3]

		arg_1_0.buffLevels[var_1_0.group] = var_1_0.level
	end
	...
	for iter_1_4, iter_1_5 in ipairs(var_0_2.all) do
		local var_1_1 = var_0_2[iter_1_5].type
	...
	arg_1_0:TryUpgradeCityLevel(false)
...
function var_0_0.TryUpgradeCityLevel(arg_2_0, arg_2_1)
	...
	while var_2_0 do
		...
		for iter_2_0, iter_2_1 in ipairs(var_0_1.all) do
			local var_2_3 = var_0_1[iter_2_1]
			...
			if var_2_3.level == arg_2_0.cityLevel then
				var_2_1 = var_2_3
			end
		end
...
function var_0_0.UpgradeBuff(arg_6_0, arg_6_1, arg_6_2)
	local var_6_0 = var_0_3.get_id_list_by_group[arg_6_1]
	...
	local var_6_2 = table.indexof(var_6_0, var_6_1) + arg_6_2
	local var_6_3 = var_6_0[var_6_2]

	table.insert(arg_6_0.buffs, var_6_3)

	arg_6_0.buffLevels[arg_6_1] = var_6_2
end
...
function var_0_0.SetLevelDatas(arg_15_0)
	...
	for iter_15_0, iter_15_1 in ipairs(var_0_1.all) do
		...
		for iter_15_2, iter_15_3 in ipairs(var_0_1[iter_15_1].include) do
			local var_15_0 = var_0_2[iter_15_3].type
...
function var_0_0.PtToShow(arg_17_0)
	...
	if arg_17_0 >= var_0_0.Billion then
		...
		local var_17_0 = arg_17_0 / var_0_0.Billion
		local var_17_1 = var_0_0.SHOW_NUM_CNT - #tostring(math.floor(var_17_0))

		return var_0_0.KeepDecimal(var_17_0, var_17_1) .. "B"
	elseif arg_17_0 >= var_0_0.Million then
		if arg_17_0 % var_0_0.Million == 0 then
			return arg_17_0 / var_0_0.Million .. "M"
		end

		local var_17_2 = arg_17_0 / var_0_0.Million
		local var_17_3 = var_0_0.SHOW_NUM_CNT - #tostring(math.floor(var_17_2))

		return var_0_0.KeepDecimal(var_17_2, var_17_3) .. "M"
	elseif arg_17_0 >= var_0_0.Thousand then
		if arg_17_0 % var_0_0.Thousand == 0 then
			return arg_17_0 / var_0_0.Thousand .. "K"
		end

		local var_17_4 = arg_17_0 / var_0_0.Thousand
		local var_17_5 = var_0_0.SHOW_NUM_CNT - #tostring(math.floor(var_17_4))

		return var_0_0.KeepDecimal(var_17_4, var_17_5) .. "K"
	end
