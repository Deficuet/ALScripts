...
function var_0_0.AddExp(arg_8_0, arg_8_1)
	...
	arg_8_1, arg_8_0.exp = arg_8_0.exp, math.min(arg_8_0.exp + arg_8_1, var_8_0)
...
function var_0_0.GetMaxLevel(arg_10_0)
	if not arg_10_0.maxLevel then
		arg_10_0.maxLevel = calcFloor(arg_10_0:getConfig("exp_upper_limit") / arg_10_0:getConfig("exp_up"))
	end
...
function var_0_0.CanUnlockLetter(arg_13_0, arg_13_1)
	local var_13_0 = arg_13_0:GetLetterList()
	local var_13_1 = table.indexof(var_13_0, arg_13_1)

	assert(var_13_1)

	return var_13_1 <= arg_13_0.level
end
...
function var_0_0.GetDisplayLevelMark(arg_17_0)
	local var_17_0 = arg_17_0:GetDisplayLevel()

	if var_17_0 < 1 then
		return "0"
	else
		return var_0_0.Mark[(var_17_0 - 1) % 10 + 1]
	end
end
...
function var_0_0.GetEmptyShipGroup(arg_20_0)
	if not arg_20_0.shipGroup then
		arg_20_0.shipGroup = ShipGroup.New({
...
function var_0_0.GetDisplayInfo(arg_24_0)
	local var_24_0 = arg_24_0:GetEmptyShipGroup():getPaintingId()
	local var_24_1 = pg.ship_skin_template[var_24_0]

	return {
		hand = var_24_1.lover_hand,
		kiss = var_24_1.lover_kiss
	}
end
...
function var_0_0.GetTrophyList(arg_26_0)
	...
	for iter_26_0 = 1, arg_26_0.level, 10 do
		local var_26_1 = 1000000000 + arg_26_0.groupId * 100 + iter_26_0
