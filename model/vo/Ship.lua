...
function var_0_0.Ctor(arg_40_0, arg_40_1)
	...
	arg_40_0:updateSkinId(var_40_5, 0)

	for iter_40_8, iter_40_9 in ipairs(arg_40_1.skin_shadow_list or {}) do
		arg_40_0:updateSkinId(iter_40_9.value, iter_40_9.key)
	end

	arg_40_0.noChangeSkin = arg_40_1.noChangeSkin or false
	arg_40_0.phantomRandomFlag = {}

	for iter_40_10, iter_40_11 in ipairs(arg_40_1.char_random_flag or {}) do
		arg_40_0:updateRandomFlag(1, iter_40_11)
	end
...
function var_0_0.getSkinId(arg_49_0, arg_49_1)
	local var_49_0 = arg_49_0:getPhantomSkin(arg_49_1 or 0)

	if not arg_49_0.noChangeSkin and tobool(arg_49_0.id) and ShipSkin.IsChangeSkin(var_49_0) then
		local var_49_1 = ShipSkin.GetStoreChangeSkinId(ShipSkin.GetChangeSkinGroupId(var_49_0), arg_49_0:GetShipPhantomMark())
...
function var_0_0.getPhantomSkin(arg_50_0, arg_50_1)
	if not arg_50_1 or arg_50_1 == 0 then
		return arg_50_0.skinId
	else
		return arg_50_0.phantomDic[arg_50_0.phantomId] or arg_50_0:getConfig("skin_id")
	end
end

function var_0_0.updateSkinId(arg_51_0, arg_51_1, arg_51_2)
	if not arg_51_1 or arg_51_1 == 0 then
		arg_51_1 = arg_51_0:getConfig("skin_id")
	end

	if arg_51_2 == 0 then
		arg_51_0.skinId = arg_51_1
	else
		arg_51_0.phantomDic[arg_51_2] = arg_51_1
	end
end

function var_0_0.getAllShipPhantomMarks(arg_52_0)
	local var_52_0 = getGameset("technology_shadow_num")[1]
	local var_52_1 = {}

	for iter_52_0 = 0, var_52_0 do
		if iter_52_0 == 0 or arg_52_0.phantomDic[iter_52_0] then
			table.insert(var_52_1, ShipPhantom.PackMark(arg_52_0.id, iter_52_0))
		end
	end
...
function var_0_0.getAllShipPhantom(arg_53_0)
	...
	for iter_53_0 = 0, var_53_0 do
		if iter_53_0 == 0 or arg_53_0.phantomDic[iter_53_0] then
			table.insert(var_53_1, ShipPhantom.Create(arg_53_0, iter_53_0))
		end
	end
...
function var_0_0.updateRandomFlag(arg_54_0, arg_54_1, arg_54_2)
	arg_54_2 = defaultValue(arg_54_2, 0)
	arg_54_0.phantomRandomFlag[arg_54_2] = arg_54_1
end

function var_0_0.getRandomFlag(arg_55_0, arg_55_1)
	return defaultValue(arg_55_0.phantomRandomFlag[arg_55_1 or 0], 0) > 0
end

function var_0_0.getRandomFlagShipPhantomMarks(arg_56_0)
	local var_56_0 = getGameset("technology_shadow_num")[1]
	local var_56_1 = {}

	for iter_56_0 = 0, var_56_0 do
		if defaultValue(arg_56_0.phantomRandomFlag[iter_56_0], 0) > 0 then
			table.insert(var_56_1, arg_56_0:GetShipPhantomMark(iter_56_0))
		end
	end
...
function var_0_0.updateName(arg_57_0)
	if arg_57_0.name ~= pg.ship_data_statistics[arg_57_0.configId].name then
		return
	end

	if arg_57_0:isRemoulded() then
		arg_57_0.name = pg.ship_skin_template[arg_57_0:getRemouldSkinId()].name
	else
		arg_57_0.name = pg.ship_data_statistics[arg_57_0.configId].name
	end
end

function var_0_0.isRemoulded(arg_58_0)
	if arg_58_0.remoulded then
		return true
	end

	local var_58_0 = pg.ship_data_trans[arg_58_0.groupId]

	if var_58_0 then
		for iter_58_0, iter_58_1 in ipairs(var_58_0.transform_list) do
			for iter_58_2, iter_58_3 in ipairs(iter_58_1) do
				local var_58_1 = pg.transform_data_template[iter_58_3[2]]

				if var_58_1.skin_id ~= 0 and arg_58_0.transforms[iter_58_3[2]] and arg_58_0.transforms[iter_58_3[2]].level == var_58_1.max_level then
					return true
				end
			end
		end
...
function var_0_0.getRemouldSkinId(arg_59_0)
	local var_59_0 = ShipGroup.getModSkin(arg_59_0.groupId)
...
function var_0_0.hasEquipmentSkinInPos(arg_60_0, arg_60_1)
	local var_60_0 = arg_60_0.equipments[arg_60_1]

	return var_60_0 and var_60_0:hasSkin()
end

function var_0_0.getPrefab(arg_61_0)
	local var_61_0 = arg_61_0:getSkinId()

	if arg_61_0:hasEquipmentSkinInPos(var_0_2) then
		local var_61_1 = arg_61_0:getEquip(var_0_2)
		local var_61_2 = var_0_7[var_61_1:getSkinId()].ship_skin_id

		var_61_0 = var_61_2 ~= 0 and var_61_2 or var_61_0
	end

	local var_61_3 = pg.ship_skin_template[var_61_0]

	assert(var_61_3, "ship_skin_template not exist: " .. arg_61_0.configId .. " " .. var_61_0)

	return var_61_3.prefab
end

function var_0_0.getAttachmentPrefab(arg_62_0)
	local var_62_0 = {}

	for iter_62_0, iter_62_1 in ipairs(arg_62_0.equipments) do
		if iter_62_1 and iter_62_1:hasSkinOrbit() then
			local var_62_1 = iter_62_1:getSkinId()
			local var_62_2 = var_0_7[var_62_1]
...
function var_0_0.getPainting(arg_63_0)
	...
	return var_63_1.painting
end

function var_0_0.GetSkinConfig(arg_64_0, arg_64_1)
...
function var_0_0.getRemouldPainting(arg_65_0)
	local var_65_0 = arg_65_0:getRemouldSkinId()
...
function var_0_0.updateStateInfo34(arg_66_0, arg_66_1, arg_66_2)
	arg_66_0.state_info_3 = arg_66_1
	arg_66_0.state_info_4 = arg_66_2
end

function var_0_0.hasStateInfo3Or4(arg_67_0)
	return arg_67_0.state_info_3 ~= 0 or arg_67_0.state_info_4 ~= 0
end

function var_0_0.isTestShip(arg_68_0)
	return arg_68_0.testShip
end

function var_0_0.canUseTestShip(arg_69_0, arg_69_1)
	assert(arg_69_0.testShip, "ship is not TestShip")

	return table.contains(arg_69_0.testShip, arg_69_1)
end

function var_0_0.updateEquip(arg_70_0, arg_70_1, arg_70_2)
	assert(arg_70_2 == nil or arg_70_2.count == 1)

	local var_70_0 = arg_70_0.equipments[arg_70_1]

	arg_70_0.equipments[arg_70_1] = arg_70_2 and Clone(arg_70_2) or false

	local function var_70_1(arg_71_0)
		arg_71_0 = CreateShell(arg_71_0)
		arg_71_0.shipId = arg_70_0.id
		arg_71_0.shipPos = arg_70_1

		return arg_71_0
	end

	if var_70_0 then
		getProxy(EquipmentProxy):OnShipEquipsRemove(var_70_0, arg_70_0.id, arg_70_1)
		var_70_0:setSkinId(0)
		pg.m02:sendNotification(BayProxy.SHIP_EQUIPMENT_REMOVED, var_70_1(var_70_0))
	end

	if arg_70_2 then
		getProxy(EquipmentProxy):OnShipEquipsAdd(arg_70_2, arg_70_0.id, arg_70_1)
		arg_70_0:reletiveEquipSkin(arg_70_1)
		pg.m02:sendNotification(BayProxy.SHIP_EQUIPMENT_ADDED, var_70_1(arg_70_2))
	end
end

function var_0_0.reletiveEquipSkin(arg_72_0, arg_72_1)
	if arg_72_0.equipments[arg_72_1] and arg_72_0.equipmentSkins[arg_72_1] ~= 0 then
		local var_72_0 = pg.equip_skin_template[arg_72_0.equipmentSkins[arg_72_1]].equip_type
		local var_72_1 = arg_72_0.equipments[arg_72_1]:getType()

		if table.contains(var_72_0, var_72_1) then
			arg_72_0.equipments[arg_72_1]:setSkinId(arg_72_0.equipmentSkins[arg_72_1])
		else
			arg_72_0.equipments[arg_72_1]:setSkinId(0)
		end
	elseif arg_72_0.equipments[arg_72_1] then
		arg_72_0.equipments[arg_72_1]:setSkinId(0)
	end
end

function var_0_0.updateEquipmentSkin(arg_73_0, arg_73_1, arg_73_2)
	if not arg_73_1 then
		return
	end

	if arg_73_2 and arg_73_2 > 0 then
		local var_73_0 = arg_73_0:getSkinTypes(arg_73_1)
		local var_73_1 = pg.equip_skin_template[arg_73_2].equip_type
		local var_73_2 = false

		for iter_73_0, iter_73_1 in ipairs(var_73_0) do
			for iter_73_2, iter_73_3 in ipairs(var_73_1) do
				if iter_73_1 == iter_73_3 then
					var_73_2 = true
		...
		if not var_73_2 then
			assert(var_73_2, "部位" .. arg_73_1 .. " 无法穿戴皮肤 " .. arg_73_2)

			return
		end

		local var_73_3 = arg_73_0.equipments[arg_73_1] and arg_73_0.equipments[arg_73_1]:getType() or false

		arg_73_0.equipmentSkins[arg_73_1] = arg_73_2

		if var_73_3 and table.contains(var_73_1, var_73_3) then
			arg_73_0.equipments[arg_73_1]:setSkinId(arg_73_0.equipmentSkins[arg_73_1])
		elseif var_73_3 and not table.contains(var_73_1, var_73_3) then
			arg_73_0.equipments[arg_73_1]:setSkinId(0)
		end
	else
		arg_73_0.equipmentSkins[arg_73_1] = 0

		if arg_73_0.equipments[arg_73_1] then
			arg_73_0.equipments[arg_73_1]:setSkinId(0)
		end
	end
end

function var_0_0.getEquip(arg_74_0, arg_74_1)
	return Clone(arg_74_0.equipments[arg_74_1])
end

function var_0_0.getEquipSkins(arg_75_0)
	return Clone(arg_75_0.equipmentSkins)
end

function var_0_0.getEquipSkin(arg_76_0, arg_76_1)
	return arg_76_0.equipmentSkins[arg_76_1]
end

function var_0_0.getCanEquipSkin(arg_77_0, arg_77_1)
	local var_77_0 = arg_77_0:getSkinTypes(arg_77_1)

	if var_77_0 and #var_77_0 then
		for iter_77_0, iter_77_1 in ipairs(var_77_0) do
			if pg.equip_data_by_type[iter_77_1].equip_skin == 1 then
				return true
			end
		end
	end
...
function var_0_0.checkCanEquipSkin(arg_78_0, arg_78_1, arg_78_2)
	if not arg_78_1 or not arg_78_2 then
		return
	end

	local var_78_0 = arg_78_0:getSkinTypes(arg_78_1)
	local var_78_1 = pg.equip_skin_template[arg_78_2].equip_type

	for iter_78_0, iter_78_1 in ipairs(var_78_0) do
		if table.contains(var_78_1, iter_78_1) then
			return true
		end
	end
...
function var_0_0.getSkinTypes(arg_79_0, arg_79_1)
	return pg.ship_data_template[arg_79_0.configId]["equip_" .. arg_79_1] or {}
end

function var_0_0.updateState(arg_80_0, arg_80_1)
	arg_80_0.state = arg_80_1
end
...
function var_0_0.getShipSkillEffects(arg_108_0)
	...
	for iter_108_0, iter_108_1 in ipairs(var_108_1) do
		local var_108_2 = arg_108_0:RemapSkillId(iter_108_1)
...
function var_0_0.getStartBattleExpend(arg_142_0)
	if table.contains(TeamType.SubShipType, arg_142_0:getShipType()) then
		return 0
	else
...
function var_0_0.getTeamType(arg_172_0)
	return TeamType.GetTeamFromShipType(arg_172_0:getShipType())
end
...
function var_0_0.RemapSkillId(arg_180_0, arg_180_1)
...
function var_0_0.GetMapStrikeAnim(arg_226_0)
	...
	switch(TeamType.GetTeamFromShipType(var_226_1), {
...
function var_0_0.IsMatchKey(arg_231_0, arg_231_1)
	...
	if var_231_0[1] == var_231_0[2] then
		table.remove(var_231_0)
	end

	return underscore.any(var_231_0, function(arg_232_0)
