...
function var_0_0.Ctor(arg_1_0, arg_1_1)
	...
	for iter_1_0, iter_1_1 in ipairs(arg_1_0:GetDrawConfig("reward_list")) do
		...
		local var_1_2 = pg.island_draw_reward[var_1_0].rarity

		arg_1_0.rarityDic[var_1_2] = arg_1_0.rarityDic[var_1_2] or {}

		table.insert(arg_1_0.rarityDic[var_1_2], var_1_0)
	end
end

function var_0_0.GetDrawConfig(arg_2_0, arg_2_1)
	local var_2_0 = pg.island_draw[arg_2_0.configId]

	assert(var_2_0, "without config in pg.island_draw:" .. arg_2_0.configId)
...
function var_0_0.GetList(arg_6_0)
	...
	for iter_6_2, iter_6_3 in ipairs(arg_6_0.rarityDic[4] or {}) do
		for iter_6_4 = defaultValue(arg_6_0.storeDic[iter_6_3], 0), defaultValue(var_6_1[iter_6_3], 0) + 1, -1 do
			table.insert(var_6_0, {
				iter_6_3,
				iter_6_4 > defaultValue(var_6_1[iter_6_3], 0) + defaultValue(arg_6_0.countDic[iter_6_3], 0)
			})
		end
	end
...
function var_0_0.CheckList(arg_7_0, arg_7_1)
	...
	for iter_7_0, iter_7_1 in ipairs(arg_7_0.rarityDic[4]) do
		var_7_0[iter_7_1] = defaultValue(arg_7_0.storeDic[iter_7_1], 0) - defaultValue(arg_7_0.countDic[iter_7_1], 0)
	...
	for iter_17_0, iter_17_1 in ipairs(arg_17_1) do
		...
		if pg.island_draw_reward[iter_17_1].rarity == 4 then
			if #arg_17_0.data1_list == 0 or arg_17_0.data1_list[1] == iter_17_1 then
				...
				assert(false, string.format("error SList drop %d in {%s}", iter_17_1, table.concat(arg_17_0.data1_list)))
			end
		end
	end
end
...
function var_0_0.GetShowRankList(arg_22_0, arg_22_1)
	...
	for iter_22_0, iter_22_1 in ipairs(arg_22_0:GetRankList(arg_22_1)) do
		...
		local var_22_3 = pg.island_draw_reward[var_22_1]

		if noEmptyStr(var_22_3.show) then
