...
function var_0_0.Ctor(arg_1_0, arg_1_1)
	...
	local var_1_0 = arg_1_1.mall

	arg_1_0.gold = var_1_0.gold
	arg_1_0.round = var_1_0.round
	arg_1_0.triggeredPointIds = var_1_0.story_list
	arg_1_0.levelData = MallLevel.New(var_1_0.level)
	arg_1_0.orderData = MallOrder.New(var_1_0.order)
	arg_1_0.lastBalance = var_1_0.last_round.balance
	arg_1_0.lastIncome = 0

	local var_1_1 = var_1_0.last_round.floor_income
	local var_1_2 = {}
	local var_1_3 = {}
	...
	for iter_1_2, iter_1_3 in ipairs(pg.activity_mall_template.all) do
		local var_1_4 = var_1_2[iter_1_3]
		local var_1_5 = MallFloor.New(var_1_4 or {
			id = iter_1_3
		}, var_1_4 ~= nil)

		var_1_5:CheckUnlock(arg_1_0.levelData.level)
		var_1_5:SetLastIncome(var_1_3[iter_1_3])

		arg_1_0.floorData[iter_1_3] = var_1_5
	end

	arg_1_0.lastFloorStaffList = arg_1_0:GetFloorStaffList()
	arg_1_0.staffData = {}

	for iter_1_4, iter_1_5 in ipairs(var_1_0.employee_list) do
...
function var_0_0.NextRound(arg_9_0, arg_9_1)
	...
	for iter_9_0, iter_9_1 in ipairs(arg_9_1) do
		if iter_9_0 ~= 1 then
			...
			arg_9_0.floorData[var_9_1]:SetLastIncome(iter_9_1)
...
function var_0_0._AddFloorStaff(arg_36_0, arg_36_1, arg_36_2, arg_36_3)
	local var_36_0 = arg_36_0.floorData[arg_36_1]:GetStaffList()[arg_36_2]

	assert(var_36_0 == 0, string.format("%d楼的第%d个位置已有员工%d, 请先移除！", arg_36_1, arg_36_2, arg_36_3))

	local var_36_1, var_36_2 = arg_36_0.staffData[arg_36_3]:GetStatusInfos()

	assert(var_36_1 == MallStaff.STATUS.NORMAL, string.format("员工%d处于被占用状态！(%d)", arg_36_3, var_36_1))
