...
function var_0_0.GetEffectStr(arg_6_0)
	return arg_6_0:GetType() == TownWorkplace2.TYPE.NUMBER and string.format("+%s/H", TownActivity2.GoldToShow(arg_6_0:GetGoldUnit() * 3600)) or string.format("+%d%%", arg_6_0:GetGoldRatio() / 100)
end
