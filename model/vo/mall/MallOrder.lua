...
function var_0_0.UpdateEndTime(arg_6_0)
	if arg_6_0.id == 0 or arg_6_0.startTime == 0 then
		...
		arg_6_0.endTime = arg_6_0.startTime + pg.activity_mall_custom_order[arg_6_0.id].cost_time
	end
end
...
function var_0_0.GetCost(arg_10_0)
	local var_10_0 = pg.activity_mall_custom_order[arg_10_0].order_cost_show
