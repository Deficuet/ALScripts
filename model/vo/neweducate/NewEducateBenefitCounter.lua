...
function var_0_0.UpdateData(arg_3_0, arg_3_1)
	for iter_3_0, iter_3_1 in ipairs(arg_3_1) do
		...
		arg_3_0.data[iter_3_1.drop_type][iter_3_1.drop_id] = {
			[var_0_0.TYPE.GAIN] = (var_3_0 and var_3_0[var_0_0.TYPE.GAIN] or 0) + iter_3_1.positive_counter,
			[var_0_0.TYPE.COST] = (var_3_0 and var_3_0[var_0_0.TYPE.COST] or 0) + iter_3_1.negative_counter
		}
	end
end
