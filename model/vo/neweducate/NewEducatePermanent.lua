...
function var_0_0.GetUnlockMemoryIds(arg_7_0)
	return underscore.select(arg_7_0:GetAllMemoryIds(), function(arg_8_0)
		local var_8_0 = pg.child2_memory[arg_8_0].lua

		return (pg.NewStoryMgr.GetInstance():IsPlayed(var_8_0))
	end)
end
...
function var_0_0.InitPolaroidsConfig(arg_12_0)
	local var_12_0 = pg.child2_polaroid.get_id_list_by_character[arg_12_0.id]

	arg_12_0.polaroidGroup2Ids = {}

	for iter_12_0, iter_12_1 in ipairs(var_12_0) do
		local var_12_1 = pg.child2_polaroid[iter_12_1].group

		if not arg_12_0.polaroidGroup2Ids[var_12_1] then
			arg_12_0.polaroidGroup2Ids[var_12_1] = {}
		end

		table.insert(arg_12_0.polaroidGroup2Ids[var_12_1], iter_12_1)
	end

	arg_12_0.unlockPolaroidGroups = {}

	for iter_12_2, iter_12_3 in ipairs(arg_12_0.polaroids) do
		local var_12_2 = pg.child2_polaroid[iter_12_3].group

		if not table.contains(arg_12_0.unlockPolaroidGroups, var_12_2) then
			table.insert(arg_12_0.unlockPolaroidGroups, var_12_2)
		end
	end
end
...
function var_0_0.AddPolaroid(arg_17_0, arg_17_1)
	...
	local var_17_0 = pg.child2_polaroid[arg_17_1].group

	if not table.contains(arg_17_0.unlockPolaroidGroups, var_17_0) then
		table.insert(arg_17_0.unlockPolaroidGroups, var_17_0)
...
function var_0_0.InitEntryConfig(arg_34_0)
	...
	for iter_34_0, iter_34_1 in ipairs(arg_34_0:GetAllEntryIds()) do
		local var_34_0 = pg.child2_benefit_list[iter_34_1].level_tag

		if not arg_34_0.entryGroup2Ids[var_34_0] then
			arg_34_0.entryGroup2Ids[var_34_0] = {}
		end

		table.insert(arg_34_0.entryGroup2Ids[var_34_0], iter_34_1)
	end
end
...
function var_0_0.GetUnlockEntryGroups(arg_39_0)
	...
	for iter_39_0, iter_39_1 in ipairs(arg_39_0:GetActivatedEntryIds()) do
		local var_39_1 = pg.child2_benefit_list[iter_39_1].level_tag

		if not table.contains(var_39_0, var_39_1) then
...
function var_0_0.InitSecretary(arg_45_0)
	...
	for iter_45_0, iter_45_1 in ipairs(pg.secretary_special_ship.all) do
		local var_45_0 = pg.secretary_special_ship[iter_45_1]

		if var_45_0.unlock_type == EducateConst.SECRETARY_UNLCOK_TYPE_POLAROID then
			local var_45_1 = var_45_0.unlock[1]

			if not table.contains(arg_45_0.unlcokTipByPolaroidCnt, var_45_1) then
				table.insert(arg_45_0.unlcokTipByPolaroidCnt, var_45_1)
			end
		end
	end
end
...
function var_0_0.UpdateSecretaryIDs(arg_47_0, arg_47_1)
	...
	for iter_47_0, iter_47_1 in ipairs(pg.secretary_special_ship.get_id_list_by_tb_id[arg_47_0.id] or {}) do
		local var_47_2 = pg.secretary_special_ship[iter_47_1].unlock_type
		...
		switch(var_47_2, {
			...
			[EducateConst.SECRETARY_UNLCOK_TYPE_SHOP] = function()
				if var_47_3[1] and getProxy(ShipSkinProxy):hasSkin(var_47_3[1]) then
					table.insert(arg_47_0.unlockSecretaryIds, iter_47_1)
				end
			end,
			[EducateConst.SECRETARY_UNLCOK_TYPE_STORY] = function()
				if var_47_3[1] and pg.NewStoryMgr.GetInstance():IsPlayed(pg.NewStoryMgr.GetInstance():StoryId2StoryName(var_47_3[1])) then
					table.insert(arg_47_0.unlockSecretaryIds, iter_47_1)
				end
			end
		})
