...
function var_0_0.GetExtraServiceItem(arg_15_0)
	...
	if arg_15_0:isPassItem() then
		...
		if var_15_2 == 130 then
			local var_15_4 = pg.black_friday_battlepass_event_pt[var_15_1].award_pay

			var_15_0 = PlayerConst.MergePassItemDrop(underscore.map(var_15_4, function(arg_16_0)
				return Drop.Create(pg.black_friday_battlepass_event_award[arg_16_0].drop_client)
			end))
		elseif var_15_2 == 54 then
			local var_15_5 = pg.battlepass_event_pt[var_15_1].award_pay

			var_15_0 = PlayerConst.MergePassItemDrop(underscore.map(var_15_5, function(arg_17_0)
	...
	if not arg_15_0:isMonthCard() and var_15_6 > 0 then
...
function var_0_0.GetExtraDrop(arg_21_0)
	...
	if arg_21_0:isPassItem() then
		...
		if var_21_3 == 130 then
			local var_21_4 = pg.black_friday_battlepass_event_pt[var_21_1].pt
		...
		elseif var_21_3 == 54 then
			local var_21_5 = pg.battlepass_event_pt[var_21_1].pt
