...
function var_0_0.OnExecute(arg_2_0)
	...
	local var_2_2 = _IslandCore:GetController().strollAllocator
	local var_2_3 = arg_2_0:GetFloatArg("pathId")

	arg_2_0.chaoticOrder = arg_2_0:GetBoolArg("chaoticOrder")

	local var_2_4 = var_2_2:GetWaypoints(var_2_3)

	assert(#var_2_4 > 0, "waypoints is empty")

	arg_2_0.waypoints = _.map(var_2_4, function(arg_3_0)
...
function var_0_0.NextOne(arg_7_0)
	...
	_IslandMoveUnit(arg_7_0.unitType, arg_7_0.unitId, var_7_0, arg_7_0.speed)
	arg_7_0:OnProcess()
end
...
function var_0_0.Shuffle(arg_8_0)
	...
	shuffle(var_8_1)
	table.insert(var_8_1, 1, var_8_0)
...
function var_0_0.ResumeMove(arg_10_0)
	local var_10_0 = Animator.StringToHash("movement")

	arg_10_0:CrossFadeInFixedTime(var_10_0, 0.2)

	local var_10_1 = arg_10_0.waypoints[arg_10_0.index].position

	_IslandMoveUnit(arg_10_0.unitType, arg_10_0.unitId, var_10_1, arg_10_0.speed)
end
...
function var_0_0.CheckAnimationState(arg_11_0, arg_11_1, arg_11_2, arg_11_3)
	...
	if var_11_0:IsName(arg_11_2) and not arg_11_0.endTime then
		local var_11_1 = var_11_0.length / arg_11_1.speed
...
function var_0_0.DisappearUnit(arg_17_0)
	setActive(arg_17_0.agent, false)
end
...
function var_0_0.PlayArriveAnimation(arg_22_0, arg_22_1)
	if not arg_22_0.animator:GetCurrentAnimatorStateInfo(0):IsName(arg_22_1) then
		local var_22_0 = Animator.StringToHash(arg_22_1)

		arg_22_0:CrossFadeInFixedTime(var_22_0, 0.2)
...
function var_0_0.PlayProcessAnimation(arg_31_0, arg_31_1)
	if not arg_31_0.animator:GetCurrentAnimatorStateInfo(0):IsName(arg_31_1) then
		local var_31_0 = Animator.StringToHash(arg_31_1)

		arg_31_0:CrossFadeInFixedTime(var_31_0, 0.2)
...
function var_0_0.OnDrawGizmosSelected(arg_34_0)
	...
	local var_34_1 = var_34_0[1].position
	...
	for iter_34_0 = 1, #var_34_0 do
		...
		LuaHelper.DrawText("point" .. iter_34_0, var_34_1, Vector3(1, 0, 0))

		local var_34_2 = var_34_0[iter_34_0 + 1].position

		LuaHelper.DrawLine(var_34_1, var_34_2, Vector3(1, 0, 0), 0)
