...
;(function()
	...
	pg.base.skill_world_display[152380] = {
		desc_get = "",
		id = 152380,
		desc = "【大型作战效果】\n进入战斗后，自身氧气存量额外提供$1点，战斗中自身因氧气不足上浮时，立即撤退并离开战斗；进入战斗后5秒，发射一轮特殊弹幕$2（威力依据技能等级）；进入大型作战中作为潜艇支援被呼叫时，消耗行动力减少$3；关卡海域内其他舰队进入战斗时，若自身存活，战斗开始后15秒，发动一轮支援攻击$2（威力依据技能等级），并暴露敌方在场潜艇8秒，同时使所有在场敌方单位在接下来8秒内命中、机动属性降低10%",
		desc_get_add = {
			{
				"4",
				"40"
