...
function var_0_0.KM(arg_5_0, arg_5_1)
	local var_5_0 = {}
	local var_5_1 = {}
	local var_5_2 = {}
	local var_5_3 = {}
	...
	local function var_5_13(arg_7_0)
		...
		while true do
			while not var_7_0:isEmpty() do
				...
				for iter_7_1 = 1, arg_5_0 do
					if not var_5_6[iter_7_1] then
						local var_7_2 = var_5_1[var_7_1] + var_5_2[iter_7_1] - var_5_0[var_7_1][iter_7_1]

						if var_7_2 < var_5_8[iter_7_1] then
							var_5_8[iter_7_1] = var_7_2
			...
			local var_7_3 = var_0_1

			for iter_7_2 = 1, arg_5_0 do
				if not var_5_6[iter_7_2] and var_7_3 > var_5_8[iter_7_2] then
					var_7_3 = var_5_8[iter_7_2]
				end
			end

			for iter_7_3 = 1, arg_5_0 do
				if var_5_5[iter_7_3] then
					var_5_1[iter_7_3] = var_5_1[iter_7_3] - var_7_3
				end

				if var_5_6[iter_7_3] then
					var_5_2[iter_7_3] = var_5_2[iter_7_3] + var_7_3
				else
					var_5_8[iter_7_3] = var_5_8[iter_7_3] - var_7_3
				end
			end
