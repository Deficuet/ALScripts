...
function var_0_0.initNotificationHandleDic(arg_60_0)
	arg_60_0.handleDic = {
		...
		[GAME.COLORING_ACHIEVE_DONE] = function(arg_69_0, arg_69_1)
			arg_69_0.viewComponent:playBonusAnim(function()
				local var_70_0 = arg_69_1:getBody()

				arg_69_0.viewComponent:emit(BaseUI.ON_ACHIEVE, var_70_0.drops, function()
					arg_69_0.viewComponent:flush_coloring()
				end)
			end)
		end,
		...
		[GAME.ACT_NEW_PT_DONE] = function(arg_76_0, arg_76_1)
			...
			arg_76_0.viewComponent:emit(BaseUI.ON_ACHIEVE, var_76_0.awards, var_76_0.callback)
		end,
		[GAME.BEGIN_STAGE_DONE] = function(arg_77_0, arg_77_1)
			local var_77_0 = arg_77_1:getBody()

			arg_77_0:sendNotification(GAME.GO_SCENE, SCENE.COMBATLOAD, var_77_0)
		end,
		[GAME.RETURN_AWARD_OP_DONE] = function(arg_78_0, arg_78_1)
			local var_78_0 = arg_78_1:getBody()

			arg_78_0.viewComponent:emit(BaseUI.ON_ACHIEVE, var_78_0.awards)
		end,
		[VoteProxy.VOTE_ORDER_BOOK_DELETE] = function(arg_79_0, arg_79_1)
			return
		end,
		[VoteProxy.VOTE_ORDER_BOOK_UPDATE] = function(...)
			arg_60_0.handleDic[VoteProxy.VOTE_ORDER_BOOK_DELETE](...)
		end,
		[GAME.REMOVE_LAYERS] = function(arg_81_0, arg_81_1)
			if arg_81_1:getBody().context.mediator == VoteFameHallMediator then
				arg_81_0.viewComponent:updateEntrances()
			end
		end,
		[GAME.MONOPOLY_AWARD_DONE] = function(arg_82_0, arg_82_1)
			local var_82_0 = arg_82_1:getBody()
			local var_82_1 = arg_82_0.viewComponent.pageDic[arg_82_0.viewComponent.activity.id]

			if var_82_1 and var_82_1.activity:getConfig("type") == ActivityConst.ACTIVITY_TYPE_MONOPOLY and var_82_1.onAward then
				var_82_1:onAward(var_82_0.awards, var_82_0.callback)
			elseif var_82_0.autoFlag then
				arg_82_0.viewComponent:emit(BaseUI.ON_ACHIEVE_AUTO, var_82_0.awards, 1, var_82_0.callback)
			else
				arg_82_0.viewComponent:emit(BaseUI.ON_ACHIEVE, var_82_0.awards, var_82_0.callback)
			end
		end,
		[GAME.SEND_MINI_GAME_OP_DONE] = function(arg_83_0, arg_83_1)
			local var_83_0 = arg_83_1:getBody()
			local var_83_1 = {
				function(arg_84_0)
					local var_84_0 = var_83_0.awards

					if #var_84_0 > 0 then
						if arg_83_0.viewComponent then
							arg_83_0.viewComponent:emit(BaseUI.ON_ACHIEVE, var_84_0, arg_84_0)
						else
							arg_83_0:emit(BaseUI.ON_ACHIEVE, var_84_0, arg_84_0)
						end
					else
						arg_84_0()
					end
			...
			seriesAsync(var_83_1, function()
				arg_83_0.viewComponent:updateTaskLayers()
			end)
		end,
		[GAME.ACTIVITY_PERMANENT_START_DONE] = function(arg_86_0, arg_86_1)
			local var_86_0 = arg_86_1:getBody()

			arg_86_0.viewComponent:verifyTabs(var_86_0.id)
		end,
		[GAME.ACTIVITY_PERMANENT_FINISH_DONE] = function(arg_87_0, arg_87_1)
			local var_87_0 = arg_87_1:getBody()

			arg_87_0.viewComponent:emit(ActivityMediator.ACTIVITY_PERMANENT, var_87_0.activity_id)
		end,
		[GAME.MEMORYBOOK_UNLOCK_AWARD_DONE] = function(arg_88_0, arg_88_1)
