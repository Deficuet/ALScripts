...
function var_0_0.UpdateFilterButtons(arg_12_0)
	for iter_12_0, iter_12_1 in pairs(arg_12_0.formulaFilterButtons) do
		local var_12_0 = arg_12_0.contextData.filterType ~= var_0_0.FilterAll
...
function var_0_0.UpdateFormulaItem(arg_13_0, arg_13_1, arg_13_2)
	...
	if var_13_1:GetMaxLimit() > 0 then
		var_13_5 = var_13_1:GetMaxLimit() - var_13_1:GetUsedCount() .. "/" .. var_13_1:GetMaxLimit()
	else
		var_13_5 = "∞"
	end
	...
	if var_13_6 then
		...
		if var_13_8 and var_13_8 == 2 then
			var_13_9 = SummerFeastScene.TransformColor(var_13_7 and "62e587" or "f27878")
		else
...
function var_0_0.FilterFormulas(arg_15_0)
	...
	for iter_15_0, iter_15_1 in pairs(arg_15_0.activity:GetFormulasByVersion(var_15_0)) do
		if arg_15_0:IsFormulaTypeFit(iter_15_1) and (not arg_15_0.showOnlyComposite or iter_15_1:IsAvaliable() and AtelierFormula.IsFormualCanComposite(iter_15_1, arg_15_0.activity, var_15_0)) then
	...
	table.sort(arg_15_0.filterFormulas, function(arg_16_0, arg_16_1)
		...
		for iter_16_0, iter_16_1 in ipairs(var_16_0) do
			local var_16_1 = iter_16_1(arg_16_0)
			local var_16_2 = iter_16_1(arg_16_1)
...
function var_0_0.IsFormulaTypeFit(arg_20_0, arg_20_1)
	local var_20_0 = arg_20_0.contextData.filterType

	if var_20_0 == var_0_0.FilterAll then
		return true
	end
