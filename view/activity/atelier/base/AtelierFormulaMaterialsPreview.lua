...
function var_0_0.ShowMaterialsPreview(arg_8_0, arg_8_1)
	...
	local function var_8_9()
		...
		local var_19_1 = CustomIndexLayer.Clone2Full(var_19_0, #var_8_3)

		table.Foreach(var_19_1, function(arg_20_0, arg_20_1)
			local var_20_0 = var_8_3[arg_20_0]

			arg_8_0._parentClass:UpdateRyzaItem(arg_20_1:Find("IconBG"), var_20_0, true)
			onButton(arg_8_0, arg_20_1, function()
				arg_8_0._parentClass:ShowItemDetail(var_20_0)
			end, SFX_PANEL)
		end)
	end
	...
	local function var_8_10()
		...
		local var_22_1 = CustomIndexLayer.Clone2Full(var_22_0, #var_8_4)

		table.Foreach(var_22_1, function(arg_23_0, arg_23_1)
			local var_23_0 = var_8_4[arg_23_0]

			arg_8_0._parentClass:UpdateRyzaItem(arg_23_1:Find("IconBG"), var_23_0, true)
			onButton(arg_8_0, arg_23_1, function()
				arg_8_0._parentClass:ShowItemDetail(var_23_0)
			end, SFX_PANEL)
		end)
	end
