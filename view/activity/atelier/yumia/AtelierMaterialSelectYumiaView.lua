...
function var_0_0.UpdateCandicateItem(arg_4_0, arg_4_1, arg_4_2)
	...
	arg_4_0._parentClass:UpdateRyzaItem(var_4_0, var_4_1, true)

	local var_4_2 = var_4_1.count <= 0
...
function var_0_0.RefreshFormula(arg_12_0)
	...
	arg_12_0._parentClass:UpdateRyzaDrop(arg_12_0.item, var_12_1)
	setText(arg_12_0.itemName, var_12_0:GetName())
	setText(arg_12_0.itemDescription, var_12_0:GetDesc())

	local var_12_2 = tostring(var_12_0:GetMaxLimit() - var_12_0:GetUsedCount())

	if var_12_0:GetMaxLimit() < 0 then
		var_12_2 = "∞"
	end

	setText(arg_12_0.itemCnt, var_12_2)
end
