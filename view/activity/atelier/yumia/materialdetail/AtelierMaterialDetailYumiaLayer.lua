...
function var_0_0.UpdateItemDetail(arg_10_0)
	...
	arg_10_0:UpdateRyzaItem(arg_10_0._tf:Find("Window/AtelierCommonYumiaItem"), var_10_0)
	setText(arg_10_0._tf:Find("Window/nameBg/Name"), var_10_0:GetName())
	setText(arg_10_0._tf:Find("Window/Description/Text"), var_10_0:GetDesc())

	local var_10_1 = var_10_0:GetSource()

	setScrollText(arg_10_0._tf:Find("Window/sourceBg/mask/sourceText"), var_10_1[1])
