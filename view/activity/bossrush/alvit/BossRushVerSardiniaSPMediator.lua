...
function var_0_0.register(arg_1_0)
	...
	local var_1_3 = var_1_0:getActivityById(arg_1_0.contextData.activityStoryID)

	arg_1_0.viewComponent:SetStoryActivity(var_1_3)

	arg_1_0.contextData.activityPTID = var_1_2.pt

	local var_1_4 = var_1_0:getActivityById(arg_1_0.contextData.activityPTID)

	arg_1_0.viewComponent:SetPtActivity(var_1_4)

	arg_1_0.contextData.activityTaskID = var_1_2.tasks

	local var_1_5 = var_1_0:getActivityById(arg_1_0.contextData.activityTaskID)

	arg_1_0.viewComponent:SetTasksActivity(var_1_5)
	...
	elseif var_12_0 == ActivityProxy.ACTIVITY_UPDATED then
		...
		switch(var_12_3.id, {
			[arg_12_0.contextData.activityID] = function()
				arg_12_0.viewComponent:SetActivity(var_12_3)
				arg_12_0.viewComponent:UpdateView()
			end,
			[arg_12_0.contextData.activityPTID] = function()
				arg_12_0.viewComponent:SetPtActivity(var_12_3)
				arg_12_0.viewComponent:UpdateView()
			end,
			[arg_12_0.contextData.activityStoryID] = function()
				arg_12_0.viewComponent:SetStoryActivity(var_12_3)
			end
		})
