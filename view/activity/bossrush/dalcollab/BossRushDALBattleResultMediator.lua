...
function var_0_0.ShowTotalAward(arg_14_0, arg_14_1)
	local var_14_0 = getProxy(ActivityProxy):getActivityByType(ActivityConst.ACTIVITY_TYPE_BOSS_RUSH_DAL_COLLAB)
	local var_14_1 = var_14_0 and var_14_0:getConfig("config_client").mediator or "BossRushDALCollabMediator"
