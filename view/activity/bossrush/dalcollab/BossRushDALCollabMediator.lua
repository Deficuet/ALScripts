...
function var_0_0.register(arg_1_0)
	...
	local var_1_3 = var_1_1:getConfig("config_client").PTID
	...
	arg_1_0.viewComponent:SetPTActivity(underscore.detect(var_1_0:getActivitiesByType(ActivityConst.ACTIVITY_TYPE_PT_RANK), function(arg_4_0)
		return arg_4_0:getConfig("config_id") == var_1_3
	end))
...
function var_0_0.handleNotification(arg_9_0, arg_9_1)
	...
	elseif var_9_0 == ActivityProxy.ACTIVITY_UPDATED then
		...
		if var_9_3 then
			if var_9_3.id == arg_9_0.viewComponent.activity.id then
				arg_9_0.viewComponent:SetActivity(var_9_3)
				arg_9_0.viewComponent:UpdateView()
			end

			if var_9_3:getConfig("type") == ActivityConst.ACTIVITY_TYPE_BUILDING_BUFF then
				arg_9_0.viewComponent.upgradeView:SetData(var_9_3)
	...
	elseif var_9_0 == GAME.COLLABRATE_BOSS_RUSH_REQUEST_DATA_DONE then
		local var_9_4 = getProxy(ActivityProxy):getActivityByType(ActivityConst.ACTIVITY_TYPE_BOSS_RUSH_DAL_COLLAB)

		arg_9_0.viewComponent:SetActivity(var_9_4)
		arg_9_0.viewComponent:UpdateView()
	end
end
