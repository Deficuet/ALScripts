...
function var_0_0.UpdateView(arg_4_0)
	...
	local var_4_1 = arg_4_0._upgradeActivity:getConfig("config_data")

	for iter_4_2, iter_4_3 in ipairs(var_4_1) do
		local var_4_2 = arg_4_0._tf:Find("Panel/upgrade_" .. iter_4_3)

		setText(var_4_2:Find("mask/name"), arg_4_0._upgradeActivity:GetBuildingConfigTable(iter_4_3).name)
	end
end
...
function var_0_0.OnLoaded(arg_6_0)
	...
	local var_6_0 = arg_6_0._upgradeActivity:getConfig("config_data")

	for iter_6_0, iter_6_1 in ipairs(var_6_0) do
		local var_6_1 = arg_6_0._tf:Find("Panel/upgrade_" .. iter_6_1)
		...
		local var_6_2 = "LV." .. arg_6_0._upgradeActivity:GetBuildingLevel(iter_6_1) - 1

		setText(var_6_1:Find("unselected/level"), var_6_2)
		setText(var_6_1:Find("selected/level"), var_6_2)
		setText(var_6_1:Find("mask/name"), arg_6_0._upgradeActivity:GetBuildingConfigTable(iter_6_1).name)

		arg_6_0._upgradeList[iter_6_1] = var_6_1
	end
	...
	for iter_6_2 = 1, 3 do
		local var_6_3 = arg_6_0._upgradeDetailView:Find("page/upgrade_list/skill_detail_" .. iter_6_2)

		setText(var_6_3:Find("active/level"), "LV." .. iter_6_2)
		setText(var_6_3:Find("active/active"), i18n("DAL_upgrade_active"))
		setText(var_6_3:Find("disable/level"), "LV." .. iter_6_2)
		setText(var_6_3:Find("disable/unlock"), i18n("DAL_upgrade_unlock"))
		table.insert(arg_6_0._upgradeDetailList, var_6_3)
	end
...
function var_0_0.openUpgradeDetail(arg_14_0, arg_14_1)
	...
	local var_14_0 = arg_14_0._upgradeActivity:GetBuildingConfigTable(arg_14_1)

	setText(arg_14_0._upgradeDetailCurrentName, var_14_0.name)

	local var_14_1 = arg_14_0._upgradeList[arg_14_1]:Find("unselected/icon"):GetComponent(typeof(Image)).sprite

	arg_14_0._upgradeDetailIcon:GetComponent(typeof(Image)).sprite = var_14_1

	local var_14_2 = arg_14_0._upgradeActivity:GetBuildingLevel(arg_14_1) - 1

	setText(arg_14_0._upgradeDetailLevel, "LV." .. var_14_2)
...
function var_0_0.updateDetail(arg_15_0, arg_15_1)
	...
	if var_15_1 >= 4 then
		...
		local var_15_2 = var_15_0.material[var_15_1][1][3]

		setText(arg_15_0._upgradeBtn:Find("label/value"), var_15_2)
	end
end
