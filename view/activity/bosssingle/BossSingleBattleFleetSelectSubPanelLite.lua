...
function var_0_0.updateFleet(arg_20_0, arg_20_1, arg_20_2)
	...
	if var_20_5 then
		setActive(var_20_5, var_20_0 and var_20_2)
	end

	if var_20_6 then
		setActive(var_20_6, var_20_0 and var_20_2)
	end

	if var_20_7 then
		setActive(var_20_7, var_20_0 and var_20_2)
	end

	if var_20_0 and var_20_2 then
		setText(var_20_4, var_20_2 and var_20_2:GetName() or "")

		if arg_20_1 == FleetType.Submarine then
			arg_20_0:updateShips(var_20_7, var_20_2.subShips, var_20_2.id, TeamType.Submarine)
		else
			arg_20_0:updateShips(var_20_5, var_20_2.mainShips, var_20_2.id, TeamType.Main)
			arg_20_0:updateShips(var_20_6, var_20_2.vanguardShips, var_20_2.id, TeamType.Vanguard)
		end
	end

	onButton(arg_20_0, var_20_9, function()
		arg_20_0.toggleList.position = (var_20_9.position + var_20_8.position) / 2
		arg_20_0.toggleList.anchoredPosition = arg_20_0.toggleList.anchoredPosition + Vector2(-arg_20_0.toggleList.rect.width / 2, -var_20_9.rect.height / 2)
...
function var_0_0.updateShips(arg_25_0, arg_25_1, arg_25_2, arg_25_3, arg_25_4)
	...
	for iter_25_0 = 1, 3 do
		...
		if var_25_1 then
			local var_25_2 = var_25_1 and arg_25_0.tfShipTpl
			local var_25_3 = cloneTplTo(var_25_2, arg_25_1)

			setActive(var_25_3, true)

			if var_25_1 then
				updateShip(var_25_3, var_25_1)
...
function var_0_0.selectFleet(arg_26_0, arg_26_1, arg_26_2, arg_26_3)
	...
	if arg_26_3 > 0 and table.contains(var_26_0, arg_26_3) then
		return
	end

	if arg_26_1 == FleetType.Normal and arg_26_0:getLimitNums(arg_26_1) > 0 and arg_26_3 == 0 and #_.filter(var_26_0, function(arg_27_0)
		return arg_27_0 > 0
	end) == 1 then
	...
	local var_26_1 = arg_26_0:getFleetById(arg_26_3)

	if var_26_1 then
		if not var_26_1:isUnlock() then
			return
		end

		if var_26_1:isLegalToFight() ~= true then
