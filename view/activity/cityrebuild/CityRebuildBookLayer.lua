		...
		if arg_12_0 == UIItemList.EventUpdate then
			...
			var_12_2:make(function(arg_13_0, arg_13_1, arg_13_2)
				if arg_13_0 == UIItemList.EventUpdate then
					...
					local var_13_1 = table.contains(arg_11_0.cityRebuildData.buildings, var_13_0.id)
					...
					arg_13_2:Find("nameMask/name"):GetComponent(typeof(Text)).color = arg_11_0.cityRebuildData.cityLevel >= arg_12_1 + 1 and Color.New(0, 0, 0, 1) or Color.New(0.34509803921568627, 0.3843137254901961, 0.4, 1)

					local var_13_3 = var_13_1 and var_13_0.name[2] or var_13_0.name[1]

					setScrollText(arg_13_2:Find("nameMask/name"), var_13_3)
					...
					if arg_11_0.cityRebuildData.cityLevel >= arg_12_1 + 1 then
						...
						onToggle(arg_11_0, arg_13_2, function(arg_14_0)
							if arg_14_0 then
								...
								setText(arg_11_0.buildingPage:Find("right/name"), var_13_3)
								GetImageSpriteFromAtlasAsync(var_13_2, "", arg_11_0.buildingPage:Find("right/iconBg/icon"))

								local var_14_0 = var_13_1 and var_13_0.desc[2] or var_13_0.desc[1]
								...
								if not var_13_1 then
									...
									updateDrop(arg_11_0.buildingPage:Find("right/consume/cost/mask/item"), var_14_1)
									onButton(arg_11_0, arg_11_0.buildingPage:Find("right/consume/cost"), function()
										arg_11_0:emit(BaseUI.ON_DROP, var_14_1)
									end, SFX_PANEL)

									local var_14_2 = arg_11_0.virtualBagActivity:getVitemNumber(var_13_0.cost[2])

									arg_11_0.buildingPage:Find("right/consume/cost/mask/item/icon_bg/count"):GetComponent(typeof(Text)).color = var_14_2 < var_13_0.cost[3] and Color.New(0.8352941176470589, 0.4627450980392157, 0.4627450980392157, 1) or Color.New(1, 1, 1, 1)
									...
									updateDrop(arg_11_0.buildingPage:Find("right/consume/ptCost/mask/item"), var_14_3)
									onButton(arg_11_0, arg_11_0.buildingPage:Find("right/consume/ptCost"), function()
										arg_11_0:emit(BaseUI.ON_DROP, var_14_3)
									end, SFX_PANEL)

									arg_11_0.buildingPage:Find("right/consume/ptCost/mask/item/icon_bg/count"):GetComponent(typeof(Text)).color = arg_11_0.cityRebuildData.pt < var_13_0.pt_cost[3] and Color.New(0.8352941176470589, 0.4627450980392157, 0.4627450980392157, 1) or Color.New(1, 1, 1, 1)

									onButton(arg_11_0, arg_11_0.buildingPage:Find("right/rebuildBtn"), function()
										if var_14_2 < var_13_0.cost[3] or arg_11_0.cityRebuildData.pt < var_13_0.pt_cost[3] then
			...
			if #var_19_0 > 0 then
				...
				var_19_2:make(function(arg_20_0, arg_20_1, arg_20_2)
					if arg_20_0 == UIItemList.EventUpdate then
						...
						local var_20_1 = table.contains(arg_18_0.cityRebuildData.roles, var_20_0.id)
						...
						arg_20_2:Find("nameMask/name"):GetComponent(typeof(Text)).color = arg_18_0.cityRebuildData.cityLevel >= arg_19_1 + 1 and Color.New(0, 0, 0, 1) or Color.New(0.34509803921568627, 0.3843137254901961, 0.4, 1)

						local var_20_6 = var_20_1 and var_20_0.name[2] or var_20_0.name[1]

						setScrollText(arg_20_2:Find("nameMask/name"), var_20_6)
						...
						if arg_18_0.cityRebuildData.cityLevel >= arg_19_1 + 1 then
							...
							onToggle(arg_18_0, arg_20_2, function(arg_22_0)
								if arg_22_0 then
									...
									setText(arg_18_0.charaPage:Find("right/name"), var_20_6)
									GetImageSpriteFromAtlasAsync(var_20_5, "", arg_18_0.charaPage:Find("right/iconBg/icon"))

									local var_22_0 = var_20_1 and var_20_0.desc[2] or var_20_0.desc[1]
									...
									if not var_20_1 and not var_20_2 then
										...
										updateDrop(arg_18_0.charaPage:Find("right/consume/cost/mask/item"), var_22_1)
										onButton(arg_18_0, arg_18_0.charaPage:Find("right/consume/cost"), function()
											arg_18_0:emit(BaseUI.ON_DROP, var_22_1)
										end, SFX_PANEL)

										local var_22_2 = arg_18_0.virtualBagActivity:getVitemNumber(var_20_0.cost[2])

										arg_18_0.charaPage:Find("right/consume/cost/mask/item/icon_bg/count"):GetComponent(typeof(Text)).color = var_22_2 < var_20_0.cost[3] and Color.New(0.8352941176470589, 0.4627450980392157, 0.4627450980392157, 1) or Color.New(1, 1, 1, 1)
										...
										updateDrop(arg_18_0.charaPage:Find("right/consume/ptCost/mask/item"), var_22_3)
										onButton(arg_18_0, arg_18_0.charaPage:Find("right/consume/ptCost"), function()
											arg_18_0:emit(BaseUI.ON_DROP, var_22_3)
										end, SFX_PANEL)

										arg_18_0.charaPage:Find("right/consume/ptCost/mask/item/icon_bg/count"):GetComponent(typeof(Text)).color = arg_18_0.cityRebuildData.pt < var_20_0.pt_cost[3] and Color.New(0.8352941176470589, 0.4627450980392157, 0.4627450980392157, 1) or Color.New(1, 1, 1, 1)

										onButton(arg_18_0, arg_18_0.charaPage:Find("right/recruitBtn"), function()
											if var_22_2 < var_20_0.cost[3] or arg_18_0.cityRebuildData.pt < var_20_0.pt_cost[3] then
												pg.TipsMgr.GetInstance():ShowTips(i18n("ninja_game_update_failed"))
									...
									setActive(arg_18_0.charaPage:Find("right/recruiting"), var_20_2 and not var_20_3)
									setActive(arg_18_0.charaPage:Find("right/endRecruitBtn"), var_20_2 and var_20_3)
									...
									if var_20_2 then
										if var_20_3 then
											...
											onButton(arg_18_0, arg_18_0.charaPage:Find("right/endRecruitBtn"), function()
												arg_18_0:emit(CityRebuildBookMediator.END_RECRUIT, arg_18_0.activityId, var_22_4)
											end, SFX_PANEL)
										else
...
function var_0_0.RefreshBuffPage(arg_29_0)
	...
	table.sort(var_29_0, CompareFuncs({
		function(arg_30_0)
			...
			if var_31_7 then
				...
				onButton(arg_29_0, arg_31_2:Find("upgradeTenBtn"), function()
					...
					for iter_43_0 = 2, 10 do
						...
						if var_31_0.level + iter_43_0 > var_31_4 or not var_43_2 then
							break
						end
						...
						if arg_31_1 + 1 == 6 then
							var_43_1 = var_43_1 + math.ceil(var_43_2.basic_cost * var_43_2.cost^(var_43_2.level - 1) * (1 - arg_29_0:GetParam(7) * (var_31_0.level + iter_43_0 - 1)))
						else
							var_43_1 = var_43_1 + math.ceil(var_43_2.basic_cost * var_43_2.cost^(var_43_2.level - 1) * (1 - arg_29_0:GetParam(7) * var_29_1[6]))
						end
					end
...
function var_0_0.SetSummaryPanel(arg_44_0)
	...
	local var_44_4 = var_44_3 % 5 == 0
	local var_44_5 = 0
	local var_44_6 = pg.activity_ninja_enemy[var_44_3].basic

	if var_44_3 < 51 then
		var_44_5 = math.ceil(var_44_6 * (var_44_3 - 1 + arg_44_0:GetParam(9)^(var_44_3 - 1)) * (var_44_4 and arg_44_0:GetParam(10) or 1) * arg_44_0:GetParam(11)^(var_44_2[3] - 1))
	else
		var_44_5 = math.ceil(var_44_6 * (arg_44_0:GetParam(16) + arg_44_0:GetParam(9)^arg_44_0:GetParam(16) * arg_44_0:GetParam(13)^(var_44_3 - (arg_44_0:GetParam(16) + 1))) * (var_44_4 and arg_44_0:GetParam(10) or 1) * arg_44_0:GetParam(11)^(var_44_2[3] - 1))
	end

	local var_44_7 = math.ceil(arg_44_0:GetParam(14)^var_44_3 * arg_44_0:GetParam(15)^var_44_2[4])
	local var_44_8 = math.ceil((#var_44_0 + var_44_2[10] + (#var_44_0 + var_44_2[10]) * arg_44_0:GetParam(1)^(var_44_2[8] - 1) / arg_44_0:GetParam(2)) * arg_44_0:GetParam(3)^(var_44_2[9] - 1) + arg_44_0:GetParam(4) * var_44_2[7])
	local var_44_9 = math.ceil((#var_44_1 + var_44_2[5]) * arg_44_0:GetParam(5)^(var_44_2[1] - 1) + arg_44_0:GetParam(6) * var_44_2[2])
	local var_44_10 = var_44_8 + var_44_9
	local var_44_11 = CityRebuildData.PtToShow(arg_44_0.cityRebuildData.pt)
	local var_44_12 = math.ceil(var_44_5 / var_44_10)
	local var_44_13 = string.format("%.2f", var_44_7 / var_44_12)

	setText(arg_44_0.buffPage:Find("left/panel/buildingDPS/Text"), var_44_8)
	setText(arg_44_0.buffPage:Find("left/panel/charaDPS/Text"), var_44_9)
	setText(arg_44_0.buffPage:Find("left/panel/DPS/Text"), var_44_10)
	setText(arg_44_0.buffPage:Find("left/panel/time/Text"), var_44_12 .. "s")
	setText(arg_44_0.buffPage:Find("left/panel/pts/Text"), "+" .. var_44_13 .. "/s")
	setText(arg_44_0.buffPage:Find("left/panel/pt/Text"), var_44_11)
end

function var_0_0.GetParam(arg_45_0, arg_45_1)
	local var_45_0 = pg.gameset["ninja_Param" .. arg_45_1]

	return var_45_0.key_value ~= 0 and var_45_0.key_value or tonumber(var_45_0.description)
end
...
function var_0_0.DescCDTime(arg_50_0, arg_50_1)
	local var_50_0 = math.floor(arg_50_1 / 60)

	arg_50_1 = arg_50_1 % 60

	return string.format("%02d:%02d", var_50_0, arg_50_1)
end
