...
function var_0_0.handleNotification(arg_6_0, arg_6_1)
	...
	if var_6_0 == GAME.CITY_REBUILD_DONE and (var_6_1.operation == CityRebuildProxy.REBUILD_OR_START_RECRUIT or var_6_1.operation == CityRebuildProxy.END_RECRUIT or var_6_1.operation == CityRebuildProxy.UPGRADE_BUFF) then
