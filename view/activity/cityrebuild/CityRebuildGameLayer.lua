...
function var_0_0.BgScroll(arg_12_0)
	...
	arg_12_0.bg1.localScale = Vector3(var_12_0, var_12_0, 0)
	arg_12_0.bg2.localScale = Vector3(var_12_0, var_12_0, 0)
	arg_12_0.bg3.localScale = Vector3(var_12_0, var_12_0, 0)

	local var_12_1 = arg_12_0.bg1.rect.width * var_12_0
	local var_12_2 = arg_12_0.bg2.rect.width * var_12_0
	local var_12_3 = arg_12_0.bg3.rect.width * var_12_0

	LeanTween.value(go(arg_12_0.bg1), 0, var_12_1, 20):setOnUpdate(System.Action_float(function(arg_13_0)
		arg_12_0.bg1.anchoredPosition = Vector2(arg_13_0, 0)
	end)):setEase(LeanTweenType.linear):setLoopClamp()
	LeanTween.value(go(arg_12_0.bg2), 0, var_12_2, 14):setOnUpdate(System.Action_float(function(arg_14_0)
		arg_12_0.bg2.anchoredPosition = Vector2(arg_14_0, 0)
	end)):setEase(LeanTweenType.linear):setLoopClamp()
	LeanTween.value(go(arg_12_0.bg3), 0, var_12_3, 10):setOnUpdate(System.Action_float(function(arg_15_0)
...
function var_0_0.SetLevelAndAward(arg_25_0)
	...
	setText(arg_25_0.enemyName, var_25_0.name)
	arg_25_0.firstAwardList:make(function(arg_26_0, arg_26_1, arg_26_2)
		if arg_26_0 == UIItemList.EventUpdate then
			...
			updateDrop(arg_26_2:Find("mask/item"), var_26_1)
			onButton(arg_25_0, arg_26_2, function()
				arg_25_0:emit(BaseUI.ON_DROP, var_26_1)
			end, SFX_PANEL)
		end
	end)
	arg_25_0.firstAwardList:align(#var_25_0.first_drop_show)
...
function var_0_0.SetSummaryPanelAndHp(arg_28_0)
	...
	local var_28_4 = var_28_3 % 5 == 0
	local var_28_5 = 0
	local var_28_6 = pg.activity_ninja_enemy[var_28_3].basic

	if var_28_3 < 51 then
		var_28_5 = math.ceil(var_28_6 * (var_28_3 - 1 + arg_28_0:GetParam(9)^(var_28_3 - 1)) * (var_28_4 and arg_28_0:GetParam(10) or 1) * arg_28_0:GetParam(11)^(var_28_2[3] - 1))
	else
		var_28_5 = math.ceil(var_28_6 * (arg_28_0:GetParam(16) + arg_28_0:GetParam(9)^arg_28_0:GetParam(16) * arg_28_0:GetParam(13)^(var_28_3 - (arg_28_0:GetParam(16) + 1))) * (var_28_4 and arg_28_0:GetParam(10) or 1) * arg_28_0:GetParam(11)^(var_28_2[3] - 1))
	end

	local var_28_7 = math.ceil(arg_28_0:GetParam(14)^var_28_3 * arg_28_0:GetParam(15)^var_28_2[4])
	local var_28_8 = math.ceil((#var_28_0 + var_28_2[10] + (#var_28_0 + var_28_2[10]) * arg_28_0:GetParam(1)^(var_28_2[8] - 1) / arg_28_0:GetParam(2)) * arg_28_0:GetParam(3)^(var_28_2[9] - 1) + arg_28_0:GetParam(4) * var_28_2[7])
	local var_28_9 = math.ceil((#var_28_1 + var_28_2[5]) * arg_28_0:GetParam(5)^(var_28_2[1] - 1) + arg_28_0:GetParam(6) * var_28_2[2])
	local var_28_10 = var_28_8 + var_28_9
	local var_28_11 = CityRebuildData.PtToShow(arg_28_0.cityRebuildData.pt)
	local var_28_12 = math.ceil(var_28_5 / var_28_10)
	local var_28_13 = string.format("%.2f", var_28_7 / var_28_12)

	setText(arg_28_0.summaryPanel:Find("buildingDPS/Text"), var_28_8)
	setText(arg_28_0.summaryPanel:Find("charaDPS/Text"), var_28_9)
	setText(arg_28_0.summaryPanel:Find("DPS/Text"), var_28_10)
	setText(arg_28_0.summaryPanel:Find("time/Text"), var_28_12 .. "s")
	setText(arg_28_0.summaryPanel:Find("pts/Text"), "+" .. var_28_13 .. "/s")
	setText(arg_28_0.summaryPanel:Find("pt/Text"), var_28_11)
	setText(arg_28_0.ptAwardCount, CityRebuildData.PtToShow(var_28_7))
	...
	local var_28_15 = math.ceil(var_28_14 / var_28_10)
	...
	if not arg_28_0.canChangeNextLevel then
		arg_28_0.canChangeNextLevel = var_28_15 <= pg.TimeMgr.GetInstance():GetServerTime() - arg_28_0.cityRebuildData.startTime
	end

	setActive(arg_28_0.nextLevelBtn, arg_28_0.canChangeNextLevel and var_28_16)
	setText(arg_28_0.damageText, "-" .. var_28_10)

	local var_28_17 = #tostring(var_28_10)
	local var_28_18 = 70

	if var_28_17 > 3 then
		var_28_18 = 67 + var_28_17
	end

	arg_28_0.damageText:GetComponent(typeof(Text)).fontSize = var_28_18

	local var_28_19 = {}
	local var_28_20 = {}
	local var_28_21 = arg_28_0.cityRebuildData.buffs

	for iter_28_0, iter_28_1 in ipairs(var_28_21) do
		local var_28_22 = pg.activity_ninja_buff[iter_28_1].battle_effect

		if not table.contains(var_28_19, var_28_22) then
			table.insert(var_28_19, var_28_22)
			table.insert(var_28_20, arg_28_0.effect:Find(var_28_22))
		end
	end
	...
	arg_28_0:StartTimer(function()
		...
		if var_29_0 >= var_28_15 then
			var_29_1 = var_28_5 - (var_29_0 - var_28_15) % var_28_12 * var_28_10
		else
			var_29_1 = var_28_14 - var_29_0 * var_28_10
		end
		...
		if arg_28_0.effectPlayingTime == 0 then
			...
			for iter_29_2, iter_29_3 in ipairs(var_28_20) do
...
function var_0_0.GetParam(arg_30_0, arg_30_1)
	local var_30_0 = pg.gameset["ninja_Param" .. arg_30_1]

	return var_30_0.key_value ~= 0 and var_30_0.key_value or tonumber(var_30_0.description)
end
