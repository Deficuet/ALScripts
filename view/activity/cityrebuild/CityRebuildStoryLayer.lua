...
function var_0_0.InitData(arg_6_0)
	...
	for iter_6_0, iter_6_1 in ipairs(pg.activity_ninja_building.all) do
		local var_6_0 = pg.activity_ninja_building[iter_6_1]

		if var_6_0.story ~= "" then
			table.insert(arg_6_0.ids, iter_6_1)
			table.insert(arg_6_0.storyCfgs, var_6_0.story)
		end
	end
end
...
function var_0_0.Refresh(arg_7_0)
	arg_7_0.storyList:make(function(arg_8_0, arg_8_1, arg_8_2)
		if arg_8_0 == UIItemList.EventUpdate then
			...
			local var_8_2 = arg_7_0.cityRebuildData:IsRepairedOrRecruited(var_8_0)

			setActive(arg_8_2:Find("normal"), var_8_2)
			setActive(arg_8_2:Find("lock"), not var_8_2)
			...
			if var_8_2 then
				...
				setScrollText(arg_8_2:Find("lock/mask/Text"), var_8_1[4])
			end
		end
	end)
