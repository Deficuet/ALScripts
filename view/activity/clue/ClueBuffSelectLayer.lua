...
function var_0_0.UpdateCluePanel(arg_17_0)
	...
	if var_17_3 then
		...
		setText(arg_17_0.explore:Find("target/Text"), var_17_4[1].unlock_desc .. var_17_4[1].unlock_num .. "/" .. var_17_4[2].unlock_num .. "/" .. var_17_4[3].unlock_num .. i18n("clue_task_tip", var_17_5))
	end
end
