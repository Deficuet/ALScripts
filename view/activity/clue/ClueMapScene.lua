...
function var_0_0.UpdateCluePanel(arg_16_0)
	...
	if var_16_3 then
		...
		setText(arg_16_0.explore:Find("target/Text"), var_16_4[1].unlock_desc .. var_16_4[1].unlock_num .. "/" .. var_16_4[2].unlock_num .. "/" .. var_16_4[3].unlock_num .. i18n("clue_task_tip", var_16_5))
	end
end
