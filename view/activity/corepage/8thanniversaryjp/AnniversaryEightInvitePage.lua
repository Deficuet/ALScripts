...
function var_0_0.OnUpdateFlush(arg_6_0)
	...
	local var_6_3 = arg_6_0.rtMarks.childCount
	local var_6_4 = arg_6_0.ptData:GetDroptItemState(arg_6_0.ptData:GetCurrLevel())
	...
	setActive(arg_6_0.rtBtns:Find("get"), var_6_4 == ActivityPtData.STATE_CAN_GET and var_6_1 <= var_6_0)
	setActive(arg_6_0.rtBtns:Find("got"), var_6_4 == ActivityPtData.STATE_GOT and var_6_1 <= var_6_0)
	setActive(arg_6_0.rtBtns:Find("red"), var_6_4 == ActivityPtData.STATE_CAN_GET and var_6_1 <= var_6_0)
	setActive(arg_6_0.rtBtns:Find("go"), var_6_0 < var_6_1)
	setActive(arg_6_0.rtFinish, var_6_4 == ActivityPtData.STATE_GOT)
end
