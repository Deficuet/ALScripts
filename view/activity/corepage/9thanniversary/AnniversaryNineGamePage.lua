...
function var_0_0.OnUpdateFlush(arg_8_0)
	...
	local var_8_3 = var_8_2 and #var_8_2 > 0 and var_8_2[1] or 0
...
function var_0_0.UpdateRankData(arg_12_0, arg_12_1)
	for iter_12_0 = 1, #arg_12_1 do
		...
		arg_12_0:SetRankItemData(var_12_2, arg_12_1[iter_12_0], iter_12_0)
...
function var_0_0.SetRankItemData(arg_13_0, arg_13_1, arg_13_2, arg_13_3)
	...
	local var_13_5 = getProxy(PlayerProxy):isSelf(var_13_1)

	setText(findTF(arg_13_1, "nameText"), var_13_0)
	...
	setText(findTF(arg_13_1, "score"), tostring(var_13_3))
	setActive(findTF(arg_13_1, "imgMy"), var_13_5)
end
