...
function var_0_0.tryColoringAchieve(arg_8_0)
	local var_8_0 = getProxy(ColoringProxy):getColorGroups()
...
function var_0_0.OnSelShips(arg_9_0, arg_9_1, arg_9_2, arg_9_3, arg_9_4)
	...
	local var_9_2 = {
		...
		selectedIds = Clone(var_9_1),
		preView = arg_9_0.viewComponent.__cname,
		...
		onSelected = function(arg_11_0, arg_11_1)
			arg_9_0:OnSelected(arg_9_1, arg_9_2, arg_11_0, arg_11_1)
		end,
		priorEquipUpShipIDList = _.filter(var_9_0:GetShipIds(), function(arg_12_0)
			return arg_12_0 > 0
		end),
...
function var_0_0.GetSelectedShipIds(arg_13_0, arg_13_1, arg_13_2)
	local var_13_0 = arg_13_2 and arg_13_2.id or -1
