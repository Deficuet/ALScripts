...
function var_0_0.OnInit(arg_1_0)
	...
	arg_1_0._msgBox = arg_1_0:findTF("msg_box")
	arg_1_0._msgBoxBtnCancel = arg_1_0:findTF("msg_box/btn_cancel")
	arg_1_0._msgBoxBtnConfirm = arg_1_0:findTF("msg_box/btn_confirm")
	arg_1_0._msgBoxLabel = arg_1_0:findTF("msg_box/label/text_cn")
	arg_1_0._msgBoxItem = arg_1_0:findTF("msg_box/item/IconTpl")
	arg_1_0._msgBoxItemName = arg_1_0:findTF("msg_box/item/name")
	arg_1_0._msgBoxItemDesc = arg_1_0:findTF("msg_box/item/desc")
end
...
function var_0_0.UpdateTask(arg_29_0, arg_29_1, arg_29_2)
	...
	setText(arg_29_0:findTF("name", arg_29_2), var_29_2)
	setText(arg_29_0:findTF("count", arg_29_2), var_29_5)
	setActive(arg_29_0:findTF("complete", arg_29_2), var_29_6 == nil)
	setActive(arg_29_0:findTF("btn_go", arg_29_2), var_29_6 ~= nil)

	if var_29_6 then
		onButton(arg_29_0, arg_29_0:findTF("btn_go", arg_29_2), function()
			var_29_6()
...
function var_0_0.OnUpdateFlush(arg_31_0)
	...
	setActive(arg_31_0:findTF("red", arg_31_0._btnExchange), arg_31_0.canExchange)
