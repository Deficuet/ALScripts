...
function var_0_0.OnInit(arg_1_0)
	...
	for iter_1_0 = 1, #var_0_1 do
		arg_1_0.loader:GetSprite("UI/CoreActivity/AprilFoolDiscovery2026Page_atlas", string.sub(var_0_1, iter_1_0, iter_1_0), arg_1_0.items[iter_1_0]:Find("Character"), true)
	end
...
function var_0_0.CreateCDTimer(arg_7_0)
	...
	if #arg_7_0.activity.data2_list == #arg_7_0.keyList or pg.TimeMgr.GetInstance():GetServerTime() >= arg_7_0.activity.data2 then
	...
	arg_7_0.CDTimer = Timer.New(function()
		...
		local var_8_3 = math.floor(var_8_2 / 60)
		local var_8_4 = var_8_2 % 60

		setText(arg_7_0.leftTime, string.format("%d:%02d", var_8_3, var_8_4))

		local var_8_5 = arg_7_0.puzzleConfig.cd

		setSlider(arg_7_0.slider, 0, 1, var_8_2 / var_8_5)
	end, 1, -1)
...
function var_0_0.OnFirstFlush(arg_9_0)
	local var_9_0 = pg.activity_event_picturepuzzle[arg_9_0.activity.id]

	assert(var_9_0, "Can't Find activity_event_picturepuzzle 's ID : " .. arg_9_0.activity.id)

	arg_9_0.puzzleConfig = var_9_0
	arg_9_0.keyList = Clone(var_9_0.pickup_picturepuzzle)

	table.insertto(arg_9_0.keyList, var_9_0.drop_picturepuzzle)
	...
	local var_9_1 = arg_9_0.activity.id
	...
	onButton(arg_9_0, arg_9_0.btnBattle, function()
		...
		local var_11_0 = arg_9_0.puzzleConfig.chapter
		...
		arg_9_0:emit(ActivityMediator.ON_SIMULATION_COMBAT, {
			...
			local var_12_1 = var_12_0:getActivityById(var_9_1)
	...
	local var_9_2 = arg_9_0.activity:getConfig("config_client").guideName

	arg_9_0:AddFunc(function(arg_13_0)
		pg.NewStoryMgr.GetInstance():Play(var_9_2[1], arg_13_0)
	end)
end
...
function var_0_0.OnUpdateFlush(arg_14_0)
	...
	for iter_14_0, iter_14_1 in ipairs(arg_14_0.items) do
		...
		local var_14_5 = table.contains(var_14_2, var_14_4) and 3 or table.contains(var_14_3, var_14_4) and 2 or 1
		...
		setActive(iter_14_1:Find("Character"), var_14_5 == 3)

		if var_14_5 == 3 then
			quickPlayAnimation(iter_14_1, "anim_AprilFoolDiscovery2026Page_open")
		end

		setActive(iter_14_1:Find("Selected"), var_14_5 == 2)

		if var_14_5 == 2 then
			setActive(iter_14_1:Find("Unlock"), true)
		end

		setActive(iter_14_1:Find("Locked"), var_14_5 == 1)
	end
	...
	local var_14_6 = pg.activity_event_picturepuzzle[arg_14_0.activity.id]

	if #table.mergeArray(arg_14_0.activity.data1_list, arg_14_0.activity.data2_list, true) >= #var_14_6.pickup_picturepuzzle + #var_14_6.drop_picturepuzzle then
		local var_14_7 = arg_14_0.activity:getConfig("config_client").comStory

		arg_14_0:AddFunc(function(arg_17_0)
			pg.NewStoryMgr.GetInstance():Play(var_14_7, arg_17_0)
		end)
	end
end
...
function var_0_0.UpdateSelection(arg_18_0)
	...
	local var_18_1 = table.contains(arg_18_0.activity.data3_list, var_18_0)

	SetActive(arg_18_0.tip, var_18_1 and i18n("SuperBulin2_tip" .. arg_18_0.selectIndex) or false)
	SetActive(arg_18_0.tip_bg, var_18_1 and i18n("SuperBulin2_tip" .. arg_18_0.selectIndex) or false)
	setText(arg_18_0.tip, var_18_1 and i18n("SuperBulin2_tip" .. arg_18_0.selectIndex) or "")
