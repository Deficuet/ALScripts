...
function var_0_0.didEnter(arg_4_0)
	...
	onButton(arg_4_0, arg_4_0.btnBack, function()
		...
		if var_5_0:IsShowingPopWindow() then
			var_5_0:ClosePopWindow()
		else
...
function var_0_0.OnSetTime(arg_9_0)
	local var_9_0 = getProxy(ActivityProxy):getActivityById(arg_9_0.finishtime).stopTime - pg.TimeMgr.GetInstance():GetServerTime()

	setText(arg_9_0._tf:Find("adapt/top/btn_home/text_tip/timetext"), i18n("activity_remain_time"))
	setText(arg_9_0._tf:Find("adapt/top/btn_home/text_tip/time"), math.floor(var_9_0 / 86400) .. i18n("word_date"))
end
