...
function var_0_0.OnUpdateFlush(arg_10_0)
	local var_10_0 = arg_10_0.ptData:GetAward()

	updateDrop(arg_10_0.awardTF:Find("IconTpl"), var_10_0)
	...
	local var_10_5 = arg_10_0.ptData:CanGetNextAward()
	local var_10_6 = arg_10_0.ptData:CanGetMorePt()

	setActive(arg_10_0.battleBtn, var_10_6 and not var_10_4 and var_10_5)
	setActive(arg_10_0.getBtn, var_10_4)
	setActive(arg_10_0.gotBtn, not var_10_5)
