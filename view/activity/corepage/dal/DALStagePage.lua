...
function var_0_0.OnUpdata(arg_5_0, arg_5_1)
	...
	updateDrop(arg_5_0.AD:Find("award"), var_5_2)
	onButton(arg_5_0, arg_5_0.AD:Find("award/icon_mask"), function()
		arg_5_0:emit(BaseUI.ON_DROP, var_5_2)
	end, SFX_PANEL)

	local var_5_3 = var_5_0:getTaskStatus()

	SetActive(arg_5_0.AD:Find("award/lock"), var_5_3 == 2)
	SetActive(arg_5_0.AD:Find("play"), var_5_3 == 1 and not arg_5_0.IsPlayeds)
	SetActive(arg_5_0.AD:Find("go"), var_5_3 == 0)
	SetActive(arg_5_0.AD:Find("Image/lock"), var_5_3 == 0)
