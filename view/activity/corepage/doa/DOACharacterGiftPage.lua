...
function var_0_0.UpdateBtnGroup(arg_7_0)
	...
	local var_7_2 = arg_7_0.ptData:CanGetMorePt()

	setActive(arg_7_0.battleBtn, var_7_2 and not var_7_0 and var_7_1)
...
function var_0_0.UpdateAward(arg_10_0)
	...
	updateDrop(arg_10_0.awardTF, var_10_0)
	onButton(arg_10_0, arg_10_0.awardTF, function()
		arg_10_0:emit(BaseUI.ON_DROP, var_10_0)
	end, SFX_PANEL)
end
