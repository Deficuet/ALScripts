...
function var_0_0.SwitchBG(arg_10_0, arg_10_1, arg_10_2, arg_10_3)
	...
	local var_10_0 = arg_10_0.loader:GetSpriteDirect("bg/" .. arg_10_1[1].BG, "", function(arg_11_0)
		setImageSprite(arg_10_0.bg, arg_11_0)
		SetActive(arg_10_0.bg, true)
	end)

	table.insert(arg_10_0.mapGroup, var_10_0)
end
...
function var_0_0.GetAllAward(arg_15_0)
	local var_15_0 = {}
	local var_15_1 = arg_15_0.ptData:GetAward()
	...
	local var_15_5, var_15_6 = Task.StaticJudgeOverflow(var_15_2.gold, var_15_2.oil, var_15_4, true, true, {
		{
			var_15_1.type,
			var_15_1.id,
			var_15_1.count
...
function var_0_0.OnUpdateFlush(arg_18_0)
	...
	local var_18_10 = arg_18_0.ptData:GetAward()

	updateDrop(arg_18_0.awardTF, var_18_10)
	onButton(arg_18_0, arg_18_0.awardTF, function()
		arg_18_0:emit(BaseUI.ON_DROP, var_18_10)
	end, SFX_PANEL)
end
