...
function var_0_0.Flush(arg_7_0, arg_7_1)
	...
	for iter_7_0, iter_7_1 in pairs(arg_7_0.taskGroupList) do
		...
		if iter_7_0 == 0 then
			var_7_1 = arg_7_0._tf:Find("frame/" .. iter_7_0)
		else
			var_7_1 = arg_7_0.toggleCount:Find(iter_7_0)
		end
	...
	if arg_7_0.contextData.weekToggle and not arg_7_0.taskGroupList[arg_7_0.contextData.weekToggle].isLock then
		...
		for iter_7_2, iter_7_3 in ipairs(var_7_2) do
			local var_7_3 = arg_7_0.taskGroupList[iter_7_3]

			if var_7_3.isLock then
				break
			elseif underscore.any(underscore.flatten(var_7_3.task_group), function(arg_15_0)
	...
	for iter_7_4, iter_7_5 in ipairs(arg_7_0.taskGroupList) do
		local var_7_4 = arg_7_0.toggleCount:Find(iter_7_4)

		SetCompomentEnabled(var_7_4, typeof(Toggle), not iter_7_5.isLock)

		if not iter_7_5.isLock then
			setGray(var_7_4, underscore.all(underscore.flatten(iter_7_5.task_group), function(arg_16_0)
...
function var_0_0.UpdateTaskGroup(arg_17_0, arg_17_1, arg_17_2)
	...
	local var_17_2 = #var_17_1 > 0 and table.remove(var_17_1, 1) or arg_17_2[#arg_17_2]
...
function var_0_0.UpdateTaskDisplay(arg_18_0, arg_18_1, arg_18_2)
	...
	local var_18_1 = arg_18_2:getConfig("target_num")

	setText(arg_18_1:Find("desc"), string.format("%s(%d/%d)", arg_18_2:getConfig("desc"), var_18_0, var_18_1))

	local var_18_2 = Drop.Create(arg_18_2:getConfig("award_display")[1])
	local var_18_3 = arg_18_0.finishAll and 2 or arg_18_2:getTaskStatus()

	setActive(arg_18_1:Find("go"), var_18_3 == 0)
	setActive(arg_18_1:Find("get"), var_18_3 == 1)
	setActive(arg_18_1:Find("got"), var_18_3 == 2)
	...
	local var_18_4 = Drop.Create(arg_18_2:getConfig("award_display")[1])
