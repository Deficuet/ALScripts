...
function var_0_0.UpdateAdapt(arg_5_0)
	...
	setSizeDelta(arg_5_0._tf:Find("adapt"), {
		x = 0,
		y = 0
	})

	local var_5_5 = NotchAdapt.CheckNotchRatio == math.clamp(NotchAdapt.CheckNotchRatio, var_5_0, var_5_1)

	SetComponentEnabled(arg_5_0._tf:Find("adapt"), "NotchAdapt", var_5_5)
end
