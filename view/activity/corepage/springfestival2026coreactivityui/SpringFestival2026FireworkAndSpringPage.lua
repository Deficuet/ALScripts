...
function var_0_0.UpdateTaskData(arg_20_0)
	...
	local var_20_0 = arg_20_0.taskActivity:getConfig("config_data")
...
function var_0_0.GetFireWorkLocalData(arg_23_0)
	...
	for iter_23_0 = 1, #arg_23_0.fireworkAllIds do
		local var_23_1 = PlayerPrefs.GetInt("fireworks_" .. arg_23_0.fireworkActId .. "_" .. arg_23_0.playerId .. "_pos_" .. iter_23_0)
...
function var_0_0.UpdateSpringData(arg_25_0)
	...
	for iter_25_2 = 1, arg_25_0.springMaxCnt do
		local var_25_0 = iter_25_2 > arg_25_0.springUnlockSlotCount

		arg_25_0.springSlotLockList[iter_25_2] = var_25_0
	end
...
function var_0_0.SetPtPanel(arg_31_0)
	...
	var_31_0:make(function(arg_32_0, arg_32_1, arg_32_2)
		if arg_32_0 == UIItemList.EventUpdate then
			...
			local var_32_2 = Drop.Create(var_32_0)

			updateDrop(arg_32_2:Find("award"), var_32_2)
			onButton(arg_31_0, arg_32_2:Find("award"), function()
				arg_31_0:emit(BaseUI.ON_DROP, var_32_2)
			end, SFX_PANEL)

			local var_32_3 = arg_31_0.ptData:GetDroptItemState(arg_32_1 + 1)

			if var_32_3 == ActivityPtData.STATE_LOCK then
				setActive(arg_32_2:Find("lock"), true)
				setActive(arg_32_2:Find("get"), false)
				setActive(arg_32_2:Find("got"), false)
			elseif var_32_3 == ActivityPtData.STATE_CAN_GET then
	...
	for iter_31_0, iter_31_1 in ipairs(arg_31_0.importants) do
		table.insert(arg_31_0.importantsPos, (iter_31_1 - var_31_4 - 1) * (var_31_1 + var_31_2) / (#arg_31_0.ptData.targets * (var_31_1 + var_31_2) - var_31_2 - var_31_3))
	end
	...
	if arg_31_0.ptData:CanGetAward() then
		...
		onButton(arg_31_0, arg_31_0.ptPanel:Find("btn_get"), function()
			local var_35_0 = {}
			local var_35_1 = arg_31_0.ptData:GetAllAvailableAwards()
			local var_35_2 = getProxy(PlayerProxy):getRawData()
			local var_35_3 = pg.gameset.urpt_chapter_max.description[1]
			local var_35_4 = LOCK_UR_SHIP and 0 or getProxy(BagProxy):GetLimitCntById(var_35_3)
			local var_35_5, var_35_6 = Task.StaticJudgeOverflow(var_35_2.gold, var_35_2.oil, var_35_4, true, true, var_35_1)
			...
			seriesAsync(var_35_0, function()
				local var_37_0 = arg_31_0.ptData:GetCurrTarget()
...
function var_0_0.PtScrollToDo(arg_38_0, arg_38_1)
	...
	local var_38_1 = Drop.Create(arg_38_0.ptData.dropList[var_38_0])

	updateDrop(arg_38_0.ptPanel:Find("award"), var_38_1)
	onButton(arg_38_0, arg_38_0.ptPanel:Find("award"), function()
		arg_38_0:emit(BaseUI.ON_DROP, var_38_1)
	end, SFX_PANEL)
...
function var_0_0.SetTaskPanel(arg_40_0)
	...
	var_40_0:make(function(arg_41_0, arg_41_1, arg_41_2)
		if arg_41_0 == UIItemList.EventUpdate then
			...
			setText(arg_41_2:Find("frame/name"), var_41_0:getConfig("name"))
			setText(arg_41_2:Find("frame/desc"), var_41_0:getConfig("desc"))

			local var_41_1 = var_41_0:getProgress()
			local var_41_2 = var_41_0:getConfig("target_num")
			local var_41_3 = math.min(var_41_1, var_41_2)

			setText(arg_41_2:Find("frame/progress"), var_41_3 .. "/" .. var_41_2)

			arg_41_2:Find("frame/slider"):GetComponent(typeof(Slider)).value = var_41_3 / var_41_2

			local var_41_4 = arg_41_2:Find("frame/awards")
			local var_41_5 = var_41_4:GetChild(0)

			arg_40_0:updateTaskAwards(var_41_0:getConfig("award_display"), var_41_4, var_41_5)

			local var_41_6 = arg_41_2:Find("frame/go_btn")
			local var_41_7 = arg_41_2:Find("frame/get_btn")
			local var_41_8 = arg_41_2:Find("frame/got_btn")

			if var_41_0:getTaskStatus() == 0 then
				setActive(var_41_6, true)
				setActive(var_41_7, false)
				setActive(var_41_8, false)
			...
			elseif var_41_0:getTaskStatus() == 2 then
				setActive(var_41_6, false)
				setActive(var_41_7, false)
				setActive(var_41_8, true)
			end

			onButton(arg_40_0, var_41_6, function()
				arg_40_0:emit(ActivityMediator.ON_TASK_GO, var_41_0)
			end, SFX_PANEL)
			onButton(arg_40_0, var_41_7, function()
	...
	if arg_40_0.canGetTaskAward then
		...
		onButton(arg_40_0, arg_40_0.taskPanel:Find("btn_get"), function()
			...
			for iter_44_0, iter_44_1 in pairs(arg_40_0.canGetTaskVOs) do
				local var_44_2 = iter_44_1:getConfig("award_display")

				for iter_44_2, iter_44_3 in ipairs(var_44_2) do
					local var_44_3 = iter_44_3
					local var_44_4 = false

					for iter_44_4, iter_44_5 in pairs(var_44_1) do
						if iter_44_5[1] == var_44_3[1] and iter_44_5[2] == var_44_3[2] then
							var_44_4 = true
							iter_44_5[3] = iter_44_5[3] + var_44_3[3]
			...
			local var_44_5 = getProxy(PlayerProxy):getRawData()
			local var_44_6 = pg.gameset.urpt_chapter_max.description[1]
			local var_44_7 = LOCK_UR_SHIP and 0 or getProxy(BagProxy):GetLimitCntById(var_44_6)
			local var_44_8, var_44_9 = Task.StaticJudgeOverflow(var_44_5.gold, var_44_5.oil, var_44_7, true, true, var_44_1)
...
function var_0_0.updateTaskAwards(arg_47_0, arg_47_1, arg_47_2, arg_47_3)
	...
	for iter_47_1 = 1, var_47_1 do
		...
		if var_47_3 then
			...
			updateDrop(var_47_2, var_47_5)
			onButton(arg_47_0, var_47_2, function()
				arg_47_0:emit(BaseUI.ON_DROP, var_47_5)
			end, SFX_PANEL)
		end
	end
end
...
function var_0_0.SetFireWorkPanel(arg_49_0)
	...
	local var_49_2 = var_49_1:Find("fire_btn")
	local var_49_3 = var_49_0:Find("scrollrect/content/item_tpl")
	local var_49_4 = var_49_0:Find("scrollrect/content")

	arg_49_0.leftUIList = UIItemList.New(var_49_4, var_49_3)

	local var_49_5 = var_49_1:Find("content/item_tpl")
	local var_49_6 = var_49_1:Find("content")

	arg_49_0.rightUIList = UIItemList.New(var_49_6, var_49_5)

	local var_49_7 = var_49_1:Find("arrows")

	onButton(arg_49_0, var_49_2, function()
	...
	arg_49_0.leftUIList:make(function(arg_51_0, arg_51_1, arg_51_2)
		if arg_51_0 == UIItemList.EventUpdate then
			...
			local var_51_1 = arg_51_2:Find("firework/icon")

			GetImageSpriteFromAtlasAsync(Item.getConfigData(var_51_0).icon, "", var_51_1)

			local var_51_2 = arg_51_2:Find("firework/selected")
			local var_51_3 = table.contains(arg_49_0.fireworkOrderIds, var_51_0)

			setActive(var_51_2, var_51_3)

			if not table.contains(arg_49_0.fireworkUnlockIds, var_51_0) then
				setActive(arg_51_2:Find("firework/lock"), true)
				setActive(arg_51_2:Find("firework/get"), false)
			elseif not table.contains(arg_49_0.fireworkGotIds, var_51_0) then
				...
				setActive(arg_51_2:Find("firework/get"), false)
				onButton(arg_49_0, arg_51_2, function()
					arg_49_0:FireworkLeftClick(var_51_0, var_51_3)
				end, SFX_PANEL)
			end
		end
	end)
	...
	if not arg_49_0.hasClonedFireworkArrows then
		...
		for iter_49_0 = 1, #arg_49_0.fireworkAllIds - 2 do
			cloneTplTo(var_49_7:Find("tpl"), var_49_7)
		end
	end
	...
	arg_49_0.rightUIList:make(function(arg_54_0, arg_54_1, arg_54_2)
		if arg_54_0 == UIItemList.EventUpdate then
			...
			setActive(arg_54_2:Find("add"), var_54_0 > #arg_49_0.fireworkOrderIds)
...
function var_0_0.CreateSpringUI(arg_59_0)
	...
	arg_59_0.springList:make(function(arg_60_0, arg_60_1, arg_60_2)
		if arg_60_0 == UIItemList.EventUpdate then
			...
			setActive(arg_60_2:Find("lock"), var_60_1)
			...
			onButton(arg_59_0, arg_60_2, function()
				...
				local var_61_1 = arg_59_0.springUnlockSlotCount
			...
			local var_60_4 = LoadSprite("shipyardicon/" .. var_60_3:getPainting())

			setImageSprite(arg_60_2:Find("ship/mask/icon"), var_60_4)
...
function var_0_0.PlayerOneFirework(arg_67_0)
	...
	if arg_67_0.firePools[var_67_0] and #arg_67_0.firePools[var_67_0] >= var_0_0.EffectPoolCnt then
		local var_67_2 = arg_67_0.firePools[var_67_0][1]

		setLocalPosition(var_67_2, arg_67_0:GetFireworkPos())
		setActive(var_67_2, true)
		pg.CriMgr.GetInstance():PlaySoundEffect_V3(var_0_0.SFX_LIST[var_67_1])
		table.removebyvalue(arg_67_0.firePools[var_67_0], var_67_2)
		table.insert(arg_67_0.firePools[var_67_0], var_67_2)
	else
		arg_67_0.loader:GetPrefab("ui/" .. var_0_0.Id2EffectName[var_67_0], "", function(arg_69_0)
			...
			if not arg_67_0.firePools[var_67_0] then
				arg_67_0.firePools[var_67_0] = {}
			end
...
function var_0_0.getStudents(arg_73_0, arg_73_1, arg_73_2)
	...
	local var_73_2 = arg_73_0.springActivity:GetShipIds()
	...
	while var_73_4 > 0 and var_73_5 > 0 do
		local var_73_6 = math.random(1, var_73_5)

		table.insert(var_73_0, var_73_1[var_73_6]:getPrefab())
...
function var_0_0.InitStudents(arg_74_0, arg_74_1, arg_74_2)
	...
	for iter_74_2, iter_74_3 in pairs(var_74_0) do
		if not arg_74_0.academyStudents[iter_74_2] then
			local var_74_4 = cloneTplTo(arg_74_0._shipTpl, arg_74_0._map)

			var_74_4.gameObject.name = iter_74_2

			local var_74_5 = arg_74_0:ChooseRandomPos(var_74_1, var_74_2)

			var_74_2 = (var_74_2 - 2) % #var_74_1 + 1

			local var_74_6 = SummerFeastNavigationAgent.New(var_74_4.gameObject)

			var_74_6.normalSpeed = 100

			var_74_6:attach()
			var_74_6:setPathFinder(arg_74_0.graphPath)
			var_74_6:SetPositionTable(var_74_3)
			var_74_6:setCurrentIndex(var_74_5 and var_74_5.id)
			var_74_6:SetOnTransEdge(function(arg_75_0, arg_75_1, arg_75_2)
				arg_75_1, arg_75_2 = math.min(arg_75_1, arg_75_2), math.max(arg_75_1, arg_75_2)

				local var_75_0 = arg_74_0[arg_74_0.edge2area[arg_75_1 .. "_" .. arg_75_2] or arg_74_0.edge2area.default]

				arg_75_0._tf:SetParent(var_75_0)
			end)
...
function var_0_0.SetTaskTip(arg_80_0)
	...
	setActive(arg_80_0.taskBtn:Find("tip"), var_80_0)
	setActive(arg_80_0.subTaskBtn:Find("tip"), var_80_0)
end

function var_0_0.SetFireworkTip(arg_81_0)
	local var_81_0 = #arg_81_0.fireworkUnlockIds ~= #arg_81_0.fireworkGotIds

	setActive(arg_81_0.fireworkBtn:Find("tip"), var_81_0)
