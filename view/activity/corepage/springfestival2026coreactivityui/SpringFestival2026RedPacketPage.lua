...
function var_0_0.updateUI(arg_9_0)
	...
	local var_9_4 = arg_9_0.activity.data1_list[2]
	local var_9_5 = arg_9_0.activity.data1_list[1]

	setText(arg_9_0.countText, var_9_4 .. "/" .. var_9_5)
end

function var_0_0.tryPlayStory(arg_10_0)
	local var_10_0 = arg_10_0.activity.data3
	local var_10_1 = arg_10_0.activity.data1 - math.min(arg_10_0.activity.data1, arg_10_0.activity.data2)
	local var_10_2 = var_10_0 - arg_10_0.activity.data2
	local var_10_3 = arg_10_0.countToStory[var_10_2]

	if var_10_3 then
		pg.NewStoryMgr.GetInstance():Play(var_10_3)
	end
end
