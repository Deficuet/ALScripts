	...
	if var_3_0 and type(var_3_0) == "table" then
		...
		if var_3_1 then
			for iter_3_0, iter_3_1 in ipairs(var_3_1) do
				...
				if var_3_2 then
					arg_3_0.storyIDTable[iter_3_0] = var_3_2
				end
			end
		end
	end
...
function var_0_0.OnFirstFlush(arg_4_0)
	...
	for iter_4_0 = 1, arg_4_0.maxDay do
		local var_4_4 = arg_4_0.storyIDTable[iter_4_0]

		if var_4_4 and iter_4_0 <= arg_4_0.curDay and iter_4_0 <= var_4_3 then
