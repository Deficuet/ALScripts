...
function var_0_0.init(arg_2_0)
	...
	arg_2_0.helpBtn = arg_2_0._tf:Find("mainPanel/helpBtn")
	arg_2_0.chatBtn = arg_2_0._tf:Find("mainPanel/left/chatBtn")
	arg_2_0.juusBtn = arg_2_0._tf:Find("mainPanel/left/juusBtn")
...
function var_0_0.didEnter(arg_3_0)
	...
	if arg_3_0.contextData.current then
		SetActive(arg_3_0.chatBtn:Find("choose"), arg_3_0.contextData.current == "chat")
		SetActive(arg_3_0.juusBtn:Find("choose"), arg_3_0.contextData.current == "juus")
	else
...
function var_0_0.SetUp(arg_5_0)
	...
	onButton(arg_5_0, arg_5_0.chatBtn, function()
		...
		if isActive(arg_5_0.juusBtn:Find("choose")) then
...
function var_0_0.OnClose(arg_10_0)
	if isActive(arg_10_0.juusBtn:Find("choose")) then
...
function var_0_0.ChangeJuusTip(arg_11_0)
	...
	SetActive(arg_11_0.juusBtn:Find("tip"), var_11_0:ShouldShowTip())
end

function var_0_0.ChangeChatTip(arg_12_0)
	local var_12_0 = getProxy(InstagramChatProxy)

	SetActive(arg_12_0.chatBtn:Find("tip"), var_12_0:ShouldShowTip())
end
