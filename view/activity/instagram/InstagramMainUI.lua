...
function var_0_0.ChangeJuusTip(arg_13_0)
	local var_13_0 = getProxy(InstagramProxy)

	SetActive(arg_13_0.juusBtn:Find("tip"), var_13_0:ShouldShowTip())
end

function var_0_0.ChangeChatTip(arg_14_0)
	local var_14_0 = getProxy(InstagramChatProxy)

	SetActive(arg_14_0.chatBtn:Find("tip"), var_14_0:ShouldShowTip() and getProxy(InstagramProxy):ShouldShowOfficialAccountsTip())
end
