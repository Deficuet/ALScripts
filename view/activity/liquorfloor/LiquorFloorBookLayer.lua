...
function var_0_0.didEnter(arg_3_0)
	...
	for iter_3_0 = 1, var_0_1 do
		...
		local var_3_2 = arg_3_0._tf:Find("ad/tag/" .. var_3_1)

		table.insert(arg_3_0.tags, {
			btn = var_3_2,
			index = var_3_1
		})
		onToggle(arg_3_0, var_3_2, function(arg_6_0)
			if arg_6_0 then
				if var_3_0 ~= var_3_1 then
					arg_3_0:selectTag(var_3_1, var_3_2)
				end
	...
	for iter_3_1 = 1, var_0_2 do
		...
		local var_3_4 = arg_3_0._tf:Find("ad/page_" .. var_3_3)
...
function var_0_0.updatePage2(arg_11_0, arg_11_1, arg_11_2)
	if not arg_11_0.page2Items then
		...
		for iter_11_0 = 1, #arg_11_2 do
			...
			local var_11_4 = var_11_3:Find("bg/icon")
			...
			local var_11_7 = var_11_3:Find("bg/lock/Text")

			setText(var_11_7, var_11_2.unlock_desc)
	...
	for iter_11_1 = 1, #arg_11_0.page2Items do
		local var_11_8 = arg_11_0.page2Items[iter_11_1].tf
		local var_11_9 = arg_11_0:getCollectDataBySiteId(arg_11_2[iter_11_1])
		local var_11_10 = var_11_9.unlock[2] <= arg_11_0.Placeac[var_11_9.unlock[1]]:GetLevel()
		local var_11_11 = var_11_8:Find("bg/icon")

		setActive(var_11_11, var_11_10)

		local var_11_12 = var_11_8:Find("bg/lock")
		...
		setActive(var_11_14, not var_11_10)
	end
end
...
function var_0_0.updatePage1(arg_12_0, arg_12_1, arg_12_2)
	if not arg_12_0.page1Items then
		...
		for iter_12_0 = 1, #arg_12_2 do
			...
			local var_12_4 = var_12_3:Find("icon")

			LoadImageSpriteAsync("bg/" .. var_12_2.icon, var_12_4)

			local var_12_5 = var_12_3:Find("desc_bg/desc")

			SetActive(var_12_3:Find("desc_bg"), memoryData)

			if var_12_2.name then
				setText(var_12_5, var_12_2.name)
			end
	...
	for iter_12_1 = 1, #arg_12_0.page1Items do
		local var_12_6 = arg_12_0.page1Items[iter_12_1].tf
		local var_12_7 = arg_12_0:getCollectDataBySiteId(arg_12_2[iter_12_1]).unlock[2] <= arg_12_0.actid:GetTownLevel()
		local var_12_8 = arg_12_0:getCollectDataBySiteId(arg_12_2[iter_12_1]).unlock[2]
		local var_12_9 = var_12_6:Find("lock")
		local var_12_10 = var_12_6:Find("bg2")
		local var_12_11 = var_12_6:Find("desc_bg")
		local var_12_12 = var_12_6:Find("icon")
		local var_12_13 = var_12_6:Find("lock/Text")

		setText(var_12_13, arg_12_0:getCollectDataBySiteId(arg_12_2[iter_12_1]).unlock_desc)
		setActive(var_12_12, var_12_7)
		setActive(var_12_11, var_12_7)
		setActive(var_12_9, not var_12_7)
		setActive(var_12_10, not var_12_7)
	end
end
...
function var_0_0.updatePage3(arg_13_0, arg_13_1, arg_13_2)
	if not arg_13_0.page3Items then
		...
		for iter_13_0 = 1, #arg_13_2 do
			...
			local var_13_6 = pg.ship_skin_template[var_13_5]
			local var_13_7 = ""

			if var_13_6 then
				var_13_7 = HXSet.hxLan(var_13_2.name)

				local var_13_8 = var_13_6.painting
				local var_13_9 = var_0_0.StaticGetPaintingName(var_13_8)

				LoadPaintingPrefabAsync(var_13_4, var_13_8, var_13_9, "biandui", function()
					return
				end)
			else
			...
			local var_13_10 = var_13_3:Find("ad")
			local var_13_11 = var_13_3:Find("ad/name_bg/name")

			setText(var_13_11, var_13_7)

			local var_13_12 = var_13_3:Find("ad/lock")
			local var_13_13 = var_13_3:Find("ad/lock/Text")

			setText(var_13_13, var_13_2.unlock_desc)
	...
	for iter_13_1 = 1, #arg_13_0.page3Items do
		local var_13_14 = arg_13_0.page3Items[iter_13_1].tf
		local var_13_15 = arg_13_0:getCollectDataBySiteId(arg_13_2[iter_13_1])
		local var_13_16 = arg_13_0:getCollectDataBySiteId(arg_13_2[iter_13_1]).unlock[2] <= arg_13_0.Placeac[arg_13_0:getCollectDataBySiteId(arg_13_2[iter_13_1]).unlock[1]]:GetLevel()
		local var_13_17 = var_13_14:Find("ad/mask/icon")
		local var_13_18 = var_13_14:Find("ad/name_bg")
		local var_13_19 = var_13_14:Find("ad/lock")

		setActive(var_13_17, var_13_16)
		setActive(var_13_18, var_13_16)
		setActive(var_13_19, not var_13_16)
	end
end
...
function var_0_0.StaticGetPaintingName(arg_19_0)
	...
	if checkABExist("painting/" .. var_19_0 .. "_n") and PlayerPrefs.GetInt("paint_hide_other_obj_" .. var_19_0, 0) ~= 0 then
	...
	local var_19_1 = getProxy(SettingsProxy):GetMainPaintingVariantFlag(arg_19_0) == var_0_0.PAINTING_VARIANT_EX

	if var_19_1 and not checkABExist("painting/" .. var_19_0 .. "_ex") then
		return var_19_0
	end

	return var_19_1 and var_19_0 .. "_ex" or var_19_0
end

function var_0_0.updateAwardPanel(arg_20_0)
	local var_20_0 = arg_20_0.taskIds[arg_20_0.selectTagIndex]
	local var_20_1 = getProxy(TaskProxy):getTaskVO(var_20_0)
	...
	onButton(arg_20_0, var_20_2, function()
		arg_20_0:emit(var_0_0.ON_DROP, var_20_4)
	end, SFX_PANEL)

	local var_20_5 = findTF(arg_20_0.awardPanelTf, "progress")

	setText(var_20_5, var_20_1:getProgress() .. "/" .. var_20_1:getConfig("target_num"))

	local var_20_6 = findTF(arg_20_0.awardPanelTf, "Slider")

	setSlider(var_20_6, 0, 1, var_20_1:getProgress() / var_20_1:getConfig("target_num"))

	local var_20_7 = findTF(arg_20_0.awardPanelTf, "desc")

	setText(var_20_7, var_20_1:getConfig("desc"))

	local var_20_8 = findTF(arg_20_0.awardPanelTf, "btnGet")
	local var_20_9 = findTF(arg_20_0.awardPanelTf, "btnGot")
	...
	elseif var_20_1:getTaskStatus() == 2 then
		setActive(var_20_9, true)
		setActive(imgGot, true)
	end

	onButton(arg_20_0, var_20_10, function()
		arg_20_0:closeView()
	end, SFX_CANCEL)
end
