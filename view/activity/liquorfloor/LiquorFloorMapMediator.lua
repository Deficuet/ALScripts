...
function var_0_0.register(arg_1_0)
	...
	arg_1_0:bind(var_0_0.GO_FIGHT, function(arg_8_0, arg_8_1)
		...
		if not var_8_1 or not var_8_0:getMapById(var_8_1):isUnlock() then
...
function var_0_0.OnSelShips(arg_11_0, arg_11_1, arg_11_2, arg_11_3)
	...
	local var_11_1 = {
		...
		selectedIds = Clone(var_11_0),
		preView = arg_11_0.viewComponent.__cname,
		hideTagFlags = ShipStatus.TAG_HIDE_BACKYARD,
		blockTagFlags = ShipStatus.TAG_BLOCK_BACKYARD,
		onSelected = function(arg_12_0, arg_12_1)
			arg_11_0:OnSelected(arg_11_1, arg_12_0, arg_12_1, arg_11_3)
		end,
		priorEquipUpShipIDList = _.filter(arg_11_0.activity:GetShipIds(), function(arg_13_0)
			return arg_13_0 > 0
		end),
...
function var_0_0.OnSelected(arg_14_0, arg_14_1, arg_14_2, arg_14_3, arg_14_4)
	...
	if arg_14_2 == nil or #arg_14_2 == 0 then
		...
		for iter_14_2, iter_14_3 in ipairs(var_14_0) do
			local var_14_3 = arg_14_2[iter_14_2]
			...
			elseif var_14_3 ~= iter_14_3 then
				table.insert(var_14_2, {
					key = iter_14_2,
					value = var_14_3
				})
