...
function var_0_0.init(arg_2_0)
	...
	onButton(arg_2_0, arg_2_0.uiGetAllBtn, function()
		local var_5_0 = arg_2_0.ptData:GetCurrTarget()
	...
	arg_2_0.storyTaskUIList:make(function(arg_6_0, arg_6_1, arg_6_2)
		if arg_6_0 == UIItemList.EventUpdate then
			...
			arg_2_0:UpdateTaskTpl(var_6_0, arg_6_2)
		end
	end)
	...
	arg_2_0.dailyTaskUIList:make(function(arg_7_0, arg_7_1, arg_7_2)
		if arg_7_0 == UIItemList.EventUpdate then
			...
			arg_2_0:UpdateTaskTpl(var_7_0, arg_7_2)
		end
	end)
...
function var_0_0.UpdateAwardTpl(arg_13_0, arg_13_1, arg_13_2)
	...
	setText(arg_13_2:Find("target/Text"), var_13_2)

	local var_13_3 = Drop.Create(var_13_1)

	updateDrop(arg_13_2:Find("award"), var_13_3)
	onButton(arg_13_0, arg_13_2:Find("award"), function()
		arg_13_0:emit(BaseUI.ON_DROP, var_13_3)
	end, SFX_PANEL)

	local var_13_4 = var_13_0 <= arg_13_0.ptData.level

	setActive(arg_13_2:Find("got"), var_13_4)
	setActive(arg_13_2:Find("get"), not var_13_4 and var_13_2 <= arg_13_0.inputGold)

	local var_13_5 = arg_13_0.ptDataUnlockStamps[var_13_0]

	setActive(arg_13_2:Find("lock"), var_13_5)

	if var_13_5 then
		local var_13_6 = pg.TimeMgr.GetInstance()

		setActive(arg_13_2:Find("lock"), var_13_5 > var_13_6:GetServerTime())

		local var_13_7 = var_13_6:STimeDescS(var_13_5, "%m")
		local var_13_8 = var_13_6:STimeDescS(var_13_5, "%d")

		setText(arg_13_2:Find("lock/Text"), i18n("mall_unlock_date_tip2", var_13_7, var_13_8))
	end
end
...
function var_0_0.UpdateTaskView(arg_15_0)
	...
	for iter_15_0, iter_15_1 in ipairs(arg_15_0.activity:getConfig("config_client").story_task) do
		local var_15_1 = var_15_0:getTaskVO(iter_15_1)

		table.insert(arg_15_0.storyTaskList, var_15_1)
	end

	for iter_15_2, iter_15_3 in ipairs(arg_15_0.activity:getConfig("config_client").daily_task) do
		local var_15_2 = var_15_0:getTaskVO(iter_15_3)

		table.insert(arg_15_0.dailyTaskList, var_15_2)
	end
...
function var_0_0.UpdateTaskTpl(arg_20_0, arg_20_1, arg_20_2)
	...
	if var_20_3 then
		...
		onButton(arg_20_0, arg_20_2:Find("award"), function()
			arg_20_0:emit(BaseUI.ON_DROP, var_20_4)
		end, SFX_PANEL)
	end
end
...
function var_0_0.IsAwardTip()
	...
	local var_25_1 = var_25_0:getActivityByType(ActivityConst.ACTIVITY_TYPE_MALL)
	local var_25_2 = var_25_0:getActivityById(var_25_1:getConfig("config_id"))

	return Activity.IsActivityReady(var_25_2)
end
...
function var_0_0.IsInputTip()
	...
	local var_26_2 = var_26_0:getActivityById(var_26_1:getConfig("config_id"))
	local var_26_3 = ActivityPtData.New(var_26_2)
	local var_26_4 = var_26_1:GetGold()

	local function var_26_5()
		local var_27_0, var_27_1, var_27_2 = var_26_3:GetResProgress()

		return var_27_1 <= var_27_0 + var_26_4
	end

	return var_26_3:CanGetNextAward() and var_26_5()
end

function var_0_0.IsTaskTip()
	local var_28_0 = getProxy(ActivityProxy):getActivityByType(ActivityConst.ACTIVITY_TYPE_MALL)
	local var_28_1 = table.mergeArray(var_28_0:getConfig("config_client").story_task, var_28_0:getConfig("config_client").daily_task)
	local var_28_2 = getProxy(TaskProxy)

	return underscore.any(var_28_1, function(arg_29_0)
		local var_29_0 = var_28_2:getTaskById(arg_29_0)
