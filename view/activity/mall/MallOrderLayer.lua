...
function var_0_0.UpdateView(arg_18_0)
	...
	if arg_18_0.paintName ~= "" then
		arg_18_0.paintingName = checkABExist("painting/" .. arg_18_0.paintName .. "_n") and arg_18_0.paintName .. "_n" or arg_18_0.paintName
	...
	setActive(arg_18_0.uiOrderPanel:Find("content"), var_18_0)
...
function var_0_0.GetStatus(arg_19_0)
	...
	if arg_19_0.orderData.id ~= 0 then
		...
		return pg.TimeMgr.GetInstance():GetServerTime() >= arg_19_0.orderData:GetEndTime() and var_0_0.STATUS.COMPLETE or var_0_0.STATUS.DOING
	else
		...
		local var_19_0 = pg.activity_mall_custom_order[arg_19_0.showId]

		return arg_19_0.level >= var_19_0.unlock_lv and arg_19_0.activity:getDayIndex() >= var_19_0.unlock_time and var_0_0.STATUS.PREPARE or var_0_0.STATUS.WAIT
	end
end
...
function var_0_0.ShowCompleteDialogue(arg_28_0, arg_28_1)
	...
	local var_28_0 = pg.activity_mall_custom_order[arg_28_0.showId].word.finished_word[1]

	setText(arg_28_0.uiDialogueTF:Find("content/Text"), var_28_0)
...
function var_0_0.UpdataOrderInfo(arg_32_0)
	...
	local var_32_1 = #arg_32_0.selectedIds >= arg_32_0.targetNum
	local var_32_2 = setColorStr(#arg_32_0.selectedIds, var_32_1 and "#4c9922" or "#df6126")
	local var_32_3 = i18n("mall_order_need_staff_header") .. var_32_2 .. "/" .. arg_32_0.targetNum
	...
	local var_32_4 = underscore.map(arg_32_0.showConfig.order_reward_show, function(arg_35_0)
		local var_35_0 = Drop.Create(arg_35_0)

		return var_35_0:getName() .. "*" .. var_35_0.count
	end)

	UIItemList.StaticAlign(arg_32_0.uiOrderAwardTF, arg_32_0.uiOrderAwardTF:Find("tpl"), #var_32_4, function(arg_36_0, arg_36_1, arg_36_2)
		if arg_36_0 == UIItemList.EventUpdate then
			setText(arg_36_2:Find("Text"), var_32_4[arg_36_1 + 1])
		end
	end)
end
...
function var_0_0.UpdateEmptyPanel(arg_40_0)
	...
	if arg_40_0.status == var_0_0.STATUS.EMPTY then
		...
		if arg_40_0.level < var_40_4.unlock_lv then
...
function var_0_0.UpdateOrderSlotTpl(arg_47_0, arg_47_1, arg_47_2)
	...
	setActive(arg_47_2:Find("icon"), var_47_0)

	if var_47_0 then
		local var_47_1 = arg_47_0.activity:GetStaff(var_47_0)

		MallStaffCard.StaticUpdateIcon(arg_47_2:Find("icon"), var_47_1.tid)
	end
...
function var_0_0.UpdateStaffSlotTpl(arg_52_0, arg_52_1, arg_52_2)
	...
	setActive(arg_52_2:Find("icon"), var_52_0)

	if var_52_0 then
		local var_52_1 = arg_52_0.activity:GetStaff(var_52_0)

		MallStaffCard.StaticUpdateIcon(arg_52_2:Find("icon"), var_52_1.tid)
	end
...
function var_0_0.StartNextTimer(arg_58_0, arg_58_1)
	...
	arg_58_0.nextOrderTime = pg.TimeMgr.GetInstance():GetTimeToNextTime() + (arg_58_1 - 1) * 86400
