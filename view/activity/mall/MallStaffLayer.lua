...
function var_0_0.InitFloorTpl(arg_14_0, arg_14_1, arg_14_2)
	local var_14_0 = arg_14_0.floorList[arg_14_1 + 1]

	arg_14_2.name = var_14_0.id

	GetImageSpriteFromAtlasAsync("ui/mallstaffui_atlas", var_14_0.id .. "f", arg_14_2:Find("unsel/f"), true)
	GetImageSpriteFromAtlasAsync("ui/mallstaffui_atlas", var_14_0.id .. "f_sel", arg_14_2:Find("sel/f"), true)
end

function var_0_0.UpdateFloorTpl(arg_15_0, arg_15_1, arg_15_2)
	local var_15_0 = arg_15_0.floorList[arg_15_1 + 1]

	setActive(arg_15_2:Find("lock"), not var_15_0:IsUnlock())

	local var_15_1 = var_15_0.id == arg_15_0.curFloorId

	setActive(arg_15_2:Find("sel"), var_15_1)
	...
	UIItemList.StaticAlign(arg_15_2:Find("staffs"), arg_15_2:Find("staffs/tpl"), #var_15_2, function(arg_16_0, arg_16_1, arg_16_2)
		if arg_16_0 == UIItemList.EventUpdate then
			...
			local var_16_1 = arg_15_0.activity:GetStaff(var_16_0)

			setActive(arg_16_2:Find("icon"), var_16_1)

			if var_16_1 then
				MallStaffCard.StaticUpdateIcon(arg_16_2:Find("icon"), var_16_1.tid)
			end
	...
	onButton(arg_15_0, arg_15_2, function()
		...
		arg_15_0.floorsUIList:eachActive(function(arg_19_0, arg_19_1)
			...
			setActive(arg_19_1:Find("sel"), var_19_0)
...
function var_0_0.UpdataRight(arg_21_0)
	...
	local var_21_2 = underscore.reduce(arg_21_0.showAttrDatas, 0, function(arg_25_0, arg_25_1)
		return arg_25_0 + arg_25_1.cur
	end)
	local var_21_3 = underscore.reduce(arg_21_0.showAttrDatas, 0, function(arg_26_0, arg_26_1)
		return arg_26_0 + arg_26_1.base
	end)
	local var_21_4 = MallUtil.GetFloorRank(var_21_2, var_21_3)
	local var_21_5 = var_21_4 ~= MallUtil.FLOOR_RANK.CLOSE

	setActive(arg_21_0.uiRankTF:Find("open"), var_21_5)
	setActive(arg_21_0.uiRankTF:Find("close"), not var_21_5)

	if var_21_5 then
		eachChild(arg_21_0.uiRankTF:Find("open"), function(arg_27_0)
			setActive(arg_27_0, tonumber(arg_27_0.name) == var_21_4)
		end)
	end
...
function var_0_0.UpdateTargetTpl(arg_32_0, arg_32_1, arg_32_2)
	local var_32_0 = arg_32_0.showAttrDatas[arg_32_1 + 1]
	local var_32_1 = var_32_0.id

	GetImageSpriteFromAtlasAsync("ui/mallstaffui_atlas", "attr" .. var_32_1, arg_32_2:Find("icon"), true)

	local var_32_2 = arg_32_0:GetAttrInfos(var_32_0)

	GetImageSpriteFromAtlasAsync("ui/mallstaffui_atlas", var_32_2[1], arg_32_2:Find("ring/v"), true)
	setFillAmount(arg_32_2:Find("ring/r"), var_32_0.base / var_32_0.max)
	setFillAmount(arg_32_2:Find("ring/v"), var_32_0.cur / var_32_0.max)
	setText(arg_32_2:Find("bg/Text"), (setColorStr(var_32_0.cur, var_32_2[2]) or var_32_0.cur) .. "/" .. var_32_0.max)
end
...
function var_0_0.OnInitStaffItem(arg_34_0, arg_34_1)
	...
	onButton(arg_34_0, var_34_0._go, function()
		local var_35_0 = arg_34_0.activity:GetFloor(arg_34_0.curFloorId):GetEmptyIdx()
		...
		if var_35_1 == MallStaff.STATUS.FLOOR and var_35_2.floorId == arg_34_0.curFloorId then
			return
		end
		...
		seriesAsync({
			function(arg_36_0)
				if var_35_1 == MallStaff.STATUS.FLOOR then
					pg.MsgboxMgr.GetInstance():ShowMsgBox({
						...
						onYes = function()
							arg_34_0.activity:SetFloorStaff(var_35_2.floorId, var_35_2.floorIdx, 0)
							arg_36_0()
						end
					})
				else
			...
			arg_34_0.activity:SetFloorStaff(arg_34_0.curFloorId, var_35_0, var_34_0.id)
			arg_34_0:UpdateView()
		end)
	end, SFX_PANEL)
