...
function var_0_0.init(arg_2_0)
	...
	local var_2_0 = _.map(pg.activity_mall_story.all, function(arg_3_0)
...
function var_0_0.UpdataToggle(arg_5_0, arg_5_1)
	...
	setText(arg_5_0.adapt:Find("tabs/" .. arg_5_1 .. "/name"), var_5_1 .. "/" .. #var_5_0)
...
function var_0_0.OnStoryUPdata(arg_10_0, arg_10_1, arg_10_2)
	...
	setText(arg_10_1:Find("on/bg/name"), var_10_1)
	setText(arg_10_1:Find("off/bg/lockname"), var_10_2)
	onButton(arg_10_0, arg_10_1, function()
		if not var_10_0 then
			return
		end

		pg.NewStoryMgr.GetInstance():Play(var_10_3, function()
			return
		end, true)
	end, SFX_PANEL)
end
...
function var_0_0.OnSkinPage(arg_13_0, arg_13_1)
	...
	local var_13_1 = var_13_0:Find("skin/" .. arg_13_0.roleindex).transform.childCount

	arg_13_0:OnSkin(var_13_1, var_13_0)
	onButton(arg_13_0, var_13_0:Find("left"), function()
		arg_13_0.roleindex = arg_13_0.roleindex - 1

		local var_14_0 = var_13_0:Find("skin/" .. arg_13_0.roleindex).transform.childCount

		arg_13_0:OnSkin(var_14_0, var_13_0)
	end, SFX_PANEL)
	onButton(arg_13_0, var_13_0:Find("right"), function()
		arg_13_0.roleindex = arg_13_0.roleindex + 1

		local var_15_0 = var_13_0:Find("skin/" .. arg_13_0.roleindex).transform.childCount

		arg_13_0:OnSkin(var_15_0, var_13_0)
	end, SFX_PANEL)
end
...
function var_0_0.OnSkinUpdata(arg_17_0, arg_17_1, arg_17_2)
	...
	local var_17_1 = arg_17_2.name
	local var_17_2 = i18n("mall_char_lock")
	local var_17_3 = arg_17_2.lua
	local var_17_4 = arg_17_2.icon

	SetActive(arg_17_1:Find("on"), var_17_0)
	SetActive(arg_17_1:Find("off"), not var_17_0)
	setText(arg_17_1:Find("on/name"), var_17_1)
	setText(arg_17_1:Find("off/lockname"), var_17_2)
	setImageSprite(arg_17_1:Find("on/bg"), LoadSprite("ui/mallstorylineui_atlas", var_17_4))
	onButton(arg_17_0, arg_17_1, function()
		if not var_17_0 then
			return
		end

		pg.NewStoryMgr.GetInstance():Play(var_17_3, function()
			return
		end, true)
	end, SFX_PANEL)
...
function var_0_0.OnRoleUPdata(arg_23_0, arg_23_1, arg_23_2)
	...
	local var_23_2 = i18n("mall_title_lock")
	...
	setText(arg_23_1:Find("on/name_s/name"), var_23_1)
	setScrollText(arg_23_1:Find("on/name_l/mask/name"), var_23_1)

	local var_23_5 = GetPerceptualSize(var_23_1) > 7

	setActive(arg_23_1:Find("on/name_s"), not var_23_5)
	setActive(arg_23_1:Find("on/name_l"), var_23_5)
	setText(arg_23_1:Find("off/lock/lockname"), var_23_2)
	setImageSprite(arg_23_1:Find("on/icon"), LoadSprite("ui/mallstorylineui_atlas", var_23_4))
	onButton(arg_23_0, arg_23_1:Find("on"), function()
		if not var_23_0 then
			return
		end

		pg.NewStoryMgr.GetInstance():Play(var_23_3, function()
			return
		end, true)
	end, SFX_PANEL)
...
function var_0_0.OnPlacePage(arg_27_0, arg_27_1)
	...
	local var_27_0 = arg_27_0.Place:Find("table").transform.childCount

	for iter_27_0 = 0, var_27_0 - 1 do
		SetActive(arg_27_0.Place:Find("table/" .. iter_27_0 + 1), arg_27_0.Placeindex == iter_27_0 + 1)
	end

	local var_27_1 = #arg_27_0.PlaceList - (arg_27_0.Placeindex + 1) * 6 > 0 and 6 or (arg_27_0.Placeindex + 1) * 6 - #arg_27_0.PlaceList

	arg_27_0:OnPlaceList(var_27_1, arg_27_0.Place)
	addSlip(SLIP_TYPE_HRZ, arg_27_0.adapt:Find("page_list/" .. arg_27_1 .. "/table"), function()
		if arg_27_0.Placeindex > 0 then
			...
			local var_28_0 = arg_27_0.adapt:Find("page_list/" .. arg_27_1)
			local var_28_1 = #arg_27_0.PlaceList - (arg_27_0.Placeindex + 1) * 6 > 0 and 6 or (arg_27_0.Placeindex + 1) * 6 - #arg_27_0.PlaceList

			arg_27_0:OnPlaceList(var_28_1, var_28_0)
		end
	end, function()
		if arg_27_0.Placeindex < 2 then
			arg_27_0.Placeindex = arg_27_0.Placeindex + 1

			local var_29_0 = arg_27_0.adapt:Find("page_list/" .. arg_27_1)
			local var_29_1 = #arg_27_0.PlaceList - (arg_27_0.Placeindex + 1) * 6 > 0 and 6 or (arg_27_0.Placeindex + 1) * 6 - #arg_27_0.PlaceList

			arg_27_0:OnPlaceList(var_29_1, var_29_0)
		end
	end)
	onButton(arg_27_0, arg_27_0.Place:Find("left"), function()
		arg_27_0.Placeindex = arg_27_0.Placeindex - 1

		local var_30_0 = arg_27_0.adapt:Find("page_list/" .. arg_27_1)
		local var_30_1 = #arg_27_0.PlaceList - (arg_27_0.Placeindex + 1) * 6 > 0 and 6 or (arg_27_0.Placeindex + 1) * 6 - #arg_27_0.PlaceList

		arg_27_0:OnPlaceList(var_30_1, var_30_0)
	end, SFX_PANEL)
	onButton(arg_27_0, arg_27_0.Place:Find("right"), function()
		arg_27_0.Placeindex = arg_27_0.Placeindex + 1

		local var_31_0 = arg_27_0.adapt:Find("page_list/" .. arg_27_1)
		local var_31_1 = #arg_27_0.PlaceList - (arg_27_0.Placeindex + 1) * 6 > 0 and 6 or (arg_27_0.Placeindex + 1) * 6 - #arg_27_0.PlaceList

		arg_27_0:OnPlaceList(var_31_1, var_31_0)
	end, SFX_PANEL)
end
...
function var_0_0.OnPlaceUPdata(arg_33_0, arg_33_1, arg_33_2, arg_33_3)
	...
	local var_33_1 = i18n("mall_continue_to_unlock")
	...
	if var_33_0 then
		setText(arg_33_1:Find("name_bg/name"), var_33_3)
		setText(arg_33_1:Find("desc/Text"), var_33_4)
		setImageSprite(arg_33_1:Find("icon"), LoadSprite("ui/mallstorylineui_atlas", var_33_2))
	end

	setText(arg_33_1:Find("lock/lockname"), var_33_1)
end
