...
function var_0_0.ShowRandomShowStaff(arg_9_0)
	local var_9_0 = math.random(1, var_0_0.STAFF_BODY_CNT)
	local var_9_1 = math.random(1, var_0_0.STAFF_CLOTHES_CNT)
	local var_9_2 = math.random(1, var_0_0.STAFF_FACE_CNT)

	GetImageSpriteFromAtlasAsync("ui/mallstafftpl_atlas", "body" .. var_9_0, arg_9_0.uiStaffTF:Find("body"))
	GetImageSpriteFromAtlasAsync("ui/mallstafftpl_atlas", "clothes" .. var_9_1, arg_9_0.uiStaffTF:Find("clothes"))
	GetImageSpriteFromAtlasAsync("ui/mallstafftpl_atlas", "face" .. var_9_2, arg_9_0.uiStaffTF:Find("face"))
end
...
function var_0_0.ChangeToEvaluate(arg_13_0)
	...
	local var_13_0 = {}
	local var_13_1 = MallLevel.GetShowInfos(arg_13_0.level)
	local var_13_2 = pg.ship_skin_template[var_13_1.skinId]
	local var_13_3 = var_13_2.name
	local var_13_4 = "squareicon/" .. var_13_2.prefab
	...
	for iter_13_0, iter_13_1 in ipairs(var_13_1.wordList) do
		table.insert(var_13_0, function(arg_14_0)
			...
			setText(var_14_0:Find("name/Text"), var_13_3)
			setText(var_14_0:Find("word/Text"), iter_13_1)
			GetImageSpriteFromAtlasAsync(var_13_4, "", var_14_0:Find("icon"), true)
