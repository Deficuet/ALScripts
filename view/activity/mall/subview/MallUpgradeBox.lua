...
function var_0_0.OnInit(arg_3_0)
	...
	for iter_3_0, iter_3_1 in ipairs(pg.activity_mall_template.all) do
		local var_3_0 = pg.activity_mall_template[iter_3_1].need_mall_level

		if not arg_3_0.lv2FloorIds[var_3_0] then
			arg_3_0.lv2FloorIds[var_3_0] = {}
		end

		table.insert(arg_3_0.lv2FloorIds[var_3_0], iter_3_1)
	end
end
	...
	for iter_7_0 = arg_7_1 + 1, arg_7_2 do
		if arg_7_0.lv2FloorIds[iter_7_0] then
			for iter_7_1, iter_7_2 in ipairs(arg_7_0.lv2FloorIds[iter_7_0]) do
				local var_7_0 = pg.activity_mall_template[iter_7_2].name

				table.insert(arg_7_0.unlockNameList, var_7_0)
			end
		end
	end
