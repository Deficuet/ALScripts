...
function var_0_0.OnInit(arg_1_0)
	arg_1_0.bg = arg_1_0:findTF("panel")
...
function var_0_0.flushTaskData(arg_3_0)
	...
	local var_3_0 = arg_3_0.activity:getConfig("config_client").task

	for iter_3_0, iter_3_1 in ipairs(var_3_0) do
		local var_3_1 = getProxy(TaskProxy):getTaskById(iter_3_1) or getProxy(TaskProxy):getFinishTaskById(iter_3_1)

		table.insert(arg_3_0._taskList, var_3_1)
	end
end
...
function var_0_0.OnFirstFlush(arg_4_0)
	...
	for iter_4_2, iter_4_3 in ipairs(arg_4_0.stageTFList) do
		...
		local var_4_5 = arg_4_0._taskList[iter_4_2]
		...
		onButton(arg_4_0, var_4_4, function()
			arg_4_0:emit(BaseUI.ON_DROP, var_4_7)
		end)
		...
		if var_4_3:GetPreChapterId() == 0 or table.contains(var_4_1, var_4_3:GetPreChapterId()) then
			...
			onButton(arg_4_0, iter_4_3, function()
				...
				local var_6_0 = getProxy(FleetProxy):GetRegularFleets()

				arg_4_0.fleetEditPanel.buffer:SetFleets(var_6_0)
	...
	if #arg_4_0.activity.data2_list == 0 then
		var_4_9:Play(arg_4_0.activity:getConfig("config_client").story[1][1])
	end
end
