...
function var_0_0.OnFirstFlush(arg_7_0)
	arg_7_0.uilist:make(function(arg_8_0, arg_8_1, arg_8_2)
		...
		elseif arg_8_0 == UIItemList.EventUpdate then
			...
			setActive(arg_8_2:Find("got"), var_8_6 and var_8_6:isOver())
			setActive(arg_8_2:Find("get_bg"), var_8_6 and var_8_6:getTaskStatus() == 1 and not var_8_6:isOver())
		end
	end)
...
function var_0_0.IsShowAwardRed()
	local var_15_0 = getProxy(ActivityTaskProxy):getTaskById(ActivityConst.DORM_SIGN_ID_2)
