...
function var_0_0.FlushTownWithoutLv(arg_20_0)
	...
	setText(arg_20_0.townUpgradeTF:Find("normal/cost/Text"), var_20_2)
	setText(arg_20_0.townUpgradeTF:Find("no_exp_or_gold/cost/Text"), var_20_2)
...
function var_0_0.UpdateShip(arg_23_0, arg_23_1, arg_23_2)
	...
	setActive(arg_23_2:Find("lock"), var_23_1)

	if var_23_1 then
		setText(arg_23_2:Find("lock/Text"), i18n("town_lock_level", "LV" .. arg_23_0.slotUnlockLv[var_23_0]))
	end

	local var_23_2 = arg_23_0.shipIds[var_23_0]
	local var_23_3 = not var_23_2 or var_23_2 == 0

	setActive(arg_23_2:Find("empty"), var_23_3)
	...
	if not var_23_3 then
		...
		if var_23_5 then
			...
			setImageSprite(arg_23_2:Find("mask/icon"), var_23_6, true)
		else
...
function var_0_0.UpdatePlace(arg_31_0, arg_31_1, arg_31_2)
	...
	seriesAsync({
		...
		function(arg_35_0)
			...
			setActive(arg_31_2:Find("next"), not var_35_1)
			...
			if not var_35_1 then
				...
				setText(arg_31_2:Find("next/infos/gold/value"), var_35_2:GetEffectStr())
			end
		end
	}, function()
		return
