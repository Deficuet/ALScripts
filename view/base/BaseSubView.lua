...
function var_0_0.isShowing(arg_20_0)
	return arg_20_0._tf and isActive(arg_20_0._tf)
end
...
function var_0_0.findTF(arg_24_0, arg_24_1, arg_24_2)
	assert(arg_24_0._tf, "transform should exist")

	return findTF(arg_24_2 or arg_24_0._tf, arg_24_1)
end

function var_0_0.getTpl(arg_25_0, arg_25_1, arg_25_2)
	local var_25_0 = arg_25_0:findTF(arg_25_1, arg_25_2)

	var_25_0:SetParent(arg_25_0._tf, false)
	SetActive(var_25_0, false)

	return var_25_0
end

function var_0_0.getUIName(arg_26_0)
	return nil
end
...
function var_0_0.ShowOrHideResUI(arg_31_0, arg_31_1)
	...
	local var_31_1 = arg_31_0:getGroupName()

	if arg_31_1 then
		pg.playerResUI:SetSettings(var_31_1, setmetatable({
			groupName = var_31_1
		}, {
			__index = var_31_0
		}))
	else
		pg.playerResUI:RemoveSettings(var_31_1)
	end
end

function var_0_0.getGroupName(arg_32_0)
	return arg_32_0.contextData.groupName or arg_32_0.__cname
end
