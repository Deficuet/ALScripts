...
function var_0_0.register(arg_1_0)
	...
	arg_1_0:bind(var_0_0.ON_ACTIVITY_MAP, function(arg_36_0, arg_36_1)
		local var_36_0 = getProxy(ChapterProxy)
		local var_36_1, var_36_2 = var_36_0:getLastMapForActivity(arg_36_1)
	...
	arg_1_0:bind(var_0_0.GO_ACT_SHOP, function()
		local var_42_0 = arg_1_0.contextData.map and arg_1_0.contextData.map:getConfig("on_activity") or nil
		local var_42_1 = var_42_0 and var_42_0 ~= 0 and getProxy(ActivityProxy):getActivityById(var_42_0)
		local var_42_2 = var_42_1 and not var_42_1:isEnd() and var_42_1:GetConfigClientSetting("PTID")
		local var_42_3 = getProxy(ActivityProxy):getActivityByType(ActivityConst.ACTIVITY_TYPE_LOTTERY)

		if var_42_3 and var_42_3:getConfig("config_client").resId == var_42_2 and not var_42_3:isEnd() then
			arg_1_0:addSubLayers(Context.New({
				mediator = LotteryMediator,
				viewComponent = LotteryLayer,
				data = {
					activityId = var_42_3.id
				}
			}), false)
		else
			local var_42_4 = _.detect(getProxy(ActivityProxy):getActivitiesByType(ActivityConst.ACTIVITY_TYPE_SHOP), function(arg_43_0)
				return arg_43_0:getConfig("config_client").pt_id == var_42_2
			end)
			local var_42_5 = var_42_4 and var_42_4.id
	...
	arg_1_0:bind(var_0_0.SHOW_ATELIER_BUFF, function(arg_44_0, arg_44_1)
		if arg_44_1 then
			arg_1_0:addSubLayers(Context.New({
	...
	arg_1_0:bind(var_0_0.ON_SHIP_DETAIL, function(arg_45_0, arg_45_1)
	...
	arg_1_0:bind(var_0_0.ON_FLEET_SHIPINFO, function(arg_46_0, arg_46_1)
		arg_1_0:sendNotification(GAME.GO_SCENE, SCENE.SHIPINFO, {
			shipId = arg_46_1.shipId,
			shipVOs = arg_46_1.shipVOs
		})

		arg_1_0.contextData.editEliteChapter = arg_46_1.chapter.id
	end)
	arg_1_0:bind(var_0_0.ON_SUPPORT_SHIPINFO, function(arg_47_0, arg_47_1)
		arg_1_0:sendNotification(GAME.GO_SCENE, SCENE.SHIPINFO, {
			shipId = arg_47_1.shipId,
			shipVOs = arg_47_1.shipVOs
		})

		arg_1_0.contextData.selectedChapterVO = arg_47_1.chapter
	end)
	arg_1_0:bind(var_0_0.ON_STAGE_SHIPINFO, function(arg_48_0, arg_48_1)
		arg_1_0:sendNotification(GAME.GO_SCENE, SCENE.SHIPINFO, {
			shipId = arg_48_1.shipId,
			shipVOs = arg_48_1.shipVOs
		})
	end)
	arg_1_0:bind(var_0_0.ON_EXTRA_RANK, function(arg_49_0)
		arg_1_0:sendNotification(GAME.GO_SCENE, SCENE.BILLBOARD, {
			page = PowerRank.TYPE_EXTRA_CHAPTER
		})
	end)
	arg_1_0:bind(var_0_0.ON_STRATEGYING_CHAPTER, function(arg_50_0)
		local var_50_0 = getProxy(ChapterProxy)
		local var_50_1 = var_50_0:getActiveChapter()

		assert(var_50_1)

		local var_50_2 = var_50_0:getMapById(var_50_1:getConfig("map"))

		pg.MsgboxMgr.GetInstance():ShowMsgBox({
			yesText = "text_forward",
			content = i18n("levelScene_chapter_is_activation", string.split(var_50_2:getConfig("name"), "|")[1] .. ":" .. var_50_1:getConfig("chapter_name")),
			onYes = function()
				arg_1_0.viewComponent:switchToChapter(var_50_1)
			end,
			onNo = function()
				arg_1_0.contextData.chapterVO = var_50_1
	...
	arg_1_0:bind(var_0_0.ON_COMMANDER_SKILL, function(arg_54_0, arg_54_1)
		arg_1_0:addSubLayers(Context.New({
	...
	arg_1_0:bind(var_0_0.ON_PERFORM_COMBAT, function(arg_55_0, arg_55_1, arg_55_2, arg_55_3)
		arg_1_0:sendNotification(GAME.BEGIN_STAGE, {
			system = SYSTEM_PERFORM,
			stageId = arg_55_1,
			exitCallback = arg_55_2,
			memory = arg_55_3
		})
	end)
	arg_1_0:bind(var_0_0.ON_CLICK_RECEIVE_REMASTER_TICKETS_BTN, function(arg_56_0)
	...
	arg_1_0:bind(var_0_0.ON_CHAPTER_REMASTER_AWARD, function(arg_67_0, arg_67_1, arg_67_2)
...
function var_0_0.DidEnterLevelMainUI(arg_75_0, arg_75_1)
	...
	if arg_75_0.contextData.ToTrackingData then
		arg_75_0:sendNotification(arg_75_0.contextData.ToTrackingData[1], arg_75_0.contextData.ToTrackingData[2])

		arg_75_0.contextData.ToTrackingData = nil
	end
end
...
function var_0_0.handleNotification(arg_84_0, arg_84_1)
	...
	elseif var_84_0 == GAME.COMMANDER_ELIT_FORMATION_OP_DONE then
		if arg_84_0.contextData.commanderOPChapter then
			...
			arg_84_0.contextData.commanderOPChapter.eliteCommanderList = var_84_2.eliteCommanderList
			...
			elseif var_86_0 == ChapterConst.OpMove then
				seriesAsync({
					function(arg_98_0)
						...
						var_86_1.fleet.line = Clone(var_98_0)
...
function var_0_0.OnExitChapter(arg_119_0, arg_119_1, arg_119_2, arg_119_3)
	...
	seriesAsync({
		...
		function(arg_126_0)
			...
			if var_126_0:isRemaster() then
				...
				if _.any(var_126_3, function(arg_127_0)
					...
					if #var_126_6 > 0 then
						_.each(var_126_5, function(arg_130_0)
							local var_130_0 = pg.memory_template[arg_130_0].unlock_pre
							local var_130_1, var_130_2 = pg.NewStoryMgr.GetInstance():StoryName2StoryId(var_130_0)

							pg.NewStoryMgr.GetInstance():SetPlayedFlag(var_130_1)
						end)
						pg.MsgboxMgr.GetInstance():ShowMsgBox({
							yesText = "text_go",
							...
							onNo = function()
								local var_132_0 = getProxy(PlayerProxy):getRawData().id

								PlayerPrefs.SetInt("MEMORY_GROUP_NOTIFICATION" .. var_132_0 .. " " .. var_126_4, 1)
								PlayerPrefs.Save()
								arg_126_0()
							end
						})
		...
		function(arg_133_0)
			...
			local var_133_0 = arg_119_3 and arg_119_3.AutoFightFlag
			local var_133_1 = {}

			if arg_119_3 and arg_119_3.ResultDrops then
				for iter_133_0, iter_133_1 in ipairs(arg_119_3.ResultDrops) do
					var_133_1 = table.mergeArray(var_133_1, iter_133_1)
				end
			end
			...
			if arg_119_3 and arg_119_3.TotalDrops then
				for iter_133_2, iter_133_3 in ipairs(arg_119_3.TotalDrops) do
					var_133_2 = table.mergeArray(var_133_2, iter_133_3)
				end
			end

			DropResultIntegration(var_133_2)

			local var_133_3 = getProxy(ChapterProxy):GetContinuousData(SYSTEM_SCENARIO)

			if var_133_3 then
				var_133_3:MergeDrops(var_133_2, var_133_1)
				var_133_3:MergeEvents(arg_119_3.ListEventNotify, arg_119_3.ListGuildEventNotify, arg_119_3.ListGuildEventAutoReceiveNotify)

				if arg_119_2 then
					var_133_3:ConsumeBattleTime()
				end

				if var_133_3:IsActive() and var_133_3:GetRestBattleTime() > 0 then
					arg_119_0.waitingTracking = true

					arg_119_0.viewComponent:emit(var_0_0.ON_RETRACKING, arg_119_1, var_133_0)

					return
				end

				getProxy(ChapterProxy):PopContinuousData(SYSTEM_SCENARIO)
				arg_119_0:DisplayContinuousOperationResult(arg_119_1, var_133_3)
				arg_133_0()

				return
			end

			local var_133_4 = var_133_0 ~= nil

			if not var_133_4 and not arg_119_3.ResultDrops then
				return arg_133_0()
			end
			...
			if var_133_4 then
				var_133_5 = i18n("autofight_rewards")
				var_133_6 = i18n("total_rewards_subtitle")
			else
				var_133_5 = i18n("settle_rewards_title")
				var_133_6 = i18n("settle_rewards_subtitle")
			end
...
function var_0_0.DisplayContinuousWindow(arg_135_0, arg_135_1, arg_135_2, arg_135_3, arg_135_4)
	local var_135_0 = arg_135_1:getConfig("oil")
	local var_135_1 = arg_135_1:getPlayType()
	local var_135_2 = 0
	local var_135_3 = 0

	if var_135_1 == ChapterConst.TypeMultiStageBoss then
		local var_135_4 = pg.chapter_model_multistageboss[arg_135_1.id]

		var_135_2 = _.reduce(var_135_4.boss_refresh, 0, function(arg_136_0, arg_136_1)
			return arg_136_0 + arg_136_1
		end)
		var_135_3 = #var_135_4.boss_refresh
	else
		var_135_2, var_135_3 = arg_135_1:getConfig("boss_refresh"), 1
	end

	local var_135_5 = arg_135_1:getConfig("use_oil_limit")

	table.Foreach(arg_135_2, function(arg_137_0, arg_137_1)
		local var_137_0 = arg_135_4[arg_137_0]

		if var_137_0 == ChapterFleet.DUTY_IDLE then
			return
		end

		local var_137_1 = arg_137_1:GetCostSum().oil

		if var_137_0 == ChapterFleet.DUTY_KILLALL then
			local var_137_2 = var_135_5[1] or 0
			local var_137_3 = var_137_1

			if var_137_2 > 0 then
				var_137_3 = math.min(var_137_3, var_137_2)
			end

			local var_137_4 = var_135_5[2] or 0
			local var_137_5 = var_137_1

			if var_137_4 > 0 then
				var_137_5 = math.min(var_137_5, var_137_4)
			end

			var_135_0 = var_135_0 + var_137_3 * var_135_2 + var_137_5 * var_135_3
		elseif var_137_0 == ChapterFleet.DUTY_CLEANPATH then
			local var_137_6 = var_135_5[1] or 0
			local var_137_7 = var_137_1

			if var_137_6 > 0 then
				var_137_7 = math.min(var_137_7, var_137_6)
			end

			var_135_0 = var_135_0 + var_137_7 * var_135_2
		elseif var_137_0 == ChapterFleet.DUTY_KILLBOSS then
			local var_137_8 = var_135_5[2] or 0
			local var_137_9 = var_137_1

			if var_137_8 > 0 then
				var_137_9 = math.min(var_137_9, var_137_8)
			end

			var_135_0 = var_135_0 + var_137_9 * var_135_3
		end
	end)

	local var_135_6 = arg_135_1:GetMaxBattleCount()
	local var_135_7 = arg_135_3 and arg_135_3 > 0
	local var_135_8 = arg_135_1:GetSpItems()
	local var_135_9 = var_135_8[1] and var_135_8[1].count or 0
	local var_135_10 = var_135_8[1] and var_135_8[1].id or 0
	local var_135_11 = arg_135_1:GetRestDailyBonus()
	...
	arg_135_0:addSubLayers(Context.New({
		...
		data = {
			...
			extraRate = {
				rate = 2,
				enabled = var_135_7,
				extraCount = var_135_9,
				spItemId = var_135_10,
				freeBonus = var_135_11
			}
		}
	}))
end

function var_0_0.DisplayContinuousOperationResult(arg_138_0, arg_138_1, arg_138_2)
	local var_138_0 = i18n("autofight_rewards")
	local var_138_1 = i18n("total_rewards_subtitle")

	arg_138_0:addSubLayers(Context.New({
		...
		data = {
			...
			subTitle = var_138_1,
			chapter = arg_138_1,
			rewards = arg_138_2:GetDrops(),
			resultRewards = arg_138_2:GetSettlementDrops(),
			continuousData = arg_138_2,
			events = arg_138_2:GetEvents(1),
			guildTasks = arg_138_2:GetEvents(2),
			guildAutoReceives = arg_138_2:GetEvents(3)
		}
	}), true)
end

function var_0_0.OnEventUpdate(arg_139_0, arg_139_1)
	local var_139_0 = getProxy(EventProxy)

	arg_139_0.viewComponent:updateEvent(var_139_0)

	if pg.SystemOpenMgr.GetInstance():isOpenSystem(arg_139_0.player.level, "EventMediator") and var_139_0.eventForMsg then
		local var_139_1 = var_139_0.eventForMsg.id or 0
		local var_139_2 = getProxy(ChapterProxy):getActiveChapter(true)

		if var_139_2 and var_139_2:IsAutoFight() then
			getProxy(ChapterProxy):AddExtendChapterDataArray(var_139_2.id, "ListEventNotify", var_139_1)
			existCall(arg_139_1)
		else
			local var_139_3 = pg.collection_template[var_139_1] and pg.collection_template[var_139_1].title or ""

			pg.MsgboxMgr.GetInstance():ShowMsgBox({
				modal = false,
				hideNo = true,
				content = i18n("event_special_update", var_139_3),
				onYes = arg_139_1,
				onNo = arg_139_1
			})
		end

		var_139_0.eventForMsg = nil
	else
		existCall(arg_139_1)
	end
end

function var_0_0.onTimeUp(arg_140_0)
	local var_140_0 = getProxy(ChapterProxy):getActiveChapter()

	if var_140_0 and not var_140_0:inWartime() then
		local function var_140_1()
			arg_140_0:sendNotification(GAME.CHAPTER_OP, {
				type = ChapterConst.OpRetreat
			})
		end

		if arg_140_0.contextData.chapterVO then
			pg.MsgboxMgr.GetInstance():ShowMsgBox({
				modal = true,
				hideNo = true,
...
function var_0_0.getDockCallbackFuncs(arg_142_0, arg_142_1, arg_142_2, arg_142_3, arg_142_4)
	local var_142_0 = getProxy(ChapterProxy)

	local function var_142_1(arg_143_0, arg_143_1)
		local var_143_0, var_143_1 = ShipStatus.ShipStatusCheck("inElite", arg_143_0, arg_143_1, {
			inElite = arg_142_3:getConfig("formation")
		})
	...
	local function var_142_3(arg_145_0)
		local var_145_0 = arg_142_3:getEliteFleetList()[arg_142_4]
...
function var_0_0.getSupportDockCallbackFuncs(arg_146_0, arg_146_1, arg_146_2, arg_146_3)
	local var_146_0 = getProxy(ChapterProxy)

	local function var_146_1(arg_147_0, arg_147_1)
		local var_147_0, var_147_1 = ShipStatus.ShipStatusCheck("inSupport", arg_147_0, arg_147_1)

		if not var_147_0 then
			return var_147_0, var_147_1
		end

		for iter_147_0, iter_147_1 in pairs(arg_146_1) do
			if arg_147_0:isSameKind(iter_147_0) then
				return false, i18n("ship_formationMediator_changeNameError_sameShip")
			end
		end
	...
	local function var_146_2(arg_148_0, arg_148_1, arg_148_2)
		arg_148_1()
	end

	local function var_146_3(arg_149_0)
		local var_149_0 = arg_146_3:getSupportFleet()

		if arg_146_2 then
			local var_149_1 = table.indexof(var_149_0, arg_146_2.id)

			assert(var_149_1)

			if arg_149_0[1] then
				var_149_0[var_149_1] = arg_149_0[1]
			else
				table.remove(var_149_0, var_149_1)
			end
		else
			table.insert(var_149_0, arg_149_0[1])
		end

		var_146_0:updateChapter(arg_146_3)
		var_146_0:duplicateSupportFleet(arg_146_3)
	end

	return var_146_1, var_146_2, var_146_3
end

function var_0_0.playAIActions(arg_150_0, arg_150_1, arg_150_2, arg_150_3)
	if not arg_150_0.viewComponent.grid then
		arg_150_3()

		return
	end

	local var_150_0 = getProxy(ChapterProxy)
	local var_150_1

	local function var_150_2()
		if var_150_1 and coroutine.status(var_150_1) == "suspended" then
			local var_151_0, var_151_1 = coroutine.resume(var_150_1)

			assert(var_151_0, debug.traceback(var_150_1, var_151_1))

			if not var_151_0 then
				arg_150_0.viewComponent:unfrozen(-1)
				arg_150_0:sendNotification(GAME.CHAPTER_OP, {
	...
	var_150_1 = coroutine.create(function()
		arg_150_0.viewComponent:frozen()

		local var_152_0 = {}
		local var_152_1 = arg_150_2 or 0

		for iter_152_0, iter_152_1 in ipairs(arg_150_1) do
			local var_152_2 = arg_150_0.contextData.chapterVO
			local var_152_3, var_152_4 = iter_152_1:applyTo(var_152_2, true)

			assert(var_152_3, var_152_4)
			iter_152_1:PlayAIAction(arg_150_0.contextData.chapterVO, arg_150_0, function()
				local var_153_0, var_153_1, var_153_2 = iter_152_1:applyTo(var_152_2, false)

				if var_153_0 then
					var_150_0:updateChapter(var_152_2, var_153_1)

					var_152_1 = bit.bor(var_152_1, var_153_2 or 0)
				end

				onNextTick(var_150_2)
			end)
			coroutine.yield()

			if isa(iter_152_1, FleetAIAction) and iter_152_1.actType == ChapterConst.ActType_Poison and var_152_2:existFleet(FleetType.Normal, iter_152_1.line.row, iter_152_1.line.column) then
				local var_152_5 = var_152_2:getFleetIndex(FleetType.Normal, iter_152_1.line.row, iter_152_1.line.column)

				table.insert(var_152_0, var_152_5)
			end
		end

		local var_152_6 = bit.band(var_152_1, ChapterConst.DirtyAutoAction)

		var_152_1 = bit.band(var_152_1, bit.bnot(ChapterConst.DirtyAutoAction))

		if var_152_1 ~= 0 then
			local var_152_7 = arg_150_0.contextData.chapterVO

			var_150_0:updateChapter(var_152_7, var_152_1)
		end

		seriesAsync({
			function(arg_154_0)
				if var_152_6 ~= 0 then
					arg_150_0.viewComponent.levelStageView:tryAutoAction(arg_154_0)
				else
					arg_154_0()
				end
			end,
			function(arg_155_0)
				table.ParallelIpairsAsync(var_152_0, function(arg_156_0, arg_156_1, arg_156_2)
					arg_150_0.viewComponent.grid:showFleetPoisonDamage(arg_156_1, arg_156_2)
				end, arg_155_0)
			end,
			function(arg_157_0)
				arg_150_3()
				arg_150_0.viewComponent:unfrozen()
			end
		})
	end)
...
function var_0_0.saveSubState(arg_158_0, arg_158_1)
	local var_158_0 = getProxy(PlayerProxy):getRawData().id

	PlayerPrefs.SetInt("chapter_submarine_ai_type_" .. var_158_0, arg_158_1 + 1)
	PlayerPrefs.Save()
end

function var_0_0.loadSubState(arg_159_0, arg_159_1)
	local var_159_0 = getProxy(PlayerProxy):getRawData().id
	local var_159_1 = PlayerPrefs.GetInt("chapter_submarine_ai_type_" .. var_159_0, 1) - 1
	local var_159_2 = math.clamp(var_159_1, 0, 1)

	if var_159_2 ~= arg_159_1 then
		arg_159_0.viewComponent:emit(LevelMediator2.ON_OP, {
...
function var_0_0.remove(arg_160_0)
	arg_160_0:removeSubLayers(LevelContinuousOperationWindowMediator)
	var_0_0.super.remove(arg_160_0)
end
