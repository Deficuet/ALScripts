		...
		function(arg_126_0)
			...
			if var_126_0:isRemaster() then
				...
				if _.any(var_126_3, function(arg_127_0)
					...
					if _.any(var_126_5, function(arg_128_0)
						return not pg.NewStoryMgr.GetInstance():IsPlayed(pg.memory_template[arg_128_0].story, true)
					end) then
						_.each(var_126_5, function(arg_129_0)
							local var_129_0 = pg.memory_template[arg_129_0].story
							local var_129_1, var_129_2 = pg.NewStoryMgr.GetInstance():StoryName2StoryId(var_129_0)

							pg.NewStoryMgr.GetInstance():SetPlayedFlag(var_129_1)
						end)
						pg.MsgboxMgr.GetInstance():ShowMsgBox({
							yesText = "text_go",
...
function var_0_0.getSupportDockCallbackFuncs(arg_145_0, arg_145_1, arg_145_2, arg_145_3)
	...
	local function var_145_3(arg_148_0)
		...
		var_145_0:duplicateSupportFleet(arg_145_3)
	end
