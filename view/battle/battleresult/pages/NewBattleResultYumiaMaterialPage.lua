...
function var_0_0.UpdateItem(arg_11_0, arg_11_1)
	local var_11_0 = var_0_0.dropFilter(arg_11_0.contextData.drops or {})
	local var_11_1 = {}
	...
	arg_11_0.timer = Timer.New(function()
		local var_12_0 = var_11_1[var_11_4]

		setActive(var_12_0, true)
		var_12_0:GetComponent(typeof(Animation)):Play("Anim_NewBattleResultYumiaRewardPages_Tpl_In")
...
function var_0_0.UpdateLine(arg_13_0)
	local var_13_0 = var_0_0.dropFilter(arg_13_0.contextData.drops or {})
	local var_13_1 = math.random(#var_13_0)
	local var_13_2 = AtelierMaterial.New({
		configId = var_13_0[var_13_1].id
	}):GetVoices()
...
function var_0_0.RegisterEvent(arg_14_0, arg_14_1)
	...
	onButton(arg_14_0, arg_14_0._tf, var_14_0, SFX_PANEL)
