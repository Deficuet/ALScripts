...
function var_0_0.findUI(arg_13_0)
	...
	arg_13_0.topPanel = arg_13_0:findTF("TopPanel")
	arg_13_0.likeFilteToggle = arg_13_0:findTF("LikeBtn", arg_13_0.topPanel)
	...
	arg_13_0.plateListPanel = arg_13_0:findTF("PlateList")
	arg_13_0.plateTpl = arg_13_0:findTF("Plate", arg_13_0.plateListPanel)
	...
	arg_13_0.playPanel = arg_13_0:findTF("PLayPanel")
	arg_13_0.playPanelNameText = arg_13_0:findTF("NameText", arg_13_0.playPanel)
	arg_13_0.likeToggle = arg_13_0:findTF("LikeBtn", arg_13_0.playPanel)
	arg_13_0.likeOnImg = arg_13_0:findTF("On", arg_13_0.likeToggle)
	arg_13_0.songImg = arg_13_0:findTF("SongImg/face", arg_13_0.playPanel)
	arg_13_0.pauseBtn = arg_13_0:findTF("PlayingBtn", arg_13_0.playPanel)
	arg_13_0.playBtn = arg_13_0:findTF("StopingBtn", arg_13_0.playPanel)
	arg_13_0.playDesc = arg_13_0.playPanel:Find("PlayDesc")
	arg_13_0.nextBtn = arg_13_0:findTF("NextBtn", arg_13_0.playPanel)
	arg_13_0.preBtn = arg_13_0:findTF("PreBtn", arg_13_0.playPanel)
	arg_13_0.playProgressBar = arg_13_0:findTF("Progress", arg_13_0.playPanel)
	arg_13_0.nowTimeText = arg_13_0:findTF("NowTimeText", arg_13_0.playProgressBar)
	arg_13_0.totalTimeText = arg_13_0:findTF("TotalTimeText", arg_13_0.playProgressBar)
	arg_13_0.playSliderSC = GetComponent(arg_13_0.playProgressBar, "LSlider")
	arg_13_0.listBtn = arg_13_0:findTF("ListBtn", arg_13_0.playPanel)
...
function var_0_0.addListener(arg_15_0)
	...
	onButton(arg_15_0, arg_15_0.likeToggle, function()
		local var_24_0 = arg_15_0.musicPlayer:GetCurrentMusicId()
		local var_24_1 = pg.music_collect_config[var_24_0].id

		pg.m02:sendNotification(GAME.APPRECIATE_MUSIC_LIKE, {
			musicID = var_24_1,
			isAdd = arg_15_0.likeDic[var_24_1] and 1 or 0
		})
		arg_15_0:ChangeLike(var_24_1)
		arg_15_0:updateLikeToggle()
		setActive(arg_15_0.likeOnImg, arg_15_0.likeDic[var_24_1])
...
function var_0_0.initPlateListPanel(arg_35_0)
	function arg_35_0.lScrollPageSC.itemInitedCallback(arg_36_0, arg_36_1)
		...
		arg_35_0:updatePlateTF(arg_36_1, var_36_0)
	end
	...
	function arg_35_0.lScrollPageSC.itemPitchCallback(arg_39_0, arg_39_1)
		...
		arg_35_0:updatePlateList(arg_39_1, var_39_0)
...
function var_0_0.updatePlateTF(arg_44_0, arg_44_1, arg_44_2)
	...
	if #var_44_2 > 0 then
		local var_44_4 = var_44_2[#var_44_2]
		local var_44_5 = pg.music_collect_config[var_44_4].album_id

		var_44_3 = pg.music_album[var_44_5].cover
	end

	setText(arg_44_1:Find("PlateImg/empty/Text"), i18n("NewMusic_7"))
	setActive(arg_44_1:Find("PlateImg/face"), var_44_3)
	setActive(arg_44_1:Find("PlateImg/empty"), not var_44_3)

	if var_44_3 then
		local var_44_6 = MusicCollectionConst.MUSIC_COVER_PATH_PREFIX .. var_44_3

		arg_44_0.resLoader:LoadSprite(var_44_6, var_44_3, arg_44_1:Find("PlateImg/face"), false)
	end
...
function var_0_0.updatePlateList(arg_45_0, arg_45_1, arg_45_2)
	...
	local var_45_2 = var_45_0 and arg_45_0.likeIds or arg_45_0.appreciateProxy:getAlbumMusicList(var_45_1)
	local var_45_3 = arg_45_1:Find("list")

	setText(var_45_3:Find("album_name"), var_45_1 == "favor" and i18n("NewMusic_5") or var_45_1)

	local var_45_4 = arg_45_0.appreciateProxy:getMainPlayerAlbumName() == var_45_1
	...
	if var_45_0 then
		...
		onToggle(arg_45_0, var_45_8, function(arg_52_0)
			if arg_52_0 then
		...
		onToggle(arg_45_0, var_45_9, function(arg_53_0)
			if arg_53_0 then
...
function var_0_0.updateAlbumTF(arg_57_0, arg_57_1, arg_57_2)
	...
	local var_57_1 = arg_57_0.appreciateProxy:getAlbumMusicList(var_57_0)
	local var_57_2 = pg.music_collect_config[var_57_1[1]].album_id
	local var_57_3 = pg.music_album[var_57_2].cover
	local var_57_4 = MusicCollectionConst.MUSIC_COVER_PATH_PREFIX .. var_57_3

	arg_57_0.resLoader:LoadSprite(var_57_4, var_57_3, arg_57_1:Find("icon/face"), false)
	...
	local var_57_5 = arg_57_0.musicPlayer and arg_57_0.musicPlayer.albumName == var_57_0

	setActive(arg_57_1:Find("playing"), var_57_5)
...
function var_0_0.updateLikeToggle(arg_59_0)
	...
	local var_59_0 = underscore.reduce(underscore.keys(arg_59_0.likeDic), 0, function(arg_60_0, arg_60_1)
		return arg_60_0 + (arg_59_0.likeDic[arg_60_1] and 1 or 0)
	end)

	setText(arg_59_0.likeFilteToggle:Find("TextNum"), string.format("(%d)", var_59_0))
end

function var_0_0.updatePlayPanel(arg_61_0, arg_61_1)
	local var_61_0 = arg_61_0.musicPlayer:GetCurrentMusicId()
	local var_61_1 = pg.music_collect_config[var_61_0]
	local var_61_2 = var_61_1.album_id
	local var_61_3 = pg.music_album[var_61_2].cover
	local var_61_4 = MusicCollectionConst.MUSIC_COVER_PATH_PREFIX .. var_61_3

	arg_61_0.resLoader:LoadSprite(var_61_4, var_61_3, arg_61_0.songImg, false)

	local var_61_5 = var_61_1.name

	changeToScrollText(arg_61_0.playPanelNameText, var_61_5)
	setActive(arg_61_0.likeOnImg, arg_61_0.likeDic[var_61_1.id])
...
function var_0_0.NewMusicPlayer(arg_73_0, arg_73_1, arg_73_2, arg_73_3)
	...
	arg_73_0.bgmMgr:TempPlay("TempMusicPlayer", var_73_0)
...
function var_0_0.descTime(arg_77_0, arg_77_1)
	...
	local var_77_1 = math.floor(var_77_0 / 3600)
	local var_77_2 = var_77_0 - var_77_1 * 3600
	local var_77_3 = math.floor(var_77_2 / 60)
	local var_77_4 = var_77_2 % 60

	if var_77_1 ~= 0 then
		return string.format("%02d:%02d:%02d", var_77_1, var_77_3, var_77_4)
	else
		return string.format("%02d:%02d", var_77_3, var_77_4)
	end
end
