...
function var_0_0.Update(arg_7_0, arg_7_1, arg_7_2)
	...
	for iter_7_0 = 1, CommanderConst.MAX_FORMATION_POS do
		...
		arg_7_0:updateCommander(arg_7_0["pos" .. iter_7_0], iter_7_0, var_7_1)
	end
...
function var_0_0.updateDesc(arg_12_0)
	...
	for iter_12_0 = 1, CommanderConst.MAX_FORMATION_POS do
		...
		arg_12_0:updateCommander(arg_12_0["descPos" .. iter_12_0], iter_12_0, var_12_1, true)
		arg_12_0:updateSkillTF(var_12_1, arg_12_0["skillTFPos" .. iter_12_0])
	end
...
function var_0_0.updateAdditions(arg_13_0)
	...
	local var_13_1 = _.values(var_13_0:getCommandersTalentDesc())
	...
	arg_13_0.abilitysTF:make(function(arg_14_0, arg_14_1, arg_14_2)
		if arg_14_0 == UIItemList.EventUpdate then
			...
			setText(arg_14_2:Find("name"), AttributeType.Type2Name(var_14_0.attrName))
			setText(arg_14_2:Find("Text"), ("+" .. math.floor(var_14_0.value * 1000) / 1000) .. "%")
			GetImageSpriteFromAtlasAsync("attricon", var_14_0.attrName, arg_14_2:Find("icon"), false)
			setImageAlpha(arg_14_2:Find("bg"), arg_14_1 % 2)
		end
	end)
	arg_13_0.abilitysTF:align(#var_13_2)
	setActive(arg_13_0.abilityArr, #var_13_2 > 4)
	arg_13_0.talentsTF:make(function(arg_15_0, arg_15_1, arg_15_2)
		if arg_15_0 == UIItemList.EventUpdate then
			local var_15_0 = var_13_1[arg_15_1 + 1]

			setScrollText(findTF(arg_15_2, "name_mask/name"), var_15_0.name)

			local var_15_1 = var_15_0.type == CommanderConst.TALENT_ADDITION_RATIO and "%" or ""

			setText(arg_15_2:Find("Text"), (var_15_0.value > 0 and "+" or "") .. var_15_0.value .. var_15_1)
			setImageAlpha(arg_15_2:Find("bg"), arg_15_1 % 2)
		end
	end)
	arg_13_0.talentsTF:align(#var_13_1)
	setActive(arg_13_0.talentsArr, #var_13_1 > 4)
...
function var_0_0.updateCommander(arg_18_0, arg_18_1, arg_18_2, arg_18_3, arg_18_4)
	...
	if arg_18_3 then
		local var_18_2 = arg_18_1:Find("info/mask/icon")
		local var_18_3 = arg_18_1:Find("info/frame")

		GetImageSpriteFromAtlasAsync("CommanderHrz/" .. arg_18_3:getPainting(), "", var_18_2)

		local var_18_4 = arg_18_1:Find("info/name")

		if var_18_4 then
			setText(var_18_4, arg_18_3:getName())
		end

		local var_18_5 = Commander.rarity2Frame(arg_18_3:getRarity())

		setImageSprite(var_18_3, GetSpriteFromAtlas("weaponframes", "commander_" .. var_18_5))
	end
...
function var_0_0.updateRecordPanel(arg_22_0)
	...
	arg_22_0.recordList:make(function(arg_23_0, arg_23_1, arg_23_2)
		if arg_23_0 == UIItemList.EventUpdate then
			...
			arg_22_0:UpdatePrefabFleet(var_23_0, arg_23_2, var_22_0)
		end
	end)
...
function var_0_0.UpdatePrefabFleet(arg_24_0, arg_24_1, arg_24_2, arg_24_3)
	...
	onInputEndEdit(arg_24_0, var_24_0, function()
		local var_25_0 = getInputText(var_24_0)
	...
	for iter_24_0, iter_24_1 in ipairs(var_24_2) do
		local var_24_4 = arg_24_1:getCommanderByPos(iter_24_0)

		arg_24_0:updateCommander(iter_24_1, iter_24_0, var_24_4)
		arg_24_0:updateSkillTF(var_24_4, var_24_3[iter_24_0])
	end
end
