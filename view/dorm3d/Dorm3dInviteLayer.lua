...
function var_0_0.ShowSelectPanel(arg_14_0)
	...
	for iter_14_0, iter_14_1 in ipairs(var_14_0) do
		if not arg_14_0.room.unlockCharacter[iter_14_1] then
			var_14_4[iter_14_1] = "lock"
		elseif not getProxy(ApartmentProxy):getApartment(iter_14_1) then
			var_14_4[iter_14_1] = "room"
		elseif Apartment.New({
			ship_group = iter_14_1
		}):needDownload() then
			var_14_4[iter_14_1] = "download"
		else
			var_14_4[iter_14_1] = nil
		end
	end

	local var_14_5 = getProxy(PlayerProxy):getRawData().id
	local var_14_6 = arg_14_0.rtSelectPanel:Find("window/character/container")
	...
	UIItemList.StaticAlign(var_14_6, var_14_6:GetChild(0), #var_14_0, function(arg_15_0, arg_15_1, arg_15_2)
		...
		if arg_15_0 == UIItemList.EventUpdate then
			...
			setActive(arg_15_2:Find("base"), var_15_0)
			...
			setActive(arg_15_2:Find("tip"), PlayerPrefs.GetInt(var_14_5 .. "_dorm3dRoomInviteSuccess_" .. arg_14_0.room.id .. "_" .. var_15_0, 1) == 0)
			PlayerPrefs.SetInt(var_14_5 .. "_dorm3dRoomInviteSuccess_" .. arg_14_0.room.id .. "_" .. var_15_0, 1)
		end
	end)
	PlayerPrefs.SetInt(var_14_5 .. "_dorm3dRoomInviteSuccess_" .. arg_14_0.room.id, 1)
...
function var_0_0.UpdateSelectableCard(arg_20_0, arg_20_1, arg_20_2, arg_20_3)
	local var_20_0 = Apartment.New({
		ship_group = arg_20_2
	}):GetSkinModelID(arg_20_0.room:getConfig("tag"))

	GetImageSpriteFromAtlasAsync(string.format("dorm3dselect/room_card_apartment_%d", var_20_0), "", arg_20_1:Find("Image"))
	GetImageSpriteFromAtlasAsync(string.format("dorm3dselect/room_card_apartment_name_%d", arg_20_2), "", arg_20_1:Find("name"))

	local var_20_1 = getProxy(ApartmentProxy):getApartment(arg_20_2)
	local var_20_2 = not var_20_1 or var_20_1:needDownload()

	setActive(arg_20_1:Find("lock"), var_20_2)
	setActive(arg_20_1:Find("mask"), var_20_2)
	setActive(arg_20_1:Find("unlock"), not var_20_2)
	setActive(arg_20_1:Find("favor_level"), var_20_1)

	if var_20_1 then
		setText(arg_20_1:Find("favor_level/Text"), var_20_1.level)
	end
	...
	onToggle(arg_20_0, arg_20_1, function(arg_21_0)
		...
		if arg_21_0 then
			...
			elseif var_20_1:needDownload() then
...
function var_0_0.didEnter(arg_24_0)
	arg_24_0.selectIds = underscore.filter(arg_24_0.contextData.groupIds or {}, function(arg_25_0)
		return arg_24_0.room.unlockCharacter[arg_25_0] and tobool(getProxy(ApartmentProxy):getApartment(arg_25_0)) and not Apartment.New({
			ship_group = arg_25_0
		}):needDownload()
	end)
