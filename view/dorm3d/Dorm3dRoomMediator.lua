...
function var_0_0.initNotificationHandleDic(arg_42_0)
	arg_42_0.handleDic = {
		[GAME.APARTMENT_TRIGGER_FAVOR_DONE] = function(arg_43_0, arg_43_1)
			local var_43_0 = arg_43_1:getBody()

			arg_43_0.viewComponent:PopFavorTrigger(var_43_0)
		end,
		[GAME.APARTMENT_LEVEL_UP_DONE] = function(arg_44_0, arg_44_1)
			local var_44_0 = arg_44_1:getBody()

			seriesAsync({
				function(arg_45_0)
					arg_44_0.viewComponent:SetAllBlackbloardValue("inLockLayer", true)
					arg_44_0.viewComponent:PopFavorLevelUp(var_44_0.apartment, var_44_0.award, arg_45_0)
				end
			}, function()
				arg_44_0.viewComponent:SetAllBlackbloardValue("inLockLayer", false)
				arg_44_0.viewComponent:CheckQueue()
				arg_44_0:sendNotification(var_0_0.ON_LEVEL_UP_FINISH)
			end)
		end,
		[STORY_EVENT.TEST] = function(arg_47_0, arg_47_1)
			local var_47_0 = arg_47_1:getBody()

			arg_47_0.viewComponent:TalkingEventHandle(var_47_0)
		end,
		[ApartmentProxy.UPDATE_APARTMENT] = function(arg_48_0, arg_48_1)
			local var_48_0 = arg_48_1:getBody()
			local var_48_1 = arg_48_0.viewComponent.apartment

			if var_48_1 and var_48_1:GetConfigID() == var_48_0:GetConfigID() then
				arg_48_0.viewComponent:SetApartment(var_48_0)
			end
		end,
		[var_0_0.OTHER_DO_TALK] = function(arg_49_0, arg_49_1)
			local var_49_0 = arg_49_1:getBody()

			arg_49_0.viewComponent.inReplayTalk = true

			arg_49_0.viewComponent:DoTalk(var_49_0.talkId, function()
				arg_49_0.viewComponent.inReplayTalk = false

				existCall(var_49_0.callback)
			end)
		end,
		[var_0_0.OTHER_POP_UNLOCK] = function(arg_51_0, arg_51_1)
			local var_51_0 = arg_51_1:getBody()

			arg_51_0.viewComponent:AddUnlockDisplay(var_51_0)
		end,
		[GAME.APARTMENT_DO_TALK_DONE] = function(arg_52_0, arg_52_1)
			arg_52_0.viewComponent:UpdateBtnState()
		end,
		[GAME.APARTMENT_COLLECTION_ITEM_DONE] = function(arg_53_0, arg_53_1)
			local var_53_0 = arg_53_1:getBody()

			arg_53_0:addSubLayers(Context.New({
				viewComponent = Dorm3dCollectAwardLayer,
				mediator = Dorm3dCollectAwardMediator,
				data = {
					itemId = var_53_0.itemId,
					isNew = var_53_0.isNew
				}
			}))
			arg_53_0.viewComponent:UpdateBtnState()
		end,
		[var_0_0.CHAMGE_TIME_RELOAD_SCENE] = function(arg_54_0, arg_54_1)
			local var_54_0 = arg_54_1:getBody()

			arg_54_0.contextData.timeIndex = var_54_0.timeIndex

			arg_54_0.viewComponent:SwitchDayNight(arg_54_0.contextData.timeIndex)
			onNextTick(function()
				arg_54_0.viewComponent:RefreshSlots()
			end)
			arg_54_0.viewComponent:UpdateContactState()
		end,
		[GAME.APARTMENT_GIVE_GIFT_DONE] = function(arg_56_0, arg_56_1)
			local var_56_0 = arg_56_1:getBody()

			arg_56_0.viewComponent:PlayHeartFX(var_56_0.groupId)
			arg_56_0.viewComponent:UpdateBtnState()
			getProxy(Dorm3dChatProxy):TriggerEvent({
				{
					value = 1,
					event_type = arg_56_0.contextData.timeIndex == 1 and 113 or 118,
					ship_id = var_56_0.groupId
				}
			})
		end,
		[var_0_0.GUIDE_CLICK_LADY] = function(arg_57_0, arg_57_1)
			warning("this.GUIDE_CLICK_LADY")
			arg_57_0.viewComponent:EnterWatchMode()
		end,
		[var_0_0.GUIDE_CHECK_GUIDE] = function(arg_58_0, arg_58_1)
			arg_58_0.viewComponent:CheckGuide()
		end,
		[var_0_0.GUIDE_CHECK_LEVEL_UP] = function(arg_59_0, arg_59_1)
			arg_59_0.viewComponent:CheckLevelUp()
		end,
		[ApartmentProxy.UPDATE_ROOM] = function(arg_60_0, arg_60_1)
			local var_60_0 = arg_60_1:getBody()

			if var_60_0:GetConfigID() == arg_60_0.viewComponent.room:GetConfigID() then
				arg_60_0.viewComponent:SetRoom(var_60_0)
			end
		end,
		[Dorm3dInviteMediator.ON_DORM] = function(arg_61_0, arg_61_1)
			local var_61_0 = arg_61_1:getBody()

			arg_61_0:sendNotification(GAME.CHANGE_SCENE, SCENE.DORM3D_ROOM, var_61_0)
		end,
		[Dorm3dMiniGameMediator.OPERATION] = function(arg_62_0, arg_62_1)
			local var_62_0 = arg_62_1:getBody()

			arg_62_0.viewComponent:HandleGameNotification(Dorm3dMiniGameMediator.OPERATION, var_62_0)
		end,
		[ApartmentProxy.ZERO_HOUR_REFRESH] = function(arg_63_0, arg_63_1)
			local var_63_0 = arg_63_1:getBody()

			arg_63_0.viewComponent:UpdateFavorDisplay()
		end,
		[var_0_0.UPDATE_FAVOR_DISPLAY] = function(arg_64_0, arg_64_1)
			arg_64_0.viewComponent:UpdateFavorDisplay()
		end,
		[ApartmentProxy.UPDATE_ROOM_INVITE_LIST] = function(arg_65_0, arg_65_1)
			local var_65_0 = arg_65_1:getBody()

			arg_65_0.viewComponent:LoadCharacterAdditionally(var_65_0.addIds, var_65_0.callback)
		end
	}
end

function var_0_0.remove(arg_66_0)
	return
end
