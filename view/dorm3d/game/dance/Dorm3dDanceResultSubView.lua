...
function var_0_0.Flush(arg_5_0)
	...
	for iter_5_0 = 1, #arg_5_0.contextData.cucoloris do
		...
		local var_5_4, var_5_5 = var_5_2:CalcScore(var_5_3)
	...
	for iter_5_1 = 1, #arg_5_0.contextData.cucoloris do
		local var_5_6 = arg_5_0.resultCucoloris:GetChild(iter_5_1 - 1)

		LoadImageSpriteAtlasAsync(arg_5_0.contextData.cucoloris[iter_5_1]:GetIcon(), "", var_5_6:Find("Image"), true)
		LoadImageSpriteAtlasAsync(arg_5_0.contextData.cucoloris[iter_5_1]:GetOutline(), "", var_5_6:Find("outline"), true)
		setText(var_5_6:Find("match"), i18n("dorm3d_cafe_minigame6", var_5_1[iter_5_1].match))
		setActive(var_5_6:Find("match"), false)
		setImageAlpha(var_5_6:Find("Image"), 1)
	end

	for iter_5_2 = 1, #arg_5_0.contextData.photoData do
		local var_5_7 = arg_5_0.photoContainer:GetChild(iter_5_2 - 1):Find("photo")

		arg_5_0.photoTfs[iter_5_2] = var_5_7

		local var_5_8 = math.random(Dorm3dDanceConst.RESULT_RANDOM_RANGE_POSY[1], Dorm3dDanceConst.RESULT_RANDOM_RANGE_POSY[2])
		local var_5_9 = math.random(Dorm3dDanceConst.RESULT_RANDOM_RANGE_ANGLE[1], Dorm3dDanceConst.RESULT_RANDOM_RANGE_ANGLE[2])

		var_5_7.localPosition = Vector3(randx, var_5_8, 0)
		var_5_7.localEulerAngles = Vector3(0, 0, var_5_9)
		var_5_7.localScale = Vector3.one

		arg_5_0.contextData.onShowRealImage(iter_5_2, var_5_7:Find("mask/Image"), var_5_7:Find("mask"))
	end
	...
	local var_5_10 = {}
	local var_5_11 = 0
	local var_5_12 = #arg_5_0.contextData.cucoloris

	local function var_5_13(arg_6_0, arg_6_1)
		var_5_10[arg_6_0 + var_5_11 * var_5_12] = arg_6_1
		var_5_11 = var_5_11 + 1
	end
	...
	local function var_5_14()
		for iter_7_0 = 1, #arg_5_0.contextData.cucoloris do
			...
			local var_7_1 = arg_5_0.resultCucoloris:GetChild(iter_7_0 - 1)
			local var_7_2 = arg_5_0.photoTfs[var_7_0]

			var_5_11 = 0

			var_5_13(iter_7_0, function(arg_8_0)
				local var_8_0 = var_7_1.position
				local var_8_1 = var_7_2.parent:InverseTransformPoint(var_8_0)

				table.insert(arg_5_0.LTList, LeanTween.move(var_7_2, var_8_1, Dorm3dDanceConst.PHOTO_MOVE_TIME):setOnComplete(System.Action(arg_8_0)).uniqueId)
				table.insert(arg_5_0.LTList, LeanTween.rotateZ(go(var_7_2), 0, Dorm3dDanceConst.PHOTO_MOVE_TIME).uniqueId)
				table.insert(arg_5_0.LTList, LeanTween.scale(var_7_2, Dorm3dDanceConst.PHOTO_SCALE, Dorm3dDanceConst.PHOTO_MOVE_TIME).uniqueId)
			end)
			var_5_13(iter_7_0, function(arg_9_0)
				local function var_9_0()
					arg_9_0()
					table.insert(arg_5_0.LTList, LeanTween.alpha(var_7_1:Find("Image"), 0, Dorm3dDanceConst.CUCOLORIS_FADE_50_0).uniqueId)
				end

				table.insert(arg_5_0.LTList, LeanTween.alpha(var_7_1:Find("Image"), 0.5, Dorm3dDanceConst.CUCOLORIS_FADE_100_50):setOnComplete(System.Action(var_9_0)).uniqueId)
			end)
			var_5_13(iter_7_0, function(arg_11_0)
				...
				setActive(var_7_1:Find("match"), true)
				table.insert(arg_5_0.LTList, LeanTween.delayedCall(Dorm3dDanceConst.MATCH_ANIM_TIME, System.Action(var_11_1)).uniqueId)
			end)
		end

		seriesAsync(var_5_10, function()
