...
function var_0_0.updateSiteItem(arg_21_0, arg_21_1, arg_21_2)
	...
	LoadImageSpriteAsync("educatesite/" .. var_21_0.icon, arg_21_2:Find("icon"), true)
	LoadImageSpriteAsync("educatesite/" .. var_21_0.name_pic, arg_21_2:Find("name"), true)
	...
	setActive(arg_21_2:Find("limit"), var_21_2)
	setActive(arg_21_2:Find("new"), EducateTipHelper.IsShowNewTip(EducateTipHelper.NEW_SITE, var_21_0.id))
