...
function var_0_0.GetCVList()
	...
	for iter_28_0, iter_28_1 in pairs(pg.character_voice) do
		if not pg.AssistantInfo.isDisableSpecialClick(iter_28_1.key) and iter_28_1.unlock_condition[1] >= 0 then
