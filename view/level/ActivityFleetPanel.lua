...
function var_0_0.updateCommanderBtn(arg_11_0, arg_11_1, arg_11_2)
	...
	local var_11_3 = var_11_2:Find("btn_select")
	local var_11_4 = var_11_2:Find("btn_clear")
	local var_11_5 = var_11_2:Find("btn_recom")
	local var_11_6 = var_11_2:Find("blank")
	local var_11_7 = var_11_2:Find("commander")
...
function var_0_0.updateFleet(arg_12_0, arg_12_1, arg_12_2)
	...
	local var_12_4 = var_12_2:Find(TeamType.Main)
	local var_12_5 = var_12_2:Find(TeamType.Vanguard)
	local var_12_6 = var_12_2:Find(TeamType.Submarine)
	local var_12_7 = var_12_2:Find("btn_select")
	local var_12_8 = var_12_2:Find("btn_recom")
	local var_12_9 = var_12_2:Find("btn_clear")
	local var_12_10 = var_12_2:Find("blank")
	local var_12_11 = var_12_2:Find("selected")
	local var_12_12 = var_12_2:Find("commander")
