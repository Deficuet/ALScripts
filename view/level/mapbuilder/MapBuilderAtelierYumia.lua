...
function var_0_0.UpdateStory(arg_8_0)
	...
	for iter_8_0, iter_8_1 in pairs(arg_8_0.storyNodesDict) do
		...
		local var_8_5 = iter_8_1:IsActive(arg_8_0.activity, arg_8_0.ptActivity)
			...
			switch(var_8_10, {
				story = function(arg_17_0)
					...
					onButton(arg_8_0, arg_17_0, function()
						...
						local var_18_0 = iter_8_1:GetStory()

						arg_8_0:PlayStory(var_18_0, function()
							arg_8_0:UpdateView()
						end)
					end)
				end,
				battle = function(arg_20_0)
					...
					onButton(arg_8_0, arg_20_0, function()
						...
						local var_21_0 = iter_8_1:GetStory()

						arg_8_0:PlayStory(var_21_0, function()
							arg_8_0:UpdateView()
						end)
					end)
				end,
	...
	if arg_8_0.storyTask then
		local var_8_11 = arg_8_0.storyTask:getConfig("award_display")
		local var_8_12 = Drop.Create(var_8_11[1])

		updateDrop(arg_8_0.storyAward:GetChild(0), var_8_12)

		local var_8_13 = arg_8_0.storyTask:getTaskStatus()

		setActive(arg_8_0.storyAward:Find("get"), var_8_13 == 1)
		setActive(arg_8_0.storyAward:Find("got"), var_8_13 == 2)
		onButton(arg_8_0, arg_8_0.storyAward, function()
			arg_8_0:emit(BaseUI.ON_DROP, var_8_12)
		end)
	end
end
...
function var_0_0.UpdateButtons(arg_28_0)
	...
	local var_28_0 = arg_28_0.contextData.displayMode == var_0_0.DISPLAY.BATTLE

	setActive(arg_28_0.sceneParent.actAtelierYumiaBuffBtn, var_28_0 and arg_28_0.contextData.map.configId == 1940002)
end
