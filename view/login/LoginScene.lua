...
function var_0_0.setBg(arg_26_0)
	...
	local var_26_0 = arg_26_0._tf:Find("background/bg"):GetComponent("AspectRatioFitter")

	if var_26_0 then
		var_26_0.aspectMode = AspectMode.FitInParent
	end
	...
	if not arg_26_0.isCriBg then
		...
		local var_26_1 = arg_26_0.criBgGo.transform

		var_26_1:SetParent(arg_26_0.bgImg.transform, false)
		var_26_1:SetAsFirstSibling()

		local var_26_2 = arg_26_0.criBgGo:GetComponent("AspectRatioFitter")
...
local function var_0_3(arg_51_0)
	...
	if pg.TimeMgr.GetInstance():inTime(var_51_1) then
		local var_51_3 = math.random(1, var_51_2)

		return var_51_0, "extra" .. var_51_3
	end
...
function var_0_0.GetExtraVoiceSheetAndCue(arg_52_0)
	local var_52_0
	local var_52_1
	local var_52_2 = pg.gameset.new_login_extra_voice

	if var_52_2 then
		var_52_0, var_52_1 = var_0_3(var_52_2)
	end
...
function var_0_0.updateAdviceServer(arg_58_0)
	...
	if arg_58_0.shareData.lastLoginServer then
		local var_58_0 = findTF(arg_58_0.recentTF, "server")

		arg_58_0:updateServerTF(var_58_0, arg_58_0.shareData.lastLoginServer)
	end

	local var_58_1 = getProxy(ServerProxy).firstServer

	setActive(arg_58_0.adviceTF, var_58_1)

	if var_58_1 then
		local var_58_2 = findTF(arg_58_0.adviceTF, "server")
...
function var_0_0.updateServerList(arg_59_0, arg_59_1)
	...
	if IsUnityEditor then
		table.sort(var_59_0, function(arg_61_0, arg_61_1)
			local var_61_0 = string.lower(arg_61_0.name)
			local var_61_1 = string.lower(arg_61_1.name)

			return string.byte(var_61_0, 1) > string.byte(var_61_1, 1)
		end)
	end
...
function var_0_0.fillterRefundServer(arg_62_0)
	...
	if var_62_0.data.limitServerIds and #var_62_0.data.limitServerIds > 0 and arg_62_0.serverList and #arg_62_0.serverList > 0 then
		...
		for iter_62_0, iter_62_1 in pairs(arg_62_0.serverList) do
			...
			for iter_62_2, iter_62_3 in pairs(var_62_2) do
		...
		pg.MsgboxMgr.GetInstance():ShowMsgBox({
			...
			hideNo = true,
			hideClose = true,
			content = i18n("login_arrears_tips", var_62_3),
			onYes = function()
				return
			end
		})
...
function var_0_0.playOpening(arg_72_0, arg_72_1)
	pg.CpkPlayMgr.GetInstance():PlayCpkMovie(function()
		if not arg_72_0.cg then
			arg_72_0.cg = GetOrAddComponent(arg_72_0._tf, "CanvasGroup")
		end
