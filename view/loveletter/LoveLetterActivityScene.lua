...
function var_0_0.init(arg_2_0)
	...
	onButton(arg_2_0, arg_2_0.btnDailyConfirm, function()
		local var_8_0 = arg_2_0.dailyActivity:getNDay()

		for iter_8_0 = 1, var_8_0 do
			local var_8_1 = arg_2_0.dailyActivity:getConfig("config_data")[iter_8_0]
			local var_8_2 = var_8_1 and getProxy(TaskProxy):getTaskVO(var_8_1) or nil

			if var_8_2 and var_8_2:getTaskStatus() == 1 then
				arg_2_0:emit(LoveLetterActivityMediator.ON_DAILY_LOGIN_REWARD, var_8_1)
...
function var_0_0.didEnter(arg_13_0)
	...
	local var_13_2 = arg_13_0.activity:getNDay()
...
function var_0_0.UpdateLoveLetterMedal(arg_18_0, arg_18_1)
	...
	setLoveLetterMedal(arg_18_1, arg_18_0.ll, {
...
function var_0_0.ShowDailyPanel(arg_20_0)
	...
	local var_20_2 = arg_20_0.dailyActivity:getNDay()
	local var_20_3 = 1

	for iter_20_0 = 1, var_20_2 do
		local var_20_4 = arg_20_0.dailyActivity:getConfig("config_data")[iter_20_0]
		local var_20_5 = var_20_4 and getProxy(TaskProxy):getTaskVO(var_20_4) or nil

		if var_20_5 and var_20_5:getTaskStatus() == 1 then
			var_20_3 = iter_20_0
	...
	setText(arg_20_0.textDailyContent, i18n("loveactivity_ui_4_" .. var_20_3, arg_20_0.ll:GetName(), arg_20_0.dailyActivity:GetConfigClientSetting("exp")))
