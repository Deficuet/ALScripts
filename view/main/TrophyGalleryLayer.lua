...
function var_0_0.checkTrophyVisible(arg_8_0, arg_8_1, arg_8_2, arg_8_3)
	...
	if arg_8_2 == var_0_0.PAGE_LIMITED and arg_8_0._hideExpire and arg_8_1:IsExpire() == 1 and not arg_8_1:getProgressTrophy():isClaimed() then
		var_8_0 = false
	end
...
function var_0_0.ensureTrophyViewCache(arg_9_0, arg_9_1)
	local var_9_0 = arg_9_0._trophyViewCache[arg_9_1]

	if var_9_0 then
		return var_9_0
	end

	local var_9_1 = cloneTplTo(arg_9_0._trophyUpperTpl, arg_9_0._trophyContainer)
	local var_9_2 = cloneTplTo(arg_9_0._trophyLowerTpl, arg_9_0._trophyContainer)
	local var_9_3 = TrophyView.New(var_9_1)
	local var_9_4 = TrophyView.New(var_9_2)

	local function var_9_5()
		local var_10_0 = arg_9_0.trophyGroups[arg_9_1]
		local var_10_1 = var_10_0:getProgressTrophy()
		local var_10_2 = arg_9_0._trophyTFList[arg_9_1]
		...
		if var_10_1:canClaimed() and not var_10_1:isClaimed() then
			if not var_10_2:IsPlaying() then
				arg_9_0:emit(TrophyGalleryMediator.ON_TROPHY_CLAIM, var_10_1.id)
			end
		elseif not var_10_2:IsPlaying() then
			arg_9_0:openTrophyDetail(var_10_0, var_10_1)
		end
	end

	onButton(arg_9_0, var_9_1.transform:Find("frame"), var_9_5)
	onButton(arg_9_0, var_9_2.transform:Find("frame"), var_9_5)
	...
	arg_9_0._trophyViewCache[arg_9_1] = var_9_6
...
function var_0_0.updateTrophyReminderMaterial(arg_12_0, arg_12_1)
	...
	local var_12_1 = arg_12_0._trophyMatCache[var_12_0]

	if var_12_1 then
		arg_12_1:SetTrophyReminderMaterial(var_12_1)

		return
	end

	local var_12_2 = "artresource/effect/xunzhang/materials/" .. var_12_0

	if checkABExist(var_12_2) then
		arg_12_0._loader:LoadBundle(var_12_2, function(arg_13_0)
...
function var_0_0.updatePage(arg_22_0, arg_22_1)
	...
	setActive(arg_22_0._center, not var_22_0)
...
function var_0_0.updateTrophyList(arg_23_0)
	...
	for iter_23_2, iter_23_3 in pairs(arg_23_0.trophyGroups) do
		if arg_23_0:checkTrophyVisible(iter_23_3, var_23_1, var_23_0) then
			...
			local var_23_4 = math.fmod(var_23_2, 2) == 1
			local var_23_5 = var_23_4 and var_23_3.upperGO or var_23_3.lowerGO
			local var_23_6 = var_23_4 and var_23_3.lowerGO or var_23_3.upperGO
			local var_23_7 = var_23_4 and var_23_3.upperView or var_23_3.lowerView

			setActive(var_23_5, true)
			setActive(var_23_6, false)
			var_23_5.transform:SetSiblingIndex(var_23_2 - 1)
			arg_23_0:updateTrophyViewByFilter(var_23_7, iter_23_3, var_23_0)
			arg_23_0:updateTrophyReminderMaterial(var_23_7)

			arg_23_0._trophyTFList[iter_23_2] = var_23_7
			var_23_2 = var_23_2 + 1
		end
	end
end
...
function var_0_0.PlayTrophyClaim(arg_24_0, arg_24_1)
	...
	local var_24_2 = Instantiate(arg_24_0._reminderRes:Find("claim_fx"))

	var_24_1:PlayClaimAnima(var_24_0, var_24_2, function()
...
function var_0_0.updateTrophyByGroup(arg_26_0, arg_26_1)
	...
	arg_26_0._trophyTFList[arg_26_1]:UpdateTrophyGroup(var_26_0)
end
...
function var_0_0.updateLoveLetterPage(arg_30_0)
	...
	local var_30_2 = var_30_0:GetAllLevel()

	setText(var_30_1:Find("count"), var_30_2)

	local var_30_3, var_30_4 = var_30_0:GetAllLevelProgress()

	if var_30_4 == 0 then
		setSlider(var_30_1:Find("Slider"), 0, 1, 1)
	else
		setSlider(var_30_1:Find("Slider"), 0, var_30_4, var_30_3)
	end

	setText(var_30_1:Find("Slider/Text"), var_30_3 .. "/" .. var_30_4)

	local var_30_5 = var_30_0:GetAllLevelNextAward()

	updateDrop(var_30_1:Find("icon/mask/IconTpl"), var_30_5[1])
	onButton(arg_30_0, var_30_1:Find("icon/mask/IconTpl"), function()
		arg_30_0:emit(BaseUI.ON_DROP, drop[1])
	end, SFX_PANEL)
	setActive(var_30_1:Find("icon/got"), var_30_4 == 0)
		...
		pg.NewStyleMsgboxMgr.GetInstance():Show(pg.NewStyleMsgboxMgr.TYPE_LOVE_LETTER_LEVEL_REWARD, {
			btnList = #var_32_0 > 0 and {
				...
				},
				{
					...
					func = function()
						arg_30_0:emit(TrophyGalleryMediator.ON_GET_ALL_LOVE_LETTER_REWARD, var_32_0)
					end,
					sound = SFX_CONFIRM
				}
			} or nil
...
function var_0_0.onUpdateCard(arg_36_0, arg_36_1, arg_36_2)
	local var_36_0 = arg_36_0.cardItems[arg_36_2]
	...
	pg.EasyRedDotMgr.GetInstance():RegisterRedDot(arg_36_2.transform:Find("content/pick_up"), {
		...
		local var_37_0 = getProxy(LoveLetterProxy):GetGroupData(var_36_2.id)
