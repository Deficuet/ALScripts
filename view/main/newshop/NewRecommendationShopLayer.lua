...
function var_0_0.InitData(arg_5_0)
	...
	for iter_5_0, iter_5_1 in ipairs(var_0_1.all) do
		local var_5_3 = var_0_1[iter_5_1]

		if pg.TimeMgr.GetInstance():inTime(var_5_3.time) and var_5_3.relation_param ~= "" then
			local var_5_4 = var_5_3.relation_param[1]
			local var_5_5 = var_5_3.relation_param[2]
			local var_5_6
			...
			if var_5_4 == 1 then
				...
				local var_5_7 = ChargeConst.getBuyCount(var_5_0, var_5_5)

				var_5_6:updateBuyCount(var_5_7)
			elseif var_5_4 == 2 then
				var_5_6 = Goods.Create({
					id = var_5_5
				}, Goods.TYPE_GIFT_PACKAGE)

				local var_5_8 = ChargeConst.getBuyCount(var_5_1, var_5_5)

				var_5_6:updateBuyCount(var_5_8)

				local var_5_9 = ChargeConst.getGroupLimit(var_5_2, var_5_6:getConfig("group") or 0)

				var_5_6:updateGroupCount(var_5_9)
			elseif var_5_4 == 3 then
				var_5_6 = Goods.Create({
					id = var_5_5
				}, Goods.TYPE_SKIN)

				local var_5_10 = ChargeConst.getBuyCount(var_5_1, var_5_5)

				var_5_6:updateBuyCount(var_5_10)

				local var_5_11 = ChargeConst.getGroupLimit(var_5_2, var_5_6:getConfig("group") or 0)

				var_5_6:updateGroupCount(var_5_11)
			end
	...
	local var_5_12 = pg.gameset.shop_banner_capacity.key_value

	arg_5_0.bnIds = Clone(var_0_1.get_id_list_by_name)

	local var_5_13 = getProxy(PlayerProxy):getRawData()

	arg_5_0.bnIds.banner_big = underscore.filter(arg_5_0.bnIds.banner_big, function(arg_6_0)
		return ShopsProxy.SpecialBannerBlockCheck(var_0_1[arg_6_0], var_5_13)
	end)
	...
	for iter_5_2, iter_5_3 in pairs(arg_5_0.bnIds) do
		...
		for iter_5_4 = #iter_5_3, 1, -1 do
			local var_5_14 = var_0_1[iter_5_3[iter_5_4]]

			if not pg.TimeMgr.GetInstance():inTime(var_5_14.time) then
				table.remove(iter_5_3, iter_5_4)
			elseif var_5_14.relation_param ~= "" then
				local var_5_15 = var_5_14.relation_param[1]
				local var_5_16 = var_5_14.relation_param[2]
				local var_5_17 = arg_5_0.commodities[var_5_15][var_5_16]

				if var_5_15 == 1 then
					if not var_5_17:inTime() or not var_5_17:canPurchase() then
						table.remove(iter_5_3, iter_5_4)
					end
				elseif (var_5_15 == 2 or var_5_15 == 3) and (not var_5_17:inTime() or not var_5_17:canPurchase() or var_5_17:IsGroupLimit()) then
					table.remove(iter_5_3, iter_5_4)
				end
			end
		end
		...
		if var_5_12 < #iter_5_3 then
			for iter_5_5 = #iter_5_3, var_5_12 + 1, -1 do
...
function var_0_0.SetPanel(arg_13_0)
	for iter_13_0, iter_13_1 in pairs(arg_13_0.banners) do
		for iter_13_2, iter_13_3 in ipairs(arg_13_0.bnIds[iter_13_0]) do
			...
			GetImageSpriteFromAtlasAsync(var_13_0.pic, "", var_13_1:Find("picture"))
			...
			if var_13_0.relation_param ~= "" then
				...
				local var_13_3 = var_13_0.relation_param[2]
				local var_13_4 = arg_13_0.commodities[var_13_2][var_13_3]

				if iter_13_0 == "banner_small2" and var_13_2 == 1 and var_13_4:isMonthCard() then
					setActive(var_13_1:Find("detail"), false)
					setActive(var_13_1:Find("monthCard"), true)
					setText(var_13_1:Find("monthCard/name"), var_13_4:getConfig("name_display"))
					GetImageSpriteFromAtlasAsync("chargeicon/" .. var_13_4:getConfig("picture"), "", var_13_1:Find("monthCard/icon"))
					setText(var_13_1:Find("monthCard/get"), i18n("shop_new_get_now", var_13_4:GetGemCnt()))

					local var_13_5 = var_13_4:GetDropList()

					while #var_13_5 > 3 do
						table.remove(var_13_5, #var_13_5)
					end

					local var_13_6 = UIItemList.New(var_13_1:Find("monthCard/items"), var_13_1:Find("monthCard/items/item"))

					var_13_6:make(function(arg_14_0, arg_14_1, arg_14_2)
					...
					var_13_6:align(#var_13_5)

					local var_13_7 = var_13_2 == 1 and var_13_4:getShowType() ~= ""
					local var_13_8 = var_13_4:isFree()

					setText(var_13_1:Find("monthCard/consume/icon_rmb"), GetMoneySymbol())
					setActive(var_13_1:Find("monthCard/consume/icon_rmb"), var_13_2 == 1 and not var_13_7)

					if PLATFORM_CODE == PLATFORM_CHT and var_13_4:IsLocalPrice() then
						setActive(var_13_1:Find("monthCard/consume/icon_rmb"), false)
					end

					setActive(var_13_1:Find("monthCard/consume/icon_gem"), var_13_2 ~= 1 and not var_13_8)
					setActive(var_13_1:Find("monthCard/consume/Text"), not var_13_8 and not var_13_7)

					if var_13_2 == 1 then
						setText(var_13_1:Find("monthCard/consume/Text"), var_13_4:getConfig("money"))
					elseif var_13_2 == 2 then
						setText(var_13_1:Find("monthCard/consume/Text"), var_13_4:GetPrice())
					end

					setActive(var_13_1:Find("monthCard/consume/FreeText"), var_13_8)
					setText(var_13_1:Find("monthCard/consume/FreeText"), i18n("shop_free_tag"))

					local var_13_9 = getProxy(PlayerProxy):getRawData():getCardById(VipCard.MONTH)
					local var_13_10 = var_13_9 and var_13_9:GetLeftDay() > (var_13_4:getConfig("limit_arg") or 0)

					setActive(var_13_1:Find("monthCardhave"), var_13_10)

					if var_13_10 then
						setText(var_13_1:Find("monthCardhave/Text"), i18n("shop_new_remaining_time", var_13_9:GetLeftDay()))
					end
				else
					if var_13_2 == 1 then
						setText(var_13_1:Find("detail/name"), var_13_4:getConfig("name_display"))
						GetImageSpriteFromAtlasAsync("chargeicon/" .. var_13_4:getConfig("picture"), "", var_13_1:Find("detail/icon"))
					elseif var_13_2 == 2 then
						setText(var_13_1:Find("detail/name"), var_13_4:GetName())
						GetImageSpriteFromAtlasAsync(var_13_4:getDropInfo():getIcon(), "", var_13_1:Find("detail/icon"))
					end

					local var_13_11 = var_13_4:GetDropList()

					while #var_13_11 > 3 do
						table.remove(var_13_11, #var_13_11)
					end

					local var_13_12 = UIItemList.New(var_13_1:Find("detail/items"), var_13_1:Find("detail/items/item"))

					var_13_12:make(function(arg_15_0, arg_15_1, arg_15_2)
						if arg_15_0 == UIItemList.EventUpdate then
							local var_15_0 = var_13_11[arg_15_1 + 1]

							updateDrop(arg_15_2:Find("mask/item"), var_15_0)
						end
					end)
					var_13_12:align(#var_13_11)

					local var_13_13 = var_13_2 == 1 and var_13_4:getShowType() ~= ""
					local var_13_14 = var_13_4:isFree()

					setText(var_13_1:Find("detail/consume/icon_rmb"), GetMoneySymbol())
					setActive(var_13_1:Find("detail/consume/icon_rmb"), var_13_2 == 1 and not var_13_13)

					if PLATFORM_CODE == PLATFORM_CHT and var_13_4:IsLocalPrice() then
						setActive(var_13_1:Find("detail/consume/icon_rmb"), false)
					end

					setActive(var_13_1:Find("detail/consume/icon_gem"), var_13_2 ~= 1 and not var_13_14)
					setActive(var_13_1:Find("detail/consume/Text"), not var_13_14 and not var_13_13)

					if var_13_2 == 1 then
						setText(var_13_1:Find("detail/consume/Text"), var_13_4:getConfig("money"))
					elseif var_13_2 == 2 then
						setText(var_13_1:Find("detail/consume/Text"), var_13_4:GetPrice())
					end

					setActive(var_13_1:Find("detail/consume/FreeText"), var_13_14)
					setText(var_13_1:Find("detail/consume/FreeText"), i18n("shop_free_tag"))
				end
			end

			if var_13_0.time_lable == 1 then
				local var_13_15 = var_13_0.time[2]
				...
				arg_13_0:StartTimer(function()
					...
					local var_16_1 = var_13_16 - var_16_0
					local var_16_2 = math.floor(var_16_1 / 86400)
					local var_16_3 = math.floor(var_16_1 % 86400 / 3600)
					local var_16_4 = math.floor(var_16_1 % 86400 % 3600 / 60)

					if iter_13_0 == "banner_big" then
						setText(var_13_1:Find("time/text"), i18n("shop_countdown", var_16_2, var_16_3, var_16_4))
					elseif var_16_2 > 0 then
						setText(var_13_1:Find("time/text"), i18n("shop_new_during_day", var_16_2))
					elseif var_16_3 > 0 then
						setText(var_13_1:Find("time/text"), i18n("shop_new_during_hour", var_16_3))
					else
						setText(var_13_1:Find("time/text"), i18n("shop_new_during_minite", var_16_4))
					end
				end)
			end
