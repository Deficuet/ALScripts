...
function var_0_0.MemoryFilter(arg_6_0)
	...
	for iter_6_0, iter_6_1 in ipairs(pg.memory_group.all) do
		local var_6_0 = pg.memory_group[iter_6_1]

		if var_6_0.type == arg_6_0.type then
			table.insert(arg_6_0.memoryGroups, var_6_0)
		end
	end
	...
	local var_6_2 = _.reduce(arg_6_0.memories, 0, function(arg_8_0, arg_8_1)
		if arg_8_1.is_open == 1 or pg.NewStoryMgr.GetInstance():IsPlayed(arg_8_1.unlock_pre, true) then
			arg_8_0 = arg_8_0 + 1
		end
	...
	setText(arg_6_0.AD:Find("progress/num"), var_6_2 .. "/" .. var_6_1)
end
...
function var_0_0.onInitMemoryGroup(arg_9_0, arg_9_1)
	...
	for iter_9_0 = 1, 3 do
		...
		onButton(arg_9_0, var_9_0:Find("BG/play"), function()
			local var_10_0 = arg_9_0.memoryItems[var_9_0]

			if var_10_0 and (var_10_0.is_open == 1 or pg.NewStoryMgr.GetInstance():IsPlayed(var_10_0.unlock_pre, true)) then
				arg_9_0:PlayMemory(var_10_0)
			end
		end, SOUND_BACK)
	end
end
...
function var_0_0.onUpdateMemoryGroup(arg_11_0, arg_11_1, arg_11_2)
	for iter_11_0 = 1, 3 do
		...
		local var_11_1 = tf(arg_11_2):Find("item_" .. iter_11_0)

		arg_11_0.memoryItems[var_11_1] = var_11_0

		local var_11_2 = var_11_0.ship_group
		local var_11_3 = var_11_0.title
		local var_11_4 = var_11_0.title
		local var_11_5 = var_11_0.condition
		local var_11_6 = var_11_0.icon
		local var_11_7 = var_11_0.year
		local var_11_8 = var_11_0.is_open == 1 or pg.NewStoryMgr.GetInstance():IsPlayed(var_11_0.unlock_pre, true)
		local var_11_9 = ShipGroup.getDefaultShipConfig(var_11_2)

		setActive(var_11_1:Find("BG/lock"), not var_11_8)
		setActive(var_11_1:Find("BG/headline"), var_11_8)
		setActive(var_11_1:Find("BG/play"), var_11_8)

		if var_11_8 then
			setText(var_11_1:Find("name_bg/name"), var_11_9.name)
			setText(var_11_1:Find("BG/lock/Text"), var_11_5)
			setText(var_11_1:Find("wire/yer"), var_11_7)
			setText(var_11_1:Find("BG/headline/Text"), var_11_4)
		else
			setText(var_11_1:Find("name_bg/name"), var_11_9.name)
			setText(var_11_1:Find("BG/headline/Text"), var_11_4)
			setText(var_11_1:Find("wire/yer"), var_11_7)
		...
		setText(var_11_1:Find("BG/lock/Text"), var_11_5)
		LoadImageSpriteAsync("MemoryIcon/" .. var_11_6, var_11_1:Find("BG/bg/bg/icon"), true)
	end
end
