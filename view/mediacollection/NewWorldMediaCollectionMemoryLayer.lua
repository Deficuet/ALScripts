...
function var_0_0.OnSelected(arg_13_0)
	...
	if var_13_0 and not var_13_0:isEnd() then
		...
		local var_13_2 = _.flatten(var_13_1)
		local var_13_3 = var_13_2[#var_13_2]
		local var_13_4 = getProxy(TaskProxy):getTaskById(var_13_3)

		if var_13_4 and not var_13_4:isFinish() then
	...
	local var_13_5 = arg_13_0.contextData.memoryGroup

	arg_13_0.contextData.memoryGroup = nil

	if var_13_5 and pg.memory_group[var_13_5] then
		arg_13_0:ShowSubMemories(pg.memory_group[var_13_5])
	else
