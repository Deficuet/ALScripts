...
function var_0_0.UpdateList(arg_10_0, arg_10_1)
	arg_10_0.UIlist:make(function(arg_11_0, arg_11_1, arg_11_2)
		if arg_11_0 == UIItemList.EventUpdate then
			...
			local var_11_2 = arg_11_2:Find("frame/slider"):GetComponent(typeof(Slider))
			local var_11_3 = arg_11_2:Find("frame/progressContent/progress")
			local var_11_4 = arg_11_2:Find("frame/progressContent/progress_1")
			local var_11_5 = arg_11_2:Find("frame/awards")
			local var_11_6 = arg_11_2:Find("frame/desc")
			local var_11_7 = arg_11_2:Find("frame/get_btn")
			local var_11_8 = arg_11_2:Find("frame/got_btn")
			local var_11_9 = arg_11_2:Find("frame/go_btn")

			setText(var_11_6, var_11_0:getConfig("desc"))

			local var_11_10, var_11_11 = arg_10_0:getTaskProgress(var_11_0)
			local var_11_12, var_11_13 = arg_10_0:getTaskTarget(var_11_0)

			var_11_2.value = var_11_10 / var_11_12

			setText(var_11_4, var_11_11 .. "/" .. var_11_13)

			local var_11_14 = var_11_5:GetChild(0)

			arg_10_0:updateAwards(var_11_0:getConfig("award_display"), var_11_5, var_11_14)
			setActive(var_11_8, var_11_0:getTaskStatus() == 2)
			setActive(var_11_7, var_11_0:getTaskStatus() == 1)
			setActive(var_11_9, var_11_0:getTaskStatus() == 0)
			onButton(arg_10_0, var_11_9, function()
