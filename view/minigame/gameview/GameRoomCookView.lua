...
function var_0_0.initEvent(arg_4_0)
	if not arg_4_0.uiCam then
		arg_4_0.uiCam = GameObject.Find("UICamera"):GetComponent("Camera")
	end
	...
	arg_4_0:bind(CookGameView.SERVE_EVENT, function(arg_7_0, arg_7_1, arg_7_2)
		...
		local var_7_8
		local var_7_9 = var_7_0 ~= var_0_8.playerChar and var_7_0 ~= var_0_8.partnerChar and var_7_0 ~= var_0_8.partnerPet
		...
		arg_4_0:addScore(var_7_11, var_7_9)
	...
	arg_4_0:bind(CookGameView.EXTEND_EVENT, function(arg_10_0, arg_10_1, arg_10_2)
		...
		arg_4_0.extendTime = var_0_8.extend_time
		arg_4_0.gameTime = 0
	end)
end
...
function var_0_0.initUI(arg_16_0)
	...
	local var_16_0 = arg_16_0:getGameUsedTimes() - 4 < 0 and 0 or arg_16_0:getGameUsedTimes() - 4

	scrollTo(arg_16_0.battleScrollRect, 0, 1 - var_16_0 / (arg_16_0.totalTimes - 4))
	...
	local var_16_1 = findTF(arg_16_0.menuUI, "tplBattleItem")

	arg_16_0.battleItems = {}
	arg_16_0.dropItems = {}

	for iter_16_0 = 1, 7 do
		local var_16_2 = tf(instantiate(var_16_1))

		var_16_2.name = "battleItem_" .. iter_16_0

		setParent(var_16_2, findTF(arg_16_0.menuUI, "battList/Viewport/Content"))

		local var_16_3 = iter_16_0

		GetSpriteFromAtlasAsync("ui/minigameui/" .. var_0_5, "battleDesc" .. var_16_3, function(arg_28_0)
			if arg_28_0 then
				setImageSprite(findTF(var_16_2, "state_open/desc"), arg_28_0, true)
				setImageSprite(findTF(var_16_2, "state_clear/desc"), arg_28_0, true)
				setImageSprite(findTF(var_16_2, "state_current/desc"), arg_28_0, true)
				setImageSprite(findTF(var_16_2, "state_closed/desc"), arg_28_0, true)
			end
		end)

		local var_16_4 = findTF(var_16_2, "icon")
		local var_16_5 = {
		...
		updateDrop(var_16_4, var_16_5)
		onButton(arg_16_0, var_16_4, function()
			arg_16_0:emit(BaseUI.ON_DROP, var_16_5)
		end, SFX_PANEL)
		table.insert(arg_16_0.dropItems, var_16_4)
		setActive(var_16_2, true)
		table.insert(arg_16_0.battleItems, var_16_2)
	end
	...
	local var_16_6 = #CookGameConst.char_ids
	local var_16_7 = findTF(arg_16_0.selectUI, "ad/charDetail")

	arg_16_0.detailDescPositons = {}

	for iter_16_1 = 1, var_16_6 do
		local var_16_8 = CookGameConst.char_ids[iter_16_1]
		local var_16_9 = arg_16_0:getCharDataById(var_16_8)
		local var_16_10 = tf(instantiate(arg_16_0.selectCharTpl))

		setParent(var_16_10, arg_16_0.selectCharsContainer)

		if var_16_9 then
			local var_16_11 = var_16_9.icon
			local var_16_12 = var_16_9.pos
			local var_16_13 = pg.gametip[var_16_9.desc].tip
			local var_16_14 = pg.ship_data_statistics[var_16_9.ship_id].name

			setScrollText(findTF(var_16_10, "name/text"), var_16_14)
			setActive(findTF(var_16_10, "desc"), false)
			setActive(findTF(var_16_10, "desc_en"), false)

			if PLATFORM_CODE == PLATFORM_US then
				setActive(findTF(var_16_10, "desc_en"), true)
				setText(findTF(var_16_10, "desc_en"), var_16_13)
			else
				setActive(findTF(var_16_10, "desc"), true)
				setText(findTF(var_16_10, "desc"), var_16_13)
			end

			local var_16_15 = findTF(var_16_10, "detailDesc")

			setActive(var_16_15, false)

			if var_16_9.detail_name then
				arg_16_0.detailDescPositons[var_16_9.detail_name] = var_16_15.anchoredPosition

				setText(findTF(var_16_15, "name"), i18n(var_16_9.detail_name))
				setText(findTF(var_16_15, "desc"), i18n(var_16_9.detail_desc))
				setActive(findTF(var_16_10, "clickDesc"), true)
				onButton(arg_16_0, findTF(var_16_10, "clickDesc"), function()
					local var_30_0 = isActive(var_16_15)
					local var_30_1

					if not var_30_0 then
						var_30_1 = var_16_7:InverseTransformPoint(var_16_15.position)

						setParent(var_16_15, var_16_7)

						arg_16_0.detailDescTf = var_16_15
						arg_16_0.detailDescContent = var_16_10
						arg_16_0.detailDescName = var_16_9.detail_name
					else
						var_30_1 = arg_16_0.detailDescPositons[var_16_9.detail_name]

						setParent(var_16_15, var_16_10)
					...
					var_16_15.anchoredPosition = var_30_1

					setActive(var_16_15, not var_30_0)
				end)
			end

			GetSpriteFromAtlasAsync("ui/minigameui/" .. var_0_5, var_16_11, function(arg_31_0)
				local var_31_0 = findTF(var_16_10, "icon/img")

				setActive(var_31_0, true)

				var_31_0.anchoredPosition = var_16_12

				setImageSprite(var_31_0, arg_31_0, true)
			end)
			setActive(findTF(var_16_10, "selected"), false)
			onButton(arg_16_0, findTF(var_16_10, "click"), function()
				arg_16_0:selectChar(var_16_9.id)
			end, SFX_PANEL)
		else
			GetComponent(var_16_10, typeof(CanvasGroup)).alpha = 0
		end
	...
	arg_16_0.pageMax = math.ceil(var_16_6 / var_0_7) - 1
...
function var_0_0.initController(arg_44_0)
	arg_44_0.judgesController = CookGameJudgesController.New(arg_44_0.sceneContainer, var_0_8, arg_44_0)

	local var_44_0 = findTF(arg_44_0.sceneContainer, "scene_background/charTpl")

	setActive(var_44_0, false)

	arg_44_0.charController = CookGameCharController.New(arg_44_0.sceneContainer, var_0_8, arg_44_0)
end
...
function var_0_0.updateSelectUI(arg_50_0)
	local var_50_0 = var_0_8.playerChar

	if var_50_0 then
		local var_50_1 = findTF(arg_50_0.selectUI, "ad/player/icon/img")
		local var_50_2 = arg_50_0:getCharData(var_50_0, "icon")
		local var_50_3 = arg_50_0:getCharData(var_50_0, "pos")

		GetSpriteFromAtlasAsync("ui/minigameui/" .. var_0_5, var_50_2, function(arg_51_0)
			var_50_1.anchoredPosition = var_50_3

			setActive(var_50_1, true)
			setImageSprite(var_50_1, arg_51_0, true)
		end)
	else
		setActive(findTF(arg_50_0.selectUI, "ad/player/icon/img"), false)
	end

	local var_50_4 = var_0_8.partnerChar

	if var_50_4 then
		local var_50_5 = findTF(arg_50_0.selectUI, "ad/partner/icon/img")
		local var_50_6 = arg_50_0:getCharData(var_50_4, "icon")
		local var_50_7 = arg_50_0:getCharData(var_50_4, "pos")

		GetSpriteFromAtlasAsync("ui/minigameui/" .. var_0_5, var_50_6, function(arg_52_0)
			var_50_5.anchoredPosition = var_50_7

			setActive(var_50_5, true)
			setImageSprite(var_50_5, arg_52_0, true)
		end)
	else
...
function var_0_0.selectChar(arg_53_0, arg_53_1)
	...
	for iter_53_0 = 1, #arg_53_0.selectChars do
		local var_53_0 = arg_53_0.selectChars[iter_53_0].data

		if var_53_0 then
			local var_53_1 = arg_53_0.selectChars[iter_53_0].tf

			if var_53_0.id == arg_53_1 then
				setActive(findTF(var_53_1, "selected"), true)
			else
				setActive(findTF(var_53_1, "selected"), false)
			end
		end
	end
...
function var_0_0.getCharData(arg_55_0, arg_55_1, arg_55_2)
	for iter_55_0 = 1, #CookGameConst.char_data do
		local var_55_0 = CookGameConst.char_data[iter_55_0]

		if var_55_0.id == arg_55_1 then
			if not arg_55_2 then
				return Clone(var_55_0)
			else
				return Clone(var_55_0[arg_55_2])
			end
		end
	end
...
function var_0_0.gameStart(arg_60_0)
	...
	for iter_60_0 = #arg_60_0.showScores, 1, -1 do
		if not table.contains(arg_60_0.showScoresPool, arg_60_0.showScores[iter_60_0]) then
			local var_60_0 = table.remove(arg_60_0.showScores, iter_60_0)

			table.insert(arg_60_0.showScoresPool, var_60_0)
		end
	end
	...
	local function var_60_1(arg_61_0, arg_61_1)
		local var_61_0 = arg_60_0:getCharData(arg_61_0, "icon")
		local var_61_1 = arg_60_0:getCharData(arg_61_0, "pos")

		GetSpriteFromAtlasAsync("ui/minigameui/" .. var_0_5, var_61_0, function(arg_62_0)
			setActive(arg_61_1, true)
			setImageSprite(arg_61_1, arg_62_0, true)
		end)
	end

	var_60_1(var_0_8.playerChar, findTF(arg_60_0.gameUI, "top/leftCharPos/player/img"))
	var_60_1(var_0_8.partnerChar, findTF(arg_60_0.gameUI, "top/leftCharPos/partner/img"))
	var_60_1(var_0_8.enemy1Char, findTF(arg_60_0.gameUI, "top/rightCharPos/enemy1/img"))
	var_60_1(var_0_8.enemy2Char, findTF(arg_60_0.gameUI, "top/rightCharPos/enemy2/img"))
...
function var_0_0.gameStep(arg_71_0)
	if arg_71_0.gameTime and arg_71_0.gameTime > 3 and arg_71_0.gameTime - Time.deltaTime < 3 and var_0_8.playerChar ~= 6 and var_0_8.playerChar ~= 6 then
	...
	var_0_8.gameTime = arg_71_0.gameTime
...
function var_0_0.showSettlement(arg_79_0)
	...
	local var_79_3 = findTF(arg_79_0.settlementUI, "ad/highText")
	local var_79_4 = findTF(arg_79_0.settlementUI, "ad/currentText")
	local var_79_5 = findTF(arg_79_0.settlementUI, "ad/otherText")

	setText(var_79_3, var_79_1)
	setText(var_79_4, var_79_0)
	setText(var_79_5, var_79_2)
	...
	for iter_79_0 = 1, #var_79_6 do
		local var_79_7 = var_79_6[iter_79_0].char_id
		local var_79_8 = findTF(arg_79_0.settlementUI, "ad/" .. var_79_6[iter_79_0].name)
		local var_79_9 = arg_79_0:getCharData(var_79_7, "icon")
		local var_79_10 = arg_79_0:getCharData(var_79_7, "pos")

		GetSpriteFromAtlasAsync("ui/minigameui/" .. var_0_5, var_79_9, function(arg_80_0)
			local var_80_0 = findTF(var_79_8, "mask/img")

			setActive(var_80_0, true)

			var_80_0.anchoredPosition = var_79_10
