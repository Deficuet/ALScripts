...
function var_0_0.GetMiniGameHudId(arg_5_0, arg_5_1)
	local var_5_0 = pg.activity_template[arg_5_1]

	if not var_5_0 then
		return nil
	end

	return var_5_0.config_id
end

function var_0_0.GetDOA2MiniGameId(arg_6_0, arg_6_1)
	local var_6_0 = pg.activity_template[arg_6_1]
	...
	local var_6_1 = var_6_0.config_id

	for iter_6_0 = #pg.mini_game.all, 1, -1 do
		local var_6_2 = pg.mini_game.all[iter_6_0]
		local var_6_3 = pg.mini_game[var_6_2]

		if var_6_3 and var_6_3.hub_id == var_6_1 then
			return var_6_2
		end
	end
...
function var_0_0.getGameData(arg_25_0)
	...
	arg_25_0.curDay = arg_25_0.hubData.ultimate == 0 and arg_25_0.hubData.usedtime + 1 or 8
	arg_25_0.unlockDay = arg_25_0.hubData.usedtime + arg_25_0.hubData.count
	arg_25_0.curDay = arg_25_0.curDay <= arg_25_0.unlockDay and arg_25_0.curDay or arg_25_0.unlockDay
	...
	local var_25_0 = getProxy(PlayerProxy):getData().id

	arg_25_0.isFirstgame = PlayerPrefs.GetInt("volleyballgame_first_" .. var_25_0)
end
...
function var_0_0.initMainUI(arg_27_0)
	...
	local var_27_0 = 215
	local var_27_1 = math.min(645, (arg_27_0.curDay - 1) * var_27_0)
...
function var_0_0.refreshSelectUI(arg_34_0)
	eachChild(arg_34_0.select4Chars, function(arg_35_0)
		...
		if arg_34_0.charNames[var_35_0] then
			...
			setImageSprite(arg_35_0:Find("char/icon"), arg_34_0.paints:Find(arg_34_0:getCharIndex(arg_34_0.charNames[var_35_0])):GetComponent(typeof(Image)).sprite, true)
			setImageSprite(arg_35_0:Find("char/tag"), arg_34_0.tags:Find(arg_34_0:getCharIndex(arg_34_0.charNames[var_35_0])):GetComponent(typeof(Image)).sprite, true)
		else
	...
	arg_34_0.canStartGame = arg_34_0.charNames.our1 and arg_34_0.charNames.our2 and arg_34_0.charNames.enemy1 and arg_34_0.charNames.enemy2 and true or false
...
function var_0_0.isSelected(arg_36_0, arg_36_1, arg_36_2)
	...
	for iter_36_0, iter_36_1 in pairs(arg_36_0.charNames) do
		if arg_36_1 == iter_36_1 then
			var_36_0 = not string.find(iter_36_0, arg_36_2) and true or false
		end
	end
...
function var_0_0.openSelectWindow(arg_37_0)
	...
	eachChild(arg_37_0.select9Chars, function(arg_38_0)
		...
		setImageSprite(arg_38_0:Find("char/frame/icon"), arg_37_0.icons:Find(var_38_0):GetComponent(typeof(Image)).sprite, true)
		onButton(arg_37_0, arg_38_0, function()
			if arg_37_0:isSelected(var_0_1[var_38_0], arg_37_0.selectCharCamp) then
				return
			end
...
function var_0_0.firstShow(arg_42_0, arg_42_1)
	...
	onButton(arg_42_0, arg_42_0.helpUI, function()
		local var_43_0 = getProxy(PlayerProxy):getData().id

		PlayerPrefs.SetInt("volleyballgame_first_" .. var_43_0, 1)
...
function var_0_0.startCountTimer(arg_44_0)
	...
	if arg_44_0.countTimer then
		arg_44_0.countTimer:Reset(var_44_0, 1, -1)
	else
		arg_44_0.countTimer = Timer.New(var_44_0, 1, -1)
	end
...
function var_0_0.enemyFly(arg_93_0)
	...
	local var_93_0 = math.random(1000, 1100)
	local var_93_1 = math.random(0, 200)
...
function var_0_0.GetBeziersPoints(arg_97_0, arg_97_1, arg_97_2, arg_97_3, arg_97_4)
	local function var_97_0(arg_98_0)
		local var_98_0 = arg_97_1:Clone():Mul((1 - arg_98_0) * (1 - arg_98_0))
		local var_98_1 = arg_97_2:Clone():Mul(2 * arg_98_0 * (1 - arg_98_0))
		local var_98_2 = arg_97_3:Clone():Mul(arg_98_0 * arg_98_0)

		return var_98_0:Clone():Add(var_98_1):Add(var_98_2)
	end
	...
	for iter_97_0 = 1, arg_97_4 do
		local var_97_2 = iter_97_0 / arg_97_4

		table.insert(var_97_1, var_97_0(var_97_2))
	end
...
function var_0_0.ballParabolaMove(arg_99_0, arg_99_1, arg_99_2, arg_99_3, arg_99_4, arg_99_5, arg_99_6)
	...
	if arg_99_5 < arg_99_6 then
		...
		local var_99_9 = var_99_5 + var_99_4
	end
	...
	arg_99_0:managedTween(LeanTween.value, function()
		...
		local var_101_0 = var_99_2 * arg_101_0 / arg_99_2
		local var_101_1 = var_99_3 * arg_101_0 / arg_99_2
		local var_101_2 = var_99_10 * arg_101_0 + 0.5 * var_0_33 * arg_101_0 * arg_101_0

		arg_99_1.anchoredPosition = Vector2(var_99_0.x + var_101_0, var_99_0.y + var_101_1 + arg_99_5 + var_101_2)
	end))
end
...
function var_0_0.qteResult(arg_117_0)
	...
	if var_117_0 <= 0 or var_117_0 > var_0_7 then
	...
	elseif var_117_0 > var_0_8 then
		...
		if arg_117_0.qteType == var_0_14 then
...
function var_0_0.getRandomPos(arg_130_0, arg_130_1)
	...
	local var_130_3 = var_130_2

	if string.find(arg_130_1, "our") then
		var_130_3 = {
			x = var_130_2.x + var_130_0 - 50,
			y = var_130_2.y + var_130_1 - 25
		}
	else
		var_130_3 = {
			x = var_130_2.x + var_130_0 - 250,
			y = var_130_2.y + var_130_1 - 25
		}
	end
...
function var_0_0.loadSpineChars(arg_131_0)
	...
	if arg_131_0.beginTeam == var_0_3 then
		arg_131_0.serveChar = "our" .. math.random(2)
	else
		arg_131_0.serveChar = "enemy" .. math.random(2)
	end
...
function var_0_0.loadOneSpineChar(arg_132_0, arg_132_1, arg_132_2)
	...
	PoolMgr.GetInstance():GetSpineChar(arg_132_0.charNames[arg_132_1], true, function(arg_133_0)
		...
		if string.find(arg_132_1, "our") then
			...
			if string.find(arg_132_1, "1") then
				var_133_1 = "our1"
			else
				var_133_1 = "our2"
			end
...
function var_0_0.charHitBall(arg_145_0)
	...
	var_145_0:move(0.5, arg_145_0.ballPosTag, nil, function()
...
function var_0_0.OnGetAwardDone(arg_159_0, arg_159_1)
	if arg_159_1.cmd == MiniGameOPCommand.CMD_COMPLETE then
		...
		if var_159_2 ~= 7 and var_159_6 and not var_159_5:IsPlayed(var_159_6) then
	...
	elseif arg_159_1.cmd == MiniGameOPCommand.CMD_ULTIMATE then
		local var_159_7 = arg_159_0.storylist[7][1] and arg_159_0.storylist[7][1] or nil
