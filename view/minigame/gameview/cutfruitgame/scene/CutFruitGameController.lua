...
function var_0_0.Prepare(arg_3_0)
	...
	for iter_3_0 = 1, #arg_3_0._npcConfig do
		...
		arg_3_0:prepareChar(arg_3_0._npcConfig[iter_3_0], findTF(arg_3_0._npcContent, var_3_0), function(arg_5_0)
...
function var_0_0.Step(arg_7_0, arg_7_1)
	...
	if arg_7_0._currrentPosition < arg_7_0._targetPosition then
		...
		arg_7_0._currrentPosition = arg_7_0._currrentPosition + var_7_0
...
function var_0_0.prepareChar(arg_18_0, arg_18_1, arg_18_2, arg_18_3)
	local var_18_0 = CutFruitGameConst.character_name[arg_18_1]
	local var_18_1 = SpineAnimChar.New()

	var_18_1:SetPaint(var_18_0)
	var_18_1:Load(true, function()
		var_18_1:SetParent(arg_18_2)
		var_18_1:SetLocalScale(Vector3(1, 1, 1))
		var_18_1:SetAnchoredPosition(Vector2(0, 0))
...
function var_0_0.InputDirect(arg_21_0, arg_21_1)
	...
	local var_21_0 = #arg_21_0._passList + 1

	if var_21_0 <= #arg_21_0._inputList then
		local var_21_1 = arg_21_1 == arg_21_0._inputList[var_21_0] and var_0_2 or var_0_3

		table.insert(arg_21_0._passList, var_21_1)
	end
...
function var_0_0.SetDirectData(arg_22_0, arg_22_1)
	...
	for iter_22_0 = 1, #arg_22_0._directGrids do
		...
		if iter_22_0 <= #arg_22_1 then
			findTF(var_22_0, "ad").localEulerAngles = CutFruitGameConst.DIRECT_ROTATION[arg_22_1[iter_22_0]].rotation
...
function var_0_0.updateDirect(arg_23_0)
	for iter_23_0 = 1, #arg_23_0._inputList do
		...
		setActive(findTF(var_23_0, "ad/" .. var_0_1), false)
		setActive(findTF(var_23_0, "ad/" .. var_0_2), false)
		setActive(findTF(var_23_0, "ad/" .. var_0_3), false)

		if iter_23_0 > #arg_23_0._passList then
			setActive(findTF(var_23_0, "ad/" .. var_0_1), true)
		else
			setActive(findTF(var_23_0, "ad/" .. arg_23_0._passList[iter_23_0]), true)
		end
	end
...
function var_0_0.getRandomDirect(arg_25_0)
	...
	for iter_25_0 = 1, var_0_4 do
		table.insert(var_25_0, arg_25_0._directRandomList[math.random(1, #arg_25_0._directRandomList)])
	end
