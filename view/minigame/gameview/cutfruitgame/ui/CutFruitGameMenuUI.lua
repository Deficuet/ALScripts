...
function var_0_0.initUI(arg_2_0)
	...
	for iter_2_0 = 1, 7 do
		...
		setText(findTF(var_2_2, "ad/desc"), i18n("which_day_2", var_2_1))
		...
		onButton(arg_2_0._event, var_2_3, function()
			arg_2_0._event:emit(BaseUI.ON_DROP, var_2_4)
		end, SFX_PANEL)
...
function var_0_0.Update(arg_13_0)
	...
	local var_13_6 = var_13_5 and #var_13_5 > 0 and var_13_5[1] or 0
