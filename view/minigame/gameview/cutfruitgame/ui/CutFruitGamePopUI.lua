...
function var_0_0.initSelectUI(arg_2_0)
	...
	for iter_2_0 = 1, CutFruitGameConst.character_num do
		...
		GetSpriteFromAtlasAsync(CutFruitGameConst.ui_atlas, "char_grid_" .. var_2_3, function(arg_6_0)
	...
	arg_2_0.selectChar = var_2_5.char ~= 0 and var_2_5.char or math.random(1, CutFruitGameConst.character_num)
	arg_2_0.selectNpc = #var_2_5.npc > 0 and var_2_5.npc or arg_2_0:GetNpcRandom(arg_2_0.selectChar)
