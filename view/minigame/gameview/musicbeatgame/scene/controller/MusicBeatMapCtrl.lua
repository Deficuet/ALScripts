...
function var_0_0.resume(arg_10_0)
	for iter_10_0 = 1, #arg_10_0.mapScenes do
		arg_10_0.mapScenes[iter_10_0]:step()
	end
end
...
function var_0_0.loadMapScene(arg_12_0, arg_12_1)
	...
	for iter_12_0, iter_12_1 in ipairs(arg_12_1) do
		...
		local var_12_2 = findTF(arg_12_0._tf, var_12_1)
		local var_12_3

		if var_12_0 == MusicBeatGameConst.map_type_plane then
			var_12_3 = BeatGameMapPlane.New(var_12_2, arg_12_0._event, iter_12_1)
		end

		if var_12_3 then
			var_12_3:setGameVo(arg_12_0._gameVo)
			table.insert(arg_12_0.mapScenes, var_12_3)
		end
	end
end
