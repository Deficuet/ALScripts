		...
		if arg_2_1 then
			...
			for iter_2_0 = 1, #arg_1_0.prepareTracks do
				if arg_1_0.prepareTracks[iter_2_0].id == var_2_0 then
					...
					local var_2_2, var_2_3 = arg_1_0:matchTrack(var_2_1)

					print("match is " .. tostring(var_2_2) .. " subtime is " .. var_2_3)

					if arg_2_2 then
						arg_2_2(var_2_2, var_2_3)
					end
...
function var_0_0.step(arg_6_0, arg_6_1)
	if arg_6_0._gameVo:isBgmPlaying() then
		...
		if arg_6_0.trackData then
			local var_6_0 = arg_6_0._gameVo:getCriInfoTime()
			local var_6_1 = arg_6_0.trackData.begin_time - var_6_0

			if var_6_1 >= 0 and var_6_1 <= MusicBeatGameConst.beat_prepare then
			...
			elseif var_6_1 <= 0 and arg_6_0.trackData.begin_time == arg_6_0.trackData.end_time and math.abs(var_6_1) >= arg_6_0.beatOffset then
	...
	if #arg_6_0.prepareTracks > 0 then
		local var_6_2 = arg_6_0._gameVo:getCriInfoTime()

		for iter_6_0 = #arg_6_0.prepareTracks, 1, -1 do
			if var_6_2 - arg_6_0.prepareTracks[iter_6_0].end_time >= arg_6_0.beatOffset then
				local var_6_3 = table.remove(arg_6_0.prepareTracks, iter_6_0)
			end
		end
	end
end
...
function var_0_0.matchTrack(arg_11_0, arg_11_1)
	...
	if var_11_0 > 0 then
		...
		if arg_11_1.begin_time == arg_11_1.end_time then
			...
			var_11_2 = math.abs(var_11_3 - var_11_0)
		...
		elseif arg_11_1.data.begin_time ~= arg_11_1.data.end_time then
			...
			var_11_2 = math.abs(var_11_4 - var_11_0)
...
function var_0_0.createTrackList(arg_12_0)
	local var_12_0 = Clone(arg_12_0.nodeData.touch_track)
