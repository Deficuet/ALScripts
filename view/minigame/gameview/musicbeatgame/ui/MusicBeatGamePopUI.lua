...
function var_0_0.setRankItemData(arg_16_0, arg_16_1, arg_16_2, arg_16_3)
	...
	if arg_16_3 > 0 and arg_16_3 <= 3 then
		...
		setText(findTF(arg_16_1, "score"), setColorStr(var_16_3, var_0_1[arg_16_3]))
	elseif var_16_5 then
		setActive(findTF(arg_16_1, "bg/me"), true)
		setActive(findTF(arg_16_1, "rank/count"), true)
		setText(findTF(arg_16_1, "score"), setColorStr(var_16_3, var_0_2))
	else
...
function var_0_0.updateSettlementUI(arg_19_0)
	...
	local var_19_2 = var_19_1 and #var_19_1 > 0 and var_19_1[1] or 0
	...
	local var_19_4 = findTF(arg_19_0.settlementUI, "ad/currentText")

	setText(var_19_4, var_19_0)
