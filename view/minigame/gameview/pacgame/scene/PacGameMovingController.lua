...
function var_0_0.MovingRole(arg_5_0, arg_5_1)
	if arg_5_1:HasTarget() then
		...
		local var_5_3 = arg_5_1:GetTargetIndex()
		local var_5_4 = Vector2(var_5_1 * var_5_0.x * arg_5_0._deltaTime, var_5_1 * var_5_0.y * arg_5_0._deltaTime)
		local var_5_5 = arg_5_1:GetTarget()
		local var_5_6 = arg_5_1:GetPosition()
		local var_5_7 = Vector2(var_5_6.x + var_5_4.x, var_5_6.y + var_5_4.y)

		if arg_5_0:checkMoveToTarget(var_5_6, var_5_7, var_5_5) then
			arg_5_1:SetPosition(var_5_5)
			arg_5_1:SetGridIndex(var_5_3)
			...
			if var_5_8 then
				arg_5_1:MoveTo(var_5_7)
			end
		end
	elseif arg_5_1:GetRoads() and #arg_5_1:GetRoads() > 0 and not arg_5_1:HasTarget() then
		local var_5_9 = arg_5_1:PopRoad()
		local var_5_10 = arg_5_1:GetGridIndex()
		local var_5_11 = arg_5_0._gridDic[var_5_9]

		if not arg_5_0:checkNear(var_5_9, var_5_10) then
			print("位置不相邻，结束 " .. tostring(var_5_9) .. ":" .. tostring(var_5_10))

			return
		end

		local var_5_12 = arg_5_0:getDirectByIndex(var_5_10, var_5_9)
		local var_5_13 = arg_5_1:GetPosition()
		local var_5_14 = var_5_11:GetPosition()
		local var_5_15 = arg_5_0:getMoving(var_5_13, var_5_14)

		arg_5_1:SetTarget(var_5_14, var_5_9, var_5_15, var_5_12)
	else
		local var_5_16 = arg_5_1:GetDirect()

		if var_5_16[1] == 0 and var_5_16[2] == 0 then
			return
		end

		local var_5_17 = arg_5_1:GetGridIndex()
		local var_5_18 = arg_5_0._runningData:getDirectGrid(var_5_17, Vector2(var_5_16[1], var_5_16[2]))

		if var_5_18 then
			local var_5_19 = arg_5_0:getMoving(arg_5_1:GetPosition(), var_5_18:GetPosition())

			arg_5_1:SetTarget(var_5_18:GetPosition(), var_5_18:GetIndex(), var_5_19, var_5_16)
		end
	end
end
...
function var_0_0.getMoving(arg_13_0, arg_13_1, arg_13_2)
	...
	local var_13_1 = arg_13_2.x >= arg_13_1.x and 1 or -1
	local var_13_2 = arg_13_2.y >= arg_13_1.y and 1 or -1
	local var_13_3 = math.cos(var_13_0) * var_13_1
	local var_13_4 = math.sin(var_13_0) * var_13_2

	if math.abs(var_13_3) <= 0.01 then
		var_13_3 = 0
	end

	if math.abs(var_13_4) <= 0.01 then
		var_13_4 = 0
	end

	return Vector2(var_13_3, var_13_4)
end
