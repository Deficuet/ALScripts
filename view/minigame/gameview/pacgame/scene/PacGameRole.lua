...
function var_0_0.Ctor(arg_1_0, arg_1_1, arg_1_2)
	...
	arg_1_0._rate = arg_1_2.rate and arg_1_2.rate or 0
...
function var_0_0.Step(arg_3_0, arg_3_1)
	...
	local var_3_0 = arg_3_0._animator:GetBool("flash")
	local var_3_1 = false
	...
	if var_3_0 ~= var_3_1 then
		arg_3_0._animator:SetBool("flash", var_3_1)
	end
...
function var_0_0.GetSpeed(arg_4_0)
	...
	return var_4_0 >= PacGameConst.enemy_max_speed and PacGameConst.enemy_max_speed or var_4_0
end
