...
function var_0_0.getDirectGrid(arg_25_0, arg_25_1, arg_25_2)
	...
	if var_25_0 % arg_25_0._mapData.horizontal == 0 and arg_25_2.x == -1 then
		return nil
	elseif var_25_0 % arg_25_0._mapData.horizontal == arg_25_0._mapData.horizontal - 1 and arg_25_2.x == 1 then
		return nil
	elseif var_25_0 < arg_25_0._mapData.horizontal and arg_25_2.y == 1 then
		return nil
	elseif var_25_0 >= arg_25_0._mapData.horizontal * (arg_25_0._mapData.vertical - 1) and arg_25_2.y == -1 then
		return nil
	end
	...
	if arg_25_2.x ~= 0 then
		var_25_1 = arg_25_1 + arg_25_2.x
	elseif arg_25_2.y ~= 0 then
		var_25_1 = arg_25_1 + -arg_25_2.y * arg_25_0._mapData.horizontal
	end

	if var_25_1 then
		local var_25_2 = arg_25_0._gridDic[var_25_1]

		if var_25_2 and var_25_2:GetPassAble() then
			return var_25_2
		end
	end
...
function var_0_0.GetNearGridIndex(arg_26_0, arg_26_1)
	...
	local var_26_2 = arg_26_0:getDirectGrid(arg_26_1, Vector2(1, 0))
	local var_26_3 = arg_26_0:getDirectGrid(arg_26_1, Vector2(0, 1))
	local var_26_4 = arg_26_0:getDirectGrid(arg_26_1, Vector2(0, -1))
