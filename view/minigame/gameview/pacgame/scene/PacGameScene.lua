...
function var_0_0.Prepare(arg_5_0)
	...
	local var_5_1 = PacGameConst.chapter_data[var_5_0]
	local var_5_2 = arg_5_0._gameVo:GetEditor()

	arg_5_0._pacGameRunningData:SetChapterData(var_5_1)
	arg_5_0._pacGameRunningData:SetEditor(var_5_2)
...
function var_0_0.Step(arg_7_0)
	...
	local var_7_1 = arg_7_0._gameVo:GetJoyStickData()

	arg_7_0._pacGameRunningData:SetJoyData(var_7_1)
