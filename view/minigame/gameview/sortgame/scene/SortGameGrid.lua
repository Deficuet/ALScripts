...
function var_0_0.Ctor(arg_1_0, arg_1_1, arg_1_2, arg_1_3)
	...
	for iter_1_0 = 1, var_0_1 do
		...
		local var_1_1 = findTF(arg_1_0._tf, "ad/" .. var_1_0)

		table.insert(arg_1_0._itemsTF, var_1_1)

		local var_1_2 = GetOrAddComponent(findTF(var_1_1, "trigger"), typeof(EventTriggerListener))

		table.insert(arg_1_0._gridEventTriggerList, var_1_2)

		local var_1_3 = GetOrAddComponent(var_1_1, typeof(Animator))

		table.insert(arg_1_0._itemsAnimator, var_1_3)

		local var_1_4 = GetOrAddComponent(var_1_1, typeof(DftAniEvent))

		var_1_4:SetEndEvent(function()
			if arg_1_0._removeDic and arg_1_0._removeDic[var_1_0] then
				arg_1_0._removeDic[var_1_0] = nil

				local var_2_0 = arg_1_0._itemIdDic[var_1_0][1]
		...
		table.insert(arg_1_0._itemsDftEvent, var_1_4)
		arg_1_0:SetItemSelect(var_1_0, false)
		arg_1_0:SetItemLock(var_1_0, false)
	end
...
function var_0_0.SetItemLock(arg_12_0, arg_12_1, arg_12_2)
	...
	setActive(findTF(var_12_0, "lock"), arg_12_2)
end
...
function var_0_0.GetBottomIds(arg_18_0)
	...
	for iter_18_0 = 1, var_0_1 do
		table.insert(var_18_0, arg_18_0._itemIdDic[iter_18_0][1])
	end
...
function var_0_0.GetAllIds(arg_20_0)
	...
	for iter_20_0 = 1, var_0_1 do
		...
		for iter_20_1 = 1, SortGameConst.grid_max_layer do
			table.insert(var_20_0, arg_20_0._itemIdDic[iter_20_0][iter_20_1])
		end
	end
...
function var_0_0.MoveItemToBottom(arg_26_0, arg_26_1)
	local var_26_0 = arg_26_1 and arg_26_1 + 1 or 1
...
function var_0_0.SetItemAlpha(arg_31_0, arg_31_1, arg_31_2)
	...
	arg_31_0._itemsAnimator[arg_31_1]:SetTrigger(var_31_1)
...
function var_0_0.AddItemEventCallback(arg_35_0, arg_35_1, arg_35_2, arg_35_3, arg_35_4)
	for iter_35_0 = 1, var_0_1 do
		...
		local var_35_1 = arg_35_0._gridEventTriggerList[var_35_0]

		if var_35_1 then
			var_35_1:AddDragFunc(function(arg_36_0, arg_36_1)
			...
			var_35_1:AddDragEndFunc(function(arg_37_0, arg_37_1)
				if arg_35_0._itemIdDic[var_35_0][1] == 0 then
					return
				end
				...
				setActive(arg_35_0._itemsTF[var_35_0], true)
			end)
			var_35_1:AddPointEnterFunc(function(arg_38_0, arg_38_1)
			...
			var_35_1:AddPointExitFunc(function(arg_39_0, arg_39_1)
				if arg_35_0._gridType == SortGameConst.grid_type_out then
					return
				end
