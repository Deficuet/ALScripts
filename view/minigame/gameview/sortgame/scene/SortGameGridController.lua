...
function var_0_0.Ctor(arg_1_0, arg_1_1, arg_1_2, arg_1_3)
	...
	for iter_1_0 = 1, var_0_1 * var_0_2 do
		...
		local var_1_1 = findTF(arg_1_0._tf, "grids/grid_" .. var_1_0)

		setParent(var_1_1, arg_1_0._gridTpl.parent)
		setActive(var_1_1, true)

		local var_1_2 = SortGameGrid.New(var_1_1, arg_1_0._event, var_1_0)
		...
		arg_1_0._grids[iter_1_0]:SetScoreCallback(function(arg_5_0, arg_5_1)
			...
			if arg_1_0._wantedItem and arg_1_0._wantedItem == arg_5_1 then
				...
				local var_5_0 = arg_1_0._runtimeData:GetPlayerName(arg_1_0._runtimeData:GetPlayerIdByItem(arg_5_1))

				arg_1_0._event:emit(SortGameView.PLAYER_SPEAK, arg_1_0._runtimeData:GetSpeakData(SortGameConst.sort_conifg_type_chat, var_5_0))
			end
...
function var_0_0.onGridDrag(arg_12_0, arg_12_1, arg_12_2, arg_12_3)
	...
	local var_12_0 = arg_12_0._grids[arg_12_1]
	...
	local var_12_2 = arg_12_0._dragGridStartPos.x + (var_0_4.x + (arg_12_3.position.x - arg_12_0._startDragPos.x)) * arg_12_0._dragScreenRate.x
	local var_12_3 = arg_12_0._dragGridStartPos.y + (var_0_4.y + (arg_12_3.position.y - arg_12_0._startDragPos.y)) * arg_12_0._dragScreenRate.y

	arg_12_0._dragGridTF.anchoredPosition = Vector2(var_12_2, var_12_3)
end
...
function var_0_0.onGridDragEnd(arg_15_0, arg_15_1, arg_15_2, arg_15_3)
	...
	if var_15_0 then
		local var_15_1 = arg_15_0._grids[arg_15_0._dragGridIndex]
		local var_15_2 = arg_15_0._grids[arg_15_0._enterGridIndex]
		local var_15_3 = var_15_1:GetItemBottomId(arg_15_0._dragGridItemIndex)
		local var_15_4 = var_15_2:GetItemBottomId(arg_15_0._enterGridItemIndex)

		var_15_1:InSertItem(arg_15_0._dragGridItemIndex, var_15_4)
		var_15_2:InSertItem(arg_15_0._enterGridItemIndex, var_15_3)
		var_15_1:CheckMoveBottom()
...
function var_0_0.GetItemIdList(arg_19_0, arg_19_1, arg_19_2, arg_19_3)
	...
	for iter_19_0 = 1, arg_19_2 do
		for iter_19_1 = 1, var_0_3 * arg_19_3 do
			table.insert(var_19_0, var_19_1[var_19_2])
		end
...
function var_0_0.GetIdFromPool(arg_22_0, arg_22_1, arg_22_2)
	if arg_22_0._itemIdsPool and #arg_22_0._itemIdsPool > 0 then
		if arg_22_1 then
			if arg_22_0:GetPassItemCount(arg_22_1) <= SortGameConst.pass_limit_num then
				...
				for iter_22_0, iter_22_1 in pairs(arg_22_1) do
					if var_22_1 < iter_22_1 and arg_22_0:checkIdExist(arg_22_0._itemIdsPool, iter_22_0) and iter_22_0 ~= arg_22_2 then
						var_22_1 = iter_22_1
						var_22_0 = iter_22_0
					end
				end
				...
				if var_22_0 then
					for iter_22_2 = 1, #arg_22_0._itemIdsPool do
						if arg_22_0._itemIdsPool[iter_22_2] == var_22_0 then
							local var_22_2 = table.remove(arg_22_0._itemIdsPool, iter_22_2)
		...
		local var_22_3 = table.remove(arg_22_0._itemIdsPool, 1)

		table.insert(arg_22_0._itemIds, var_22_3)
...
function var_0_0.GetScreentScaleRate(arg_24_0)
	local var_24_0 = UnityEngine.Screen.width
	local var_24_1 = UnityEngine.Screen.height
	local var_24_2 = tf(GameObject.Find("UICamera/Canvas"))
	local var_24_3 = var_24_2.sizeDelta.x
	local var_24_4 = var_24_2.sizeDelta.y

	return Vector2(var_24_3 / var_24_0, var_24_4 / var_24_1)
end
...
function var_0_0.GetScore(arg_28_0, arg_28_1)
	local var_28_0 = arg_28_0._wantedItem and arg_28_1 == arg_28_0._wantedItem and SortGameConst.wanted_score_num or SortGameConst.score_num

	if not arg_28_0._comboIndex or arg_28_0._comboIndex == 0 then
		return var_28_0
	else
		for iter_28_0 = 1, #SortGameConst.combo_rate do
			local var_28_1 = SortGameConst.combo_rate[iter_28_0]

			if arg_28_0._comboIndex >= var_28_1.range[1] and arg_28_0._comboIndex <= var_28_1.range[2] then
				return math.floor(var_28_0 * var_28_1.rate)
			end
		end
...
function var_0_0.Prepare(arg_29_0)
	...
	local var_29_0 = arg_29_0._runtimeData:GetComonItems()
	local var_29_1 = arg_29_0._runtimeData:GetPlayers()
	local var_29_2 = arg_29_0._runtimeData:GetChapterConfig("item_count")
	local var_29_3 = arg_29_0._runtimeData:GetChapterConfig("player_own_item_count") or 1
	local var_29_4 = arg_29_0._runtimeData:GetChapterConfig("item_rate")
	local var_29_5 = arg_29_0._runtimeData:GetChapterConfig("grid_weight")

	arg_29_0._normalItemWeight = arg_29_0:CalculateWeight(var_29_5)

	local var_29_6 = arg_29_0:GetItemIdList(var_29_0, var_29_2, var_29_4)
	local var_29_7 = {}

	for iter_29_0 = 1, #var_29_1 do
		local var_29_8 = arg_29_0._runtimeData:GetPlayerItems(var_29_1[iter_29_0])

		for iter_29_1 = 1, #var_29_8 do
			table.insert(var_29_7, var_29_8[iter_29_1])
		end
	end

	local var_29_9 = arg_29_0:GetItemIdList(var_29_7, var_29_3, 1)

	arg_29_0._itemIdsPool = {}

	for iter_29_2 = 1, #var_29_6 do
		table.insert(arg_29_0._itemIdsPool, var_29_6[iter_29_2])
	end

	for iter_29_3 = 1, #var_29_9 do
		table.insert(arg_29_0._itemIdsPool, var_29_9[iter_29_3])
	end
	...
	for iter_29_4 = 1, SortGameConst.init_pass_num do
		local var_29_11 = arg_29_0._itemIdsPool[math.random(1, #arg_29_0._itemIdsPool)]
		local var_29_12 = 0

		for iter_29_5 = #arg_29_0._itemIdsPool, 1, -1 do
			if arg_29_0._itemIdsPool[iter_29_5] == var_29_11 then
				table.insert(var_29_10, table.remove(arg_29_0._itemIdsPool, iter_29_5))
	...
	if #var_29_10 > 0 then
		for iter_29_6 = 1, #var_29_10 do
			table.insert(arg_29_0._itemIdsPool, 1, var_29_10[iter_29_6])
		end
	...
	for iter_29_7 = 1, #arg_29_0._boundsData do
		local var_29_14 = iter_29_7
		local var_29_15 = arg_29_0._boundsData[iter_29_7]

		for iter_29_8 = 1, #var_29_15 do
			local var_29_16 = iter_29_8
			local var_29_17 = (var_29_14 - 1) * var_0_2 + iter_29_8

			arg_29_0._activeGridCount = var_29_15[iter_29_8] > 0 and arg_29_0._activeGridCount + 1 or arg_29_0._activeGridCount

			arg_29_0._grids[var_29_17]:SetType(var_29_15[iter_29_8])
		end
	end

	for iter_29_9 = 1, #arg_29_0._offsetData do
		local var_29_18 = arg_29_0._offsetData[iter_29_9]
		local var_29_19 = arg_29_0._grids[iter_29_9]

		if var_29_19 then
			var_29_19:SetOffset(var_29_18)
		end
	end
...
function var_0_0.Step(arg_30_0, arg_30_1, arg_30_2)
	...
	if not arg_30_0._wantedStepTime then
		if not arg_30_0._wantedRefreshTime then
			arg_30_0._wantedRefreshTime = SortGameConst.wanted_refresh_time
		end
			...
			if arg_30_0._wantedRefreshTime <= 0 then
				if math.random() < SortGameConst.wanted_rate then
					...
					if arg_30_0._wantedItem then
						local var_30_0 = arg_30_0._runtimeData:GetPlayerIdByItem(arg_30_0._wantedItem)

						arg_30_0._event:emit(SortGameView.WANTED_ITEM_REFRESH, {
							item_id = arg_30_0._wantedItem,
							player_prefab = SortGameConst.player_data[var_30_0].prefab
						})
	...
	if arg_30_0._checkLockTime >= 1.3 then
		...
		for iter_30_0 = 1, #arg_30_0._grids do
			var_30_1 = var_30_1 + arg_30_0._grids[iter_30_0]:GetInputEmptyCount()
		end

		local var_30_2 = arg_30_0:GetIdsDic(arg_30_0:GetAllBottomIds())
		local var_30_3 = arg_30_0:GetPassItemCount(var_30_2)

		if var_30_1 == 0 or var_30_1 == 1 and var_30_3 == 0 or var_30_1 == 2 and var_30_3 == 0 then
...
function var_0_0.GetAllBottomIds(arg_33_0)
	...
	for iter_33_0 = 1, #arg_33_0._grids do
		local var_33_1 = arg_33_0._grids[iter_33_0]:GetBottomIds()

		for iter_33_1, iter_33_2 in ipairs(var_33_1) do
...
function var_0_0.GetIdsDic(arg_34_0, arg_34_1)
	...
	for iter_34_0 = 1, #arg_34_1 do
		local var_34_1 = arg_34_1[iter_34_0]

		if var_34_1 and var_34_1 > 0 then
			if not var_34_0[var_34_1] then
				var_34_0[var_34_1] = 1
			else
				var_34_0[var_34_1] = var_34_0[var_34_1] + 1
			end
		end
	end
