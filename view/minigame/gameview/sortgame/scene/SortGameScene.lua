...
function var_0_0.Prepare(arg_5_0)
	...
	local var_5_1 = SortGameConst.chapter_data[var_5_0]

	arg_5_0._sortGameRunningData:SetChapterData(var_5_1)
...
function var_0_0.Step(arg_7_0)
	...
	local var_7_1 = arg_7_0._gameVo:GetTimeInteger()

	if var_7_1 <= SortGameConst.last_speak_time and not arg_7_0._gameTimeSpeak then
	...
	arg_7_0._gridController:Step(var_7_0, var_7_1)
end
