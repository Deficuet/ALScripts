...
function var_0_0.CreateScoreTF(arg_5_0, arg_5_1, arg_5_2)
	...
	if #arg_5_0._scoreTfPool > 0 then
		...
		local var_5_1 = GetComponent(findTF(var_5_0, "ad"), typeof(DftAniEvent))
	...
	local var_5_2 = math.floor(arg_5_1 / 1000)
	local var_5_3 = math.floor(arg_5_1 % 1000 / 100)
	local var_5_4 = math.floor(arg_5_1 % 100 / 10)
	local var_5_5 = math.floor(arg_5_1 % 10)

	arg_5_0:SetScoreText(var_5_0, "thousand", arg_5_1 >= 1000 and var_5_2 or nil)
	arg_5_0:SetScoreText(var_5_0, "hundred", arg_5_1 >= 100 and var_5_3 or nil)
	arg_5_0:SetScoreText(var_5_0, "ten", arg_5_1 >= 10 and var_5_4 or nil)
	arg_5_0:SetScoreText(var_5_0, "one", arg_5_1 >= 0 and var_5_5 or nil)
end
...
function var_0_0.Start(arg_13_0)
	...
	if not var_13_0 or not (#var_13_0 > 0) or not var_13_0[1] then
		local var_13_1 = 0
	end
...
function var_0_0.Step(arg_14_0, arg_14_1)
	if arg_14_0._time ~= arg_14_0._gameVo:GetTimeInteger() then
		...
		local var_14_0 = math.floor(arg_14_0._time / 60)
		local var_14_1 = math.floor(arg_14_0._time % 60)

		setText(arg_14_0.timeTF, string.format("%02d : %02d", var_14_0, var_14_1))
	end
...
function var_0_0.StepScoreTween(arg_15_0, arg_15_1)
	for iter_15_0 = #arg_15_0._scoreTfTweenDic, 1, -1 do
		local var_15_0 = arg_15_0._scoreTfTweenDic[iter_15_0]

		if var_15_0 and not var_15_0.finish then
			if var_15_0.show and var_15_0.show > 0 then
				var_15_0.show = var_15_0.show - arg_15_1

				if var_15_0.show <= 0 then
					var_15_0.show = nil
				end
			else
				local var_15_1, var_15_2, var_15_3, var_15_4 = arg_15_0:GetSmoothOffset(var_15_0.start, arg_15_0.scoreTextTf.position, arg_15_1, 0.75, var_15_0.state)

				if var_15_0.tf then
					var_15_0.tf.position = var_15_2
				end

				var_15_0.state = var_15_4

				if var_15_3 then
					var_15_0.finish = true

					if var_15_0.tf then
						GetComponent(findTF(var_15_0.tf, "ad"), typeof(Animator)):SetTrigger("hide")
						table.insert(arg_15_0._scoreTfPool, var_15_0.tf)
...
function var_0_0.StepTimeToScore(arg_22_0)
	...
	local var_22_1 = 3
	local var_22_2 = arg_22_0._gameVo:GetTimeInteger() / var_22_1

	arg_22_0._timeToScoreStep = var_22_1 * SortGameConst.time_trans_score
	arg_22_0._timeToScoreTimer = Timer.New(function()
		...
		local var_23_0 = math.floor(arg_22_0._time / 60)
		local var_23_1 = math.floor(arg_22_0._time % 60)

		setText(arg_22_0.timeTF, string.format("%02d : %02d", var_23_0, var_23_1))
...
function var_0_0.GetSmoothOffset(arg_28_0, arg_28_1, arg_28_2, arg_28_3, arg_28_4, arg_28_5)
	...
	local var_28_9 = 0.5 - 0.5 * math.cos(math.pi * var_28_8)
	local var_28_10 = {
		x = var_28_2 + (var_28_5 - var_28_2) * var_28_9,
		y = var_28_3 + (var_28_6 - var_28_3) * var_28_9
	}

	if var_28_4 ~= nil or var_28_7 ~= nil then
		local var_28_11 = var_28_4 or 0

		var_28_10.z = var_28_11 + ((var_28_7 or 0) - var_28_11) * var_28_9
	end

	local var_28_12 = {
		x = var_28_10.x - (arg_28_5.currentPos.x or 0),
		y = var_28_10.y - (arg_28_5.currentPos.y or 0)
	}

	if var_28_10.z ~= nil then
		var_28_12.z = var_28_10.z - (arg_28_5.currentPos.z or 0)
	end

	arg_28_5.currentPos = var_28_10

	local var_28_13 = var_28_1 <= arg_28_5.elapsed
	...
	if var_28_13 then
		...
		if var_28_10.z ~= nil then
			local var_28_14 = var_28_7 or 0

			var_28_12.z = var_28_14 - ((arg_28_5.currentPos.z or 0) - (var_28_12.z or 0))
			arg_28_5.currentPos.z = var_28_14
		end
	end

	return var_28_12, var_28_0(arg_28_5.currentPos), var_28_13, arg_28_5
end
