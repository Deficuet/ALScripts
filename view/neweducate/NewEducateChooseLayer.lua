...
function var_0_0.UpdateView(arg_16_0)
	...
	arg_16_0.type = arg_16_0.config[arg_16_0.choices[1]].type == NewEducateBuff.TYPE.TAROT and var_0_0.TYPE.TAROT or var_0_0.TYPE.ENTYR
...
function var_0_0.UpdateGiveUpBtn(arg_19_0)
	...
	if arg_19_0.tarotId then
		local var_19_0 = arg_19_0.state:IsFromShop() and "shop_disclaim_refund" or "event_disclaim_refund"
		local var_19_1 = arg_19_0.contextData.char:getConfig(var_19_0)
		local var_19_2 = arg_19_0.type == var_0_0.TYPE.TAROT and var_19_1[2] or var_19_1[2]

		setText(arg_19_0.giveupBtn:Find("res/Text"), "+" .. var_19_2[3])
	end
end
...
function var_0_0.UpdateChoices(arg_20_0)
	...
	;(arg_20_0.type == var_0_0.TYPE.TAROT and arg_20_0.tarotUIList or arg_20_0.entryUIList):align(#arg_20_0.choices)
end
...
function var_0_0.UpdateTarotChoice(arg_21_0, arg_21_1, arg_21_2)
	...
	arg_21_0.cards[var_21_0]:Update(var_21_1)
...
function var_0_0.UpdateEntryChoice(arg_25_0, arg_25_1, arg_25_2)
	...
	arg_25_0.cards[var_25_0]:Update(var_25_1)
...
function var_0_0.UpdateRefreshBtn(arg_27_0, arg_27_1, arg_27_2, arg_27_3)
	...
	local var_27_1 = (arg_27_0.type == var_0_0.TYPE.TAROT and arg_27_0.tarotRefreshCnt or arg_27_0.entryRefreshCnt) - var_27_0
	local var_27_2 = arg_27_0.refreshCnt > 0 and var_27_1 > 0
	local var_27_3 = arg_27_0:IsPoolEmpty()

	setText(arg_27_2:Find("Text"), math.min(var_27_1, arg_27_0.refreshCnt))
	setText(arg_27_3:Find("Text"), math.min(var_27_1, arg_27_0.refreshCnt))
...
function var_0_0.GetUIList(arg_30_0)
	return arg_30_0.type == var_0_0.TYPE.TAROT and arg_30_0.tarotUIList or arg_30_0.entryUIList
end
...
function var_0_0.OnRefreshDone(arg_35_0, arg_35_1)
	...
	eachChild(arg_35_0:GetUIList().container, function(arg_36_0)
		if tonumber(arg_36_0.name) == arg_35_1.idx then
			...
			local var_36_1 = arg_35_0.type == var_0_0.TYPE.TAROT and "Anim_Neweducate_talent_tpl_change" or "Anim_Neweducate_tentry_tpl_change1"

			arg_36_0:GetComponent(typeof(Animation)):Play(var_36_1)
		end
	end)
end
