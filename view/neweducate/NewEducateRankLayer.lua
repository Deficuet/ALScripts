...
function var_0_0.didEnter(arg_3_0)
	...
	for iter_3_0, iter_3_1 in pairs(arg_3_0.toggleTFs) do
		onToggle(arg_3_0, iter_3_1, function(arg_5_0)
			...
			quickPlayAnimation(iter_3_1, var_5_0)
		end, SFX_PANEL)
	end
...
function var_0_0.OnInitItem(arg_9_0, arg_9_1)
	local var_9_0 = NewEducateRankCard.New(arg_9_1, NewEducateRankCard.TYPE_OTHER, arg_9_0)
...
function var_0_0.UpdateView(arg_11_0)
	...
	if not arg_11_0.rankVOs[arg_11_0.curType] or getProxy(BillboardProxy):canFetch(arg_11_0.curType, arg_11_0.charId) then
...
function var_0_0.UpdataRankList(arg_12_0)
	...
	local var_12_1 = arg_12_0.playerRankVOs[arg_12_0.curType]

	setActive(arg_12_0.playerRankTF, var_12_1)

	if var_12_1 then
		arg_12_0.playerCard:Update(var_12_1, arg_12_0.curType)
	end
end
