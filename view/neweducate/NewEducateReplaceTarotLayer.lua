...
function var_0_0.CheckState(arg_8_0)
	...
	if arg_8_0.state:IsFinish() then
		local var_8_0 = arg_8_0.contextData.char:GetTarotId()
		local var_8_1 = arg_8_0.state:GetHoldId() == var_8_0 and 0 or arg_8_0.state:GetHoldId()

		arg_8_0:emit(NewEducateReplaceTarotMediator.ON_REPLACE_TAROT, var_8_1)
	else
		arg_8_0:closeView()
	end
end
