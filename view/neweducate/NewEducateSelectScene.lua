...
function var_0_0.didEnter(arg_6_0)
	...
	onToggle(arg_6_0, arg_6_0.hardToggle, function(arg_13_0)
		...
		quickPlayAnimation(arg_6_0._tf:Find("root/window"), var_13_0)
		setActive(arg_6_0.hardSureBtn, arg_13_0)
		setActive(arg_6_0.sureBtn, not arg_13_0)

		local var_13_1 = arg_6_0.infos[arg_6_0.selectedId]

		setText(arg_6_0.gameTF, (arg_13_0 and i18n("child2_hard") or "") .. i18n("child2_game_cnt", var_13_1.gameCnt))
	end, SFX_PANEL)
	arg_6_0:InitData()
...
function var_0_0.UpdataInfo(arg_15_0)
	...
	setActive(arg_15_0.hardTF, var_15_1)
...
function var_0_0.CheckGuide(arg_25_0, arg_25_1)
	if arg_25_1 and not pg.NewStoryMgr.GetInstance():IsPlayed("tb2_19") then
