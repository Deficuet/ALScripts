...
function var_0_0.didEnter(arg_3_0)
	...
	arg_3_0.pctUIList:make(function(arg_13_0, arg_13_1, arg_13_2)
		...
		local var_13_1 = NewEducateHelper.GetDropConfig(var_13_0)
		...
		elseif arg_13_0 == UIItemList.EventUpdate then
			local var_13_2 = arg_3_0.summaryToggleTF:GetComponent(typeof(Toggle)).isOn
			local var_13_3 = arg_3_0.showPctList[arg_13_1 + 1].a
			local var_13_4 = arg_3_0.showPctList[arg_13_1 + 1].b

			setText(arg_13_2:Find("Text"), (var_13_2 and var_13_4 or var_13_3) .. "%")
			setText(arg_13_2:Find("info/content/name"), var_13_1.name)

			local var_13_5 = i18n("child2_benefit_summary") .. var_13_3 .. "%" .. "\n" .. i18n("child2_benefit_summary2") .. var_13_4 .. "%"

			setText(arg_13_2:Find("info/content/desc"), var_13_5)

			local var_13_6 = arg_3_0.contextData.char:GetOwnCnt(var_13_0)

			if var_13_0.type == NewEducateConst.DROP_TYPE.ATTR then
				local var_13_7, var_13_8 = NewEducateInfoPanel.GetArrtInfo(var_13_1.rank, var_13_6)

				setText(arg_13_2:Find("info/content/value"), var_13_8)
			else
...
function var_0_0.UpdateRight(arg_19_0)
	...
	setActive(arg_19_0.upgradeTF, var_19_0)
...
function var_0_0.UpdataUpgrade(arg_20_0)
	...
	setText(arg_20_0.upgradeTF:Find("name"), var_20_0.name)
	...
	local var_20_1 = var_20_0.next_level

	setText(arg_20_0.upgradeTF:Find("after/level/Text"), "LV." .. arg_20_0.config[var_20_1].benefit_level)
...
function var_0_0.UpdateSummary(arg_22_0)
	...
	local var_22_4 = PlayerPrefs.GetInt(arg_22_0:GetBenefitShowLocalKey())

	triggerToggle(arg_22_0.summaryToggleTF, var_22_4 == 1)
end
...
function var_0_0.GetGoBtnVisibility(arg_25_0)
	...
	if arg_25_0.contextData.char:GetFSM():CheckStystem() == NewEducateFSM.SYSTEM.ENDING then
		return false
	end

	if arg_25_0.contextData.char:GetFSM():GetSystemNo() == NewEducateFSM.SYSTEM.ENDING then
		return false
	end
...
function var_0_0.OnInitItem(arg_26_0, arg_26_1)
	local var_26_0 = NewEducateEntryCard.New(arg_26_1)
