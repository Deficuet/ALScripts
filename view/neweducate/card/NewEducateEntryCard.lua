...
function var_0_0.Update(arg_2_0, arg_2_1)
	...
	local var_2_0 = arg_2_0.config.benefit_level > 1 and "bg_entry_2" or "bg_entry"

	LoadImageSpriteAtlasAsync("ui/neweducateentrycard_atlas", var_2_0, arg_2_0._tf:Find("icon"))
end

function var_0_0.UpdateDescMode(arg_3_0, arg_3_1)
	arg_3_0.descText.text = arg_3_1 and arg_3_0.config.desc or arg_3_0.config.simple_desc
end

function var_0_0.UpdateCountDesc(arg_4_0)
	local var_4_0 = getProxy(NewEducateProxy):GetCurChar():GetBenefitData()
	local var_4_1 = Clone(arg_4_0.config.count_desc)
	local var_4_2 = string.gsub(var_4_1, "{(%d+),%$val}", function(arg_5_0)
		return var_4_0:GetBuff(arg_4_0.id):GetDisplayNum(arg_5_0)
	end)
	local var_4_3 = var_4_0:GetDisplayCounterData(arg_4_0.config.debuff_tag)
	...
	arg_4_0.countText.text = var_4_2
end
...
function var_0_0.StaticShow(arg_8_0, arg_8_1)
	...
	setText(arg_8_0:Find("level/Text"), GetRomanDigitPlus(var_8_0.rare))
	...
	local var_8_1 = var_8_0.benefit_level > 1 and "bg_entry_2" or "bg_entry"

	LoadImageSpriteAtlasAsync("ui/neweducateentrycard_atlas", var_8_1, arg_8_0:Find("icon"))
end
