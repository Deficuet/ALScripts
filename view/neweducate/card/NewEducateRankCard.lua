...
function var_0_0.Update(arg_2_0, arg_2_1, arg_2_2)
	...
	setActive(arg_2_0.rankText, var_2_3 and var_2_0 > 3)
	setActive(arg_2_0.notOnTF, not var_2_3)

	local var_2_4 = "qicon/" .. pg.ship_skin_template[arg_2_1.skinId].prefab

	GetImageSpriteFromAtlasAsync(var_2_4, "", arg_2_0.iconTF)
end
