...
function var_0_0.StaticShow(arg_5_0, arg_5_1)
	local var_5_0 = pg.child2_benefit_list[arg_5_1]

	setText(arg_5_0:Find("simple/name/Text"), var_5_0.name)
	setText(arg_5_0:Find("detail/name"), var_5_0.name)
	setText(arg_5_0:Find("simple/desc/Text"), var_5_0.simple_desc)
	setText(arg_5_0:Find("detail/desc/Text"), var_5_0.desc)
	LoadImageSpriteAsync("neweducateicon/" .. var_5_0.item_icon, arg_5_0:Find("icon"))
end
