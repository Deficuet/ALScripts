...
function var_0_0.didEnter(arg_4_0)
	...
	eachChild(arg_4_0.togglesTF, function(arg_6_0)
		...
		setText(arg_6_0:Find("name"), var_0_2[var_6_0])
		onButton(arg_4_0, arg_6_0, function()
			arg_4_0.animCom:Play("anim_NewEducateBuffUI_left_click")

			local var_7_0 = tonumber(arg_6_0.name)

			arg_4_0:SwtichView(var_7_0)
		end, SFX_PANEL)
	end)
...
function var_0_0.InitData(arg_12_0)
	...
	for iter_12_0, iter_12_1 in pairs(arg_12_0.allIdMap) do
		local var_12_0 = arg_12_0.pageTFs[iter_12_0]:Find("content").childCount

		arg_12_0.pageAllCntMap[iter_12_0] = math.ceil(#iter_12_1 / var_12_0)
	end
end
...
function var_0_0.UpdatePage(arg_27_0)
	...
	if var_27_1 < arg_27_0.curPageIdx then
	...
	local var_27_4 = arg_27_0.curType == NewEducateBuff.TYPE.TALENT and var_27_1 <= arg_27_0.curPageIdx

	setActive(arg_27_0.nextBtn, not var_27_4)

	local var_27_5 = arg_27_0.curType == NewEducateBuff.TYPE.TAROT and arg_27_0.curPageIdx <= 1

	setActive(arg_27_0.lastBtn, not var_27_5)
	setText(var_27_0:Find("pagination"), arg_27_0.curPageIdx .. "/" .. var_27_1)

	local var_27_6 = var_27_0:Find("content")
	local var_27_7 = var_27_6.childCount
	local var_27_8 = (arg_27_0.curPageIdx - 1) * var_27_7

	for iter_27_0 = 1, var_27_7 do
		local var_27_9 = var_27_6:Find(tostring(iter_27_0))
		local var_27_10 = arg_27_0.allIdMap[arg_27_0.curType][var_27_8 + iter_27_0]

		if var_27_10 then
			setActive(var_27_9, true)
			arg_27_0:UpdateItem(var_27_10, var_27_9)
		else
			setActive(var_27_9, false)
		end
	end
end
...
function var_0_0.UpdateItem(arg_28_0, arg_28_1, arg_28_2)
	...
	switch(arg_28_0.curType, {
		...
		[NewEducateBuff.TYPE.TALENT] = function()
			...
			LoadImageSpriteAsync("neweducateicon/" .. var_33_0.item_icon, arg_28_2:Find("unlock/icon"))
			setText(arg_28_2:Find("lock/Text"), var_33_0.get)
			setText(arg_28_2:Find("name"), var_33_0.name)
			LoadImageSpriteAtlasAsync("ui/neweducatebuffui_atlas", "rarity_" .. var_33_0.rare, arg_28_2:Find("unlock"))
			onButton(arg_28_0, arg_28_2, function()
				if not var_28_0 then
					return
				end
...
function var_0_0.ShowDetailBox(arg_35_0, arg_35_1, arg_35_2)
	...
	switch(arg_35_0.curType, {
		...
		[NewEducateBuff.TYPE.TALENT] = function()
			...
			local var_39_1 = var_35_0:Find("bg/talent")

			LoadImageSpriteAsync("neweducateicon/" .. var_39_0.item_icon, var_39_1:Find("rarity/icon"))
			setText(var_39_1:Find("name"), var_39_0.name)
			setText(var_39_1:Find("level"), "LV." .. var_39_0.benefit_level)
			setText(var_39_1:Find("desc/Text"), var_39_0.desc)
			LoadImageSpriteAtlasAsync("ui/neweducatebuffui_atlas", "rarity_" .. var_39_0.rare, var_39_1:Find("rarity"))
		end
	})
end
...
function var_0_0.ShowEntryBox(arg_40_0, arg_40_1, arg_40_2, arg_40_3)
	...
	table.sort(var_40_0, CompareFuncs({
		function(arg_41_0)
	...
	UIItemList.StaticAlign(arg_40_1:Find("bg/toggles"), arg_40_1:Find("bg/toggles"):GetChild(0), #var_40_0, function(arg_43_0, arg_43_1, arg_43_2)
		if arg_43_0 == UIItemList.EventUpdate then
			local var_43_0 = var_40_0[arg_43_1 + 1]
			local var_43_1 = arg_40_0.config[var_43_0]
			local var_43_2 = var_43_1.benefit_level

			arg_43_2.name = tostring(var_43_0)

			setText(arg_43_2:Find("sel/Text"), "LV." .. var_43_2)
			setText(arg_43_2:Find("unsel/Text"), "LV." .. var_43_2)

			local var_43_3 = table.contains(arg_40_0.unlockEntryIds, var_43_0)
