...
function var_0_0.OnInit(arg_3_0)
	...
	LoadImageSpriteAsync("neweducateicon/" .. var_3_1, arg_3_0.personalityTF:Find("tag1"), true)

	local var_3_2 = underscore.detect(var_3_0, function(arg_5_0)
		return arg_5_0[1] == "tag2"
	end)[2]

	LoadImageSpriteAsync("neweducateicon/" .. var_3_2, arg_3_0.personalityTF:Find("tag2"), true)
end

function var_0_0.FlushPersonality(arg_6_0, arg_6_1, arg_6_2)
	arg_6_0:Show()

	local var_6_0 = arg_6_1 > 0 and arg_6_0.personalityTF:Find("tag2") or arg_6_0.personalityTF:Find("tag1")

	seriesAsync({
		function(arg_7_0)
			local var_7_0 = arg_6_1 > 0 and arg_6_0.contextData.char:GetPersonalityTagTip(2) or arg_6_0.contextData.char:GetPersonalityTagTip(1)
		...
		function(arg_9_0)
			...
			if var_9_0 ~= arg_6_2 then
				...
				local var_9_1 = var_9_0 == "tag1" and "Anim_educate_personality_2to1" or "Anim_educate_personality_1to2"

				arg_6_0.animCom:Play(var_9_1)
			else
				arg_9_0()
			end
		end
