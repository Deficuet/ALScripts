...
function var_0_0.Flush(arg_11_0)
	local var_11_0 = pg.child2_site_display[arg_11_0.siteId]

	if var_11_0.type == NewEducateConst.SITE_TYPE.SHOP then
		setText(arg_11_0.shopTF:Find("title"), var_11_0.title)
		setText(arg_11_0.shopRefreshTF:Find("cost/Text"), arg_11_0.shopRefreshCost)
		arg_11_0:ShowShop()
	else
		arg_11_0:ShowNormal(var_11_0)
	end
end

function var_0_0.UpdateCost(arg_12_0, arg_12_1, arg_12_2)
	local var_12_0 = NewEducateHelper.GetDropConfig(arg_12_2).icon

	LoadImageSpriteAsync("neweducateicon/" .. var_12_0, arg_12_1:Find("Image"))
...
function var_0_0.ShowNormal(arg_13_0, arg_13_1)
	...
	switch(arg_13_1.type, {
		[NewEducateConst.SITE_TYPE.WORK] = function()
			local var_16_0 = arg_13_0.contextData.char:GetNormalIdByType(NewEducateConst.SITE_NORMAL_TYPE.WORK)
			local var_16_1 = pg.child2_site_normal[var_16_0]

			var_13_3 = var_16_1.title
			var_13_2 = NewEducateHelper.Config2Drop(var_16_1.cost)

			function var_13_4()
				arg_13_0:emit(NewEducateMapMediator.ON_SITE_NORMAL, var_16_1.id)
			end
		end,
		[NewEducateConst.SITE_TYPE.TRAVEL] = function()
			local var_18_0 = arg_13_0.contextData.char:GetNormalIdByType(NewEducateConst.SITE_NORMAL_TYPE.TRAVEL)
			local var_18_1 = pg.child2_site_normal[var_18_0]

			var_13_3 = var_18_1.title
			var_13_2 = NewEducateHelper.Config2Drop(var_18_1.cost)

			function var_13_4()
				arg_13_0:emit(NewEducateMapMediator.ON_SITE_NORMAL, var_18_1.id)
			end
		end,
		[NewEducateConst.SITE_TYPE.SHIP] = function()
			local var_20_0 = pg.child2_site_character[arg_13_1.param]

			var_13_3 = var_20_0.option_name
			var_13_2 = NewEducateHelper.Config2Drop(var_20_0.cost)
		...
		[NewEducateConst.SITE_TYPE.EVENT] = function()
			...
			var_13_3 = var_22_0.option_word
			var_13_2 = NewEducateHelper.Config2Drop(var_22_0.event_cost)
	...
	setScrollText(arg_13_0.enterTF:Find("mask/Text"), var_13_3)
	arg_13_0:UpdateCost(arg_13_0.enterTF:Find("cost"), var_13_2)

	var_13_2.operator = ">="

	local var_13_5 = not arg_13_0.contextData.char:IsMatch(var_13_2)
...
function var_0_0.ShowShop(arg_25_0)
	...
	table.sort(arg_25_0.goods, CompareFuncs({
		function(arg_26_0)
			local var_26_0 = pg.child2_shop[arg_26_0.id].limit_num
...
function var_0_0.UpdateGoodsItem(arg_30_0, arg_30_1, arg_30_2)
	...
	local var_30_4 = var_30_3.number ~= var_30_2.number and "(" .. var_30_3.number .. ")" or ""
...
function var_0_0.ClickBenefitGood(arg_35_0, arg_35_1)
	...
	local var_35_2 = arg_35_0.contextData.char:GetStatus(arg_35_1:getConfig("goods_id"))

	if var_35_2 and var_35_2:getConfig("is_tip") == 0 then
		local var_35_3 = var_35_2:GetEndRound() - arg_35_0.contextData.char:GetRoundData().round
...
function var_0_0.ClickResGood(arg_38_0, arg_38_1)
	local var_38_0 = {}
	local var_38_1 = arg_38_0.contextData.char:GetResIdByType(NewEducateChar.RES_TYPE.ACTION)

	if arg_38_1:getConfig("goods_id") == var_38_1 and arg_38_0.contextData.char:GetPoint(var_38_1) + arg_38_1:getConfig("goods_num") > pg.child2_resource[var_38_1].max_value then
