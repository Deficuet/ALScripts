...
function var_0_0.Update(arg_3_0, arg_3_1, arg_3_2)
	...
	setActive(arg_3_0.detailTF, var_3_1)
...
function var_0_0.FlushNormal(arg_4_0)
	...
	local var_4_6 = var_4_2 > 0 and "39bfff" or "ff6767"

	setTextColor(var_4_5, Color.NewHex(var_4_6))

	local var_4_7 = arg_4_0.detailTF:Find("target/content/value")
	local var_4_8 = arg_4_0.char:GetAttrSum()

	setText(var_4_7, i18n("child2_assess_target", var_4_8, var_4_3))

	local var_4_9 = var_4_3 <= var_4_8 and "39bfff" or "848498"

	setTextColor(var_4_7, Color.NewHex(var_4_9))
end
