...
function var_0_0.OnInitItem(arg_4_0, arg_4_1, arg_4_2)
	...
	local var_4_1 = pg.child2_resource[var_4_0]

	LoadImageSpriteAsync("neweducateicon/" .. var_4_1.icon, arg_4_2:Find("icon"))
...
function var_0_0.OnUpdateItem(arg_6_0, arg_6_1, arg_6_2)
	...
	local var_6_1 = var_6_0.type == NewEducateChar.RES_TYPE.MOOD and "/" .. var_6_0.max_value or ""
