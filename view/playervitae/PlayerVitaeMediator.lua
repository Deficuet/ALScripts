...
function var_0_0.register(arg_1_0)
	...
	arg_1_0:bind(var_0_0.CHANGE_PAINT, function(arg_14_0, arg_14_1)
		local var_14_0 = {}
		local var_14_1 = getProxy(PlayerProxy):getRawData()
		local var_14_2 = var_14_1:GetShipPhantomMarks()

		if arg_14_1 then
			table.removebyvalue(var_14_2, arg_14_1:GetShipPhantomMark())
		end

		arg_1_0.contextData.showSelectCharacters = true

		local var_14_3, var_14_4 = PlayerVitaeShipsPage.GetSlotMaxCnt()
		local var_14_5 = {
			callbackQuit = true,
			selectedMax = var_14_4,
			hideTagFlags = ShipStatus.TAG_HIDE_ADMIRAL,
			selectedIds = var_14_0,
			selectedMarks = var_14_2,
			ignoredIds = pg.ShipFlagMgr.GetInstance():FilterShips({
				isActivityNpc = true
			}),
			onSelected = function(arg_15_0, arg_15_1)
				local var_15_0 = arg_1_0:ReSortShipIds(var_14_1:GetShipPhantomMarks(), arg_15_0)
