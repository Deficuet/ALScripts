...
function var_0_0.OnInit(arg_19_0)
	...
	onButton(arg_19_0, arg_19_0.educateCharSettingBtn, function()
		local var_29_0 = isActive(arg_19_0.educateCharSettingList.container)

		setActive(arg_19_0.educateCharSettingList.container, not var_29_0)
	end, SFX_PANEL)
...
function var_0_0.Update(arg_32_0)
	local var_32_0 = getProxy(SettingsProxy)
	local var_32_1

	if arg_32_0.randomFlag and arg_32_0.nativeFlag then
		var_32_1 = var_0_4
	else
		var_32_1 = var_32_0:IsOpenRandomFlagShip() and var_0_5 or var_0_4
	end
...
function var_0_0.UpdateEducateCharSettings(arg_37_0)
	...
	local function var_37_1()
		local var_38_0 = var_37_0:GetFlagShipDisplayMode()

		setText(arg_37_0.educateCharSettingBtn:Find("Text"), i18n("flagship_display_mode_" .. var_38_0))
	end
	...
	arg_37_0.educateCharSettingList:make(function(arg_39_0, arg_39_1, arg_39_2)
		if arg_39_0 == UIItemList.EventUpdate then
			...
			setText(arg_39_2:Find("Text"), i18n("flagship_display_mode_" .. var_39_0))
	...
	arg_37_0.educateCharSettingList:align(#var_37_2)
	var_37_1()
end
...
function var_0_0.EditCardsForRandom(arg_51_0, arg_51_1)
	local var_51_0 = {}
	local var_51_1 = arg_51_0.cards[var_0_1]
	...
	local var_51_2 = arg_51_0.cards[var_0_2]
...
function var_0_0.SaveRandomSettings(arg_52_0, arg_52_1)
	...
	for iter_52_0 = 1, arg_52_0.max do
		if not arg_52_1[iter_52_0] then
			arg_52_1[iter_52_0] = var_52_0:RawGetRandomShipAndSkinValueInpos(iter_52_0)
		end
	end
