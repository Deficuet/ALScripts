local var_0_0 = {
	...
	GetMaxTeamCnt = function(arg_7_0)
		local var_7_0 = pg.mode_room[arg_7_0].count
		local var_7_1 = 0
...
function var_0_0.IsViewer()
	...
	local var_10_1 = getProxy(PlayerProxy):getPlayerId()

	return table.contains(var_10_0.viewerList, var_10_1)
end
...
function var_0_0.GetUnfullTeamIndex(arg_13_0)
	...
	local var_13_1 = pg.mode_room[var_13_0.gameType].count
...
function var_0_0.GetPtScrore(arg_17_0)
	...
	local var_17_1 = getProxy(ActivityProxy):getActivityByType(var_17_0)

	return var_17_1 and var_17_1.data1 or 0
end
...
function var_0_0.GetPtScoreIcon(arg_18_0)
	...
	return switch(var_18_0, {
		[ActivityConst.ACTIVITY_TYPE_ISLAND_CHEAT_BAR] = function()
			...
			local var_19_1 = var_19_0 and var_19_0.data1 or 0
			local var_19_2

			for iter_19_0, iter_19_1 in ipairs(pg.island_integral_rank.all) do
				local var_19_3 = pg.island_integral_rank[iter_19_1]

				if var_19_1 >= var_19_3.lower_limit then
					var_19_2 = var_19_3.icon
				end
			end
...
function var_0_0.SearchRoomList(arg_22_0)
	local var_22_0 = {}
	local var_22_1 = getProxy(PlayRoomProxy):GetPlayRoomList()

	for iter_22_0, iter_22_1 in ipairs(var_22_1) do
		if string.match(arg_22_0, "^%d+$") ~= nil then
			local var_22_2 = tonumber(arg_22_0)

			if iter_22_1.id == var_22_2 then
