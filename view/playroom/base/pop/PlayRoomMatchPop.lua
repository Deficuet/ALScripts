...
function var_0_0.RefreshMatch(arg_10_0)
	...
	local var_10_2 = var_10_0:GetMatchStarTime()
	local var_10_3 = pg.TimeMgr.GetInstance():GetServerTime()
	local var_10_4 = var_10_1 - var_10_3
	local var_10_5 = var_10_3 - var_10_2

	setText(arg_10_0.uiTipsText, i18n("match_ui_matching_waiting1", var_10_5))

	if var_10_4 <= 0 then
		pg.GameTrackerMgr.GetInstance():Record(GameTrackerBuilder.BuildPlayRoomMatch("bar", 2, 1, var_10_5, 0))
