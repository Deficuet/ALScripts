...
function var_0_0.didEnter(arg_3_0, arg_3_1)
	...
	setText(arg_3_0.uiNameText, var_3_1.name)
	...
	if var_3_0 == 0 then
		var_3_2 = getProxy(PlayerProxy):getData():GetFlagShip()
	else
		var_3_2 = Ship.New({
	...
	local var_3_3 = PlayRoomTools.GetPtScoreIcon(PlayRoomTools.GetGameTypeID())

	GetImageSpriteFromAtlasAsync("Island/IslandCheaterTavernIcon/" .. var_3_3, "", arg_3_0.uiPtIcon)
end
