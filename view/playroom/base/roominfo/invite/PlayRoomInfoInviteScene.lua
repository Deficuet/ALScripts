...
function var_0_0.init(arg_2_0)
	...
	onToggle(arg_2_0, arg_2_0.uiFriendToggle, function(arg_5_0)
		...
		arg_2_0.uiFriendText.color = arg_5_0 and Color.NewHex("FEFEFE") or Color.NewHex("6B6E75")
	end, SFX_PANEL)
	onToggle(arg_2_0, arg_2_0.uiGuildToggle, function(arg_6_0)
		...
		arg_2_0.uiGuildText.color = arg_6_0 and Color.NewHex("FEFEFE") or Color.NewHex("6B6E75")
	end, SFX_PANEL)
