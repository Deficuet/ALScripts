...
function var_0_0.IndexItem(arg_11_0, arg_11_1, arg_11_2)
	local var_11_0 = PlayRoomTools.GetHostID() == getProxy(PlayerProxy):getPlayerId()
	local var_11_1 = arg_11_0.viewerList[arg_11_1]

	arg_11_2:didEnter(arg_11_0.roomData.playerDataList[var_11_1], var_11_0)
end
