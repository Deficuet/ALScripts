...
function var_0_0.didEnter(arg_5_0)
	...
	onButton(arg_5_0, arg_5_0.sortBtn, function()
		...
		local var_17_0 = arg_5_0:GetShipList(arg_5_0.mode)

		arg_5_0:FlushShipList(var_17_0)
	end, SFX_PANEL)
...
function var_0_0.GetDockYardShipAndNotInRandom(arg_22_0)
	if not arg_22_0.dockyardShips then
		...
		local var_22_2 = getProxy(BayProxy):getRawData()
...
function var_0_0.OnConfirm(arg_26_0)
	...
	arg_26_0.msgbox:ExecuteAction("Flush", var_26_2, var_26_3, var_26_0, var_26_1)
end
...
function var_0_0.OnFilter(arg_31_0, arg_31_1)
	...
	setActive(arg_31_0.indexBtnSel, var_0_1(var_31_0))
...
function var_0_0.FlushShipList(arg_36_0, arg_36_1)
	...
	arg_36_0.scrollrect:SetTotalCount(var_36_0)
...
function var_0_0.FilterShips(arg_37_0, arg_37_1, arg_37_2)
	...
	local function var_37_3(arg_38_0)
		...
		local var_38_1 = not var_37_1 or not not arg_38_0:IsPreferenceTag()
		local var_38_2 = ShipIndexConst.filterByType(arg_38_0, var_37_2.typeIndex)
		local var_38_3 = ShipIndexConst.filterByCamp(arg_38_0, var_37_2.campIndex)
		local var_38_4 = ShipIndexConst.filterByRarity(arg_38_0, var_37_2.rarityIndex)
		local var_38_5 = ShipIndexConst.filterByExtra(arg_38_0, var_37_2.extraIndex)
...
function var_0_0.SortShips(arg_39_0, arg_39_1)
	...
	local var_39_3, var_39_4 = ShipIndexConst.getSortFuncAndName(var_39_2, var_39_1)

	table.insert(var_39_3, 1, function(arg_40_0)
		return -arg_40_0.activityNpc
	end)
	table.sort(arg_39_1, CompareFuncs(var_39_3))

	arg_39_0.sortTxt.text = i18n(var_39_4)
end
