...
function var_0_0.init(arg_2_0)
	...
	arg_2_0.destroyPage:SetConfirmCallBack(function()
		local var_21_0 = {}
		local var_21_1, var_21_2 = arg_2_0:checkDestroyGold()
		...
		local var_21_3 = underscore.map(arg_2_0.selectedIds, function(arg_23_0)
			return arg_2_0.shipVOsById[arg_23_0]
		end)

		table.insert(var_21_0, function(arg_24_0)
			arg_2_0:checkDestroyShips(var_21_3, arg_24_0)
		end)
...
function var_0_0.SwitchContainerDisplay(arg_28_0)
	...
	switch(tobool(arg_28_0.isPhantomMode), {
		[true] = function()
			...
			local var_29_0 = getProxy(TechnologyProxy)
			local var_29_1 = arg_28_0._tf:Find("main/phantom_container/title/content")
			local var_29_2 = var_29_0:getConfigMaxVersion()

			UIItemList.StaticAlign(var_29_1, var_29_1:GetChild(0), var_29_2 + 1, function(arg_30_0, arg_30_1, arg_30_2)
			...
			if arg_28_0.contextData.techVersion and #underscore.filter(arg_28_0.shipBluePrints, function(arg_36_0)
				...
				var_29_3 = arg_28_0.contextData.techVersion
			end

			arg_28_0.contextData.techVersion = nil

			triggerToggle(arg_28_0._tf:Find("main/phantom_container/title/content"):GetChild(var_29_3), true)
		end,
		[false] = function()
			arg_28_0.initDic = arg_28_0.initDic or {}
			...
			local var_37_0 = _G[arg_28_0.contextData.preView]

			if var_37_0 then
				arg_28_0.sortIndex = var_37_0.sortIndex or ShipIndexConst.SortLevel
				arg_28_0.selectAsc = var_37_0.selectAsc or false
				arg_28_0.typeIndex = var_37_0.typeIndex or ShipIndexConst.TypeAll
				arg_28_0.campIndex = var_37_0.campIndex or ShipIndexConst.CampAll
				arg_28_0.rarityIndex = var_37_0.rarityIndex or ShipIndexConst.RarityAll
				arg_28_0.extraIndex = var_37_0.extraIndex or ShipIndexConst.ExtraAll
				arg_28_0.commonTag = var_37_0.commonTag or Ship.PREFERENCE_TAG_NONE
			elseif arg_28_0.contextData.sortData then
				local var_37_1 = arg_28_0.contextData.sortData

				arg_28_0.sortIndex = var_37_1.sort or ShipIndexConst.SortLevel
				arg_28_0.selectAsc = var_37_1.Asc or false
				arg_28_0.typeIndex = var_37_1.typeIndex or ShipIndexConst.TypeAll
				arg_28_0.campIndex = var_37_1.campIndex or ShipIndexConst.CampAll
				arg_28_0.rarityIndex = var_37_1.rarityIndex or ShipIndexConst.RarityAll
				arg_28_0.extraIndex = var_37_1.extraIndex or ShipIndexConst.ExtraAll
				arg_28_0.commonTag = var_37_1.commonTag or Ship.PREFERENCE_TAG_NONE
			else
				arg_28_0.selectAsc = DockyardScene.selectAsc or false
			...
			local var_37_2 = arg_28_0.attrBtn:Find("off"):GetComponent("Image")
			local var_37_3 = arg_28_0.attrBtn:Find("on"):GetComponent("Image")

			if arg_28_0.isFormTactics then
				GetImageSpriteFromAtlasAsync("ui/dockyardui_atlas", "skill_off", var_37_2)
				GetImageSpriteFromAtlasAsync("ui/dockyardui_atlas", "skill_on", var_37_3)
			else
				GetImageSpriteFromAtlasAsync("ui/dockyardui_atlas", "attr_off", var_37_2)
				GetImageSpriteFromAtlasAsync("ui/dockyardui_atlas", "attr_on", var_37_3)
			end

			triggerButton(arg_28_0.attrBtn)

			if arg_28_0.isRemouldOrUpgradeMode then
				local var_37_4 = getProxy(SettingsProxy)

				arg_28_0.isFilterLevelForMod = var_37_4:GetDockYardLevelBtnFlag()
				...
				arg_28_0.isFilterLockForMod = var_37_4:GetDockYardLockBtnFlag()
...
function var_0_0.OnClickCard(arg_50_0, arg_50_1)
	if arg_50_1.shipVO then
		if not arg_50_0.selecteEnabled then
			...
			pg.CriMgr.GetInstance():PlaySoundEffect_V3(table.contains(arg_50_0.selectedIds, arg_50_1.shipVO.id) and SFX_UI_CANCEL or SFX_UI_FORMATION_SELECT)
	...
	arg_57_0.scrollPhantoms[arg_57_1] = arg_57_0.scrollPhantoms[arg_57_1] or {
		...
		updateSelected = function(arg_58_0, arg_58_1)
			...
			eachChild(arg_58_0.tf:Find("phantoms"), function(arg_59_0, arg_59_1)
				...
				setActive(arg_59_0:Find("selected"), var_59_0 and arg_58_1[var_59_0.phantomId])
			end)
		end,
...
function var_0_0.updatePhantomGroup(arg_61_0, arg_61_1, arg_61_2)
	...
	local var_61_2 = getGameset("technology_shadow_num")[1]
	local var_61_3 = var_61_0.tf:Find("phantoms")

	UIItemList.StaticAlign(var_61_3, var_61_3:GetChild(0), var_61_2, function(arg_64_0, arg_64_1, arg_64_2)
		arg_64_1 = arg_64_1 + 1

		if arg_64_0 == UIItemList.EventUpdate then
			local var_64_0 = var_61_1[arg_64_1 + 1]

			setActive(arg_64_2:Find("skin"), tobool(var_64_0))
			...
			if var_64_0 then
				...
				local var_64_1 = var_64_0:getSkinId()

				changeToScrollText(arg_64_2:Find("skin/name/Text"), pg.ship_skin_template[var_64_1].name)
				setActive(arg_64_2:Find("skin/status"), false)

				local var_64_2 = var_64_0:GetShipPhantomMark()

				setActive(arg_64_2:Find("selected"), underscore.any(arg_61_0.selectedMarks or {}, function(arg_65_0)
					return var_64_2 == arg_65_0
				end))
				...
				triggerToggle(arg_64_2:Find("skin/mark/toggle"), var_64_3)
			else
...
function var_0_0.onUpdateItem(arg_70_0, arg_70_1, arg_70_2)
	...
	local var_70_1 = var_70_0 and var_70_0.id or 0
	...
	var_70_2:updateSelected(var_70_2.shipVO and underscore.any(arg_70_0.selectedIds, function(arg_71_0)
	...
	var_70_2:updateIntimacyEnergy(arg_70_0.contextData.energyDisplay or arg_70_0.sortIndex == ShipIndexConst.SortEnergy)

	local var_70_3 = (arg_70_0.sortIndex == ShipIndexConst.SortIntimacy or arg_70_0.extraIndex == ShipIndexConst.ExtraMarry) and arg_70_0.contextData.mode ~= DockyardScene.MODE_UPGRADE

	var_70_2:updateIntimacy(var_70_3)
end
...
function var_0_0.onReturnItem(arg_72_0, arg_72_1, arg_72_2)
	...
	local var_72_0 = arg_72_0.scrollItems[arg_72_2]
...
function var_0_0.initIndexPanel(arg_74_0)
	onButton(arg_74_0, arg_74_0.indexBtn, function()
		...
		arg_74_0:emit(DockyardMediator.OPEN_DOCKYARD_INDEX, var_75_0)
	end, SFX_PANEL)
	onToggle(arg_74_0, arg_74_0.preferenceBtn, function(arg_77_0)
		if arg_77_0 then
			arg_74_0.commonTag = Ship.PREFERENCE_TAG_COMMON
		else
			arg_74_0.commonTag = Ship.PREFERENCE_TAG_NONE
		end
...
function var_0_0.updateBarInfo(arg_82_0)
	...
	setText(arg_82_0.bottomTipsText, arg_82_0.contextData.leftTopInfo and i18n("dock_yard_left_tips", arg_82_0.contextData.leftTopInfo) or "")
	setActive(arg_82_0.bottomTipsWithFrame, arg_82_0.contextData.leftTopWithFrameInfo)
	setText(arg_82_0.bottomTipsWithFrame:Find("Text"), arg_82_0.contextData.leftTopWithFrameInfo or "")
...
function var_0_0.filter(arg_91_0)
	...
	LoadImageSpriteAtlasAsync("ui/dockyardui_atlas", var_91_0, arg_91_0.indexBtn, true)
	...
	if arg_91_0.contextData.quitTeam then
		...
		table.insert(arg_91_0.shipVOs, var_91_1, false)
	end
	...
	if arg_91_0.contextData.priorEquipUpShipIDList then
		...
		for iter_91_0, iter_91_1 in ipairs(arg_91_0.contextData.priorEquipUpShipIDList) do
			var_91_2[iter_91_1] = true
		end

		for iter_91_2 = #arg_91_0.shipVOs, 1, -1 do
			local var_91_3 = type(arg_91_0.shipVOs[iter_91_2]) == "table" and arg_91_0.shipVOs[iter_91_2].id

			if var_91_2[var_91_3] then
				var_91_2[var_91_3] = table.remove(arg_91_0.shipVOs, iter_91_2)
			end
		end

		for iter_91_3, iter_91_4 in ipairs(arg_91_0.contextData.priorEquipUpShipIDList) do
			local var_91_4 = var_91_2[iter_91_4]

			if type(var_91_4) == "table" then
				var_91_1 = var_91_1 + 1

				table.insert(arg_91_0.shipVOs, var_91_1, var_91_4)
			end
		end
	end

	if var_0_0.MODE_OVERVIEW == arg_91_0.contextData.mode and DockyardScene.value then
		arg_91_0:updateShipCount(DockyardScene.value or 0)
...
function var_0_0.filterCommon(arg_96_0)
	...
	local var_96_2 = arg_96_0.searchBar:GetInputText()
	...
	local var_96_3, var_96_4 = ShipIndexConst.getSortFuncAndName(var_96_0, arg_96_0.selectAsc)

	if (var_96_0 ~= ShipIndexConst.SortIntimacy and true or false) and not defaultValue((arg_96_0.contextData.hideTagFlags or {}).inFleet, ShipStatus.TAG_HIDE_BASE.inFleet) then
	...
	setText(arg_96_0.sortBtn:Find("Image"), i18n(var_96_4))
end
...
function var_0_0.didEnter(arg_109_0)
	...
	setActive(arg_109_0.stampBtn, getProxy(TaskProxy):mingshiTouchFlagEnabled() and arg_109_0.contextData.mode ~= var_0_0.MODE_GUILD_BOSS)
	...
	onButton(arg_109_0, arg_109_0.viewEquipmentBtn, function()
		local var_114_0 = arg_109_0.selectedIds[#arg_109_0.selectedIds]

		if not var_114_0 then
			return
		end

		local var_114_1 = arg_109_0.shipVOsById[var_114_0]
		local var_114_2 = var_114_1.user

		arg_109_0.guildShipEquipmentsPage:ExecuteAction("Show", var_114_1, var_114_2)
	end, SFX_PANEL)
	onButton(arg_109_0, arg_109_0.attrBtn, function()
		if not arg_109_0.isFormTactics then
			...
			arg_109_0.itemDetailType = arg_109_0.itemDetailType == DockyardShipItem.DetailType0 and DockyardShipItem.DetailType3 or DockyardShipItem.DetailType0
		end
		...
		arg_109_0.attrBtn:GetComponent("Button").targetGraphic = arg_109_0.itemDetailType == DockyardShipItem.DetailType0 and imageOff or imageOn
	...
	onButton(arg_109_0, arg_109_0.selectPanel:Find("quick_select"), function()
		...
		for iter_125_0, iter_125_1 in pairs(var_125_0) do
			if iter_125_1 ~= 0 then
				var_125_2[iter_125_1] = var_125_2[iter_125_1] or var_125_1
				var_125_1 = var_125_1 - 1
			end
		end

		local var_125_3 = getProxy(BayProxy):getShips()
		local var_125_4 = {}
		local var_125_5 = {}

		for iter_125_2, iter_125_3 in pairs(var_125_3) do
			if iter_125_3:isMaxStar() then
				var_125_4[iter_125_3:getGroupId()] = true
			else
				local var_125_6 = iter_125_3:getMaxStar() - iter_125_3:getStar() + 1

				if iter_125_3:GetLockState() == Ship.LOCK_STATE_UNLOCK then
					var_125_6 = var_125_6 + 1
				end

				local var_125_7 = var_125_5[iter_125_3:getGroupId()]

				var_125_5[iter_125_3:getGroupId()] = var_125_7 and var_125_7 < var_125_6 and var_125_7 or var_125_6
			end
		end

		local var_125_8 = _.select(arg_109_0.shipVOs, function(arg_126_0)
			return arg_126_0.configId ~= 100001 and arg_126_0.configId ~= 100011 and arg_126_0:GetLockState() == Ship.LOCK_STATE_UNLOCK and table.contains(var_125_0, arg_126_0:getRarity()) and arg_126_0.level == 1 and not arg_109_0.blacklist[arg_126_0:getGroupId()] and not table.contains(arg_109_0.selectedIds, arg_126_0.id) and not arg_126_0:hasAnyFlag({
				"inFleet",
				"inChapter",
				"inWorld",
				"inEvent",
		...
		if not _.all(var_125_8, function(arg_127_0)
			return arg_109_0.blacklist[arg_127_0:getGroupId()]
		end) then
			var_125_8 = _.select(var_125_8, function(arg_128_0)
		...
		table.sort(var_125_8, function(arg_129_0, arg_129_1)
			local var_129_0 = var_125_2[arg_129_0:getRarity()] or 0
			local var_129_1 = var_125_2[arg_129_1:getRarity()] or 0
		...
		local var_125_9 = PlayerPrefs.GetString("QuickSelectWhenHasAtLeastOneMaxstar", "KeepNone")
		local var_125_10 = PlayerPrefs.GetString("QuickSelectWithoutMaxstar", "KeepAll")
		local var_125_11 = {}
		local var_125_12 = _.select(var_125_8, function(arg_130_0)
			if var_125_4[arg_130_0:getGroupId()] then
				if var_125_9 == "KeepNone" then
					return true
				elseif var_125_9 == "KeepOne" then
					if not var_125_11[arg_130_0:getGroupId()] then
						var_125_11[arg_130_0:getGroupId()] = true
			...
			elseif var_125_10 == "KeepNone" then
				return true
			elseif var_125_10 == "KeepNeeded" then
				if var_125_5[arg_130_0:getGroupId()] > 0 then
					var_125_5[arg_130_0:getGroupId()] = var_125_5[arg_130_0:getGroupId()] - 1

					return false
				end

				return true
			elseif var_125_10 == "KeepAll" then
				return false
			end
		end)
		local var_125_13 = 0
		local var_125_14 = false
		local var_125_15 = false
		local var_125_16 = 0
		local var_125_17 = 0

		for iter_125_4, iter_125_5 in ipairs(arg_109_0.selectedIds) do
			local var_125_18, var_125_19 = arg_109_0.shipVOsById[iter_125_5]:calReturnRes()

			var_125_16 = var_125_16 + var_125_18
			var_125_17 = var_125_17 + var_125_19
		end

		for iter_125_6, iter_125_7 in ipairs(var_125_12) do
			if arg_109_0.selectedMax > 0 and arg_109_0.selectedMax <= arg_109_0:GetSelectCount() then
				break
			end

			local var_125_20, var_125_21 = iter_125_7:calReturnRes()

			var_125_16 = var_125_16 + var_125_20
			var_125_17 = var_125_17 + var_125_21
			var_125_14 = arg_109_0.player:OilMax(var_125_17)
			var_125_15 = arg_109_0.player:GoldMax(var_125_16)

			if var_125_15 then
				break
			end

			var_125_13 = var_125_13 + 1

			arg_109_0:selectShip(iter_125_7)
		end

		if var_125_13 == 0 then
			if var_125_15 then
				if #arg_109_0.selectedIds == 0 then
					pg.TipsMgr.GetInstance():ShowTips(i18n("gold_max_tip_title") .. i18n("resource_max_tip_retire"))
				else
...
function var_0_0.TriggerCard(arg_134_0, arg_134_1)
	...
	local function var_134_4()
		...
		local var_135_0 = arg_134_0.shipVOs[var_134_2]

		if not var_135_0 or arg_134_0.checkShip(var_135_0) then
			return var_135_0
		else
			return var_134_4()
		end
	...
	local function var_134_6()
		...
		for iter_136_0, iter_136_1 in pairs(arg_134_0.scrollItems) do
	...
	local var_134_7 = arg_134_0.cardItemDic[var_134_0]
	local var_134_8 = var_134_7 and arg_134_0.scrollItems[var_134_7]
	local var_134_9 = var_134_8 and var_134_8.shipVO.id == var_134_5.id and var_134_8 or nil

	if var_134_9 then
		local var_134_10 = getBounds(arg_134_0._tf:Find("main/ship_container"))
		local var_134_11 = getBounds(var_134_9.tr)

		if not var_134_10:Intersects(var_134_11) then
			local var_134_12 = arg_134_1 * (arg_134_0.shipContainer:HeadIndexToValue(7) - arg_134_0.shipContainer:HeadIndexToValue(1))
			local var_134_13 = arg_134_0.shipContainer.value + var_134_12

			arg_134_0.shipContainer:SetNormalizedPosition(var_134_13, 1)
		end
	end

	if not var_134_9 then
		local var_134_14 = (math.ceil(var_134_2 / 7) - math.ceil(var_134_1 / 7)) * (arg_134_0.shipContainer:HeadIndexToValue(21) - arg_134_0.shipContainer:HeadIndexToValue(1))
		local var_134_15 = arg_134_0.shipContainer.value + var_134_14

		arg_134_0.shipContainer:SetNormalizedPosition(var_134_15, 1)

		var_134_9 = var_134_6()
	end

	if var_134_9 then
		triggerButton(var_134_9.tr)

		local var_134_16 = arg_134_0.shipVOsById[var_134_9.shipVO.id]

		arg_134_0.guildShipEquipmentsPage:Refresh(var_134_16, var_134_16.user)
	end
end
...
function var_0_0.OnShipSkinChanged(arg_140_0, arg_140_1)
	...
	local var_140_2 = arg_140_0.phantomGroupDic[var_140_0]
	local var_140_3 = var_140_2 and arg_140_0.scrollPhantoms[var_140_2]

	if var_140_3 and var_140_3.shipCard.shipVO.id == var_140_0 then
...
function var_0_0.updateShipStatusById(arg_143_0, arg_143_1)
	local var_143_0 = arg_143_0.cardItemDic[arg_143_1]
	local var_143_1 = var_143_0 and arg_143_0.scrollItems[var_143_0]

	if var_143_1 and var_143_1.shipVO.id == arg_143_1 then
		var_143_1:flush(arg_143_0.selectedIds)

		if arg_143_0.contextData.mode == DockyardScene.MODE_WORLD then
			var_143_1:updateWorld()
		end
	end
end
...
function var_0_0.selectShip(arg_145_0, arg_145_1)
	...
	if var_145_0 or arg_145_0.selectedMax == 1 and arg_145_0:GetSelectCount() > 0 then
		...
		if not var_145_4 then
			if var_145_5 then
				pg.TipsMgr.GetInstance():ShowTips(var_145_5)
			end
		...
		if arg_145_0.selectedMax ~= 1 then
			arg_145_0:updateBlackBlocks(var_145_3)
		end
	end
	...
	if not var_145_0 then
		...
		if not var_145_6 then
			if var_145_7 then
				pg.TipsMgr.GetInstance():ShowTips(var_145_7)
			end
...
function var_0_0.updateSelected(arg_151_0)
	if arg_151_0.shipContainer then
		for iter_151_0, iter_151_1 in pairs(arg_151_0.scrollItems) do
			if not iter_151_1.isClear then
				...
				iter_151_1:updateSelected(iter_151_1.shipVO and underscore.any(arg_151_0.selectedIds, function(arg_152_0)
	...
	if arg_151_0.phantomContainer then
		for iter_151_2, iter_151_3 in pairs(arg_151_0.scrollPhantoms) do
			if not iter_151_3.isClear then
				...
				local var_151_2 = {}
				local var_151_3 = getGameset("technology_shadow_num")[1]

				for iter_151_4 = 0, var_151_3 do
					if iter_151_4 == 0 then
						var_151_2[iter_151_4] = underscore.any(arg_151_0.selectedIds, function(arg_153_0)
							return var_151_1 == arg_153_0
						end)
					else
						var_151_2[iter_151_4] = underscore.any(arg_151_0.selectedMarks, function(arg_154_0)
	...
	if arg_151_0.selectedMax == 0 then
		...
		local var_151_4 = arg_151_0:GetSelectCount()

		if arg_151_0.contextData.mode ~= var_0_0.MODE_DESTROY or arg_151_0:GetSelectCount() == 0 then
			var_151_4 = setColorStr(var_151_4, COLOR_WHITE)
		elseif arg_151_0.contextData.mode == var_0_0.MODE_DESTROY then
			var_151_4 = setColorStr(var_151_4, #arg_151_0.selectedIds == 10 and COLOR_RED or COLOR_GREEN)
		end

		setText(arg_151_0.selectPanel:Find("bottom_info/bg_input/count"), var_151_4 .. "/" .. arg_151_0.selectedMax)
	end
...
function var_0_0.updateDestroyRes(arg_157_0)
	...
	local var_157_0 = _.map(arg_157_0.selectedIds, function(arg_158_0)
		return arg_157_0.shipVOsById[arg_158_0]
	end)
	local var_157_1, var_157_2, var_157_3 = ShipCalcHelper.CalcDestoryRes(var_157_0)
	...
	if arg_157_0.destroyResList then
		...
		arg_157_0.destroyResList:make(function(arg_159_0, arg_159_1, arg_159_2)
			if arg_159_0 == UIItemList.EventUpdate then
				...
				if arg_159_1 == 0 then
					var_159_0, var_159_1 = "Props/gold", var_157_1
				elseif arg_159_1 == 1 then
					if not var_157_4 then
						var_159_0, var_159_1 = "Props/oil", var_157_2
					else
						local var_159_2 = var_157_3[1]

						var_159_0, var_159_1 = Item.getConfigData(var_159_2.id).icon, var_159_2.count
					end
				elseif arg_159_1 > 1 then
					local var_159_3 = var_157_4 and var_157_3[arg_159_1] or var_157_3[arg_159_1 - 1]

					var_159_0, var_159_1 = Item.getConfigData(var_159_3.id).icon, var_159_3.count
				end
		...
		arg_157_0.destroyResList:align(var_157_5)
	end
...
function var_0_0.updateModAttr(arg_161_0)
	...
	for iter_161_0, iter_161_1 in ipairs(arg_161_0.selectedIds) do
		table.insert(var_161_1, arg_161_0.shipVOsById[iter_161_1])
	end

	local var_161_2 = ShipModLayer.getModExpAdditions(arg_161_0.modShip, var_161_1)

	for iter_161_2, iter_161_3 in pairs(ShipModAttr.ID_TO_ATTR) do
		if iter_161_2 ~= ShipModLayer.IGNORE_ID then
			local var_161_3 = arg_161_0.modAttrContainer:Find("attr_" .. iter_161_2)
...
function var_0_0.uiStartAnimating(arg_167_0)
	...
	if isActive(arg_167_0.selectPanel) then
		shiftPanel(arg_167_0.selectPanel, nil, 0, var_167_2, var_167_1, true, true)
	end
end
...
function var_0_0.uiExitAnimating(arg_168_0)
	if arg_168_0.contextData.mode == var_0_0.MODE_OVERVIEW then
		...
		shiftPanel(arg_168_0.selectPanel, nil, -1 * arg_168_0.selectPanel.rect.height, var_168_1, var_168_0, true, true)
	end
end
...
function var_0_0.checkDestroyShips(arg_176_0, arg_176_1, arg_176_2)
	...
	if PlayerPrefs.GetInt("RetireProtect", 1) == 0 then
		...
		if #var_176_1 > 0 then
			table.insert(var_176_0, function(arg_177_0)
				arg_176_0.destroyConfirmWindow:ExecuteAction("ShowOneShipProtect", var_176_1, arg_177_0)
			end)
		end
	end
	...
	if #var_176_6 > 0 then
		table.insert(var_176_0, function(arg_180_0)
			arg_176_0.destroyConfirmWindow:ExecuteAction("ShowEliteTag", var_176_6, arg_180_0)
		end)
	end
