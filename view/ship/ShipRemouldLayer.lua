...
function var_0_0.initShipModel(arg_19_0)
	...
	local var_19_2 = SpineAnimChar.New()

	var_19_2:SetPaint(var_19_0)
	var_19_2:Load(true, function(arg_21_0)
		var_19_1(arg_21_0)
	end)
end
...
function var_0_0.updateFinished(arg_23_0, arg_23_1)
	...
	for iter_23_2 = 1, var_23_3 do
		...
		if iter_23_2 <= #var_23_2 then
			updateDrop(var_23_4:Find("IconTpl"), var_23_2[iter_23_2])
...
function var_0_0.updateProgress(arg_29_0, arg_29_1)
	...
	for iter_29_1 = 1, var_29_9 do
		...
		if iter_29_1 <= #var_29_5 then
			...
			updateDrop(var_29_10:Find("IconTpl"), {
				id = var_29_11[1],
				type = DROP_TYPE_ITEM,
				count = var_29_12
			})
