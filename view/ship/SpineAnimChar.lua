...
function var_0_0.SetAction(arg_12_0, arg_12_1, arg_12_2)
	...
	if not arg_12_0.modelScale then
		arg_12_0.modelScale = tf(arg_12_0._model).localScale
	end

	local var_12_2

	if var_12_1 then
		local var_12_3 = math.abs(arg_12_0.modelScale.x)

		tf(arg_12_0._model).localScale = Vector3(var_12_3, arg_12_0.modelScale.y, arg_12_0.modelScale.z)
	else
		local var_12_4 = math.sign(arg_12_0.modelScale.x)
