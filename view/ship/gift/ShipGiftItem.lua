...
function var_0_0.didEnter(arg_8_0, arg_8_1, arg_8_2, arg_8_3, arg_8_4, arg_8_5)
	...
	setText(arg_8_0.valueText, arg_8_2.count or 0)
	setActive(findTF(arg_8_0.item, "icon_bg/count"), false)

	local var_8_0 = ShipGiftTools.GetItemFavoriteState(arg_8_1, arg_8_2)
	local var_8_1 = GetSpriteFromAtlas("energy", ShipGiftTools.GetItemIntimacySpriteName(arg_8_1, arg_8_2))

	setImageSprite(arg_8_0.favoriteTF, var_8_1)
