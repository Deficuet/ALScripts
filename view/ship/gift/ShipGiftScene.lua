...
function var_0_0.init(arg_3_0)
	arg_3_0.adapt = arg_3_0:findTF("adapt")
	arg_3_0.topPanel = arg_3_0:findTF("adapt/top")
	arg_3_0.backBtn = arg_3_0:findTF("adapt/top/back_btn")
	arg_3_0.homeBtn = arg_3_0:findTF("adapt/top/option")
	arg_3_0.bgTf = arg_3_0:findTF("bgGo")
	arg_3_0.imageGrass = arg_3_0:findTF("bgGo/ImageGrass")
	arg_3_0.character = arg_3_0:findTF("adapt/content")
	arg_3_0.chat = arg_3_0:findTF("adapt/content/chat")
	arg_3_0.chatBg = arg_3_0:findTF("adapt/content/chat/chatbgtop")
	arg_3_0.chatText = arg_3_0:findTF("adapt/content/chat/Text")
	...
	arg_3_0.namePanel = arg_3_0:findTF("adapt/name")
	arg_3_0.shipName = arg_3_0:findTF("adapt/name/nameRect/name_mask/Text")
	arg_3_0.shipNameEn = arg_3_0:findTF("adapt/name/english_name")
	arg_3_0.starts = arg_3_0:findTF("adapt/name/stars")
	arg_3_0.shipInfoStarTpl = arg_3_0:findTF("adapt/name/star_tpl")
	arg_3_0.shipType = arg_3_0:findTF("adapt/name/type")
	arg_3_0.intimacyIcon = arg_3_0:findTF("adapt/intimacy/icon")
	arg_3_0.intimacyValueText = arg_3_0:findTF("adapt/intimacy/value")
	arg_3_0.intimacyAddValueText = GetComponent(arg_3_0:findTF("adapt/intimacy/addValue"), typeof(RectTransform))
	arg_3_0.painting = arg_3_0:findTF("content/paint/fitter", arg_3_0.adapt)
	arg_3_0.l2dParent = arg_3_0:findTF("content/paint/live2d", arg_3_0.adapt)
	arg_3_0.spineParent = arg_3_0:findTF("content/paint/spinePainting", arg_3_0.adapt)
	arg_3_0.effectParent = arg_3_0:findTF("content/paint/effect", arg_3_0.adapt)
	arg_3_0.intimacyAddValuePos = arg_3_0.intimacyAddValueText.localPosition
	arg_3_0.rightPanel = arg_3_0:findTF("adapt/right")
	arg_3_0.scrollRect = GetComponent(arg_3_0:findTF("adapt/right/scrollRect"), "LScrollRect")
	arg_3_0.giftBtn = arg_3_0:findTF("adapt/right/giftBtn")

	setText(arg_3_0:findTF("adapt/right/titlePanel/title/text"), i18n("ship_gift"))
	setText(arg_3_0:findTF("label", arg_3_0.giftBtn), i18n("ship_gift2"))
