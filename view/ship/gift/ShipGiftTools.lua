...
function var_0_0.GetGiftList(arg_1_0)
	...
	local var_1_4 = var_0_0.SortGiftList(var_1_0, arg_1_0)

	table.insertto(var_1_3, var_1_4)
...
function var_0_0.GetNeedMaxCnt(arg_8_0, arg_8_1)
	...
	local var_8_1 = var_0_0.GetShipNeedIntimacyValue(arg_8_0)

	if var_8_1 <= 0 then
		return 0
	end

	local var_8_2 = math.ceil(var_8_1 / var_8_0)

	return var_8_2 < arg_8_1.count and var_8_2 or arg_8_1.count
end
