...
function var_0_0.LoadShip(arg_2_0, arg_2_1, arg_2_2, arg_2_3)
	...
	elseif arg_2_0.l2dCallback and checkABExist(var_2_2) then
		...
		local var_2_4 = SpinePainting.GenerateData(arg_2_3)

		arg_2_0.spinePaintingClass = SpinePainting.New(var_2_4, function(arg_4_0)
...
function var_0_0.GetShipPaintingName(arg_10_0, arg_10_1)
	...
	if arg_10_0:IsHideMeshBg(var_10_1) then
		var_10_1 = string.format("%s_n", var_10_0)
	end

	local var_10_2 = HXSet.autoHxShiftPath(var_10_1)
	local var_10_3 = HXSet.autoHxShiftPath(string.format("spinepainting/%s", var_10_2))
	local var_10_4 = HXSet.autoHxShiftPath(string.format("live2d/%s", var_10_2))

	return var_10_2, var_10_4, var_10_3
end
