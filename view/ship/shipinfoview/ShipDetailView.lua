...
function var_0_0.InitEvent(arg_6_0)
	...
	onToggle(arg_6_0, arg_6_0.commonTagToggle, function(arg_10_0)
		...
		if var_10_1 ~= arg_10_0 then
			if var_10_0 == Ship.PREFERENCE_TAG_COMMON then
				var_10_1 = Ship.PREFERENCE_TAG_NONE
			else
				var_10_1 = Ship.PREFERENCE_TAG_COMMON
			end
	...
	function arg_6_0.list.onUpdateItem(arg_29_0, arg_29_1)
		...
		if arg_29_0 == 0 and not arg_6_0.selectedEquip.empty then
			...
			onButton(arg_6_0, tf(arg_29_1), function()
				...
				local var_30_1 = arg_6_0:GetShipVO()
				local var_30_2 = var_30_1:getEquip(arg_6_0.selectedEquip.index):getConfig("name")
				local var_30_3 = var_30_1:getName()
			...
			local var_29_0 = arg_6_0.selectedEquip.empty and arg_29_0 + 1 or arg_29_0
			...
			if var_29_1.shipId then
				local var_29_2 = getProxy(BayProxy):getShipById(var_29_1.shipId)

				setImageSprite(findTF(tf(arg_29_1), "IconTpl/icon_bg/equip_flag/Image"), LoadSprite("qicon/" .. var_29_2:getPainting()))
			end

			setActive(findTF(tf(arg_29_1), "IconTpl/icon_bg/equip_flag"), var_29_1.shipId and var_29_1.shipId > 0)
	...
	onButton(arg_6_0, arg_6_0.fillter, function()
		...
		arg_6_0:emit(ShipMainMediator.OPEN_EQUIPMENT_INDEX, var_33_0)
	end, SFX_PANEL)
end
...
function var_0_0.changeEquip(arg_36_0, arg_36_1)
	...
	if var_36_2 then
		if PlayerPrefs.GetInt("QUICK_CHANGE_EQUIP", 1) == 1 then
			arg_36_0:emit(BaseUI.ON_EQUIPMENT, var_36_2)
		else
			local var_36_3, var_36_4 = var_36_1:canEquipAtPos(arg_36_1, var_36_0)

			if not var_36_3 then
				pg.TipsMgr.GetInstance():ShowTips(i18n("equipment_equipmentInfoLayer_error_canNotEquip", var_36_4))

				return
			end

			if arg_36_1.shipId then
				local var_36_5 = getProxy(BayProxy):getShipById(arg_36_1.shipId)
				local var_36_6, var_36_7 = ShipStatus.ShipStatusCheck("onModify", var_36_5)

				if not var_36_6 then
					pg.TipsMgr.GetInstance():ShowTips(var_36_7)
				else
...
function var_0_0.OnSelected(arg_39_0, arg_39_1)
	...
	if arg_39_0.onSelected and arg_39_0.selectedEquip then
		local var_39_0 = arg_39_0.selectedEquip.index

		arg_39_0:selectedEquipItem(nil)
		arg_39_0:selectedEquipItem(var_39_0)
	end
end
...
function var_0_0.UpdateUI(arg_40_0)
	...
	triggerToggle(arg_40_0.randomFlagToggle, arg_40_0:GetShipVO():getRandomFlag())
end
...
function var_0_0.UpdateFashionTag(arg_44_0)
	...
	setActive(arg_44_0.fashionTag, #PaintingGroupConst.GetPaintingNameListByShipVO(var_44_0) > 0)
end
...
function var_0_0.UpdateEquipments(arg_45_0, arg_45_1)
	...
	for iter_45_0, iter_45_1 in ipairs(arg_45_1.equipments) do
		...
		if iter_45_1 then
			...
			table.insert(arg_45_0.equipItems, var_45_4)
	...
	elseif arg_45_0.selectedEquip and arg_45_0.isShowQuick then
		local var_45_8 = arg_45_0.selectedEquip.index

		arg_45_0:selectedEquipItem(nil)
		arg_45_0:selectedEquipItem(var_45_8)
	end

	arg_45_0.lastShipVo = arg_45_1.id

	local var_45_9, var_45_10 = arg_45_1:IsSpweaponUnlock()

	setActive(arg_45_0.spWeaponSlot:Find("Lock"), not var_45_9)

	local var_45_11 = arg_45_1:GetSpWeapon()

	setActive(arg_45_0.spWeaponSlot:Find("Icon"), var_45_11)
	setActive(arg_45_0.spWeaponSlot:Find("IconShadow"), var_45_11)

	if var_45_11 then
		UpdateSpWeaponSlot(arg_45_0.spWeaponSlot, var_45_11)
	end

	onButton(arg_45_0, arg_45_0.spWeaponSlot, function()
		if not var_45_9 then
			pg.TipsMgr.GetInstance():ShowTips(i18n(var_45_10))

			return
		elseif var_45_11 then
...
function var_0_0.getEquipments(arg_57_0)
	local var_57_0 = getProxy(BayProxy)
	local var_57_1 = arg_57_0:GetShipVO()
	local var_57_2 = getProxy(EquipmentProxy)
	...
	if arg_57_0.equipingFlag then
		for iter_57_0, iter_57_1 in ipairs(var_57_0:getEquipsInShips(function(arg_58_0, arg_58_1)
			return var_57_1.id ~= arg_58_1 and not var_57_1:isForbiddenAtPos(arg_58_0, arg_57_0.selectedEquip.index)
		end)) do
			if var_57_6 == "" or iter_57_1:IsMatchKey(var_57_6) then
				table.insert(var_57_5, iter_57_1)
			end
		end
	end
	...
	for iter_57_2, iter_57_3 in pairs(var_57_5) do
		if arg_57_0:checkFillter(iter_57_3, var_57_8) and (var_57_6 == "" or iter_57_3:IsMatchKey(var_57_6)) then
			table.insert(var_57_7, iter_57_3)
		end
	end

	_.each(var_57_7, function(arg_59_0)
		if not var_57_1:canEquipAtPos(arg_59_0, arg_57_0.selectedEquip.index) then
			arg_59_0.mask = true
		end
	end)
	table.sort(var_57_7, CompareFuncs(var_0_1.sortFunc(var_0_1.sort[1], false)))

	return var_57_7
end

function var_0_0.checkFillter(arg_60_0, arg_60_1, arg_60_2)
	return (arg_60_1.count > 0 or arg_60_1.shipId and arg_60_0.equipingFlag) and IndexConst.filterEquipByType(arg_60_1, arg_60_0.indexData.typeIndex) and IndexConst.filterEquipByProperty(arg_60_1, arg_60_2) and IndexConst.filterEquipAmmo1(arg_60_1, arg_60_0.indexData.equipAmmoIndex1) and IndexConst.filterEquipAmmo2(arg_60_1, arg_60_0.indexData.equipAmmoIndex2) and IndexConst.filterEquipByCamp(arg_60_1, arg_60_0.indexData.equipCampIndex) and IndexConst.filterEquipByRarity(arg_60_1, arg_60_0.indexData.rarityIndex) and IndexConst.filterEquipByExtra(arg_60_1, arg_60_0.indexData.extraIndex)
end
...
function var_0_0.Show(arg_64_0)
	...
	setActive(arg_64_0.randomFlagToggle, true)
end
...
function var_0_0.UpdateRecordEquipments(arg_71_0, arg_71_1)
	...
	local var_71_1 = arg_71_0:GetShipVO():getEquipmentRecord(arg_71_0.shareData.player.id)[arg_71_1] or {}

	for iter_71_0 = 1, 5 do
		local var_71_2 = tonumber(var_71_1[iter_71_0])
		local var_71_3 = var_71_2 and var_71_2 ~= -1
		local var_71_4 = var_71_0:Find("equipment_" .. iter_71_0)
		local var_71_5 = var_71_4:Find("empty")
		local var_71_6 = var_71_4:Find("info")

		setActive(var_71_6, var_71_3)
		setActive(var_71_5, not var_71_3)

		if var_71_3 then
			local var_71_7 = arg_71_0.equipmentProxy:getEquipmentById(var_71_2)
			local var_71_8 = arg_71_0:GetShipVO().equipments[iter_71_0]
			local var_71_9 = not (var_71_8 and var_71_8.id == var_71_2 or false) and (not var_71_7 or not (var_71_7.count > 0))

			setActive(var_71_6:Find("tip"), var_71_9)
			updateEquipment(var_71_6:Find("IconTpl"), Equipment.New({
				id = var_71_2
			}))

			if var_71_9 then
				onButton(arg_71_0, var_71_6, function()
...
function var_0_0.UpdateRecordSpWeapons(arg_73_0, arg_73_1)
	...
	table.Foreach(arg_73_0.recordBars, function(arg_74_0, arg_74_1)
		...
		local var_74_2 = arg_73_0:GetShipVO():IsSpweaponUnlock()

		setActive(var_74_1:Find("Lock"), not var_74_2)
		...
		if var_74_0 then
			...
			local var_74_3 = arg_73_0:GetShipVO():GetSpWeapon()
...
function var_0_0.clearListener(arg_78_0)
	if arg_78_0.equipItems then
		for iter_78_0 = 1, #arg_78_0.equipItems do
			local var_78_0 = arg_78_0.equipItems[iter_78_0].tf

			if var_78_0 then
				ClearEventTrigger(GetOrAddComponent(go(var_78_0), typeof(EventTriggerListener)))
				removeOnButton(go(var_78_0))
			end
		end
	end
end
