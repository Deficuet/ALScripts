...
function var_0_0.checkToggleActive(arg_11_0, arg_11_1)
	...
	elseif arg_11_1 == ShipViewConst.PAGE.REMOULD then
		return not arg_11_0.shipVO:isTestShip() and not arg_11_0.shipVO:isBluePrintShip() and pg.ship_data_trans[arg_11_0.shipVO.groupId] and not arg_11_0.shipVO:isMetaShip()
	elseif arg_11_1 == ShipViewConst.PAGE.FASHION then
		if not arg_11_0:hasFashion() then
			...
			if not PaintingGroupConst.IsPaintingNeedCheck() then
				...
				local var_11_2 = PaintingGroupConst.GetPaintingNameListByShipVO(arg_11_0.shipVO)

				var_11_1 = PaintingGroupConst.CalcPaintingListSize(var_11_2) > 0
			end
...
function var_0_0.initPages(arg_26_0)
	...
	onButton(arg_26_0, arg_26_0.shipName, function()
		if arg_26_0.shipVO.propose and not arg_26_0.shipVO:IsXIdol() then
			...
			local var_27_0 = arg_26_0.shipVO.renameTime + 2592000 - pg.TimeMgr.GetInstance():GetServerTime()
...
function var_0_0.updatePreference(arg_56_0, arg_56_1)
	...
	local var_56_4 = arg_56_1:getStar()
	local var_56_5 = arg_56_1:getMaxStar()

	for iter_56_0 = 1, var_56_5 do
		local var_56_6 = cloneTplTo(arg_56_0.shipInfoStarTpl, var_56_3, "star_" .. iter_56_0)

		setActive(var_56_6:Find("star_tpl"), iter_56_0 <= var_56_4)
		setActive(var_56_6:Find("empty_star_tpl"), true)
	end
	...
	local var_56_7 = GetSpriteFromAtlas("shiptype", arg_56_1:getShipType())
...
function var_0_0.displayShipWord(arg_65_0, arg_65_1, arg_65_2)
	...
	if arg_65_2 or not arg_65_0.chatFlag then
		...
		if #var_65_4.text > CHAT_POP_STR_LEN then
			var_65_4.alignment = TextAnchor.MiddleLeft
		else
			var_65_4.alignment = TextAnchor.MiddleCenter
		end

		local var_65_5 = var_65_4.preferredHeight + 120

		if var_65_5 > arg_65_0.initChatBgH then
			arg_65_0.chatBg.sizeDelta = Vector2.New(arg_65_0.chatBg.sizeDelta.x, var_65_5)
		else
			arg_65_0.chatBg.sizeDelta = Vector2.New(arg_65_0.chatBg.sizeDelta.x, arg_65_0.initChatBgH)
		end
		...
		local function var_65_7()
			...
			arg_65_0.chatani1Id = LeanTween.scale(rtf(arg_65_0.chat.gameObject), Vector3.New(1, 1, 1), var_0_3):setEase(LeanTweenType.easeOutBack):setOnComplete(System.Action(function()
...
function var_0_0.switchToPage(arg_77_0, arg_77_1, arg_77_2)
	local function var_77_0(arg_78_0, arg_78_1)
		...
		elseif arg_78_0 == ShipViewConst.PAGE.EQUIPMENT then
			...
			shiftPanel(arg_77_0.equipLCon, var_78_1[var_78_5], 0, var_0_2, 0):setFrom(var_78_1[var_78_4])
			shiftPanel(arg_77_0.equipRCon, var_78_2[var_78_5], 0, var_0_2, 0):setFrom(var_78_2[var_78_4])
			shiftPanel(arg_77_0.equipBCon, 0, var_78_3[var_78_5], var_0_2, 0):setFrom(var_78_3[var_78_4])
		elseif arg_78_0 == ShipViewConst.PAGE.FASHION then
			local var_78_6 = arg_78_1 and {
				arg_77_0.fashionContainer.rect.width + 150,
				0
			} or {
				0,
				arg_77_0.fashionContainer.rect.width + 150
			...
			shiftPanel(arg_77_0.fashionContainer, var_78_6[2], 0, var_0_2, 0):setFrom(var_78_6[1])
		...
		local var_78_8 = arg_77_0.bgEffect[arg_77_0.shipVO:getRarity()]

		if var_78_8 then
			setActive(var_78_8, arg_78_0 ~= ShipViewConst.PAGE.REMOULD and arg_77_0.shipVO.bluePrintFlag and arg_77_0.shipVO.bluePrintFlag == 0)
			arg_77_0:changePaintingSortLayer(true)
		end

		setActive(arg_77_0.helpBtn, var_78_7)
	end
	...
	if arg_77_0.viewList[arg_77_1] ~= nil then
		local var_77_1 = arg_77_0.viewList[arg_77_1]

		if not var_77_1:GetLoaded() then
			var_77_1:Load()
			var_77_1:CallbackInvoke(switchHandler)
		else
			switchHandler()
		end
	else
...
function var_0_0.setPreOrNext(arg_83_0, arg_83_1, arg_83_2)
	...
	if arg_83_0.shipVO:getGroupId() ~= arg_83_2:getGroupId() then
		arg_83_0.switchCnt = (arg_83_0.switchCnt or 0) + 1
	end
...
function var_0_0.loadPainting(arg_84_0, arg_84_1, arg_84_2)
	...
	arg_84_1 = MainMeshImagePainting.StaticGetPaintingName(var_84_0)
	...
	if var_84_3 then
		table.insert(var_84_5, function(arg_85_0)
			local var_85_0 = var_84_3:GetComponent(typeof(RectTransform))
			local var_85_1 = var_84_3:GetComponent(typeof(CanvasGroup))

			LeanTween.cancel(go(var_85_1))
			LeanTween.alphaCanvas(var_85_1, 0, 0.3):setFrom(1):setUseEstimatedTime(true)
			LeanTween.moveX(var_85_0, -var_84_2, 0.3):setFrom(0):setOnComplete(System.Action(function()
	...
	if arg_84_0.paintingCode and var_84_6 then
		...
		table.insert(var_84_5, function(arg_87_0)
			arg_84_0.nowPainting = var_84_6

			LoadPaintingPrefabAsync(var_84_6, var_84_0, arg_84_0.paintingCode, arg_84_0.paintingFrameName or "chuanwu", function()
				local var_88_0 = arg_84_0.shipVO:getCVIntimacy()
				local var_88_1 = arg_84_0:getInitmacyWords()

				ShipExpressionHelper.SetExpression(findTF(var_84_6, "fitter"):GetChild(0), arg_84_0.paintingCode, var_88_1, var_88_0)
				arg_87_0()
			end)
		end)
		table.insert(var_84_5, function(arg_89_0)
			...
			local var_89_0 = var_84_6:GetComponent(typeof(CanvasGroup))

			LeanTween.alphaCanvas(var_89_0, 1, 0.3):setFrom(0):setUseEstimatedTime(true)
		end)
	end
