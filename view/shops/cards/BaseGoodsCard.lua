...
function var_0_0.Ctor(arg_1_0, arg_1_1)
	...
	setActive(arg_1_0.tf:Find("group_locked"), false)
	setActive(arg_1_0.tf:Find("group_locked/Text"), i18n("shop_item_unobtained"))
	...
	setText(arg_1_0.sellEndTag, i18n("shop_sell_ended"))
