...
function var_0_0.findUI(arg_7_0)
	local var_7_0 = arg_7_0._tf:Find("Window/top/bg/obtain/title")

	setText(var_7_0, i18n("tec_speedup_title"))

	local var_7_1 = arg_7_0._tf:Find("Window")

	arg_7_0.backBtn = var_7_1:Find("top/btnBack")
	arg_7_0.bg = arg_7_0._tf:Find("BG")

	local var_7_2 = var_7_1:Find("Panel")
	local var_7_3 = var_7_2:Find("Task")

	arg_7_0.taskNameText = var_7_3:Find("Name/Text")
	arg_7_0.expProgressText = var_7_3:Find("ExpProgressText")
	arg_7_0.expProgressSlider = var_7_3:Find("Slider")
	arg_7_0.taskText = var_7_3:Find("TaskText")
	arg_7_0.progressNumText = var_7_3:Find("ProgressNumText")

	local var_7_4 = var_7_2:Find("ItemPanel")

	arg_7_0.itemIcon = var_7_4:Find("Item/Icon")
	arg_7_0.itemCountText = var_7_4:Find("Item/CountText")
	arg_7_0.itemNameText = var_7_4:Find("NameText")
	arg_7_0.minusBtn = var_7_4:Find("UsePanel/MinusBtn")
	arg_7_0.addBtn = var_7_4:Find("UsePanel/AddBtn")
	arg_7_0.maxBtn = var_7_4:Find("UsePanel/MaxBtn")
	arg_7_0.useCountText = var_7_4:Find("UsePanel/UseCountText")
	arg_7_0.confirmBtn = var_7_1:Find("ConfirmBtn")
	arg_7_0.helpBtn = var_7_1:Find("HelpBtn")
	arg_7_0.helpPanel = var_7_1:Find("HelpPanel")
