...
function var_0_0.initUITextTips(arg_5_0)
	local var_5_0 = arg_5_0._tf:Find("Window/top/bg/infomation/title")
	local var_5_1 = arg_5_0._tf:Find("Window/MetaSkillDetailBox/ExpDetail/ExpTipText")
	local var_5_2 = arg_5_0._tf:Find("Window/MetaSkillDetailBox/TipText")
...
function var_0_0.updateSkillTF(arg_11_0, arg_11_1, arg_11_2)
	...
	local var_11_10 = var_11_0:Find("Tag/unlockable")
